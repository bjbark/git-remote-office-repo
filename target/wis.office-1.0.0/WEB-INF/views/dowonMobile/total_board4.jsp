...
var arrs = new Array();
	$(document).ready(function(){
		...
		$('#select').change(function(){
			...
			$.ajax({																			//TODO 그리드 1
				url : _global.api_host_info+'/system/mobile/get/total_board4.do',
				data:{param:jsonData},
				type:"post",
				async: false,
				dataType : 'json',
...
// 			rowList : [10,20,30,40],
			viewrecords:true,
			colNames:['idcd','금형번호','부품명','공정명','현재상태','예상완료','보관처'],
			colModel: [
				...
				{name: 'prog_stat_dvcd', index : 'prog_stat_dvcd', width : '80px',formatter:dvcd, align:'center'},
				{name: 'edtm'          , index : 'edtm'          , width : '80px',formatter:dateFmt,align:'center'},
				{name: 'cstm_code'     , index : 'cstm_code'     , width : '80px'},
			],
// 	 		caption : "신작 금형",
...
<body>
	<jsp:include page="header.jsp">
		<jsp:param value="대기 부품" name="name"/>
	</jsp:include>
		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					...
					<li class="active"><a href="#">대기 부품 <span class="sr-only">(current)</span></a></li>
