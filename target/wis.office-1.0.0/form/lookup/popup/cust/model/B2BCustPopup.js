Ext.define('lookup.popup.cust.model.B2BCustPopup',{ extend:'Axt.data.Model', 
    fields: [
...
//   		 {name: 'stor_grp'      , type: 'string'  , defaultValue : _global.stor_grp },
    	     ...
    	     {name: 'memb_id'       , type: 'string'  },
    	     {name: 'memb_nm'       , type: 'string'  },
    	     {name: 'memb_gb'       , type: 'string'  , defaultValue : '3' },
    	     {name: 'memb_sts'      , type: 'string'  , defaultValue : '1' },
    	     {name: 'sale_gb'      , type: 'string'  , defaultValue : '1' }, /* 매출계정구분 0: 일반매출고객, 1: 매출계정고객 */
    	     {name: 'cust_sts'      , type: 'string'  },
    	     {name: 'sts_memo'      , type: 'string'  },
    	     {name: 'sales_man_id'   , type: 'string'  },
    	     {name: 'salesman_nm'   , type: 'string'  },
    	     {name: 'chnl'       , type: 'string'  },
			 ...
			 {name: 'biz_no' 		, type: 'string' , persist : false  , convert : Ext.util.Format.StrToBiz  }, /* 사업자 등록번호 */
			 {name: 'biz_nm' 		, type: 'string' , persist : false }, /* 사업자 등록명칭 */
			 {name: 'biz_kind' 		, type: 'string' , persist : false }, /* 사업자 업태 */
			 ...
			 {name: 'reve_hp_no' 	, type: 'string' , persist : false }, /* 수령지 전화번호 */
			 ...
			 {name: 'memb_addr1' 	, type: 'string' , persist : false }, /* 회원 주소 */
			 ...
			 {name: 'pri_no'       , type: 'int'    , defaultValue : 7 }, /* 판매가격번호 0:통합고객가격, 1~5:출하가, 6:소비자가, 7:포스가, 8:B2C가, 9.구매가, 10.직원가, 11:B2B */    	     
