/**
 */
Ext.define('lookup.popup.view.CstmPopup3', { extend: 'Axt.popup.Search',
	id		: 'lookup-cstm-popup3',
	alias	: 'widget.lookup-cstm-popup3',
	store	: 'lookup.popup.store.CstmPopup3',
	requires: [
		'lookup.popup.view.CstmClassPopup3',
	],
		...
		var  me = this,
			grid = {
				...
				columns: [
					...
					},{	text : Language.get( 'acpt_typl_char'	, '주문인식'   )	, dataIndex: 'acpt_typl_char'	, width: 60,
						renderer: function(value, meta){
							if(me.popup.params.tema){
								this.columns[0].width = 120;
								meta.style = 'font-size:2em !important;height:30px;line-height:30px;'; // applied style for DIV element
