/**
 */
Ext.define('lookup.popup.view.WrhsPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-wrhs-popup',
	alias	: 'widget.lookup-wrhs-popup',
	store	: 'lookup.popup.store.WrhsPopup',

	title	: Language.get('wrhs_popup','창고 코드 찾기'),
	closable: true,
	autoShow: true,
	width	: 700,
	height	: 500,
