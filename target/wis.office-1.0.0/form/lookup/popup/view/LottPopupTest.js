/**
 */
Ext.define('lookup.popup.view.LottPopupTest', { extend: 'Axt.popup.Search',
	id: 'lookup-lott-popup-test',
	alias: 'widget.lookup-lott-popup-test',
	store: 'lookup.popup.store.LottPopupTest',
