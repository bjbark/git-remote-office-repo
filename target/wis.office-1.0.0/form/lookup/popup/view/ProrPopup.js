/**
 */
Ext.define('lookup.popup.view.ProrPopup', { extend: 'Axt.popup.Search',
	id		: 'lookup-pror-popup',
	alias	: 'widget.lookup-pror-popup',
	store	: 'lookup.popup.store.ProrPopup',
	title	: Language.get('','작업 지시 선택'),
	closable: true,
	autoShow: true,
	width	: 680,
	height	: 500,
	...
	searchForm: function(){
		var me = this,
			...
			layout: { type: 'vbox' },
			fieldDefaults: { height : 22, width : 260, labelWidth : 60},
			items :	[
				{	xtype : 'fieldset', layout: 'hbox',
					fieldDefaults: { width : 260, labelWidth : 60},
					items : [
						{	xtype		: 'label',
							text		: '품목',
							width		: 70,
	...
	createGrid: function(){
		var me = this,
			...
			columns:[
				...
				},{ dataIndex: 'cstm_code'		, text : Language.get('cstm_code'		,'거래처코드'	) , width : 100 , align : 'left',hidden : true
