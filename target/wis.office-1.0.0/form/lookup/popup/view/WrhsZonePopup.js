/**
 */
Ext.define('lookup.popup.view.WrhsZonePopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-wrhs-zone-popup',
	alias	: 'widget.lookup-wrhs-zone-popup',
	store	: 'lookup.popup.store.WrhsZonePopup',

	title	: Language.get('zone_popup','보관 위치 찾기'),
	closable: true,
	autoShow: true,
	width	: 700,
	height	: 500,
	...
	createGrid: function(){
		var me = this,
			grid = {
				...
				columns: [
					{	dataIndex: 'zone_idcd'	, text : Language.get('zone_idcd'	,'구역ID'	)	, width :  90	, hidden : true
