/**
 */
Ext.define('lookup.popup.view.WkctInspPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-wkct-insp-popup',
	alias	: 'widget.lookup-wkct-insp-popup',
	store	: 'lookup.popup.store.WkctInspPopup',

	title	: Language.get('wkct_popup','검사공정 코드 선택'),
	closable: true,
	autoShow: true,
	width	: 700,
	height	: 500,
