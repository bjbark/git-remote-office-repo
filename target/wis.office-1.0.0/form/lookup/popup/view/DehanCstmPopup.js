/**
 */
Ext.define('lookup.popup.view.DehanCstmPopup', { extend: 'Axt.popup.Search',
	id		: 'lookup-dehan-cstm-popup',
	alias	: 'widget.lookup-dehan-cstm-popup',
	 ...
	 createGrid: function(){
		var  me = this,
			grid = {
				...
				columns: [
					{	text : Language.get( 'buss_numb'	, '사업자등록번호'   )	, dataIndex: 'buss_numb'	, width : 100, align : 'center',
