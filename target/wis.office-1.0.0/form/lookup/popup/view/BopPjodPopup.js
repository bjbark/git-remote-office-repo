/**
 */
Ext.define('lookup.popup.view.BopPjodPopup', { extend: 'Axt.popup.Search',
	id: 'lookup-boppjod-popup',
	alias: 'widget.lookup-boppjod-popup',
	store: 'lookup.popup.store.BopPjodPopup',
