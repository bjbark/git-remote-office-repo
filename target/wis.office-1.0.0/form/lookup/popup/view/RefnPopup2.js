/**
 */
Ext.define('lookup.popup.view.RefnPopup2', { extend: 'Axt.popup.Search',
	id		: 'lookup-refn-popup2',
	alias	: 'widget.lookup-refn-popup2',
...
//				cls: tema,
				...
				columns: [
					...
					},{	text : Language.get( 'user_memo'		, '메모사항 ')	, dataIndex: 'user_memo'	, width : 100 ,
