Ext.define('lookup.popup.view.HntopItemTypePopup', { extend: 'Axt.popup.Search',

	alias	: 'widget.lookup-hntop-type-popup',
	store	: 'lookup.popup.store.HntopItemTypePopup',

	title	: Language.get('item_type_popup','창호 형태 찾기'),
	closable: true,
	autoShow: true,
	 ...
	 createGrid: function(){
			...
			grid = {
				...
				columns: [
					...
					},{ dataIndex: 'wdtp_name'		, text : Language.get('wdtp_name'		,'창호형태'		) , width : 250 , align : 'left'
					},{ dataIndex: ''				, text : Language.get(''				,'고유번호'		) , width : 120 , align : 'center'
					},{ dataIndex: 'wdtp_code'		, text : Language.get('wdtp_code'		,'창호형태 코드'	) , width : 100 , align : 'center'
