Ext.define('lookup.popup.view.CstmPopup4', { extend: 'Axt.popup.Search',
	alias	: 'widget.lookup-cstm-popup4',
	store	: 'lookup.popup.store.CstmPopup4',

	title	: Language.get('','사업자 조회'),
	closable: true,
	autoShow: true,
	//width	: 800,
	height	: 508,
								...
								{	xtype	: 'fieldset',
									...
									items	: [
										{	xtype	: 'label',
											...
											margin	: '3 10 0 0',
											flex	: 1,
											emptyText	: '사업자명 또는 사업자번호를 입력하세요....',
	 ...
	 */
	 createGrid: function(){
			...
			grid = {
				...
				columns: [
					{	dataIndex:	'buss_name'	, width: 150, align : 'center', text: Language.get( ''	, '회사명'			),
					},{	dataIndex:	'boss_name'	, width:  80, align : 'center', text: Language.get( ''	, '대표자명'		),
					},{	dataIndex:	'buss_numb'	, width: 100, align : 'center'  , text: Language.get( ''	, '사업자번호'		),
					},{	dataIndex:	'mail_addr'	, width: 100, align : 'center', text: Language.get( ''	, 'Email'	),
					},{	dataIndex:	'tele_numb'	, width: 100, align : 'center'  , text: Language.get( ''	, '전화번호'		),
					},{	dataIndex:	'post_code'	, width:  70, align : 'center', text: Language.get( ''	, '우편번호'			),
					},{	dataIndex:	'addr_1fst'	, width:  70, align : 'center' , text: Language.get( ''	, '주소1'		), 
						hidden : true
					}
				],
				listeners: {
	...
	selectAction: function(){
		console.log('_global.token_id', _global.token_id);
		var me = this,
			store = me.down('grid').getStore(),
			param = Ext.merge( me.down('form').getValues(), me.popup.params , {hq_id : 'N1000SJUNG'});
