/**
 */
Ext.define('lookup.popup.view.MoldPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-mold-popup',
	alias	: 'widget.lookup-mold-popup',
	store	: 'lookup.popup.store.MoldPopup',

	title	: Language.get('mold_code','금형 코드')+'찾기',
	closable: true,
	autoShow: true,
	width	: 700,
	height	: 500,
								...
								{	xtype	: 'fieldset',
									...
									items	: [
										{	xtype	: 'label',
											...
											margin	: '3 10 0 0',
											flex	: 1,
											emptyText	: Language.get('mold_code', '금형코드'	)+' 또는 '+Language.get('mold_name', '금형명')+'을 입력하세요....',
	...
	createGrid: function(tema){
		var me = this,
			grid = {
				...
				columns: [
					{	text: Language.get('wrsh_idcd'		, '창고id')		, dataIndex: 'mold_idcd'	, width : 150, hidden	: true,
					...
					},{	text: Language.get('mold_code'		, '금형코드')		, dataIndex: 'mold_code'	, width :  80, align	: 'center',
						renderer: function(value, meta){
							if(me.popup.params.tema){
					...
					},{	text: Language.get('mold_name'		, '금형명')		, dataIndex: 'mold_name'	, flex  : 1,
						renderer: function(value, meta){
							if(me.popup.params.tema){
					...
					},{	text: Language.get('afsv_tele_numb'	, 'AS전화번호')		, dataIndex: 'afsv_tele_numb', width : 160,
						renderer: function(value, meta){
							if(me.popup.params.tema){
					...
					},{	text: Language.get('grad_dvcd'		, '등급구분코드')	, dataIndex: 'grad_dvcd', width : 120, hidden	: true
