/**
 */
Ext.define('lookup.popup.view.ItemPopupV2', { extend: 'Axt.popup.Search',

	alias	: 'widget.lookup-item-popup-v2',
	store	: 'lookup.popup.store.ItemPopupV2',
	requires: [
	 ...
	 createGrid: function(){
			...
			grid = {
				...
				columns: [
					...
					},{	dataIndex:	'item_code'	, width:  95, align : 'center' , text: Language.get( 'item_idcd'      , '품목코드')
