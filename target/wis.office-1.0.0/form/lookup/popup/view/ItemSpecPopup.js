/**
 */
Ext.define('lookup.popup.view.ItemSpecPopup', { extend: 'Axt.popup.Search',

	alias	: 'widget.lookup-item-spec-popup',
	store	: 'lookup.popup.store.ItemSpecPopup',
	requires: [
