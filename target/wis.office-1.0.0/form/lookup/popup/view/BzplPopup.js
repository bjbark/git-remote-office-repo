/**
 */
Ext.define('lookup.popup.view.BzplPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-bzpl-popup',
	alias	: 'widget.lookup-bzpl-popup',
	store	: 'lookup.popup.store.BzplPopup',

	title	: Language.get('bzpl_popup','사업장 선택'),
	closable: true,
	autoShow: true,
	width	: 700,
	height	: 500,
	...
	createGrid: function(){
		var me = this,
			grid = {
				...
				columns: [
					{	text: Language.get('bzpl_idcd','사업장id')	, dataIndex: 'bzpl_code',  width : 150, hidden	: true
					},{	text: Language.get('bzpl_code','사업장코드')	, dataIndex: 'bzpl_code',  width :  80
					},{	text: Language.get('bzpl_name','사업장명')	, dataIndex: 'bzpl_name',  flex  : 1
					},{	text: Language.get('user_memo','비고')		, dataIndex: 'user_memo',  flex  : 2
