/**
 */
Ext.define('lookup.popup.view.WkrnPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-wkrn-popup',
	alias	: 'widget.lookup-wkrn-popup',
	store	:'lookup.popup.store.WkrnPopup',

	title	: Language.get('wkrn_popup','직급 코드 선택'),
	closable: true,
	autoShow: true,
	width	: 700,
	height	: 500,
	...
	createGrid: function(){
		...
		var me = this,
			grid = {
				...
				columns: [
					{	text: Language.get('wkrn_code','직급코드')	, dataIndex: 'wkrn_code',  width: 150 },
					{	text: Language.get('wkrn_name','직급명')	, dataIndex: 'wkrn_name',  flex  : 1  }
				],
				listeners: {
