/**
 */
Ext.define('lookup.popup.view.HdcoPopup', { extend: 'Axt.popup.Search',
	id   : 'lookup-hdco-popup',
	alias: 'widget.lookup-hdco-popup',
	store: 'lookup.popup.store.HdcoPopup',
	title: Language.get( 'hdco_mst' , '택배사 찾기') ,
	closable: true,
	autoShow: true,
	width: 700,
	height: 500,
	...
	createGrid: function(tema){
		var	me		= this,
			grid	= {
				...
				columns		:[
					{	text	: Language.get('hdco_dvcd'    , '택배사코드')	, dataIndex: 'hdco_dvcd'	, width: 100,
					...
					{	text		: Language.get('hdco_name'  , '본사명')	, dataIndex: 'hdco_name'	, width: 120,
						renderer: function(value, meta){
							if(me.popup.params.tema){
					...
					{	text	: Language.get('brch_name'    , '지점명'  )	, dataIndex: 'brch_name'	, width: 120 ,
						renderer: function(value, meta){
							if(me.popup.params.tema){
					...
					},{	text	: Language.get('tele_numb'    , '전화번호'  )	, dataIndex: 'tele_numb'	, width: 120 ,
						renderer: function(value, meta){
							if(me.popup.params.tema){
					...
					},{	text	: Language.get('hdph_numb'    , '휴대폰번호'  )	, dataIndex: 'hdph_numb'	, width: 120 ,
						renderer: function(value, meta){
							if(me.popup.params.tema){
