/**
 */
Ext.define('lookup.popup.item.UnitPopup', { extend: 'Axt.popup.Search',

    alias: 'widget.lookup-unit-popup',
    store: 'lookup.popup.item.store.UnitPopup',

    title:  Language.get('unit_popup','포장단위 찾기') ,
    closable: true,
    autoShow: true,
    width: 400,
    height: 500,
        ...
        var me = this,
        	grid = {
        		...
        		columns:[
             		...
             		{ text: Language.get('unt_cd' , '단위코드' ) , dataIndex: 'unt_cd',   flex  : 1  }
