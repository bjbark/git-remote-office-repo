Ext.define('lookup.popup.class.ClssMastPopup', { extend: 'Axt.popup.Search',
	alias	: 'widget.lookup-clss-mast-popup',
	store	: 'lookup.popup.class.store.ClssMastPopup',
...
//		me.selectAction();
								...
								{	xtype	: 'fieldset',
									...
									items	: [
										{	xtype	: 'label',
											...
											name	: 'clss_dvcd',
											margin	: '3 10 0 0',
											lookupValue	: resource.lookup('clss_dvcd'),
											value	: me.popup.params.search_code, 		//팝업을 부르는 프로그램에서 search_code 파라미터로 넘기기
											width	: 100,
											hidden	: true
										},{	name	: 'find_name',
											xtype	: 'searchfield',
	...
	selectAction: function(){
		...
		store.load({
			...
			callback:function(records, operation, success) {
				console.log(records);
				me.down('#itemclass4').getStore().removeAll();
				me.down('#itemclass3').getStore().removeAll();
				me.down('#itemclass2').getStore().removeAll();
