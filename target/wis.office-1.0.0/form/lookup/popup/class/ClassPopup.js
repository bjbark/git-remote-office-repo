 ...
 * 상품분류코드 팝업
 */
Ext.define('lookup.popup.class.ClassPopup', { extend: 'Axt.popup.Search',

	id   : 'lookup-class-popup',
    alias: 'widget.lookup-class-popup',
    store: 'lookup.popup.class.store.ClassPopup',
    		...
    		form = {
    			...
    			items		: [
    		 		{	xtype      : 'grid-panel',
    		 			...
    		 			columns    : [{ text: '대분류' , dataIndex: 'class_nm',  flex : 1  }],
    		 			listeners  : {
    		 			...
    		 			viewConfig : { loadMask: new Ext.LoadMask( me , { msg: Const.SELECT.mask }) },
    		 			store      : Ext.create( me.store ),
    		 			columns    : [{ text: '중분류' , dataIndex: 'class_nm',  flex : 1  }],
    		 			listeners  : {
    		 				itemclick : function (dv, record, item, index, e) {
    		 					me.selectRecord( record);
    		 				},
    		 			...
    		 			viewConfig : { loadMask: new Ext.LoadMask( me , { msg: Const.SELECT.mask }) },
    		 			store      : Ext.create( me.store ),
    		 			columns    : [{ text: '품목분류' , dataIndex: 'class_nm',  flex : 1  }],
    		 			listeners  : {
    		 				itemclick : function (dv, record, item, index, e) {
    		 					me.selectRecord( record);
    		 				},
