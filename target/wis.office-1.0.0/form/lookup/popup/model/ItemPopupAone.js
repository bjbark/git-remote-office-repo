Ext.define('lookup.popup.model.ItemPopupAone',{ extend:'Axt.data.Model',
	fields: [
		...
		},{	name: 'max_pric'			, type: 'float'		// 입고건 최근 30건중 최고 단가
		},{	name: 'clss_desc'			, type: 'string'		// 입고건 최근 30건중 최고 단가
