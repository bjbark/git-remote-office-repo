Ext.define('lookup.popup.model.MemberPopup',{ extend:'Axt.data.Model',
	fields: [
		...
		{	name: 'mond_yorn'		, type: 'string' },
		{	name: 'tued_yorn'		, type: 'string' },
		{	name: 'wedd_yorn'		, type: 'string' },
		{	name: 'thud_yorn'		, type: 'string' },
		{	name: 'frid_yorn'		, type: 'string' },
		{	name: 'satd_yorn'		, type: 'string' },
		{	name: 'sund_yorn'		, type: 'string' },
