Ext.define('lookup.popup.model.WorkCvicPopup',{ extend:'Axt.data.Model',
	fields: [
		{	name: 'code'                , type: 'string' 	/* 코드		*/
		},{ name: 'name'                , type: 'string' 	/* 명		*/
		},{ name: 'idcd'                , type: 'string' 	/* id		*/
		},{ name: 'otod'                , type: 'float' 	/* 외주여부		*/ , defaultValue : 0
