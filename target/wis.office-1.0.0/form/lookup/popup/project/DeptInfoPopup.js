Ext.define('lookup.popup.project.DeptInfoPopup', { extend: 'Axt.popup.Search',

    id   : 'lookup-deptinfo-popup',
    alias: 'widget.lookup-deptinfo-popup',
    store: 'lookup.popup.project.store.DeptInfoPopup',
    title: Language.get('dept_popup','department search'),
    closable: true,
    autoShow: true,
    width: 700,
    height: 500,
    ...
    createGrid: function(){
        var me = this, grid =
        {
            ...
            columns:[
             	{ text: Language.get('dept_cd' , 'dept code'    )	, dataIndex: 'dept_id', width: 100 } ,
             	{ text: Language.get('dept_nm' , 'department name'    )	, dataIndex: 'dept_nm', width: 150 }
           ],
            listeners: {
