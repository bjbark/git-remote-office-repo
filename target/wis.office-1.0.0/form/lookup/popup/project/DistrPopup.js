/**
 */
Ext.define('lookup.popup.project.DistrPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.lookup-distr-popup',
	store: 'lookup.popup.project.store.DistrPopup',
    title: '채널 선택',
    closable: true,
    autoShow: true,
    width: 700,
    ...
    createGrid: function(){
        var me   = this ,
        	grid = {
        		...
        		columns: [
        		 	{ text : '채널'  , dataIndex: 'distr_nm'  , width: 150 } ,
        		 	{ text : '메모사항'  , dataIndex: 'user_memo' , flex : 1 } ,
        		 	{ text : '관리코드'  , dataIndex: 'retail_chnl_id'  , width: 140 }
        		],
        		listeners: {
