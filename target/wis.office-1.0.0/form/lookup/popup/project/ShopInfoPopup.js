/**
 */
Ext.define('lookup.popup.project.ShopInfoPopup', { extend: 'Axt.popup.Search',

    alias: 'widget.lookup-shopinfo-popup',
    store: 'lookup.popup.project.store.ShopInfoPopup',
    ...
    createGrid: function(){
        var me = this, grid =
        {
            ...
            columns:
            [
                { text: Language.get(''      , '쇼핑몰 코드'   )   , dataIndex: 'shop_id'  ,   width: 100 },
                { text: Language.get(''      , '대표 도메인'   )   , dataIndex: 'shop_cd'  ,   width: 100 },
             	{ text: Language.get(''      , '쇼핑몰 이름'   )   , dataIndex: 'shop_nm'  ,   width: 180 }
            ],
            listeners: {
