Ext.define('module.prod.mold.moldlist.view.MoldListLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-moldlist-lister'			,
	selModel	: { selType: 'checkboxmodel', mode : 'SINGLE' },
	store		: 'module.prod.mold.moldlist.store.MoldList',
	border		: 0,
	columnLines : true,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'used_tons'		, text : Language.get('used_tons'		,'사출기(TON)'		) , width : 90  , align : 'right' , xtype : 'numericcolumn'
