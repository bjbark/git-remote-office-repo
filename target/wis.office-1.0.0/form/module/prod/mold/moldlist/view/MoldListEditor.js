Ext.define('module.prod.mold.moldlist.view.MoldListEditor', { extend: 'Axt.form.Editor',

	alias	: 'widget.module-moldlist-editor',
	height	: 480,
	layout	: {
	type	: 'border'
	},
	title			: Language.get('mold_info','금형 정보'),
	collapsible 	: true	,
	collapsed		: true	,
	getStore: function() {
		return Ext.getStore( 'module.prod.mold.moldlist.store.MoldListInvoice' );
	},
			...
			item = {
				...
				items			: [
					{	xtype	: 'fieldset', layout: 'hbox' ,padding:'0', border: 0,margin : '0 0 5 0',
						...
						name		: 'mold_name',
						width		: 340,
					},{	fieldLabel	: Language.get('mold_spec','금형규격'),
						xtype		: 'textfield',
						name		: 'mold_spec',
						width		: 340,
					},{	fieldLabel	: '거래처'	,
					...
					},{	fieldLabel	: Language.get('user_memo','금형상태'),
						xtype		: 'textarea',
						name		: 'user_memo',
						width		: 340,
						height		: 50
	...
	createTabs : function () {
		var me = this,
			item = {
				...
				margin	: 0,
				plain	: true,
				items	: [ me.createTab1(), me.createTab2(),{title : '첨부파일',xtype: 'module-moldlist-editorlister'},{title : '이동정보',xtype: 'module-moldlist-movelister'},me.createTab3()]
			}
		;
		return item;
	},
				...
				fieldDefaults	: { width : 200, labelWidth : 80, labelSeparator : '' , readOnly:true},
					items	: [
						{	xtype	: 'fieldset', layout: 'hbox' ,padding:'0', border: 0, margin:'10 0 0 0',
							...
							items	: [
								{	fieldLabel	: Language.get('mold_edtn_numb','금형판갯수'),						//temp
									xtype		: 'numericfield',
									width		: 200,
									name		: 'mold_edtn_numb'
							...
							items	: [
								{	fieldLabel	: Language.get('work_shot','작업Shot'),
									xtype		: 'numericfield',
									name		: 'work_shot',
								},{	fieldLabel	: Language.get('ejac_mchn','사출기기'),											//temp
									xtype		: 'textfield',
									width		: 200,
									name		: 'ejac_mchn',
								}
							...
							{	xtype		: 'form-panel',
								...
								items		: [
									{	xtype   : 'form-panel',
										...
										items: [
											{	xtype		: 'label' , text : '금형' ,margin : '5 0 0 195'
