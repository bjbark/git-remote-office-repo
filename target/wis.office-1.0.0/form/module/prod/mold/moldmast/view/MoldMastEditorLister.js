Ext.define('module.prod.mold.moldmast.view.MoldMastEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-moldmast-editorlister'			,
	store		: 'module.prod.mold.moldmast.store.MoldMastFile',
	border		: 0,
	columnLines : true,
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-moldmast-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
