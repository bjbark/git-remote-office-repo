Ext.define('module.prod.mold.moldcheck.view.MoldCheckListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-moldcheck-lister-master',
	store		: 'module.prod.mold.moldcheck.store.MoldCheckMaster',
