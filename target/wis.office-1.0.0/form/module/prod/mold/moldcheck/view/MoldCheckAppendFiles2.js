Ext.define('module.prod.mold.moldcheck.view.MoldCheckAppendFiles2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-moldcheck-file2'			,
	store		: 'module.prod.mold.moldcheck.store.MoldCheckFile2',
	border		: 0,
	columnLines : true,
