Ext.define('module.prod.mold.moldshot.view.MoldShotListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-moldshot-lister-master',
	store		: 'module.prod.mold.moldshot.store.MoldShotMaster',
