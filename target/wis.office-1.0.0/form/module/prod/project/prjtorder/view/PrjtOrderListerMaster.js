Ext.define('module.prod.project.prjtorder.view.PrjtOrderListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtorder-lister-master',
	store		: 'module.prod.project.prjtorder.store.PrjtOrderMaster',
