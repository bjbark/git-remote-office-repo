Ext.define('module.prod.project.prjtworkentry.view.PrjtWorkEntryEditor', { extend: 'Axt.form.Editor',

	alias: 'widget.module-prjtworkentry-editor',
	layout : {
	type: 'border'
	},
	title			: Language.get('',''),
	...
	getProd_qntt : function() {
		...
		if(!param.invc_numb){
			...
			if(!param.work_date){
				...
				Ext.Ajax.request({
					url		: _global.location.http() + '/prod/order/prjtworkentry/get/prod.do',
					params	: {
