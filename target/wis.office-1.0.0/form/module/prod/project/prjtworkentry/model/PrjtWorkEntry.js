Ext.define('module.prod.project.prjtworkentry.model.PrjtWorkEntry',{ extend:'Axt.data.Model',
	fields:
	[
		{	name: 'pjod_idcd'			, type: 'string' },		//프로젝트수주id
		{	name: 'work_schd_dvcd'		, type: 'string' },		//작업일정구분코드
		{	name: 'work_ordr_dvcd'		, type: 'string' },		//작업오더구분
		{	name: 'ordr_degr'			, type: 'string' },		//작업오더구분
		...
		{	name: 'sttm'				, type: 'string' ,convert : Ext.util.Format.strToTime, serialize: Ext.util.Format.timeToStr },    //시작시간
		{	name: 'edtm'				, type: 'string' ,convert : Ext.util.Format.strToTime, serialize: Ext.util.Format.timeToStr },    //종료시간
		...
		{	name: 'wker_idcd_4frt'		, type: 'string' },		//작업자ID4
		{	name: 'wker_idcd_5fit'		, type: 'string' },		//작업자ID5
