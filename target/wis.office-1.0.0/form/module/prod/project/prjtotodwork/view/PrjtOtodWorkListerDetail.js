Ext.define('module.prod.project.prjtotodwork.view.PrjtOtodWorkDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-prjtotodwork-lister-detail',

	store: 'module.prod.project.prjtotodwork.store.PrjtOtodWorkDetail',
