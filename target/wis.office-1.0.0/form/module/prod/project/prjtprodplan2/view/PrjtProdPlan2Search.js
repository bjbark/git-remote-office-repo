Ext.define('module.prod.project.prjtprodplan2.view.PrjtProdPlan2Search', { extend: 'Axt.form.Search',

	alias: 'widget.module-prjtprodplan2-search',
					...
					{	xtype		: 'fieldset',
						...
						items		:[
							{	xtype	: 'label',
								...
								listeners:{
									change:function(){
										me.down('[name=ordr_degr]').setValue("");
									}
								}
