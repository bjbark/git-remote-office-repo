Ext.define('module.prod.project.prjtprodplan2.view.PrjtProdPlan2Finder', { extend: 'Axt.form.Editor',

	alias: 'widget.module-prjtprodplan2-finder',
			...
			item = {
				...
				items			: [
					{	name	: 'prjt_idcd', xtype : 'textfield' , hidden : true
							...
							{	fieldLabel	: Language.get('pjod_idcd', '금형번호'),
								...
								popup		: {
									...
									result	: function(records, nameField, pairField){
										...
										var editor = Ext.ComponentQuery.query('module-prjtprodplan2-finder')[0],
										...
										var listerdetail = Ext.ComponentQuery.query('module-prjtprodplan2-lister-detail1')[0];
										var listerdetail3 = Ext.ComponentQuery.query('module-prjtprodplan2-lister-detail3')[0];
										listerdetail.getStore().load({
											params:{param:JSON.stringify({pjod_idcd:records[0].get('pjod_idcd')}) }
											, scope:me,
											callback:function(records, operation, success) {
												if (success) {
													listerdetail.getRootNode().expand();
													listerdetail.getSelectionModel().select(0);
													console.log(listerdetail.getStore());
												} else {
												}
											}
										});
						...
						listeners	:{
							render:function(val){
								var lister = Ext.ComponentQuery.query('module-prjtprodplan2-lister-detail1')[0],
