Ext.define('module.prod.project.prjtprodplan1.view.PrjtProdPlan1Finder', { extend: 'Axt.form.Editor',

	alias: 'widget.module-prjtprodplan1-finder',
			...
			item = {
				...
				items			: [
					{	name	: 'prjt_idcd', xtype : 'textfield' , hidden : true
							...
							{	fieldLabel	: Language.get('pjod_idcd', '금형번호'),
								...
								popup		: {
									...
									result	: function(records, nameField, pairField){
										...
										var editor = Ext.ComponentQuery.query('module-prjtprodplan1-finder')[0],
										...
										var listerdetail = Ext.ComponentQuery.query('module-prjtprodplan1-lister-detail1')[0];
										listerdetail.select({
						...
						listeners	:{
							render:function(val){
								var lister = Ext.ComponentQuery.query('module-prjtprodplan1-lister-detail1')[0],
				...
				fieldDefaults	: { width : 400, labelWidth : 100, labelSeparator : '' },
					items	: [
						{	xtype 	: 'panel',
							...
							fieldDefaults: { width : 200, labelWidth : 70, labelSeparator : '' },
							items		: [
								{	fieldLabel : '계산서메일'	, name : 'mail_addr'	, xtype : 'textfield'	, vtype : 'email'	, readOnl		: true , onwerEditing : true, width:200,labelWidth:70
