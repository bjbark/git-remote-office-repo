Ext.define('module.prod.jig.jigcheck.model.JigCheckMaster',{ extend:'Axt.data.Model',
	fields:
	[
		...
		{	name: 'mngt_dept_name'		, type: 'string' },		//관리부서ID
		{	name: 'aset_idcd'			, type: 'string' },		//자산ID
		{	name: 'aset_name'			, type: 'string' },		//자산명
		{	name: 'puch_cstm_idcd'		, type: 'string' },		//구매거래처ID
		{	name: 'puch_cstm_name'		, type: 'string' },		//구래거래처명
		{	name: 'vend_tele_numb'		, type: 'string' },		//구래거래처전화번호
		{	name: 'afsv_tele_numb'		, type: 'string' },		//AS전화번호
		{	name: 'sral_numb_strt'		, type: 'float'  },		//시리얼번호시작
		{	name: 'sral_numb_endd'		, type: 'string' },		//시리얼번호저장
		...
		{	name: 'norm_ivst_date'		, type: 'string' },		//양산투입일자
		{	name: 'jigg_usge'			, type: 'string' },		//지그용도
		{	name: 'puch_amnt'			, type: 'float' },		//구매금액
		{	name: 'dsse_date'			, type: 'string'  },	//폐기일자
		...
		{	name: 'cvic_tpye_dvcd'		, type: 'string'  },	//설비형식구분코드
		{	name: 'cvic_abty'			, type: 'string'  },	//설비능력
		{	name: 'labo_rate_idcd'		, type: 'string'  },	//임율ID
		{	name: 'dept_name'			, type: 'string'  },	//관리부서
