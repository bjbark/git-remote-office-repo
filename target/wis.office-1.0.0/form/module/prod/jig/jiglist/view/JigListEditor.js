Ext.define('module.prod.jig.jiglist.view.JigListEditor', { extend: 'Axt.form.Editor',

	alias: 'widget.module-jiglist-editor',
	...
	createTabs : function () {
		var me = this,
			jig = {
				...
				margin	: 0,
				plain	: true,
				items	: [ me.createTab1(), me.createTab2(), me.createTab3(), {title : '첨부파일',xtype: 'module-jiglist-editorlister'}]
			}
		;
		return jig;
	},
