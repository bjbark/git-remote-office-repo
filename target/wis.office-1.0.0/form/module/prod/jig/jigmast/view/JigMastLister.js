Ext.define('module.prod.jig.jigmast.view.JigMastLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-jigmast-lister',
	store		: 'module.prod.jig.jigmast.store.JigMast',
