Ext.define('module.prod.plan.prodplanv2.view.ProdPlanV2Lister2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prodplanv2-lister2',
	store		: 'module.prod.plan.prodplanv2.store.ProdPlanV22',
	...
	columnItem : function () {
		var me = this,
			...
			items : [
				...
				},{	dataIndex: 'plan_qntt'		, width:  70, text: Language.get('plan_qntt'		, '계획수량'		), align:'right'	, xtype : 'numericcolumn' , summaryType : 'sum' , hidden : true
