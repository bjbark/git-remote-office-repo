Ext.define('module.prod.plan.prodplan.model.ProdPlan3', { extend:'Axt.data.Model',
	fields : [
		...
		},{	name : 'prod_qntt'			, type : 'float'		//지시수량
		},{	name : 'qntt'				, type : 'float'		//잔량(지시수량-생산수량)
		},{	name : 'unit_idcd'			, type : 'string'		//단위ID
		},{	name : 'indn_qntt'			, type : 'float'		//지시수량
		},{	name : 'plan_strt_dttm'		, type : 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.dateToStr		//작업시작시간
		},{	name : 'plan_endd_dttm'		, type : 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.dateToStr		//작업시작시간
		},{	name : 'work_strt_dttm'		, type : 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.dateToStr		//작업시작시간
		},{	name : 'prod_endd_dttm'		, type : 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.dateToStr		//작업종료시간
		},{	name : 'prod_strt_dttm'		, type : 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.dateToStr		//생산시작시간
		...
		},{	name : 'acpt_remk_text'		, type : 'string'		//협력사변경사유
		},{	name : 'invc_qntt'			, type : 'float'		//발주수량
		},{	name : 'deli_date'			, type : 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr	//협력사납기일자
		},{	name : 'deli_chge_resn'		, type : 'string'		//후공정
		},{	name : 'pckg_bacd'			, type : 'string'		//포장분류코드
		},{	name : 'pckg_qntt'			, type : 'float'		//포장수량
		},{	name : 'sum_indn_qntt'		, type : 'float'		//총수주량
		},{	name : 'cstm_offr_date'		, type : 'string'		//고객발주일자
