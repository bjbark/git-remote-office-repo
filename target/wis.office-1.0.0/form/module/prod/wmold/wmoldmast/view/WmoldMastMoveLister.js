Ext.define('module.prod.wmold.wmoldmast.view.WmoldMastMoveLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-wmoldmast-movelister',
	border		: 0,
//	store	: 'module.prod.wmold.wmoldmast.store.WmoldMastMove',
//	store	: 'module.prod.wmold.wmoldmast.store.WmoldMastInvoice',
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-wmoldmast-movesearch'}];
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex: 'move_date'			, text : Language.get('move_date'			,'일자'	)		, width  : 220 , align : 'center',
					...
					},{ dataIndex: 'move_memo'			, text : Language.get('move_memo'			,'이동목적')		, width  : 240 ,
					},{ dataIndex: 'wrhs_idcd'			, text : Language.get('wrhs_idcd'			,'보관장소')		, width  : 240 ,
					}
				],
			}
		;
