Ext.define('module.prod.wmold.wmoldcheck.WmoldCheck', { extend:'Axt.app.Controller',
	...
	models	: [
		'module.prod.wmold.wmoldcheck.model.WmoldCheckMaster',
		'module.prod.wmold.wmoldcheck.model.WmoldCheckDetail1',
		'module.prod.wmold.wmoldcheck.model.WmoldCheckDetail2',
		'module.prod.wmold.wmoldcheck.model.WmoldCheckFile1',
		'module.prod.wmold.wmoldcheck.model.WmoldCheckFile2'
	],
	stores	: [
		'module.prod.wmold.wmoldcheck.store.WmoldCheckMaster',
		'module.prod.wmold.wmoldcheck.store.WmoldCheckDetail1',
		'module.prod.wmold.wmoldcheck.store.WmoldCheckDetail2',
		'module.prod.wmold.wmoldcheck.store.WmoldCheckFile1',
		'module.prod.wmold.wmoldcheck.store.WmoldCheckFile2'
	],
	views	: [
		'module.prod.wmold.wmoldcheck.view.WmoldCheckLayout',
		'module.prod.wmold.wmoldcheck.view.WmoldCheckSearch',
		'module.prod.wmold.wmoldcheck.view.WmoldCheckListerMaster',
		'module.prod.wmold.wmoldcheck.view.WmoldCheckListerDetail1',
		'module.prod.wmold.wmoldcheck.view.WmoldCheckListerDetail2',
		'module.prod.wmold.wmoldcheck.view.WmoldCheckEditor1',
		'module.prod.wmold.wmoldcheck.view.WmoldCheckEditor2',
		'module.prod.wmold.wmoldcheck.view.WmoldCheckAppendFiles1',
		'module.prod.wmold.wmoldcheck.view.WmoldCheckAppendFiles2'
	],
	...
	init: function() {
		...
		me.control({
			// layout event
			'module-wmoldcheck-layout button[action=selectAction]'          : { click : me.selectAction },	// 조회
			'module-wmoldcheck-layout #detail'                              : { tabchange : me.selectDetail },
			// lister detail1 event
			'module-wmoldcheck-lister-detail1 button[action=modifyAction]'  : { click : me.modifyAction },	// 수정
			'module-wmoldcheck-lister-detail1 button[action=insertAction]'  : { click : me.insertAction },	// 신규
			'module-wmoldcheck-lister-detail1 button[action=exportAction]'  : { click : me.exportAction },	// 엑셀
			'module-wmoldcheck-lister-detail1 button[action=deleteAction]'  : { click : me.deleteAction },	// 삭제

			// lister2 detail event
			'module-wmoldcheck-lister-detail2 button[action=modifyAction]'  : { click : me.modifyAction1 },	// 수정
			'module-wmoldcheck-lister-detail2 button[action=insertAction]'  : { click : me.insertAction1 },	// 신규
			'module-wmoldcheck-lister-detail2 button[action=exportAction]'  : { click : me.exportAction1 },	// 엑셀
			'module-wmoldcheck-lister-detail2 button[action=deleteAction]'  : { click : me.deleteAction1 },	// 삭제

			// editer event
			'module-wmoldcheck-editor1 button[action=updateAction]'         : { click : me.updateAction },	// 저장
			'module-wmoldcheck-editor1 button[action=cancelAction]'         : { click : me.cancelAction },	// 취소

			// editer event
			'module-wmoldcheck-editor2 button[action=updateAction]'         : { click : me.updateAction1 },	// 저장
			'module-wmoldcheck-editor2 button[action=cancelAction]'         : { click : me.cancelAction1 },	// 취소
			// lister master event
			'module-wmoldcheck-lister-master' : {
				itemdblclick : me.selectDetail ,
				selectionchange : me.attachRecord
			},
			'module-wmoldcheck-lister-detail1' : {
				selectionchange : me.attachRecord2
			},
			'module-wmoldcheck-lister-detail2' : {
	...
	pocket : {
		layout			: function () { return Ext.ComponentQuery.query('module-wmoldcheck-layout')[0] },
		search			: function () { return Ext.ComponentQuery.query('module-wmoldcheck-search')[0] },
		listermaster	: function () { return Ext.ComponentQuery.query('module-wmoldcheck-lister-master')[0] },
		listerdetail1	: function () { return Ext.ComponentQuery.query('module-wmoldcheck-lister-detail1')[0] },
		listerdetail2	: function () { return Ext.ComponentQuery.query('module-wmoldcheck-lister-detail2')[0] },
		editor1			: function () { return Ext.ComponentQuery.query('module-wmoldcheck-editor1')[0] },
		editor2			: function () { return Ext.ComponentQuery.query('module-wmoldcheck-editor2')[0] },
		file1			: function () { return Ext.ComponentQuery.query('module-wmoldcheck-file1')[0] },
		file2			: function () { return Ext.ComponentQuery.query('module-wmoldcheck-file2')[0] },
	},
