Ext.define('module.prod.wmold.wmoldcheck.view.WmoldCheckListerDetail1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-wmoldcheck-lister-detail1',
	store		: 'module.prod.wmold.wmoldcheck.store.WmoldCheckDetail1',
