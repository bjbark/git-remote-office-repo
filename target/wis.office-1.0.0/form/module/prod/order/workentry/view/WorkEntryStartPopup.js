Ext.define('module.prod.order.workentry.view.WorkEntryStartPopup', { extend: 'Axt.popup.Upload',
	alias		: 'widget.module-workentry-popup-start'			,
...
//									}
							...
							items	: [
								...
								},{	name : 'wigh_wker_idcd', xtype : 'textfield' , hidden : true,
								},
							]
						},{	xtype	: 'panel',
							layout	: 'hbox',
...
//				features	: [{ ftype : 'grid-summary' }],
				...
				store: Ext.create('Ext.data.Store', {
					fields: ['line_seqn','item_code', 'item_name', 'mixx_rate','ostt_qntt','lott_numb','stnd_unit_qntt','used'],
