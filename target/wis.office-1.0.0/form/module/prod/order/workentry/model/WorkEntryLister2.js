Ext.define('module.prod.order.workentry.model.WorkEntryLister2',{ extend:'Axt.data.Model',
	fields:
	[
		...
		{	name: 'poor_type_name'		, type: 'string' },		//불량유형구분명
		...
		{	name: 'insp_strt_time'		, type: 'string' },		//시작시간
		{	name: 'insp_endd_time'		, type: 'string' },		//종료시간
		{	name: 'cvic_name'			, type: 'string' },		//설비명
		{	name: 'insp_cvic_idcd'		, type: 'string' },		//설비ID
