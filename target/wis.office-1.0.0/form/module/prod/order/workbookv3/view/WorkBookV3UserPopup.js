Ext.define('module.prod.order.workbookv3.view.WorkBookV3UserPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-workbookv3-user-popup',
	alias	: 'widget.lookup-workbookv3-user-popup',
	store	: 'module.prod.order.workbookv3.store.WorkBookV3UserPopup',
