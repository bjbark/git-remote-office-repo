Ext.define('module.prod.order.workbookv2.view.WorkBookV2Detail1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workbookv2-detail1'			,
	store		: 'module.prod.order.workbookv2.store.WorkBookV2Detail1',
