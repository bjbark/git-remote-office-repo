Ext.define('module.prod.order.workbookv2.model.WorkBookV2',{ extend:'Axt.data.Model',
	fields : [
		...
		{name: 'prod_date'				, type: 'string', defaultValue : Ext.Date.format(new Date(),'Ymd'), convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr},	//생산일자
		...
		{name: 'wkct_name'				, type: 'string' },		//공정ID
		...
		{name: 'deff_qntt'				, type: 'float' },		//잔량
		{name: 'good_perc'				, type: 'float' },		//양품률
		{name: 'acum_qntt'				, type: 'float' },		//누적
		{name: 'loss_qntt'				, type: 'float' },		//
		{name: 'total'					, type: 'float' },		//금액
		{name: 'work_eddt'				, type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr},		//작업종료일
		{name: 'work_edtm'				, type: 'string' , convert : Ext.util.Format.strToTime, serialize: Ext.util.Format.timeToStr},		//작업종료시간
		{name: 'work_stdt'				, type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr},		//작업종료일
		{name: 'work_sttm'				, type: 'string' , convert : Ext.util.Format.strToTime, serialize: Ext.util.Format.timeToStr},		//작업종료시간
		...
		{name: 'cstm_offr_date'			, type: 'string' },		//발주일자
		{name: 'deli_date'				, type: 'string' },		//협력사납기일자
		{name: 'wker_name'				, type: 'string' },		//작업자
		{name: 'mold_repa'				, type: 'string' },		//
