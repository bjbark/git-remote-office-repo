Ext.define('module.prod.order.lotchange.view.LotChangeWorkerSearch', { extend: 'Axt.form.Search',
	store	: 'module.prod.order.lotchange.store.LotChangeInvoice',
	alias	: 'widget.module-lotchange-worker-search',
