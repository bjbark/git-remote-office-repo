Ext.define('module.prod.order.prodrealtime.view.ProdRealTimeChart2', { extend: 'Axt.form.Panel',
	alias		: 'widget.module-prodrealtime-chart2',
	...
	drawChart:function() {
		var store = Ext.ComponentQuery.query('module-prodrealtime-lister2')[0].getStore();
		store.on("datachanged", function(){
			...
			for(var i = 0; i<store.data.items.length; i++){
				var temp = [];
				temp.push(store.data.items[i].data.item_name);
