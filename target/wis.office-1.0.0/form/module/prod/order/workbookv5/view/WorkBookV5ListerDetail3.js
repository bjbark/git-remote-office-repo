Ext.define('module.prod.order.workbookv5.view.WorkBookV5ListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workbookv5-detail3'			,
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-workbookv5-detailSearch'}];
		...
		var me = this,
			item = {
				...
				items : [
					{	dataIndex: 'prog_stat_dvcd'	, text : Language.get('prog_stat_dvcd'	,'상태'		) , width	: 70	, xtype : 'lookupcolumn', lookupValue : resource.lookup('prog_stat_dvcd'), align : 'center'
					},{ dataIndex: 'wkct_name'		, text : Language.get('wkct_name'		,'공정'		) , width	: 100	, align : 'center'
					},{ dataIndex: 'invc_numb'		, text : Language.get('acpt_numb'		,'수주번호'	) , width	: 165	, align : 'center'
						...
						renderer: function(val,meta,rec) {
							var id     = Ext.id(),
								search = Ext.ComponentQuery.query('module-workbookv5-detailSearch')[0]
	...
	insert : function (rec) {
		var search = Ext.ComponentQuery.query('module-workbookv5-detailSearch')[0],
			store = this.getStore(),
