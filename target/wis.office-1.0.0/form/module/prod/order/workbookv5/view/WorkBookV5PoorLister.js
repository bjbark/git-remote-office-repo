Ext.define('module.prod.order.workbookv5.view.WorkBookV5PoorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workbookv5-poor'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.prod.order.workbookv5.store.WorkBookV5PoorLister',
	border		: 0,
	...
	listeners:{
		afterrender:function(){
			var store = Ext.ComponentQuery.query('module-workbookv5-poor')[0].getStore(),
