Ext.define('module.prod.order.workbook.view.WorkBookListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workbook-lister-detail3',
	store		: 'module.prod.order.workbook.store.WorkBookDetail3',
