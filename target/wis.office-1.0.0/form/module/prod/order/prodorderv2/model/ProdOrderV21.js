Ext.define('module.prod.order.prodorderv2.model.ProdOrderV21',{ extend:'Axt.data.Model',
	fields : [
		...
		{	name: 'strt_dttm',			type: 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.dateToStr},		//작업시작일시
