Ext.define('module.prod.order.prodorderv2.model.ProdOrderV2Detail',{ extend:'Axt.data.Model',
	fields : [
		{	name: 'invc_numb',				type: 'string'},		//INVOICE번호호
		...
		{	name: 'mtrl_bacd_name',			type: 'string'},		//재질분류명
		...
		{	name: 'pref_rank',				type: 'string', defaultValue : '1'},		//우선순위
		...
		{	name: 'otod_yorn',				type: 'float' },		//외주여부
		{	name: 'plan_strt_dttm',			type: 'string', convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.dateToStr},		//계획시작일시
		{	name: 'plan_endd_dttm',			type: 'string', convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.dateToStr},		//계획종료일시
		...
		{	name: 'item_code',				type: 'string' },		//품번
		{	name: 'bzpl_name',				type: 'string' },		//사업장명
		{	name: 'wkct_name',				type: 'string' },		//공정명
		{	name: 'mold_name',				type: 'string' },		//금형명
		{	name: 'wkct_item_name',			type: 'string' },		//공정품명
		{	name: 'prod_dept_name',			type: 'string' },		//생산부서명
		{	name: 'unit_name',				type: 'string' },		//단위명
		{	name: 'plan_strt_date',			type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr },		//계획일
		{	name: 'plan_strt_time',			type: 'string' , convert : Ext.util.Format.strToTime, serialize: Ext.util.Format.TimeToStr },		//계획시간
		{	name: 'plan_endd_date',			type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr },		//계획종료일
		{	name: 'plan_endd_time',			type: 'string' , convert : Ext.util.Format.strToTime, serialize: Ext.util.Format.TimeToStr },		//계획종료시간
