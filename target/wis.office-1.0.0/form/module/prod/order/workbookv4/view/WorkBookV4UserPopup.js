Ext.define('module.prod.order.workbookv4.view.WorkBookV4UserPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-workbookv4-user-popup',
	alias	: 'widget.lookup-workbookv4-user-popup',
	store	: 'module.prod.order.workbookv4.store.WorkBookV4UserPopup',
