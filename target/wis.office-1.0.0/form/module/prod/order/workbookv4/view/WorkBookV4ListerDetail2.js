Ext.define('module.prod.order.workbookv4.view.WorkBookV4ListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workbookv4-detail2'			,
	selModel	: { selType: 'checkboxmodel', mode : 'SINGLE' },
	store		: 'module.prod.order.workbookv4.store.WorkBookV4Detail2',
	border		: 0,
												...
												change	: function(){
													...
													if(select.get('prod_qntt') != val){
														if(val==null||val==''){
															...
															Ext.Ajax.request({
																url			: _global.api_host_info + '/' + _global.app_site + '/prod/order/workbookv4/set/prod_qntt.do',
																method		: "POST",
																params		: {
																	token	: _global.token_id,
																	param	: Ext.encode({
										...
										{	fieldLabel	: Language.get('remk_text','비고사항'),
											...
											listeners	:{
												change	: function(){
													...
													if(val!=''){
														Ext.Ajax.request({
															url			: _global.api_host_info + '/' + _global.app_site + '/prod/order/workbookv4/set/stat_dvcd_update.do',
															method		: "POST",
															params		: {
																token	: _global.token_id,
																param	: Ext.encode({
