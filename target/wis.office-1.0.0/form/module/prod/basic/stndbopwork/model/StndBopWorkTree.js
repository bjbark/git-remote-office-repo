Ext.define('module.prod.basic.stndbopwork.model.StndBopWorkTree',{ extend:'Axt.data.Model',
	fields : [
		{	name: 'id'					, type: 'string'
		...
		},{	name: 'used_yorn'			, type: 'boolean', mapping : 'resource.used_yorn'
		},{	name: 'has_chld'			, type: 'string', mapping : 'resource.has_chld'
		},{	name: 'ordr_degr'			, type: 'string', mapping : 'resource.ordr_degr'
		},{	name: 'work_ordr_dvcd'			, type: 'string', mapping : 'resource.work_ordr_dvcd'
		}
	],
