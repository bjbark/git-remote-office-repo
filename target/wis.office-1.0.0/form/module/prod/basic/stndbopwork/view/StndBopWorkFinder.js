Ext.define('module.prod.basic.stndbopwork.view.StndBopWorkFinder', { extend: 'Axt.form.Editor',

	alias: 'widget.module-stndbopwork-finder',
					...
					{	name	: 'prjt_idcd', xtype : 'textfield' , hidden : true
							...
							{	fieldLabel	: Language.get('pjod_idcd', '금형번호'),
								...
								popup		: {
									...
									result	: function(records, nameField, pairField){
										...
										var editor = Ext.ComponentQuery.query('module-bopwork-finder')[0],
										...
										var listertree = Ext.ComponentQuery.query('module-bopwork-tree')[0];
						...
						listeners	:{
							change:function(){
								...
								var results;
								Ext.Ajax.request({
									url		: _global.location.http() + '/prod/basic/bopwork/get/getcstm.do',
									params	: {
