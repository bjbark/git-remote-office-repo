Ext.define('module.prod.basic.stndbopwork.view.StndBopWorkListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-stndbopwork-lister-detail3',
	store		: 'module.prod.basic.stndbopwork.store.StndBopWorkDetail3',
