Ext.define('module.prod.basic.stndbopwork.view.StndBopWorkSearch', { extend: 'Axt.form.Search',

	alias: 'widget.module-stndbopwork-search',
						...
						items		:[
							{	xtype	: 'label',
								...
								popup: {
									...
									params : { stor_grp : _global.stor_grp , line_stat : '0',work_ordr_dvcd : '1100', dvcd : 'stnd' },
