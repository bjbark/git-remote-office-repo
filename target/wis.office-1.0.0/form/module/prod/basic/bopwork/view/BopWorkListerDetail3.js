Ext.define('module.prod.basic.bopwork.view.BopWorkListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-bopwork-lister-detail3',
	store		: 'module.prod.basic.bopwork.store.BopWorkDetail3',
