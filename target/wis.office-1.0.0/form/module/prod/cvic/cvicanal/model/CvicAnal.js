Ext.define('module.prod.cvic.cvicanal.model.CvicAnal',{ extend:'Axt.data.Model',
	fields : [
		...
		{	name: 'lcls_idcd'			, type: 'string' },		//대분류
		{	name: 'mcls_idcd'			, type: 'string' },		//중분류
		{	name: 'scls_idcd'			, type: 'string' },		//소분류
