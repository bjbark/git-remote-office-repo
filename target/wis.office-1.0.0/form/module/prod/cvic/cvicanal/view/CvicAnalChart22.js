Ext.define('module.prod.cvic.cvicanal.view.CvicAnalChart22', { extend: 'Axt.form.Panel',
	alias		: 'widget.module-cvicanal-chart22',
	store		: 'module.prod.cvic.cvicanal.store.CvicChart4',
	...
	drawChart:function() {
		var store = Ext.getStore('module.prod.cvic.cvicanal.store.CvicChart4');
