Ext.define('module.prod.cvic.cviccheck.view.CvicCheckEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-cviccheck-editorlister'			,
	store		: 'module.prod.cvic.cviccheck.store.CvicCheckFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-cviccheck-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'cviccheck';											// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
