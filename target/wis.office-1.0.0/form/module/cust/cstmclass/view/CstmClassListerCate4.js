Ext.define('module.cust.cstmclass.view.CstmClassListerCate4', { extend: 'Axt.grid.Panel',


	plugins		: [{ ptype:'gridcolumnconfig'  } ],
	alias		: 'widget.module-cstmclass-lister-cate4',
	store		: 'module.cust.cstmclass.store.CstmClassCate4',
