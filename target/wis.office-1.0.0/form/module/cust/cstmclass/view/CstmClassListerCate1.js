Ext.define('module.cust.cstmclass.view.CstmClassListerCate1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-cstmclass-lister-cate1',
	store		: 'module.cust.cstmclass.store.CstmClassCate1',
	border		: 0,
