Ext.define('module.cust.cstmclass.view.CstmClassListerCate2', { extend: 'Axt.grid.Panel',

	plugins		: [{ ptype:'gridcolumnconfig'  } ],
	alias		: 'widget.module-cstmclass-lister-cate2',
	store		: 'module.cust.cstmclass.store.CstmClassCate2',
