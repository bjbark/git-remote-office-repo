Ext.define('module.cust.cstmvist.view.view.CstmVistLister2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-cstmvist-lister2'			,
	store		: 'module.cust.cstmvist.store.CstmVistFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-cstmvist-lister2')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'cstm_vist_book';		// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
