Ext.define('module.cust.cstmprice.model.CstmPriceWorkerSearch', { extend:'Axt.data.Model',
	fields: [
		{	name: 'item_idcd'			, type: 'string' },		//품목ID
		{	name: 'item_code'			, type: 'string' },		//품목ID
		{	name: 'item_name'			, type: 'string' },		//품목ID
		{	name: 'item_name2'			, type: 'string' },		//품목ID
		{	name: 'item_spec'			, type: 'string' },		//품목규격
		{	name: 'item_spec2'			, type: 'string' },		//품목규격
		{	name: 'line_seqn'			, type: 'float'   , defaultValue : 1},		//순번
		{	name: 'cstm_idcd'			, type: 'string' },		//거래처ID
		{	name: 'cstm_name'			, type: 'string' },		//거래처명
		{	name: 'cont_date'			, type: 'string' , convert : Ext.util.Format.strToDateTime },		//계약일자
		...
		{	name: 'trmn_date'			, type: 'string' , convert : Ext.util.Format.strToDateTime },		//해지일자
		...
		{	name: 'item_clss_bacd_name2'	, type: 'string' },	//품목군
