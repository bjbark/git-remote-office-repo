Ext.define('module.cust.cstmprice.view.CstmPriceListerDetail1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-cstmprice-lister-detail1'			,
...
//		me.dockedItems = [{xtype: 'module-cstmprice-worker-search'}];
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'cstm_idcd'		, width: 100, align : 'center'	, text: Language.get('cstm_idcd'	, '거래처id'	), hidden : true
					},{	xtype	: 'actioncolumn',
						header	: '',
						width	: 20,
						align	: 'center',
							...
							{	iconCls	: Const.SELECT.icon,
								...
								handler	: function (grid, rowIndex, colIndex, item, e, record) {
									resource.loadPopup({
										...
										params	: { stor_grp : _global.stor_grp, line_stat : '0',puch_item_yorn : '1' },
					...
					},{	dataIndex:	'pric_dvcd', width:  80, align : 'left'	, text: Language.get('pric_dvcd', '단가구분'), hidden:true
								,value : '3000'
	...
	rowInsert: function(){
		var me			= this,
			myform		= Ext.ComponentQuery.query('module-cstmprice-lister-detail1')[0],
	 ...
	 ******************************************************************/
	rowDelete: function(){
		var myform	= Ext.ComponentQuery.query('module-cstmprice-lister-detail1')[0],
