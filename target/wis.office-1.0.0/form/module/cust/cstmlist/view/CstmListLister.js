Ext.define('module.cust.cstmlist.view.CstmListLister', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-cstmlist-lister',
	store		: 'module.cust.cstmlist.store.CstmList',
	border		: 0,
	columnLines	: true,
	...
	columnItem : function () {
		var me   = this,
			item =  {
				...
				items   : [
					{	dataIndex:	'cstm_idcd'			, width:  70, align : 'left' ,	text: Language.get( 'cstm_idcd'		, '거래처ID'		), hidden : true
					},{	dataIndex:	'cstm_code'			, flex :   1, align : 'center',	text: Language.get( 'cstm_code'		, '거래처코드'		)
					...
					},{	dataIndex:	'file_name'			, width: 100, align : 'center',	text: Language.get( ''				, '사업자등록증'		), hidden : true,
					...
					},{	dataIndex:	'mail_addr'			, width: 180, align : 'left',	text: Language.get( 'mail_addr'		, '이메일주소'		), hidden : true
					...
					},{	dataIndex:	'tele_numb_2snd'	, width:  80, align : 'left',	text: Language.get( 'tele_numb_2snd', '전화번호2'		), hidden : true
					},{	dataIndex:	'faxi_numb'			, width: 100, align : 'left',	text: Language.get( 'faxi_numb'		, '팩스번호'		), hidden : true
					},{	dataIndex:	'home_page_addr'	, width: 220, align : 'left',	text: Language.get( 'home_page_addr', '홈페이지주소'		), hidden : true
					},{	dataIndex:	'buss_numb'			, width: 100, align : 'left',	text: Language.get( 'buss_numb'		, '사업자등록번호'	), hidden : true
					...
					},{	dataIndex:	'tele_numb'			, width: 110, align : 'left',	text: Language.get( 'tele_numb'		, '전화번호'		), hidden : true
					},{	dataIndex:	'post_code'			, width:  60, align : 'center',	text: Language.get( 'post_code'		, '우편번호'		), hidden : true
					},{	dataIndex:	'addr_1fst'			, width: 200, align : 'left',	text: Language.get( 'addr_1fst'		, '주소'			), hidden : true
					},{	dataIndex:	'addr_2snd'			, width: 150, align : 'left',	text: Language.get( 'addr_2snd'		, '상세주소'		), hidden : true
...
//					},{	dataIndex:	'blto_idcd_1fst'	, width: 100, align : 'left',	text: Language.get( 'blto_idcd_1fst', '청구처ID1'		), hidden: true
//					},{	dataIndex:	'blto_idcd_2snd'	, width: 100, align : 'left',	text: Language.get( 'blto_idcd_2snd', '청구처ID2'		), hidden: true
//					},{	dataIndex:	'scrt_sett_dvcd'	, width:  80, align : 'left',	text: Language.get( 'scrt_sett_yorn', '담보설정'		), xtype: 'lookupcolumn' , lookupValue: resource.lookup( 'scrt_sett_dvcd' )
//					},{	dataIndex:	'scrt_sett_amnt'	, width:  90, align : 'right',	text: Language.get( 'scrt_sett_amnt', '담보설정금액'		), xtype: 'numericcolumn'  , summaryType: 'sum' , format:  '#,##0.00'
//					},{	dataIndex:	'crdt_name'			, width:  80, align : 'left',	text: Language.get( 'crdt_name'		, '신용등급'		)
					...
					},{	dataIndex:	'updt_dttm'			, width: 125, align : 'left',	text: Language.get( 'updt_dttm'		, '수정일시'		), hidden : true
					},{	dataIndex:	'crte_dttm'			, width: 125, align : 'left',	text: Language.get( 'crte_dttm'		, '생성일시'		), hidden : true
					},{	dataIndex:	'favo_numb'			, width:  60, align : 'center',	text: Language.get( ''				, '즐겨찾기'		), hidden : true
