Ext.define('module.workshop.sale.sale.salelist.view.SaleListLister3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-salelist-lister3',
	store		: 'module.workshop.sale.sale.salelist.store.SaleListLister3',
	border		: 0 ,
	columnLines : true ,
