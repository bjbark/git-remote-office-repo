Ext.define('module.workshop.sale.sale.salelist.SaleList', { extend : 'Axt.app.Controller',
	...
	models	: [
		'module.workshop.sale.sale.salelist.model.SaleListLister1',
		'module.workshop.sale.sale.salelist.model.SaleListLister2',
		'module.workshop.sale.sale.salelist.model.SaleListLister3',
		'module.workshop.sale.sale.salelist.model.SaleListLister4',
		'module.workshop.sale.sale.salelist.model.SaleListLister5'
	],
	stores	: [
		'module.workshop.sale.sale.salelist.store.SaleListLister1',
		'module.workshop.sale.sale.salelist.store.SaleListLister2',
		'module.workshop.sale.sale.salelist.store.SaleListLister3',
		'module.workshop.sale.sale.salelist.store.SaleListLister4',
		'module.workshop.sale.sale.salelist.store.SaleListLister5'
	],
	views	: [
		'module.workshop.sale.sale.salelist.view.SaleListLayout',
		'module.workshop.sale.sale.salelist.view.SaleListLister1',
		'module.workshop.sale.sale.salelist.view.SaleListLister2',
		'module.workshop.sale.sale.salelist.view.SaleListLister3',
		'module.workshop.sale.sale.salelist.view.SaleListLister4',
		'module.workshop.sale.sale.salelist.view.SaleListLister5',
		'module.workshop.sale.sale.salelist.view.SaleListSearch',
	],
