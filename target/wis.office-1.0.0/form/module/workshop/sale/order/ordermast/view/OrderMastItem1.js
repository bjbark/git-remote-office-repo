Ext.define('module.workshop.sale.order.ordermast.view.OrderMastItem1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-ordermast-lister-item1',
	store		: 'module.workshop.sale.order.ordermast.store.OrderMastItem1',
					...
					{	fieldLabel	: '생산라인',
						...
						popup		: {
							...
							result	: function(records, nameField, pairField){
								var editor = Ext.ComponentQuery.query('module-ordermast-worker-editor2')[0],
									editorMaster = Ext.ComponentQuery.query('module-ordermast-worker-editor')[0],
									values = editor.getValues(),
									masterval = editorMaster.getValues()
								;
								//TODO : 생산라인 선택시 공정 저장 서비스 만들어야함.
								Ext.Ajax.request({
									url		: _global.location.http() + '/custom/hjsys/sale/order/ordermast/set/wkfw.do',
									params	: {
