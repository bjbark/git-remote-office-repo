Ext.define('module.workshop.sale.order.ordermast.view.OrderMastCnslLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workshop-ordermast-cnsllister'			,
	store		: 'module.workshop.sale.order.ordermast.store.OrderMastCnslLister',
