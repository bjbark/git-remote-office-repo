Ext.define('module.workshop.sale.order.ordermast.view.OrderMastEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workshop-ordermast-editorlister'			,
	store		: 'module.workshop.sale.order.ordermast.store.OrderMastFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-workshop-ordermast-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
