Ext.define('module.workshop.sale.order.ordermast.view.OrderMastBomListMaster', { extend: 'Ext.tree.Panel',
	alias	: 'widget.module-ordermast-bomlistmaster',
	store	: 'module.workshop.sale.order.ordermast.store.OrderMastBomListMaster',
	border	: 0  ,
