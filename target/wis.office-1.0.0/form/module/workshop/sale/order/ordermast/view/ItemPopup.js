Ext.define('module.workshop.sale.order.ordermast.view.ItemPopup', { extend: 'Axt.popup.Search',
	alias	: 'widget.module-workshop-item-popup',
	store	: 'module.workshop.sale.order.ordermast.store.ItemPopup',

	title	: Language.get('disp_popup','품목종류 찾기'),
	closable: true,
	autoShow: true,
	width	: 400,
	height	: 230,
	...
	createGrid: function(){
		var me = this,
			grid = {
				...
				columns: [
					{	text: Language.get( 'clss_name'		, '상위메뉴'	), dataIndex:	'clss_name'			,minWidth: 120, align : 'left'
					},{	text: Language.get('clss_idcd'		, '메뉴명'	), dataIndex: 	'clss_idcd'			, hidden  : true
					}
				],
				listeners: {
