Ext.define('module.workshop.sale.order.ordermast.view.OrderMastProcLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workshop-ordermast-proclister'			,
	store		: 'module.workshop.sale.order.ordermast.store.OrderMastProcLister',
