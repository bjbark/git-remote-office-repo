Ext.define('module.workshop.sale.order.ordermast.view.OrderMastListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-ordermast-lister-detail',

	store: 'module.workshop.sale.order.ordermast.store.OrderMastDetail',
