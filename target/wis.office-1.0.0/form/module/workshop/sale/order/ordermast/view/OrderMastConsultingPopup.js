Ext.define('module.workshop.sale.order.ordermast.view.OrderMastConsultingPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-ordermast-consulting-popup',
	...
	finishAction: function(){
		var me = this,
			...
			store = Ext.ComponentQuery.query('module-ordermast-lister-detail2')[0].getStore()
		;
		var mask = new Ext.LoadMask(Ext.getBody(), {msg: Const.UPDATE.mask });
		mask.show();
		Ext.Ajax.request({
			url		: _global.location.http() + '/sale/order/ordermast/set/consulting.do',
			params	: {
