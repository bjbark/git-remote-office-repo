Ext.define('module.workshop.sale.order.ordermast.view.OrderMastSubItem', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-ordermast-lister-subItem',
	store		: 'module.workshop.sale.order.ordermast.store.OrderMastSubItem',
...
//					}
	...
	rowInsert: function(){
		...
		// ROW 추가
		store.add(record);
		Ext.ComponentQuery.query('module-ordermast-worker-editor4')[0].down('[name=modify]').setValue('Y');
