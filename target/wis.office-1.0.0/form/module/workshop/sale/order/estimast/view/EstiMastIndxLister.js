Ext.define('module.workshop.sale.order.estimast.view.EstiMastIndxLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workshop-estimast-indxlister'			,
	store		: 'module.workshop.sale.order.estimast.store.EstiMastIndxLister',
