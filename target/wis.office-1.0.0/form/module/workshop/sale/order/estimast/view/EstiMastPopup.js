Ext.define('module.workshop.sale.order.estimast.view.EstiMastPopup', { extend: 'Axt.popup.Upload',
	alias	: 'widget.module-estimast-popup'			,
...
//							}
	...
	finishAction : function (button) {
		...
		Ext.Ajax.request({
			url		: _global.location.http() + '/workshop/sale/order/estimast/set/covr.do',
			params	: {
				token : _global.token_id,
				param : JSON.stringify({
					invc_numb		: values.invc_numb,
					line_seqn		: values.line_seqn,
					assi_seqn		: values.line_seqn,
