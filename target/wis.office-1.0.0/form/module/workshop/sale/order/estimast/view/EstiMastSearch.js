Ext.define('module.workshop.sale.order.estimast.view.EstiMastSearch', { extend: 'Axt.form.Search',


	alias: 'widget.module-estimast-search',
	/**
	 *
	 */
					...
					{	xtype	: 'fieldset',
						...
						items	: [
							{	xtype	: 'label',
								...
								xtype		: 'searchfield',
								flex		: 4,
								emptyText	: '조회할 견적일자 또는 거래처코드를 입력하세요...',
