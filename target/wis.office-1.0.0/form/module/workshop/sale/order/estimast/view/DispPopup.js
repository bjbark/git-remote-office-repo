Ext.define('module.workshop.sale.order.estimast.view.DispPopup', { extend: 'Axt.popup.Search',
	alias	: 'widget.module-workshop-disp-popup',
	store	: 'module.workshop.sale.order.estimast.store.DispPopup',
