Ext.define('module.workshop.sale.order.estimast.view.EstiMastWorkerEditor2', { extend: 'Axt.form.Editor',

	alias	: 'widget.module-estimast-worker-editor2',
	height	: 180,
	header	: false,
	getStore: function() {
		return Ext.getStore( 'module.workshop.sale.order.estimast.store.EstiMastInvoice' );
	},
				...
				{	name	: 'dept_idcd', xtype : 'textfield' , hidden : true
					...
					items	: [
						...
						{	fieldLabel	: Language.get('rctr_name','수취인'),
							...
							width		: 65,
							margin		: '1 0 0 5'
						},{	name : 'modify', xtype	: 'textfield', hidden : false
						}
					]
				}
			]
