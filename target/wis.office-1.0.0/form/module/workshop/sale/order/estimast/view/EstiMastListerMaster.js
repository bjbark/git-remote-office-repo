Ext.define('module.workshop.sale.order.estimast.view.EstiMastListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-estimast-lister-master',
	store		: 'module.workshop.sale.order.estimast.store.EstiMastMaster',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'invc_numb'		, text : Language.get('invc_numb'		,'견적번호'	)	, width : 80 , align : 'center'
					...
					},{ dataIndex: 'mail_addr'		, text : Language.get('mmbr_name'		,'메일주소'	)	, width : 130
