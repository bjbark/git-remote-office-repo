Ext.define('module.workshop.sale.order.estilist.model.EstiList',{ extend:'Axt.data.Model',
	fields:
	[
	 // master + item
		...
		{name: 'regi_path_dvcd',		type: 'string', defaultValue : '1'},		//
...
//		{name: 'prod_cmpl_dttm',		type: 'string'},		//
...
//		{name: 'attc_file_yorn',		type: 'string'},		//첨부파일여부
//		{name: 'prod_cmpl_dttm',		type: 'string'},		//생산완료일시
...
//		{name: 'prod_cmpl_dttm',		type: 'string'},		//생산완료일시
		...
		{name: 'etcc_proc_amnt',		type: 'float ',defaultValue:0},		//기타가공금액
