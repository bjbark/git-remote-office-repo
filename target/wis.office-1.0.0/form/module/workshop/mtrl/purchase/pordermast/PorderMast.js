Ext.define('module.workshop.mtrl.purchase.pordermast.PorderMast', { extend : 'Axt.app.Controller',
	...
	models:[
		'module.workshop.mtrl.purchase.pordermast.model.PorderMastInvoice',
		'module.workshop.mtrl.purchase.pordermast.model.PorderMastMaster',
	],
	stores:[
		'module.workshop.mtrl.purchase.pordermast.store.PorderMastInvoice',
		'module.workshop.mtrl.purchase.pordermast.store.PorderMastMaster',
	],
	views : [
		'module.workshop.mtrl.purchase.pordermast.view.PorderMastLayout',
		/* 현황 */
		'module.workshop.mtrl.purchase.pordermast.view.PorderMastSearch',
		'module.workshop.mtrl.purchase.pordermast.view.PorderMastListerMaster',
		/* 작업 */
		'module.workshop.mtrl.purchase.pordermast.view.PorderMastWorkerEditor',
		'module.workshop.mtrl.purchase.pordermast.view.PorderMastWorkerSearch',
		'module.workshop.mtrl.purchase.pordermast.view.PorderMastWorkerLister',
	],
	...
	init: function() {
		var me = this;
		me.control({
			'module-pordermast-layout button[action=selectAction]'					: { click : me.selectAction       }, /* 조회 */
			'module-pordermast-layout #mainpanel'									: { tabchange : me.selectAction  },

			'module-pordermast-lister-master menuitem[action=closeActiveAction]'	: { click : me.closeAction        }, /* 마감 */
			'module-pordermast-lister-master menuitem[action=closeCancelAction]'	: { click : me.closeAction        }, /* 마감취소 */
			'module-pordermast-lister-master menuitem[action=okAction]'				: { click : me.okAction           }, /* 승인 */
			'module-pordermast-lister-master menuitem[action=okCancelAction]'		: { click : me.okCancelAction     }, /* 승인취소 */

			'module-pordermast-lister-master menuitem[action=closeAction]'			: { click : me.closeAction        }, /* 마감 */
			'module-pordermast-lister-master menuitem[action=closeCancelAction]'	: { click : me.closeCancelAction  }, /* 마감해지 */
			'module-pordermast-lister-master button[action=amendAction]'			: { click : me.amendAction        }, /* Amend */
			'module-pordermast-lister-master button[action=copyAction]'				: { click : me.copyAction         }, /* 수주복사 */
			'module-pordermast-lister-master button[action=orderAction]'			: { click : me.orderAction        }, /* 출고지시 */
			'module-pordermast-lister-master button[action=etcPrintAction]'			: { click : me.invReportAction    }, /* 명세서 발행 */
			'module-pordermast-lister-master button[action=insertAction]'			: { click : me.insertAction       }, /* 등록 */
			'module-pordermast-lister-master button[action=modifyAction]'			: { click : me.modifyAction       }, /* 수정 */
			'module-pordermast-lister-master button[action=exportAction]'			: { click : me.exportAction       }, /* 엑셀 */
			'module-pordermast-lister-master button[action=deleteAction]'			: { click : me.deleteAction       }, /* 삭제 */
			'module-pordermast-lister-master button[action=ganttAction]'			: { click : me.ganttAction        }, /* 일정보기 */
			'module-pordermast-lister-master button[action=uploadAction]'			: { click : me.excelUploadAction },
			'module-pordermast-lister-master button[action=pasteUploadAction]'		: { click : me.pasteUploadAction }, /* 엑셀 붙여 넣기 액션 */

			'module-pordermast-lister-detail2 button[action=consultingAction]'		: { click : me.consultingAction},	// 상담입력
			'module-pordermast-lister-detail2 button[action=resultAction]'			: { click : me.resultAction},		// 결과입력

			'module-pordermast-lister-detail2 button[action=test]'					: { click : me.test},		// test

			'module-pordermast-worker-lister button[action=updateAction]'			: { click : me.updateAction }, /* 저장 */
			'module-pordermast-worker-lister button[action=cancelAction]'			: { click : me.cancelAction }, /* 취소 */
		});
		me.callParent(arguments);
	},
	pocket : {
		layout : function () { return Ext.ComponentQuery.query('module-pordermast-layout')[0] },
		search : function () { return Ext.ComponentQuery.query('module-pordermast-search')[0] },
		worker : {
			editor : function () { return Ext.ComponentQuery.query('module-pordermast-worker-editor')[0] },
			lister : function () { return Ext.ComponentQuery.query('module-pordermast-worker-lister')[0] }
		},
		lister : {
			master  : function () { return Ext.ComponentQuery.query('module-pordermast-lister-master')[0] },
		},
	},
