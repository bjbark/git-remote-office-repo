Ext.define('module.qc.insp.inspentry5.view.InspEntry5Master', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-inspentry5-lister'			,
	selModel	: { selType: 'checkboxmodel', mode : 'SINGLE' },
	store		: 'module.qc.insp.inspentry5.store.InspEntry5Master',
	border		: 0,
	columnLines : true,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'lott_numb'		, text : Language.get('lott_numb'		,'Lot No')		, width : 120 , align : 'center'
