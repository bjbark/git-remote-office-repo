Ext.define('module.qc.insp.inspentry3.view.InspEntry3ListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-inspentry3-lister-detail',

	store: 'module.qc.insp.inspentry3.store.InspEntry3Detail',
