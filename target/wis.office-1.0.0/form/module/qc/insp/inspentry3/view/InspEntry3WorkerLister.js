Ext.define('module.qc.insp.inspentry3.view.InspEntry3WorkerLister', { extend: 'Axt.grid.Panel',
	alias: 'widget.module-inspentry3-worker-lister',
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-inspentry3-worker-search'}];
