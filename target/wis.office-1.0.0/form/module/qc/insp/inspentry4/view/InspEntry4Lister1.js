Ext.define('module.qc.insp.inspentry4.view.InspEntry4Lister1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-inspentry4-lister1',
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.qc.insp.inspentry4.store.InspEntry4Lister1',
	border		: 0,
	columnLines : true,
		...
		var me = this,
			item = {
				...
				items	: [
					...
					'->', '-' ,
					{	text : '<span class="write-button">바코드발행</span>', action : 'printAction', cls: 'button1-style',
	...
	insert : function () {
		...
		;
		if(tempa.getSelectionModel().selected.items[0]){
			selectItem = tempa.getSelectionModel().selected.items[0].data;
		}else{
			selectItem = selectMaster;
		}
		Ext.Ajax.request({
			url		: _global.location.http() + '/qc/insp/inspentry4/get/search.do',
			params	: {
		...
		var	form = Ext.widget('form', {
			...
			items:[
				{	xtype	: 'fieldset', layout: 'hbox' ,padding:'0', border: 0,margin : '0 0 5 0',
					items	: [
						{	fieldLabel	: Language.get('spts_numb','지시번호'),
							name		: 'spts_numb',
							xtype		: 'textfield',
							value		: selectItem.get('invc_numb'),
							width		: 250,
							readOnly	: true,
							...
							xtype		: 'numericfield',
							margin		: '0 0 0 10',
							value		: selectItem.get('line_seqn'),
							width		: 40,
							readOnly	: true,
							fieldCls	: 'readonlyfield',
	...
	//						value		: selectItem.acpt_numb,
							...
							name		: 'user_name',
							xtype		: 'textfield',
							value		: selectItem.get('dttr_name'),
							width		: 300,
							readOnly	: true,
							fieldCls	: 'readonlyfield',
					...
					items	: [
						{	fieldLabel	: Language.get('item_name','품명'),
							name		: 'item_name',
							xtype		: 'textfield',
							value		: selectItem.get('item_name'),
							width		: 300,
							readOnly	: true,
							fieldCls	: 'readonlyfield',
							...
							width		: 300,
							readOnly	: true,
							value		: selectItem.get('item_spec'),
							fieldCls	: 'readonlyfield',
