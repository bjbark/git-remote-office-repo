Ext.define('module.qc.basic.moldinspstd.view.MoldInspStdListerItem2', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-moldinspstd-lister-item2',
	store		: 'module.qc.basic.moldinspstd.store.MoldInspStdItem2',
		...
		var me = this,
			item = {
				...
				items	: [
					...
					},{ dataIndex: 'mold_idcd'		, text : Language.get('mold_idcd'		,'금형id')	, width :100  , align : 'center',hidden : true
