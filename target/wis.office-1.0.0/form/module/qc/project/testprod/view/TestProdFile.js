Ext.define('module.qc.project.testprod.view.TestProdFile', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-testprod-file'			,
	store		: 'module.qc.project.testprod.store.TestProdFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-testprod-file')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'testprod';		// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
