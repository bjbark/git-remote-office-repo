Ext.define('module.membership.basic.memberentry.view.MemberEntryMemoPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-memberentry-memo-popup',
	...
	finishAction: function(){
		var me = this,
			...
			store	= Ext.ComponentQuery.query('module-memberentry-memolister')[0].getStore(),
