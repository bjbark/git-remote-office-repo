Ext.define('module.membership.basic.memberentry.view.MemberEntryCrctLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-memberentry-crct-lister'			,
	store		: 'module.membership.basic.memberentry.store.MemberEntryCrct'	,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'stot_dvcd'	, width: 100, align : 'center'	, text: Language.get('stot_dvcd'	, '결제방법'		), xtype : 'lookupcolumn' , lookupValue : resource.lookup('stot_dvcd') , hidden: false
					},{	dataIndex: 'acct_nmbr'	, width: 130, align : 'center'	, text: Language.get('acct_nmbr'	, '입금계좌번호'	),
					},{	dataIndex: 'prtl_colt_yorn'	, width:  80, align : 'center'	, text: Language.get('prtl_colt_yorn', '일부수금여부'	), xtype : 'lookupcolumn' , lookupValue : resource.lookup('yorn') , hidden: false
