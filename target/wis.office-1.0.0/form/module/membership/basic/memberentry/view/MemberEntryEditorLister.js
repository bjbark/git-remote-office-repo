Ext.define('module.membership.basic.memberentry.view.MemberEntryEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-memberentry-editorlister'			,
	store		: 'module.membership.basic.memberentry.store.MemberEntryFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-memberentry-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
