Ext.define('module.membership.basic.memberentry.model.MemberEntryCrct', { extend:'Axt.data.Model',
	fields: [
		...
		{	name: 'prtl_colt_yorn'	, type: 'string' },
