Ext.define('module.membership.basic.memberlist.view.MemberListEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-memberlist-editorlister'			,
	store		: 'module.membership.basic.memberlist.store.MemberListFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-memberlist-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
