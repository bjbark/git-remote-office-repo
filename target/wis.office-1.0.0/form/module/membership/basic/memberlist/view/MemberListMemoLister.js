Ext.define('module.membership.basic.memberlist.view.MemberListMemoLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-memberlist-memolister'			,
	store		: 'module.membership.basic.memberlist.store.MemberListMemo'	,
