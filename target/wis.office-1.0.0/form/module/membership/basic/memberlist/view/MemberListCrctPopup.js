Ext.define('module.membership.basic.memberlist.view.MemberListCrctPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-memberlist-crct-popup',
		...
		form = {
			...
			items	: [
				{	xtype	: 'panel',
					...
					margin	: '6 0 0 0',
					items	: [
						{	fieldLabel	: Language.get('dwup_empy_idcd','수납사원'),
							xtype		: 'popupfield',
							editable	: true,
	...
	finishAction: function(){
		var me = this,
			...
			store	= Ext.ComponentQuery.query('module-memberlist-crct-lister')[0].getStore(),
