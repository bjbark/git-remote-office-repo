Ext.define('module.membership.basic.memberlist.view.MemberListLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-memberlist-lister'			,
	store		: 'module.membership.basic.memberlist.store.MemberList'	,
