Ext.define('module.project.tablemanager.model.TableManagerDomain',{ extend:'Axt.data.Model',
	fields: [
		{	name: 'prjt_dvsn'		, type: 'string'
		},{	name: 'fied_name'		, type: 'string'
		},{	name: 'fied_name_alis'		, type: 'string'
		},{	name: 'engl_fied_name'	, type: 'string'
		},{	name: 'dmin_name'		, type: 'string'
