Ext.define('module.project.tablemanager.view.TableManagerListerDomain', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-tablemanager-lister-domain',
	store		: 'module.project.tablemanager.store.TableManagerDomain',
	columnLines	: true ,
