Ext.define( 'module.project.projmenu.ProjMenu', { extend:'Axt.app.Controller',

	models:[
	 	'module.project.projmenu.model.ProjMenu'
	],
	stores: [
	  	'module.project.projmenu.store.ProjMenu'
	],
	views : [
	 	'module.project.projmenu.view.ProjMenuLayout',
	 	'module.project.projmenu.view.ProjMenuLister',
	 	'module.project.projmenu.view.ProjMenuSearch',
	 	'module.project.projmenu.view.ProjMenuEditor'
	],
	...
	init: function() {
		var me = this;
		me.control({
			'module-projmenu-layout button[action=selectAction]' : { click : me.selectAction }, // 조회
			'module-projmenu-editor button[action=updateAction]' : { click : me.updateAction }, // 저장
			'module-projmenu-editor button[action=cancelAction]' : { click : me.cancelAction }, // 취소
			'module-projmenu-lister button[action=insertAction]' : { click : me.insertAction }, // 신규
			'module-projmenu-lister button[action=modifyAction]' : { click : me.modifyAction }, // 수정
			'module-projmenu-lister button[action=deleteAction]' : { click : me.deleteAction }, // 삭제
			'module-projmenu-lister' : { selectionchange: me.selectRecord  }, //, itemclick : me.selectRecord
			'module-projmenu-lister dataview' : {nodedragover : me.nodeDragOver, beforedrop : me.beforeDrop, drop : me.finishDrop }
		});
		me.callParent(arguments);
	},

	pocket : {
		layout  : function () { return Ext.ComponentQuery.query('module-projmenu-layout')[0] } ,
		search  : function () { return Ext.ComponentQuery.query('module-projmenu-search')[0] } ,
		editor  : function () { return Ext.ComponentQuery.query('module-projmenu-editor')[0] } ,
		lister  : function () { return Ext.ComponentQuery.query('module-projmenu-lister')[0] }
	},
		...
		if (parent){
			editor.insertBefore({
				...
				callback : function (keygen){
					console.debug(keygen.records[0].seq)
					if (keygen.success){
						editor.insertRecord({
							record   : Ext.create( lister.getStore().model.modelName ,{
								id : keygen.records.seq,
								leaf : true,
