Ext.define('module.eis.project.eisreport.model.EisReportDetail2',{ extend:'Axt.data.Model',
	fields:
	[
		...
		{	name: 'sttm'				, type: 'string' ,convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr },    //시작시간
		{	name: 'edtm'				, type: 'string' ,convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr},    //종료시간
