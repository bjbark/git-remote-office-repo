Ext.define('module.eis.project.eisreport.view.EisReportListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-eisreport-lister-detail3',
		...
		var me = this,
			item = {
				...
				items	: [
					...
					},{ dataIndex: 'invc_date'	, text : Language.get('strt_aday'	,'착수일'		)	, width : 120 , align : 'center',
					},{ dataIndex: 'work_sttm'	, text : Language.get('strt_time'	,'착수시간'	)	, width : 80 , align : 'center',
