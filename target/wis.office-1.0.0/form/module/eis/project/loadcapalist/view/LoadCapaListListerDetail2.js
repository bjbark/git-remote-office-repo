Ext.define('module.eis.project.loadcapalist.view.LoadCapaListListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-loadcapalist-lister-detail2',
		...
		var me = this,
			...
			item = {
				...
				items : [
					...
					},{ dataIndex: 'drtr_name'		, text : Language.get('drtr_name'	,'영업담당')		, width : 130 , align : 'center'
