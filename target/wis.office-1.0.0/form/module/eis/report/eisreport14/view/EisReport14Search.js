Ext.define('module.eis.report.eisreport14.view.EisReport14Search', { extend: 'Axt.form.Search',

	alias: 'widget.module-eisreport14-search',
						...
						items	: [
							{	fieldLabel	: Language.get('item_name','품목코드'),
								...
								popup		: {
									...
									params	: { stor_grp : _global.stor_grp , line_stat : '0', prnt_idcd : '1402' },
									result	: function(records, nameField, pairField) {
