Ext.define('module.eis.report.eisreport13.view.EisReport13Search', { extend: 'Axt.form.Search',

	alias: 'widget.module-eisreport13-search',
						...
						items	: [
							{	fieldLabel	: Language.get('item_name','품목코드'),
								...
								popup		: {
									...
									params	: { stor_grp : _global.stor_grp , line_stat : '0', prnt_idcd : '1302' },
									result	: function(records, nameField, pairField) {
