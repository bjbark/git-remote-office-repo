Ext.define('module.basic.clssmast.view.ClssMastListerCate3', { extend: 'Axt.grid.Panel',

	plugins		: [{ ptype:'gridcolumnconfig'  } ],
	alias		: 'widget.module-clssmast-lister-cate3',
	store		: 'module.basic.clssmast.store.ClssMastCate3',
