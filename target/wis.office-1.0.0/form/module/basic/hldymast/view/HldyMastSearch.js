Ext.define('module.basic.hldymast.view.HldyMastSearch', { extend: 'Axt.form.Search',

	alias: 'widget.module-hldymast-search',
			...
			line = {
				...
				items	: [
					{	fieldLabel	: Language.get('bzpl','사업장'),
						...
						xtype		: 'betweenfield',
						fieldLabel	: Language.get('date_sale', '검색일자' ),
						name		: 'fr_dt',
						pair		: 'to_dt',
						width		: 170,
						root		: true,
