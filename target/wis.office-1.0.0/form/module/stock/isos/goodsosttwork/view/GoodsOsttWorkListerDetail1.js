Ext.define('module.stock.isos.goodsosttwork.view.GoodsOsttWorkListerDetail1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-goodsosttwork-lister-detail1',
	store		: 'module.stock.isos.goodsosttwork.store.GoodsOsttWorkDetail1',
