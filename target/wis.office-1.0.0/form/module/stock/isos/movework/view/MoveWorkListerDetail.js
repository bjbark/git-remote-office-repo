Ext.define('module.stock.isos.movework.view.MoveWorkListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-movework-lister-detail',

	store: 'module.stock.isos.movework.store.MoveWorkDetail',
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex:	'line_seqn'		, width:  40, align : 'center' , text: Language.get( 'line_seqn'	, '순번'			), xtype: 'numericcolumn' , summaryType: 'count' , format:  '#,##0'
					...
					},{	dataIndex:	'move_qntt'		, width:  80, align : 'right'  , text: Language.get( 'ostt_qntt'	, '수량'			), xtype: 'numericcolumn'  , summaryType: 'sum' , format:  '#,##0.##'
					},{	dataIndex:	'stnd_pric'		, width:  80, align : 'right'  , text: Language.get( 'stnd_pric'	, '단가'			), xtype: 'numericcolumn'  , format:  '#,##0'
					},{	dataIndex:	'amnt'			, width:  80, align : 'right'  , text: Language.get( 'amnt'			, '금액'			), xtype: 'numericcolumn'  , summaryType: 'sum' , format:  '#,##0'
					...
					},{	dataIndex:	'orig_line_seqn', width:  60, align : 'center' , text: Language.get( 'reqt_seqn'	, '요청항번'		), xtype: 'numericcolumn' , format:  '#,##0'
