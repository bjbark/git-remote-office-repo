...
Ext.define('module.stock.isos.mtrlisttwork.view.MtrlIsttWorkWorkerEditor', { extend: 'Axt.form.Editor',

	alias: 'widget.module-mtrlisttwork-worker-editor',
	height : 180,
	header : false,
	getStore : function() {
		return Ext.getStore( 'module.stock.isos.mtrlisttwork.store.MtrlIsttWorkInvoice' );
	},
