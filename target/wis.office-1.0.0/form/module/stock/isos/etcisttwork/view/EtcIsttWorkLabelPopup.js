Ext.define('module.stock.isos.etcisttwork.view.EtcIsttWorkLabelPopup', { extend: 'Axt.popup.Search',
	...
	finishAction: function(){
		var me = this,
			...
			master	= Ext.ComponentQuery.query('.module-etcisttwork-lister-master')[0],
...
//			a+= '{\'invc_numb\':\''+record[i].get('invc_numb')+'\',\'line_seqn\':'+ record[i].get('line_seqn')+'}';
		...
		Ext.Ajax.request({
			url		: _global.location.http() + '/stock/etcisttwork/get/report_kind.do',
			params	: {
