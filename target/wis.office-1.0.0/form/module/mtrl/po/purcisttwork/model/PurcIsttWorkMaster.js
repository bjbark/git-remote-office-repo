Ext.define('module.mtrl.po.purcisttwork.model.PurcIsttWorkMaster',{ extend:'Axt.data.Model',
	fields : [
		...
		{	name: 'istt_qntt',			type: 'float' },		//입고수량
		{	name: 'pack_qntt',			type: 'float'},			//부가세포함여부
		{	name: 'vatx_incl_yorn',		type: 'string'},		//부가세포함여부
		{	name: 'vatx_rate',			type: 'float' },		//부가세율
		{	name: 'istt_amnt',			type: 'float' },		//입고금액
		{	name: 'istt_vatx',			type: 'float' },		//입고부가세
		...
		{	name: 'make_cmpy_name2',		type: 'string'},		//제조회사명
		{	name: 'make_natn',			type: 'string'},		//제조국
		{	name: 'make_natn_name',			type: 'string'},		//제조국
		{	name: 'proc_date',			type: 'string', convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr  },		//제조국
		{	name: 'work_cont',			type: 'string'},		//제조국
		...
		{	name: 'remn_date',			type: 'string'},			//유통기한
