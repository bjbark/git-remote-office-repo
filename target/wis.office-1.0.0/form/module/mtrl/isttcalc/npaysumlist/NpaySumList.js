Ext.define('module.mtrl.isttcalc.npaysumlist.NpaySumList', {  extend   : 'Axt.app.Controller',
	requires : [
		'lookup.popup.view.CstmPopup',
	],
	models	: [
		'module.mtrl.isttcalc.npaysumlist.model.NpaySumList',
	],
	stores	: [
		'module.mtrl.isttcalc.npaysumlist.store.NpaySumList',
	],
	views	: [
		'module.mtrl.isttcalc.npaysumlist.view.NpaySumListLayout',
		'module.mtrl.isttcalc.npaysumlist.view.NpaySumListLister',
		'module.mtrl.isttcalc.npaysumlist.view.NpaySumListSearch',
	],
