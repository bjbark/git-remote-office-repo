Ext.define('module.sale.order.saleorder2.view.SaleOrder2Search', { extend: 'Axt.form.Search',


	alias: 'widget.module-saleorder2-search',
	/**
	 *
	 */
					...
					{	xtype : 'fieldset', layout: 'hbox', margin	: '0 40 3 40',
						...
						items : [
							{	xtype		: 'lookupfield',
								...
								editable	: true,
								width		: 207,
								lookupValue	: [['','전체'],['1','납품중'],['2','확정'],['3','중단'],['4','입고완료']]
							}
						]
					},{	xtype : 'fieldset', layout: 'hbox', margin	: '0 40 3 40',
						items : [
