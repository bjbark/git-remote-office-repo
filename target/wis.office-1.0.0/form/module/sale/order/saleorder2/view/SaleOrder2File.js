Ext.define('module.sale.order.saleorder2.view.SaleOrder2File', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-saleorder2-file'			,
	store		: 'module.sale.order.saleorder2.store.SaleOrder2File',
