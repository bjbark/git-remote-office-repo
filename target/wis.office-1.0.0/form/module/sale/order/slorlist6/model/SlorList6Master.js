Ext.define('module.sale.order.slorlist6.model.SlorList6Master', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'wkct_item_idcd'		, type: 'string' 	//품목ID
		},{	name: 'wkct_item_code'		, type: 'string' 	//품목ID
		},{	name: 'wkct_item_name'		, type: 'string' 	//품명
		},{	name: 'wkct_item_spec'		, type: 'string' 	//규격
		...
		},{	name: 'strt_dttm'			, type: 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.datetimeToStr	//시작시간
		},{	name: 'endd_dttm'			, type: 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.datetimeToStr	//종료시간
		},{	name: 'wker_name'			, type: 'string'	//작업자
		},{	name: 'indn_qntt'			, type: 'float'		//지시수량
		},{	name: 'prod_qntt'			, type: 'float'		//생산수량
		},{	name: 'poor_qntt'			, type: 'float'		//불량수량
		},{	name: 'jan_qntt'			, type: 'float'		//생산잔량
		},{	name: 'ordr_qntt'			, type: 'float'		//주문수량
		},{	name: 'wkct_name'			, type: 'string'	//공정상태
		...
		},{	name: 'crte_name'			, type: 'string'	//생성ID
