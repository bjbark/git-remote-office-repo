Ext.define('module.sale.project.prjtplan.view.PrjtPlanListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtplan-lister-master',
	store		: 'module.sale.project.prjtplan.store.PrjtPlanMaster',
