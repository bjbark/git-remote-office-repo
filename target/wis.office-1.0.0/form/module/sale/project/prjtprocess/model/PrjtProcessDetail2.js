Ext.define('module.sale.project.prjtprocess.model.PrjtProcessDetail2',{ extend:'Axt.data.Model',
	fields : [
		...
		{name: 'chge_deli_date',	type: 'string'  , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr },		//조정남기일자
