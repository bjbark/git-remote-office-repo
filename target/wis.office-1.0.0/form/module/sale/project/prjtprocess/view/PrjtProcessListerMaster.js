Ext.define('module.sale.project.prjtprocess.view.PrjtProcessListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtprocess-lister-master',
	store		: 'module.sale.project.prjtprocess.store.PrjtProcessMaster',
		...
		var me = this,
			item = {
				...
				items	: [
					...
					{	text : '<span class="write-button">수금보고</span>'	, action : 'coltreportAction', cls: 'button1-style', hidden : !_global.auth.auth_sale_1002 },
					'-', '->', '-',
		...
		var me = this,
			item = {
				...
				items	: [
					...
					},{ dataIndex: 'item_spec'	, text : Language.get('mold_spec'	,'금형규격'		) , width : 170 , align : 'left',hidden : true
