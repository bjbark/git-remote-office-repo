Ext.define('module.sale.project.prjtprocess.view.PrjtProcessListerDetail8', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtprocess-lister-detail8',
	store		: 'module.sale.project.prjtprocess.store.PrjtProcessDetail8',
