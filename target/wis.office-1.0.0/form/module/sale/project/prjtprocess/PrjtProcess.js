Ext.define('module.sale.project.prjtprocess.PrjtProcess', { extend:'Axt.app.Controller',
	...
	models	: [
		'module.sale.project.prjtprocess.model.PrjtProcessMaster',
		'module.sale.project.prjtprocess.model.PrjtProcessDetail1',
		'module.sale.project.prjtprocess.model.PrjtProcessDetail2',
		'module.sale.project.prjtprocess.model.PrjtProcessDetail3',
		'module.sale.project.prjtprocess.model.PrjtProcessDetail5',
		'module.sale.project.prjtprocess.model.PrjtProcessDetail6',
		'module.sale.project.prjtprocess.model.PrjtProcessDetail7',
		'module.sale.project.prjtprocess.model.PrjtProcessDetail8'
	],
	stores	: [
		'module.sale.project.prjtprocess.store.PrjtProcessMaster',
		'module.sale.project.prjtprocess.store.PrjtProcessDetail1',
		'module.sale.project.prjtprocess.store.PrjtProcessDetail2',
		'module.sale.project.prjtprocess.store.PrjtProcessDetail3',
		'module.sale.project.prjtprocess.store.PrjtProcessDetail5',
		'module.sale.project.prjtprocess.store.PrjtProcessDetail6',
		'module.sale.project.prjtprocess.store.PrjtProcessDetail7',
		'module.sale.project.prjtprocess.store.PrjtProcessDetail8'
	],
	views	: [
		'module.sale.project.prjtprocess.view.PrjtProcessLayout',
		'module.sale.project.prjtprocess.view.PrjtProcessSearch',
		'module.sale.project.prjtprocess.view.PrjtProcessListerMaster',
		'module.sale.project.prjtprocess.view.PrjtProcessListerDetail1',
		'module.sale.project.prjtprocess.view.PrjtProcessListerDetail2',
		'module.sale.project.prjtprocess.view.PrjtProcessListerDetail3',
		'module.sale.project.prjtprocess.view.PrjtProcessListerDetail4',
		'module.sale.project.prjtprocess.view.PrjtProcessListerDetail5',
		'module.sale.project.prjtprocess.view.PrjtProcessListerDetail6',
		'module.sale.project.prjtprocess.view.PrjtProcessListerDetail7',
		'module.sale.project.prjtprocess.view.PrjtProcessListerDetail8',
		'module.sale.project.prjtprocess.view.PrjtProcessColtPopup',
	],
	...
	init: function() {
		...
		me.control({
			...
			// lister detail event
			'module-prjtprocess-lister-detail1 button[action=modifyAction]'	: { click : me.modifyAction },	// 수정
			'module-prjtprocess-lister-detail1 button[action=insertAction]'	: { click : me.insertAction },	// 신규
			'module-prjtprocess-lister-detail1 button[action=exportAction]'	: { click : me.exportAction2 },	// 디테일1엑셀
			'module-prjtprocess-lister-detail2 button[action=exportAction]'	: { click : me.exportAction3 },	// 디테일2엑셀
			...
			'module-prjtprocess-lister-detail6 button[action=exportAction]'	: { click : me.exportAction7 },	// 디테일6엑셀
			'module-prjtprocess-lister-detail7 button[action=exportAction]'	: { click : me.exportAction8 },	// 디테일7엑셀
	...
	pocket : {
		...
		listerdetail1 : function () { return Ext.ComponentQuery.query('module-prjtprocess-lister-detail1')[0] },
		listerdetail2 : function () { return Ext.ComponentQuery.query('module-prjtprocess-lister-detail2')[0] },
		...
		listerdetail6 : function () { return Ext.ComponentQuery.query('module-prjtprocess-lister-detail6')[0] },
		listerdetail7 : function () { return Ext.ComponentQuery.query('module-prjtprocess-lister-detail7')[0] },
	...
	selectDetail : function(grid, record) {
		var me = this,
			...
			listerdetail7 = me.pocket.listerdetail7(),
		...
		if (record) {
			if(tindex == 0){
				...
				lister = listerdetail6
			}else if(tindex == 6){
				lister = listerdetail7
			}else if(tindex == 7){
