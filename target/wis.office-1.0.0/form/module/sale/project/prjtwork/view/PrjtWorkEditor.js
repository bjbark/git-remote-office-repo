Ext.define('module.sale.project.prjtwork.view.PrjtWorkEditor', { extend: 'Axt.form.Editor',
	...
	collapsed		: true	,
	getStore: function() {
		return Ext.getStore( 'module.sale.project.prjtwork.store.PrjtWorkInvoice' );
	},
			...
			item = {
				...
				items			: [
					{	xtype	: 'fieldset', layout: 'hbox' ,padding:'0', border: 0,margin : '0 0 5 0',
						...
						items	: [
							{	fieldLabel	: Language.get('rela_pjod_idcd','관련금형'),
								xtype		: 'popupfield',
								editable	: true,
								enableKeyEvents : true,
								name		: 'rela_pjod_idcd',
						...
						fieldCls	: 'requiredindex',
						emptyText	: Const.invalid.emptyValue
					},{	fieldLabel	: Language.get('mold_spec','규격'),
						xtype		: 'textfield',
						name		: 'item_spec',
						fieldCls	: 'requiredindex',
						hidden		: true,
