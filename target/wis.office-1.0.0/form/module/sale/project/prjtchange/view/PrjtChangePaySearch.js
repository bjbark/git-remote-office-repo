Ext.define('module.sale.project.prjtchange.view.PrjtChangePaySearch', { extend: 'Axt.form.Search',
	store	: 'module.sale.project.prjtchange.store.PrjtChangeInvoice',
	alias	: 'widget.module-prjtchange-paysearch',
							...
							listeners	: {
								keydown : function(self, e) {
									if (e.keyCode == e.ENTER) {
										...
										var e = self.up('form').down('[name=user_memo]').getValue();
										if(a =='' || a == null ){
