Ext.define('module.sale.project.prjtchange.view.PrjtChangeListerDetail4', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtchange-lister-detail4',
	store		: 'module.sale.project.prjtchange.store.PrjtChangeDetail4',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'cnsl_cont'		, text : Language.get('cnsl_cont'		,'상담내용')	, flex  : 100 , align : 'left'
					...
					},{ dataIndex: 'cost_yorn'		, text : Language.get('cost_yorn'		,'원가')		, width :  50 , align : 'right' , xtype : 'lookupcolumn', lookupValue:resource.lookup('yorn'), hidden : true
