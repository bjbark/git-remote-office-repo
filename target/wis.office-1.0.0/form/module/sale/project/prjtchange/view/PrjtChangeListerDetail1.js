Ext.define('module.sale.project.prjtchange.view.PrjtChangeListerDetail1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtchange-lister-detail1',
	store		: 'module.sale.project.prjtchange.store.PrjtChangeDetail1',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'item_modl'	, text : Language.get('item_modl'	,'차종명'		) , width : 120 , align : 'left'
