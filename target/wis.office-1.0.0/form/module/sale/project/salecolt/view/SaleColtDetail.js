Ext.define('module.sale.project.salecolt.view.SaleColtDetail', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-salecolt-detail',
	store		: 'module.sale.project.salecolt.store.SaleColtDetail',
