Ext.define('module.sale.project.prjttestordr.view.PrjtTestOrdrEditor', { extend: 'Axt.form.Editor',

	alias: 'widget.module-prjttestordr-editor',
	...
	title			: Language.get('pjod_mast_prod','시험생산 의뢰 정보'),
	collapsible 	: true			,
	collapsed		: true			,
			...
			item = {
				...
				items			: [
					{	xtype	: 'fieldset', layout: 'hbox' ,padding:'0', border: 0,margin : '0 0 5 0',
						items	: [
							{	fieldLabel	: Language.get('pjod_idcd','금형코드'),
								name		: 'pjod_idcd',
								xtype		: 'textfield',
								allowBlank	: false,
						...
						items	: [
							{	fieldLabel	: Language.get('line_seqn','순번'),
								...
								width		: 167,
								readOnly	: true
							},{	fieldLabel	: Language.get('regi_date','지시일자'),
								name		: 'regi_date',
								xtype		: 'datefield',
