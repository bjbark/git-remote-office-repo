/**
 */
Ext.define('module.sale.project.salework.view.SaleWorkPjodPopup', { extend: 'Axt.popup.Search',
	id: 'module-salework-pjodpopup',
	alias: 'widget.module-salework-pjodpopup',
	store: 'module.sale.project.salework.store.SaleWorkPjodPopup',
	...
	createGrid: function(){
		var me = this,
			...
			columns:[
				...
				},{ dataIndex: 'pjod_idcd', text : Language.get('pjod_idcd', '금형번호'			), width : 110 , align : 'center'
				},{ dataIndex: 'amnd_degr', text : Language.get('amnd_degr', '차수'			), width : 50 , align : 'center'
				...
				},{ dataIndex: 'item_name', text : Language.get('acpt_case_name', '금형명'		), width : 220 , align : 'left'
				},{ dataIndex: 'item_spec', text : Language.get('mold_spec', '규격'			), width : 180 , align : 'left'
