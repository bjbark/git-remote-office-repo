Ext.define('module.sale.spts.sptsmast.view.SptsMastListerDetail2', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-sptsmast-lister-detail2',

	store: 'module.sale.spts.sptsmast.store.SptsMastDetail2',
