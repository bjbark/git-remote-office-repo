Ext.define('module.sale.clam.clamentry1.view.ClamEntry1EditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-clamentry1-editorlister'			,
	store		: 'module.sale.clam.clamentry1.store.ClamEntry1File',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-clamentry1-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'clam_mast';											// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
