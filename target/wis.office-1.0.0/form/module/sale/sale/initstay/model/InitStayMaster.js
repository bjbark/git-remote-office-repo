Ext.define('module.sale.sale.initstay.model.InitStayMaster', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'trns_date'			, type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr,		//납기일자
		...
		},{	name: 'ostt_qntt'			, type: 'float' 	//환율
		},{	name: 'sale_pric'			, type: 'float' 	//환율
		},{	name: 'sale_amnt'			, type: 'float' 	//환율
		},{	name: 'vatx_amnt'			, type: 'float'		//환율
