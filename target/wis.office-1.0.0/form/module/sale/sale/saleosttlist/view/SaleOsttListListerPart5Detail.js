Ext.define('module.sale.sale.saleosttlist.view.SaleOsttListListerPart5Detail', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-salelist-lister-part5-detail',
	store		: 'module.sale.sale.saleosttlist.store.SaleOsttListPart5Detail',
	...
	pagingItem : function() {
		var me = this,
			item = {
				...
				items : [
					'->', '-',
					{ text : Const.EXPORT.text, iconCls : Const.EXPORT.icon, action : Const.EXPORT.action, button : 'part5Detail',cls: 'button-style' }
				], pagingButton : false
			}
		;
		return item;
		...
		var me = this,
			item =
				{	defaults: {style: 'text-align:center'},
					items : [
						{	dataIndex: 'sale_invc_date'	, width:  80, text: Language.get('ostt_date','출고일자'		) , align:'center'
						...
						},{	dataIndex: 'acpt_invc_date'	, width:  80, text: Language.get('acpt_date','수주일자'		) , align:'center'
