Ext.define('module.custom.symct.sale.prjtmast.view.PrjtMastListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtmast-lister-master',
	store		: 'module.custom.symct.sale.prjtmast.store.PrjtMastMaster',
