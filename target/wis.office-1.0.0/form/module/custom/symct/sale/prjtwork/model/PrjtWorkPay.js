Ext.define('module.custom.symct.sale.prjtwork.model.PrjtWorkPay',{ extend:'Axt.data.Model',
	fields : [
		...
		{name: 'colt_date',				type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr } ,		//수금일자
