Ext.define('module.custom.symct.sale.prjtwork.view.PrjtWorkListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtwork-lister-detail3',
	store		: 'module.custom.symct.sale.prjtwork.store.PrjtWorkDetail3',
