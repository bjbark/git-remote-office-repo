Ext.define('module.custom.symct.sale.prjtwork.view.PrjtWorkConsultingPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-prjtwork-consulting-popup',
	...
	finishAction: function(){
		...
		mask.show();
		Ext.Ajax.request({
			url		: _global.location.http() + '/sale/project/prjtwork/set/consulting.do',
			params	: {
