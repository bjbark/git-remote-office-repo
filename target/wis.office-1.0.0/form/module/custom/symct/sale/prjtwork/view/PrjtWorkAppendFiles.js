Ext.define('module.custom.symct.sale.prjtwork.view.PrjtWorkAppendFiles', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtwork-editorlister'			,
	store		: 'module.custom.symct.sale.prjtwork.store.PrjtWorkFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-prjtwork-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'pjod_mast';											// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
