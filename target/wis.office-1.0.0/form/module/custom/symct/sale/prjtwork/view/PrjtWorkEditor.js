Ext.define('module.custom.symct.sale.prjtwork.view.PrjtWorkEditor', { extend: 'Axt.form.Editor',

	alias: 'widget.module-prjtwork-editor',
	...
	collapsed		: true	,
	getStore: function() {
		return Ext.getStore( 'module.custom.symct.sale.prjtwork.store.PrjtWorkInvoice' );
	},
	...
	createTabs : function () {
		var me = this,
			item = {
				...
				margin	: 0,
				plain	: true,
				items	: [ me.createTab2(),me.createTab1(),me.createTab3(),me.createTab4()]
			}
		;
		return item;
	},
	...
	createTab1 : function() {
		var me = this,
			item = {
				title	: '결제일자 및 조건',
				xtype	: 'module-prjtwork-paylister',
				...
				fieldDefaults	: { width : 400, labelWidth : 100, labelSeparator : '' },
					items	: [
						{	xtype 	: 'panel',
							...
							items	: [
								{	xtype		: 'form-panel',
									...
									items		: [
										...
										{	fieldLabel : '전화번호'	, name : 'tele_numb'	, xtype : 'textfield'	, readOnly : true	, onwerEditing : true } ,
										{	fieldLabel : '팩스번호'	, name : 'faxi_numb'	, xtype : 'textfield'	, onwerEditing : true ,readOnly	: true,}  //, width : 250 , labelWidth : 70
									]
								}
							]
						},{	layout		: 'hbox',
							...
							items		: [
								{	fieldLabel : '계산서메일'	, name : 'mail_addr'	, xtype : 'textfield'	, width : 245, labelWidth : 70 , readOnly   : true , onwerEditing : true
								},{	fieldLabel : '휴대전화'	, name : 'hdph_numb'	, xtype : 'textfield'	, width : 250, labelWidth : 75, onwerEditing : true, readOnly	: true,}  // width : 250,
							]
