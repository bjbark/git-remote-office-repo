Ext.define('module.custom.symct.sale.prjtwork.view.PrjtWorkSearch', { extend: 'Axt.form.Search',

	alias: 'widget.module-prjtwork-search',
					...
					{	xtype		: 'fieldset',
						...
						items		:[
							{	xtype	: 'label',
								...
								xtype	: 'searchfield',
								flex	: 4,
								emptyText		: '조회할 수주번호 또는 품명 또는 거래처코드 또는 거래처명을 입력하세요...',
