Ext.define('module.custom.symct.sale.prjtlist.PrjtList', { extend:'Axt.app.Controller',
	...
	models	: [
		'module.custom.symct.sale.prjtlist.model.PrjtListMaster',
		'module.custom.symct.sale.prjtlist.model.PrjtListDetail1',
		'module.custom.symct.sale.prjtlist.model.PrjtListDetail2',
		'module.custom.symct.sale.prjtlist.model.PrjtListDetail3',
		'module.custom.symct.sale.prjtlist.model.PrjtListDetail4',
		'module.custom.symct.sale.prjtlist.model.PrjtListInvoice',
		'module.custom.symct.sale.prjtlist.model.PrjtListFile'
	],
	stores	: [
		'module.custom.symct.sale.prjtlist.store.PrjtListMaster',
		'module.custom.symct.sale.prjtlist.store.PrjtListDetail1',
		'module.custom.symct.sale.prjtlist.store.PrjtListDetail2',
		'module.custom.symct.sale.prjtlist.store.PrjtListDetail3',
		'module.custom.symct.sale.prjtlist.store.PrjtListDetail4',
		'module.custom.symct.sale.prjtlist.store.PrjtListInvoice',
		'module.custom.symct.sale.prjtlist.store.PrjtListFile'
	],
	views	: [
		'module.custom.symct.sale.prjtlist.view.PrjtListLayout',
		'module.custom.symct.sale.prjtlist.view.PrjtListSearch',
		'module.custom.symct.sale.prjtlist.view.PrjtListListerMaster',
		'module.custom.symct.sale.prjtlist.view.PrjtListListerDetail1',
		'module.custom.symct.sale.prjtlist.view.PrjtListListerDetail2',
		'module.custom.symct.sale.prjtlist.view.PrjtListListerDetail3',
		'module.custom.symct.sale.prjtlist.view.PrjtListListerDetail4',
		'module.custom.symct.sale.prjtlist.view.PrjtListEditor',
		'module.custom.symct.sale.prjtlist.view.PrjtListEditor2',
		'module.custom.symct.sale.prjtlist.view.PrjtListAppendFiles',
		'module.custom.symct.sale.prjtlist.view.PrjtListImg'
	],
