Ext.define('module.custom.symct.sale.prjtlist.view.PrjtListEditor', { extend: 'Axt.form.Editor',
	...
	collapsed		: true	,
	getStore: function() {
		return Ext.getStore( 'module.custom.symct.sale.prjtlist.store.PrjtListInvoice' );
	},
