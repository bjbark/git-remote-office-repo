Ext.define('module.custom.symct.sale.prjtlist.view.PrjtListListerDetail4', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtlist-lister-detail4',
	store		: 'module.custom.symct.sale.prjtlist.store.PrjtListDetail4',
