Ext.define('module.custom.sjflv.item.bomlist.view.BomListExcel', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-bomlist-excel',
	store		: 'module.custom.sjflv.item.bomlist.store.BomListExcel',
	border		: 0,
