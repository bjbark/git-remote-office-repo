Ext.define('module.custom.sjflv.item.bomlist.view.BomListLister2', { extend: 'Axt.grid.Panel',

	plugins		: [{ ptype:'gridcolumnconfig'  } ],
	alias		: 'widget.module-sjflv-bomlist-lister2',
	store		: 'module.custom.sjflv.item.bomlist.store.BomListLister2',
