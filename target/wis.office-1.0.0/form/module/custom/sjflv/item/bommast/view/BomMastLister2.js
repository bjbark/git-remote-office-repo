Ext.define('module.custom.sjflv.item.bommast.view.BomMastLister2', { extend: 'Axt.grid.Panel',

	plugins		: [{ ptype:'gridcolumnconfig'  } ],
	alias		: 'widget.module-sjflv-bommast-lister2',
	store		: 'module.custom.sjflv.item.bommast.store.BomMastLister2',
