Ext.define('module.custom.sjflv.stock.isos.goodsosttwork.view.GoodsOsttWorkExcelPopup', { extend: 'Axt.popup.Upload',
	alias		: 'widget.module-sjflv-goodsosttwork-excel-popup'			,
	...
	*/
			...
			items	: [
				{
					...
					border			:  false,
					url				: 'system/custom/sjflv/stock/goodsosttwork/set/excel.do',
					timeout			: 120000,
					method			: 'POST',
					layout			: { type: 'vbox', align: 'stretch' } ,
					padding			: 10 ,
	...
	finishAction : function (button) {
		...
		param.invc_date = me.down('[name=invc_date]').getValue().toLocaleDateString().replace(/\./g, '').replace(/\s/g, ''),
