Ext.define('module.custom.sjflv.stock.isos.etcosttwork.view.EtcOsttWorkSearch', { extend: 'Axt.form.Search',
					...
					{	xtype	: 'fieldset', layout: 'hbox',
						...
						items	: [
							{	fieldLabel	: '출고기간',
								...
								labelWidth	: 15,
								value		: new Date()
							},{	fieldLabel	: Language.get('stok_type_dvcd', '출고유형' ),
								xtype		: 'lookupfield',
								name		: 'stok_type_dvcd',
								editable	: false,
								width		: 206,
								lookupValue	: resource.lookup('stok_type_dvcd' ),
							},{	fieldLabel	: Language.get('ostt_dvcd','출고구분'),
								xtype		: 'lookupfield',
								name		: 'ostt_dvcd',
								width		: 206,
								//labelWidth	: 77,
