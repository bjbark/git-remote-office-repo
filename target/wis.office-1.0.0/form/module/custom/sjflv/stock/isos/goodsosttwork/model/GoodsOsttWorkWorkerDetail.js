Ext.define('module.custom.sjflv.stock.isos.goodsosttwork.model.GoodsOsttWorkWorkerDetail',{ extend:'Axt.data.Model',
	fields  : [
		...
		{	name: 'unpaid2',			type: 'float' ,defaultValue:0 },
		{	name: 'sale_pric',			type: 'float' ,defaultValue:0 },
		{	name: 'new_sale_amnt',		type: 'float' ,defaultValue:0},
		{	name: 'new_vatx_amnt',		type: 'float' ,defaultValue:0 },
		{	name: 'new_ttsm_amnt',		type: 'float' ,defaultValue:0 },
