Ext.define('module.custom.sjflv.stock.isos.etcisttwork.model.EtcIsttWorkRegiModel',{ extend:'Axt.data.Model',
	fields  : [
		...
		{	name: 'proc_drtr_name',		type: 'string'},		//처리담당자명
		...
		{	name: 'pack_qntt',			type: 'float' },		//창고ID
		{	name: 'zone_idcd',			type: 'string' },		//렉위치
		{	name: 'zone_name',			type: 'string' },		//렉위치
		...
		{	name: 'orig_seqn',			type: 'float'  , defaultValue: '0'},		//원순번
		...
		{	name: 'make_natn_name',		type: 'string'},		//유통기한
