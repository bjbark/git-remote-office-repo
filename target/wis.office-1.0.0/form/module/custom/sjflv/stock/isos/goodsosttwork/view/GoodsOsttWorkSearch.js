Ext.define('module.custom.sjflv.stock.isos.goodsosttwork.view.GoodsOsttWorkSearch', { extend: 'Axt.form.Search',
						...
						items : [
							{	fieldLabel	: Language.get('item','품목'),
								...
								popup		: {
									...
									params	: { stor_grp : _global.stor_grp , line_stat : '0' , acct_bacd : '삼정(제품출고)'},
									result	: function(records, nameField, pairField) {
