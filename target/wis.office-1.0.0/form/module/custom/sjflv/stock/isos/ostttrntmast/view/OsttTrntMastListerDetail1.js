Ext.define('module.custom.sjflv.stock.isos.ostttrntmast.view.OsttTrntMastListerDetail1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-ostttrntmast-lister-detail1',
	store		: 'module.custom.sjflv.stock.isos.ostttrntmast.store.OsttTrntMastDetail1',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'ostt_qntt'	, text : Language.get('ostt_qntt'	,'출고수량'	) , width :  80 , xtype : 'numericcolumn', align : 'right', summaryType: 'sum', format:'#,##0.###',
