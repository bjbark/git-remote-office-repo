Ext.define('module.custom.sjflv.stock.isos.etcisttwork.view.EtcIsttWorkLayout', { extend: 'Axt.form.Layout' ,
						...
						{	title	: '입고 현황',
							...
							items	: [
								{	region	: 'center',
									...
									border	: 0,
									items	: [
										{	xtype	: 'module-etcisttwork-regi-search',
											height	: 40,
											split	: false,
											region	: 'north',
											style	: Const.borderLine.bottom
										},{	xtype	: 'module-etcisttwork-regi-lister',
											flex	: 1,
											split	: false,
											region	: 'center',
											style	: Const.borderLine.top
