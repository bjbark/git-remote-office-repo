Ext.define('module.custom.sjflv.sale.sale.salework.model.SaleWorkWorkerDetail',{ extend:'Axt.data.Model',
	fields  : [
		...
		},{	name: 'vatx2'				, type: 'float'		/* 부가세		*/ , defaultValue : 0
		...
		},{	name: 'sale_deff_amnt'		, type: 'float'		/* 판매미발행금액		*/
		},{	name: 'rett_deff_amnt'		, type: 'float'		/* 반품미발행금액		*/
