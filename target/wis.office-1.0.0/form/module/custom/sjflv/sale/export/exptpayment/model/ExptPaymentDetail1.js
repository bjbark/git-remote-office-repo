Ext.define('module.custom.sjflv.sale.export.exptpayment.model.ExptPaymentDetail1',{ extend:'Axt.data.Model',
	fields : [
		...
		},{	name: 'exch_pric'			, type: 'float'			//외화단가
		},{	name: 'mngt_numb'			, type: 'string'		//offer관리번호
		},{	name: 'exch_amnt'			, type: 'float'			//외화금액
