Ext.define('module.custom.sjflv.sale.export.ordermast2.view.OrderMast2FileLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-export-ordermast2-filelister'			,
	store		: 'module.custom.sjflv.sale.export.ordermast2.store.OrderMast2File',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-sjflv-export-ordermast2-filelister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'expt_offr_item';		// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
