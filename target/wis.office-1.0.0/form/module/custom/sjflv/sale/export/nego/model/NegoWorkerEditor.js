Ext.define('module.custom.sjflv.sale.export.nego.model.NegoWorkerEditor',{ extend:'Axt.data.Model',
	fields  : [
		...
		{	name: 'invc_date1',			type: 'string'},		//통관기간
		{	name: 'invc_date2',			type: 'string'},		//통관기간
