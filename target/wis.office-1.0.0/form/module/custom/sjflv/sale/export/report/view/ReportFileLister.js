Ext.define('module.custom.sjflv.sale.export.report.view.ReportFileLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-report-filelister'			,
	store		: 'module.custom.sjflv.sale.export.report.store.ReportFile',
