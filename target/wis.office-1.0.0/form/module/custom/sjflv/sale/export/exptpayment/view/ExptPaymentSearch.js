Ext.define('module.custom.sjflv.sale.export.exptpayment.view.ExptPaymentSearch', { extend: 'Axt.form.Search',

	alias: 'widget.module-sjflv-exptpayment-search',
				...
				items			: [
					{	xtype : 'fieldset', layout: 'hbox',
						items : [
							...
							},{	fieldLabel	: Language.get('offr_numb','Order No'),
								xtype		: 'popupfield',
								editable	: true,
								enableKeyEvents : true,
								name		: 'offr_numb',
