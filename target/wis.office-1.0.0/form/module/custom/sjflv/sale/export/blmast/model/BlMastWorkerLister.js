Ext.define('module.custom.sjflv.sale.export.blmast.model.BlMastWorkerLister',{ extend:'Axt.data.Model',
	fields  : [
		...
		{	name: 'stop_time_dvcd',		type: 'string'},		//결제시기구분코드
		{	name: 'mney_unit',			type: 'string'},		//화폐단위
		{	name: 'amnd_degr',			type: 'string'},		//AMD
		{	name: 'ship_viaa_dvcd',		type: 'string'},		//shipvia구분코드
		{	name: 'cstm_pcod_numb',		type: 'string'},		//고객 pono
