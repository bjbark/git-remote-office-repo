Ext.define('module.custom.sjflv.sale.export.blmast.model.BlMastWorkerDetail',{ extend:'Axt.data.Model',
	fields  : [
...
//		{	name: 'ostt_qntt2',			type: 'float' },
		...
		{	name: 'item_hscd',			type: 'string' },		//품명hs코드
