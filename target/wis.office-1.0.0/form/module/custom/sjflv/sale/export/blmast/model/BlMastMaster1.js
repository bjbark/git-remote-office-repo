Ext.define('module.custom.sjflv.sale.export.blmast.model.BlMastMaster1',{ extend:'Axt.data.Model',
	fields : [
		...
		{	name: 'nego_amnt'				, type: 'string' },		//NEGO금액
		{	name: 'krwn_nego_amnt'			, type: 'string' },		//원화 NEGO금액
