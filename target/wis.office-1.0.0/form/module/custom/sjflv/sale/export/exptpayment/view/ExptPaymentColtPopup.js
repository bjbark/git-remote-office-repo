Ext.define('module.custom.sjflv.sale.export.exptpayment.view.ExptPaymentColtPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-exptpayment-colt-popup',
					...
					{	xtype : 'fieldset', layout: 'vbox', border		: 0,
						items : [
							{	xtype : 'fieldset', layout: 'hbox', border		: 0,
								items : [
									{	fieldLabel	: Language.get('invc_numb', '관리번호' ),
										xtype		: 'textfield',
										name		: 'buyr_name',
										width		: 298,
										allowBlank	: false ,
								...
								items : [
									{	fieldLabel	: Language.get('invc_date','지급일자'),
										xtype		: 'datefield',
										name		: 'invc_date',
	...
	finishAction: function(){
		var me = this,
			...
			master	= Ext.ComponentQuery.query('module-exptpayment-lister-master1')[0],
			detail	= Ext.ComponentQuery.query('module-exptpayment-lister-detail1')[0],
			record
		;
...
//					record = String(me.params.param).slice(0,-3)+",\"deli_date\":\""+values.deli_date+"\"}]}";
					...
					Ext.Ajax.request({
						url			: _global.api_host_info + '/' + _global.app_site + '/custom/sjflv/sale/export/exptpayment/set/acpt.do',
						method		: "POST",
						params		: {
