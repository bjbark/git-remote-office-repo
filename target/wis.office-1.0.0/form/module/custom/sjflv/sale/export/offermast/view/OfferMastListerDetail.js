Ext.define('module.custom.sjflv.sale.export.offermast.view.OfferMastListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-offermast-lister-detail',

	store: 'module.custom.sjflv.sale.export.offermast.store.OfferMastDetail',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'exch_pric'			, width: 100, align : 'right'	, text: Language.get('exch_pric'			, '판매단가'	), xtype: 'numericcolumn'
					},{	dataIndex: 'exch_amnt'			, width: 100, align : 'right'	, text: Language.get('exch_amnt'			, '판매금액'	), xtype: 'numericcolumn', summaryType: 'sum'
					},{	dataIndex: 'krwn_pric'			, width: 100, align : 'right'	, text: Language.get('krwn_pric'			, '원화단가'	), xtype: 'numericcolumn', summaryType: 'sum'
					...
					},{	dataIndex: 'user_memo'			, flex : 1,minWidth: 150, align : 'center'	, text: Language.get('user_memo'			, '비고'		),
					}
				]
			};
		return item;
