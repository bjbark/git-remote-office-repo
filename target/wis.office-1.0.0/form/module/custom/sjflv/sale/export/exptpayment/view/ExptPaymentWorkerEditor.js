Ext.define('module.custom.sjflv.sale.export.exptpayment.view.ExptPaymentWorkerEditor', { extend: 'Axt.form.Editor',
	alias	: 'widget.module-sjflv-exptpayment-worker-editor',
	sotre	:  'module.custom.sjflv.sale.export.exptpayment.store.ExptPaymentWorkerEditor',
	header	: false,
	getStore: function() {
		return Ext.getStore( 'module.custom.sjflv.sale.export.exptpayment.store.ExptPaymentInvoice' );
	},
