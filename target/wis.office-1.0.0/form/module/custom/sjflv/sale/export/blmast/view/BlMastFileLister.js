Ext.define('module.custom.sjflv.sale.export.blmast.view.BlMastFileLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-blmast-BlMastFileLister'			,
	store		: 'module.custom.sjflv.sale.export.blmast.store.BlMastFile',
				...
				fbar	: [
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							render:function(){
								this.popup.params.orgn_dvcd = 'expt_rept';		// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex: 'line_seqn'		, text : Language.get(''		,'순번'	)		, width : 80 , align : 'center',hidden:true
					},{	dataIndex: 'assi_seqn'		, text : Language.get(''		,'순번'	)		, width : 80 , align : 'center'
					},{ dataIndex: 'file_ttle'		, text : Language.get(''		,'파일명')		, width : 120 ,hidden:true
					},{ dataIndex: 'file_name'		, text : Language.get(''		,'파일명')		, flex : 1 ,
