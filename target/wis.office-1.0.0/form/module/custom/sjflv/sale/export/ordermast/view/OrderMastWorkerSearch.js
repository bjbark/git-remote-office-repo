Ext.define('module.custom.sjflv.sale.export.ordermast.view.OrderMastWorkerSearch', { extend: 'Axt.form.Search',
	store	: 'module.custom.sjflv.sale.export.ordermast.store.OrderMastInvoice',
	alias	: 'widget.module-sjflv-ordermast-worker-search',
...
//									},
	...
	attachItem : function (config) {
		...
		if (config.clear || !config.record) {
			...
			var cstm = Ext.ComponentQuery.query('module-sjflv-ordermast-worker-editor')[0].down('[name=cstm_idcd]').getValue(),
				val = [],
				result1 = []
			;
			if(cstm != '' && cstm != null){
