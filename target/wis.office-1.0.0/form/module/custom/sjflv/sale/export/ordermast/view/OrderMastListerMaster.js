Ext.define('module.custom.sjflv.sale.export.ordermast.view.OrderMastListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-ordermast-lister-master',
	store		: 'module.custom.sjflv.sale.export.ordermast.store.OrderMastMaster',
	...
	pagingItem : function () {
		var me = this,
			item = {
				xtype	: 'grid-paging',
				items	: [
					{	text : '<span class="write-button">Payment 등록</span>'	, action : 'coltAction'		, cls: 'button-style', width: 100	} ,
					{	text : '<span class="write-button">Invoice 등록</span>'	, action : 'invoiceAction'	, cls: 'button-style', width: 100	} ,
					{	text : '<span class="write-button">수출신고필증등록</span>'	, action : 'reportpopupAction'	, cls: 'button-style', width: 100	} ,
					{	text : '<span class="write-button">B/L 등록</span>'		, action : 'blpopupAction'	, cls: 'button-style', width: 100	} ,
					{	text : '<span class="write-button">NEGO 등록</span>'		, action : 'negopopupAction', cls: 'button-style', width: 100	} ,
					'-', '->', '->','->',
					{	text : '<span class="write-button">부대비용 등록</span>'	, action : 'costAction'		, cls: 'button-style', width: 100	} , '-',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'po_date'		, width: 100, align : 'center'	, text: Language.get('po_date'			, 'PO Date'			) , xtype : 'lookupcolumn' , lookupValue : resource.lookup('offr_dvcd')
