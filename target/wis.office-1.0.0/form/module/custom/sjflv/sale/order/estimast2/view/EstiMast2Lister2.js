Ext.define('module.custom.sjflv.sale.order.estimast2.view.EstiMast2Lister2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-estimast2-lister2'			,
	store		: 'module.custom.sjflv.sale.order.estimast2.store.EstiMast2File',
