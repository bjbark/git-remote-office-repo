Ext.define('module.custom.sjflv.sale.order.saleorder.view.SaleOrderConsultingPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-sjflv-saleorder-consulting-popup',
	...
	finishAction: function(){
		...
		mask.show();
		Ext.Ajax.request({
			url		: _global.location.http() + '/custom/sjflv/sale/order/saleorder/set/consulting.do',
			params	: {
