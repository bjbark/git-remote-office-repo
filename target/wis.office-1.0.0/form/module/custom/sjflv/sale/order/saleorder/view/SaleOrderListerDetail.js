Ext.define('module.custom.sjflv.sale.order.saleorder.view.SaleOrderListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-sjflv-saleorder-lister-detail',

	store: 'module.custom.sjflv.sale.order.saleorder.store.SaleOrderDetail',
