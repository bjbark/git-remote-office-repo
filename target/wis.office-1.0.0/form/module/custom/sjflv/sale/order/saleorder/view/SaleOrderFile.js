Ext.define('module.custom.sjflv.sale.order.saleorder.view.SaleOrderFile', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-saleorder-file'			,
	store		: 'module.custom.sjflv.sale.order.saleorder.store.SaleOrderFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),		// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-sjflv-saleorder-file')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
