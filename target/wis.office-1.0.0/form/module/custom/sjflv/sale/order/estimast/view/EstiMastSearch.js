Ext.define('module.custom.sjflv.sale.order.estimast.view.EstiMastSearch', { extend: 'Axt.form.Search',


	alias: 'widget.module-sjflv-estimast-search',
	/**
	 *
	 */
			...
			line = {
				...
				items			: [
					{	xtype : 'fieldset', layout: 'hbox',
						items : [
							{	fieldLabel	: Language.get('inqy_term','견적일자'),
								xtype		: 'betweenfield',
								name		: 'invc1_date',
								pair		: 'invc2_date',
								labelWidth	: 99,
