Ext.define('module.custom.sjflv.sale.order.estimast2.view.EstiMast2CopyPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-estimast2-copy-popup',
	...
	finishAction: function(){
		...
		mask.show();
		Ext.Ajax.request({
			url		: _global.location.http() + '/custom/sjflv/sale/order/estimast2/set/copy.do',
			params	: {
			...
			success	: function(response, request) {
				...
				Ext.Msg.alert("알림", "견적서 복사가 완료 되었습니다.");
