Ext.define('module.custom.sjflv.sale.order.estimast.view.EstiMastWorkerEditor2', { extend: 'Axt.form.Editor',

	alias	: 'widget.module-sjflv-estimast-worker-editor2',
	height	: 180,
	header	: false,
	getStore: function() {
		return Ext.getStore( 'module.custom.sjflv.sale.order.estimast.store.EstiMastInvoice2' );
	},
