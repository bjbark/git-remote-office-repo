Ext.define('module.custom.sjflv.sale.order.estimast2.view.EstiMast2ListerMaster', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-estimast2-lister-master',
	store		: 'module.custom.sjflv.sale.order.estimast2.store.EstiMast2Master',
		...
		var me = this,
			item = {
				...
				items	: [
					...
					{	text : '<span class="write-button">수주등록</span>'	, action : 'orderAction'	, cls: 'button1-style', hidden: _global.hq_id.toUpperCase()!='N1000SJUNG' ? false : true	} , '-',
