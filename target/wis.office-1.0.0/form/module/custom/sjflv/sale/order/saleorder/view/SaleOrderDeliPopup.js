Ext.define('module.custom.sjflv.sale.saleorder.view.SaleOrderDeliPopup', { extend: 'Axt.popup.Search',
	...
	finishAction: function(){
		...
		if (select) {
			Ext.each(select, function(record) {
				Ext.Ajax.request({
					url		: _global.location.http() + '/custom/sjflv/sale/saleorder/set/deli.do',
					params	: {
