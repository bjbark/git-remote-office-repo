Ext.define('module.custom.sjflv.mtrl.po.purcordr.view.PurcOrdrWorkerEditor', { extend: 'Axt.form.Editor',
	...
	header	: false,
	getStore: function() {
		return Ext.getStore( 'module.custom.sjflv.mtrl.po.purcordr.store.PurcOrdrInvoice' );
	},
...
//						}
					...
					hidden		: true
				},,{fieldLabel	: Language.get('won_pric', '원화단가' ),
					name		: 'won_pric',
					xtype		: 'numericfield',
					hidden		: true
