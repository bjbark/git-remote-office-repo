Ext.define('module.custom.sjflv.mtrl.po.purcordr.view.PurcOrdrIsttPopup', { extend: 'Axt.popup.Search',
	...
	finishAction: function(){
		...
		if(values.invc_date==''||values.invc_date==null){
			...
			Ext.Ajax.request({
				url		: _global.location.http() + '/system/custom/sjflv/mtrl/po/purcordr/set/istt2.do',
				params	: {
