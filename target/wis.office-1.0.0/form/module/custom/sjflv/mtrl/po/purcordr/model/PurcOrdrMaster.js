Ext.define('module.custom.sjflv.mtrl.po.purcordr.model.PurcOrdrMaster', { extend: 'Axt.data.Model',
	fields: [
		{	name: 'invc_numb'			, type: 'string'	/*invoice번호*/
		},{	name: 'amnd_degr'			, type: 'float'		/* amd차수	*/, defaultValue : 1
		},{	name: 'line_seqn'			, type: 'float'		/* amd차수	*/, defaultValue : 1
		},{	name: 'impt_amnd_degr'		, type: 'float'		/* amd차수	*/,
		},{	name: 'paym_numb'			, type: 'float'		/* amd차수	*/,
		...
		},{	name: 'paym_send_ddln'		, type: 'string'	/*송금기한 	*/, convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr,
		},{	name: 'paym_date'			, type: 'string'	/*지급일자 	*/, convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr,
		...
		},{	name: 'apvl_yorn'			, type: 'string'	/*승인여부*/, defaultValue : 0
		},{	name: 'mney_unit'			, type: 'string',	//화폐단위
		},{	name: 'trde_trnt_dvcd'		, type: 'string'	/*운송수단*/
		},{	name: 'won_pric'			, type: 'string'	/*원화단가*/
		},{	name: 'won_ttsm_amnt'		, type: 'string'	/*원화합계금액*/
		},{	name: 'impt_invc_numb'		, type: 'string'	/*운송수단*/
