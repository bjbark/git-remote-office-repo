Ext.define('module.custom.sjflv.mtrl.isttcalc.initstay.view.InitStayWorkerLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-mtrl-initstay-worker-lister',
	store		: 'module.custom.sjflv.mtrl.isttcalc.initstay.store.InitStayWorkerLister',
	...
	initComponent: function () {
		var rowIndexNum;
		var me = this;
		me.dockedItems = [{xtype: 'module-mtrl-initstay-worker-search'}];
