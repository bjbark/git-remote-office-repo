Ext.define('module.custom.sjflv.mtrl.isttcalc.purcpaywork.model.PurcPayWorkWorkerLister',{ extend:'Axt.data.Model',
	fields  : [
		...
		},{	name: 'orig_invc_seqn'		, type: 'float'		/* 원INVOICE번호	*/
		},{	name: 'txbl_numb'			, type: 'string'		/* 세금계산서번호		*/
		},{	name: 'istt_type'			, type: 'string'		/* 세금계산서번호		*/
