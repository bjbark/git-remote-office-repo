Ext.define('module.custom.sjflv.mtrl.imp.ordermast2.model.OrderMast2Master', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'paym_send_ddln'		, type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr
		},{	name: 'bzpl_idcd'			, type: 'string'	//사업장
		},{	name: 'cstm_idcd'			, type: 'string'	//거래처ID
		},{	name: 'offr_numb'			, type: 'string'	//발주번호
		},{	name: 'incm_dvcd'			, type: 'string' , defaultValue: '1000'	//수입구분코드
...
//		},{	name: 'buyr_name'			, type: 'string'	//바이어명
		...
		},{	name: 'pack_qntt'			, type: 'string'	//Pack Size(구매발주수정용)
