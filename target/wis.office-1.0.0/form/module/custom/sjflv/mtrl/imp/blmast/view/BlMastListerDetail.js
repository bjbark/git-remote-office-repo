Ext.define('module.custom.sjflv.mtrl.imp.blmast.view.BlMastListerDetail', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-blmast-lister-detail',
		...
		var me   = this,
			item =  {
				...
				items   : [
					...
					},{	dataIndex: ''	, text : Language.get(''	,'Order No'		) , width :  120 , xtype : 'numericcolumn'
