Ext.define('module.custom.sjflv.mtrl.imp.invoicemast.view.InvoiceMastWorkerEditor', { extend: 'Axt.form.Editor',

	alias	: 'widget.module-invoicemast-worker-editor',
	header	: false,
	height	: 110,
		...
		var me	= this,
			...
			items		: [
					{	xtype : 'fieldset',
						...
						},{	text		: '<span class="btnTemp" style="font-size:1.3em">대기 Order 조회</span>',
							xtype		: 'button',
							width		: 160,
							height		: 80,
							margin		: '2 0 0 0',
