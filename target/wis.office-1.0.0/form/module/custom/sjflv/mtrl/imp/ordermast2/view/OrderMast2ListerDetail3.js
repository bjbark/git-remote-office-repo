Ext.define('module.custom.sjflv.mtrl.imp.ordermast2.view.OrderMast2ListerDetail3', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-ordermast2-lister-detail3',

	store: 'module.custom.sjflv.mtrl.imp.ordermast2.store.OrderMast2Detail3',
