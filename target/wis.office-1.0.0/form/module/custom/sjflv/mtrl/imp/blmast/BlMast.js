Ext.define('module.custom.sjflv.mtrl.imp.blmast.BlMast', {  extend   : 'Axt.app.Controller',
	requires : [
	...
	models	: [
		'module.custom.sjflv.mtrl.imp.blmast.model.BlMastListerMaster',
		'module.custom.sjflv.mtrl.imp.blmast.model.BlMastListerDetail',
		'module.custom.sjflv.mtrl.imp.blmast.model.BlMastWorkerMaster',
	],
	stores	: [
		'module.custom.sjflv.mtrl.imp.blmast.store.BlMastListerMaster',
		'module.custom.sjflv.mtrl.imp.blmast.store.BlMastListerDetail',
		'module.custom.sjflv.mtrl.imp.blmast.store.BlMastWorkerMaster',
	],
	views	: [
		'module.custom.sjflv.mtrl.imp.blmast.view.BlMastLayout',
		'module.custom.sjflv.mtrl.imp.blmast.view.BlMastSearch',
		'module.custom.sjflv.mtrl.imp.blmast.view.BlMastListerMaster',
		'module.custom.sjflv.mtrl.imp.blmast.view.BlMastListerDetail',
		'module.custom.sjflv.mtrl.imp.blmast.view.BlMastWorkerEditor',
		'module.custom.sjflv.mtrl.imp.blmast.view.BlMastWorkerMaster',
		'module.custom.sjflv.mtrl.imp.blmast.view.BlMastWorkerDetail',
		'module.custom.sjflv.mtrl.imp.blmast.view.BlMastCostPopup',
		'module.custom.sjflv.mtrl.imp.blmast.view.BlMastInsertPopup'
	],
	...
	init: function() {
		var me = this;
		me.control({
			'module-blmast-layout #mainpanel'							: { tabchange : me.selectAction	},
			'module-blmast-layout button[action=selectAction]'			: { click : me.selectAction },
			'module-blmast-worker-editor button[action=selectAction2]'	: { click : me.selectAction2},	//조회2

			'module-blmast-lister-master button[action=costAction]'		: { click : me.costAction   }, /* 부대비용등록 */

			'module-blmast-worker-master button[action=InsertAction]'	: { click : me.InsertAction }, /* blInvoice 등록 */
		});
		me.callParent(arguments);
	},
	pocket : {
		layout	: function () { return Ext.ComponentQuery.query('module-blmast-layout')[0] },
		search	: function () { return Ext.ComponentQuery.query('module-blmast-search')[0] },
		lister	: function () { return Ext.ComponentQuery.query('module-blmast-lister')[0] },
		lister2	: function () { return Ext.ComponentQuery.query('module-blmast-lister2')[0] },
		worker : {
			editor : function () { return Ext.ComponentQuery.query('module-blmast-worker-editor')[0] },
			master : function () { return Ext.ComponentQuery.query('module-blmast-worker-master')[0] },
			detail : function () { return Ext.ComponentQuery.query('module-blmast-worker-detail')[0] }
		},
	},
...
//			master = me.pocket.lister.master()
		...
		var me = this
		resource.loadPopup({
			widget : 'module-blmast-cost-popup',
		});
...
//			master = me.pocket.lister.master()
		...
		var me = this
		resource.loadPopup({
			widget : 'module-blmast-insert-popup',
		});
//		var numb = Ext.ComponentQuery.query('#invc_numb')[0].setValue(records[0].data.invc_numb);
//		var numb2 = Ext.ComponentQuery.query('#cstm_name')[0].setValue(records[0].data.cstm_name);
	},
