Ext.define('module.custom.sjflv.mtrl.imp.estimast.model.EstiMastDetail', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'cstm_idcd'			, type: 'string'		//거래처품목코드
		...
		},{	name: 'expt_dvcd'			, type: 'string'		//부가세포함여부
		...
		},{	name: 'pric_cond_dvcd'		, type: 'string'		//생성UI
		},{	name: 'trde_stot_dvcd'		, type: 'string'		//생성UI
		},{	name: 'drtr_name'			, type: 'string'		//생성UI
		},{	name: 'dlvy_cond'			, type: 'string'		//생성UI
		}
	],
