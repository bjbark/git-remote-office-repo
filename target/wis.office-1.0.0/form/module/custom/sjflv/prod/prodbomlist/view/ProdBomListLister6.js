Ext.define('module.custom.sjflv.prod.prodbomlist.view.ProdBomListLister6', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-prodbomlist-lister6',
	store		: 'module.custom.sjflv.prod.prodbomlist.store.ProdBomListLister6',
	border		: 0,
		...
		var me = this,
			item = {
				...
				items : [
							...
							},{	dataIndex: 'invc_qntt'		, width:  60, align: 'right'	, text: Language.get('invc_qntt'		, '사용량'			), xtype:'numericcolumn', format:'#,##0.##'
