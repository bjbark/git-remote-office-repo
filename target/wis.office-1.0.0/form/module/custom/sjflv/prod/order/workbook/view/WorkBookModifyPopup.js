Ext.define('module.custom.sjflv.prod.order.workbook.view.WorkBookModifyPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-sjflv-workbook-modifypopup',
	...
	update: function(){
		var me = this,
			...
			endd_time,strt_time,
			lister = Ext.ComponentQuery.query('module-workbook-lister')[0]
		;
		...
		if(endd_time && strt_time){
			if(strt_time<=endd_time){
				Ext.Ajax.request({
					url		: _global.location.http() + '/prod/order/workbook/set/modify.do',
					params	: {
