Ext.define('module.custom.sjflv.prod.order.prodorder.model.ProdOrder2',{ extend:'Axt.data.Model',
	fields  : [
		{	name: 'invc_numb',			type: 'string'},		//invoice번호
		{	name: 'pdsd_numb',			type: 'string'},		//계획번호
		...
		{	name: 'plan_strt_dttm',		type: 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.dateTimeToStr},		//계획시작시간
		{	name: 'plan_endd_dttm',		type: 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.dateTimeToStr},		//계획시작시간
		...
		{	name: 'stok_used_qntt',		type: 'float' },		//수량
		{	name: 'prog_stat_dvcd',		type: 'string'},		//생성UI

		{	name: 'pckg_unit',			type: 'string'},		//포장단위
		{	name: 'labl_qntt',			type: 'float' },		//라벨수량
		{	name: 'yorn',				type: 'string'},		//분할여부
		{	name: 'drtr_idcd',			type: 'string'},		//분할여부
		{	name: 'drtr_name',			type: 'string'},		//분할여부
		{	name: 'work_invc',			type: 'string'},		//분할여부
		{	name: 'bomt_degr',			type: 'string'},
