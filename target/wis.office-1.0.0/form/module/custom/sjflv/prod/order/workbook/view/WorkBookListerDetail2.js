Ext.define('module.custom.sjflv.prod.order.workbook.view.WorkBookListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-workbook-lister-detail2',
	store		: 'module.custom.sjflv.prod.order.workbook.store.WorkBookDetail2',
