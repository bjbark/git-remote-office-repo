Ext.define('module.custom.sjflv.prod.order.workbook.model.WorkBook',{ extend:'Axt.data.Model',
	fields : [
		...
		{name: 'wker_idcd'				, type: 'string'},		//작업자ID
		{name: 'wker_name'				, type: 'string'},		//작업자ID
		...
		{name: 'wkct_idcd'				, type: 'string'},		//공정흐름ID
		{name: 'stnd_unit_qntt'			, type: 'float'},		//공정흐름ID
		{name: 'labl_qntt'				, type: 'float'},		//공정흐름ID
		...
		{name: 'mixx_rate'				, type: 'float'},		//생성UI
		{name: 'cvic_idcd'				, type: 'string'},		//생성ID
		{name: 'cvic_name'				, type: 'string'},		//생성UI
		{name: 'pckg_unit'				, type: 'string'},		//생성UI
		{name: 'usge_attc_yorn'			, type: 'string'},		//생성UI
		{name: 'yorn'					, type: 'string'},		//생성UI
		{name: 'work_invc'				, type: 'string'},		//생성UI
