Ext.define('module.custom.sjflv.prod.prodmtrlamnt.ProdMtrlAmnt', { extend:'Axt.app.Controller',
	...
	models	: [
		'module.custom.sjflv.prod.prodmtrlamnt.model.ProdMtrlAmntCost',
		'module.custom.sjflv.prod.prodmtrlamnt.model.ProdMtrlAmntLister2'
	],
	stores	: [
		'module.custom.sjflv.prod.prodmtrlamnt.store.ProdMtrlAmnt',
		'module.custom.sjflv.prod.prodmtrlamnt.store.ProdMtrlAmntLister2'
	],
	views	: [
		'module.custom.sjflv.prod.prodmtrlamnt.view.ProdMtrlAmntLayout',
		'module.custom.sjflv.prod.prodmtrlamnt.view.ProdMtrlAmntSearch',
		'module.custom.sjflv.prod.prodmtrlamnt.view.ProdMtrlAmntLister',
		'module.custom.sjflv.prod.prodmtrlamnt.view.ProdMtrlAmntLister2',
	],
