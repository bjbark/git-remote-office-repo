Ext.define('module.custom.sjflv.haccp.docmmast.view.DocmMastPopup1', { extend: 'Axt.popup.Upload',
	alias	: 'widget.module-sjflv-docmmast-popup1',
	...
	showHtml: function(){
		var me = this,
			...
			url = _global.location.http() + '/custom/sjflv/haccp/docmmast/get/html/template.do?param={"hq_id":"'+hq_id+'","api_host":"'+api_host+'","mngt_numb":"'+me.params.get('mngt_numb')+'"}',
			item = {
				xtype:'component',
				autoEl:{
					tag:'iframe',
	...
	finishAction: function() {
		var document = Ext.getCmp('docm_mast_html_viewer').el.dom.contentWindow.document;
