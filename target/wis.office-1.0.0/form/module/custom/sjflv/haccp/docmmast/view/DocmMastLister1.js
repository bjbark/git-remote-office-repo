Ext.define('module.custom.sjflv.haccp.docmmast.view.DocmMastLister1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-docmmast-lister1',
	
	store		: 'module.custom.sjflv.haccp.docmmast.store.DocmMastStore1',
	border		: 0,
	columnLines	: true,
