Ext.define('module.custom.sjflv.oms.omsmast.model.OmsMastSmpl',{ extend:'Axt.data.Model',
	 fields:
	[
		...
		{	name: 'labl_chck_yorn'		, type: 'string' },		//시리얼관리여부
		...
		{	name: 'make_natn'			, type: 'string' },		//검사수준구분코드
		{	name: 'make_natn_name'			, type: 'string' },		//검사수준구분코드
		...
		{	name: 'lead_time'			, type: 'float'  },		//리드타임
		...
		{	name: 'otod_yorn'			, type: 'string', defaultValue : '0' },		//OEM
		...
		{	name: 'make_cmpy_name2'			, type: 'string' },		//제조회사			(item_purc)
...
//		{	name: 'make_cmpy_name'		, type: 'string' },		//제조회사명
		...
		{	name: 'expt_dmst_dvcd'		, type: 'string' },		//내수,수출
		...
		{	name: 'labl_cont'			, type: 'string' },		//라벨내용
		{	name: 'labl_algy_code'		, type: 'string' },		//라벨알러지
		{	name: 'labl_algy_name'		, type: 'string' },		//라벨알러지명
