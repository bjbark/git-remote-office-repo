Ext.define('module.custom.komec.prod.workbook.view.WorkBookFailLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-komec-workbook-fail'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.custom.komec.prod.workbook.store.WorkBookFailLister',
	border		: 0,
