Ext.define('module.custom.komec.prod.prodplan.model.ProdPlanListerMaster', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'drtr_idcd'			, type: 'string', defaultValue: _global.login_pk		//담당자ID
		},{	name: 'drtr_name'			, type: 'string'	//담당자명
		},{	name: 'dept_idcd'			, type: 'string'	//부서ID
		},{	name: 'dept_name'			, type: 'string'	//부서명
		},{	name: 'ostt_wrhs_idcd'		, type: 'string'	//출고창고코드
		...
		},{	name: 'item_cnt'			, type: 'float' , defaultValue : 0		//
		...
		},{	name: 'deli_date'		, type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr,		//납기요청일자
		},{	name: 'login_nm'			, type: 'string' 	//로그인nm
		},{	name: 'login_id'			, type: 'string' 	//로그인id
		},{	name: 'cnt'					, type: 'string' 	//승인취소 확인값
