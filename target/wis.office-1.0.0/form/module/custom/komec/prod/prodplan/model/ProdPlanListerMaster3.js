Ext.define('module.custom.komec.prod.prodplan.model.ProdPlanListerMaster3', { extend: 'Axt.data.Model',
	fields: [
		{	name: 'invc_numb'			, type: 'string'	//invoice번호
		},{	name: 'line_clos'			, type: 'float'		//상태
		...
		},{	name: 'orig_indn_qntt'		, type: 'float'		//당초지시수량
		...
		},{	name: 'prog_stat_dvcd'		, type: 'string',	defaultValue:'0'	//진행상태
