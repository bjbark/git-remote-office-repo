Ext.define('module.custom.komec.item.itemmast.view.ItemMastEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemmast-editorlister'			,
	store		: 'module.custom.komec.item.itemmast.store.ItemMastFile',
