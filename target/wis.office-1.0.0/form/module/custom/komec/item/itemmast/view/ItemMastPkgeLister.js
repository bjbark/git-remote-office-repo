Ext.define('module.custom.komec.item.itemmast.view.ItemMastPkgeLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemmast-pkgelister'			,
	store		: 'module.custom.komec.item.itemmast.store.ItemMastPkge'	,
