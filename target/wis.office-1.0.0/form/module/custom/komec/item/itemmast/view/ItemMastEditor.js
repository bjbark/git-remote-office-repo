Ext.define('module.custom.komec.item.itemmast.view.ItemMastEditor', { extend: 'Axt.form.Editor',
			...
			item = {
				...
				items			: [
					{	fieldLabel	: Language.get('acct_bacd_name','계정구분'),
						...
						items	: [
							{	fieldLabel	: Language.get('yorn','LOT 관리'),
								xtype		: 'lookupfield',
								name		: 'lott_mngt_yorn',
								width		: 180,
								margin		: '0 0 0 0',
								lookupValue	: resource.lookup('yorn'),
							},{	fieldLabel	: Language.get('', '생산담당'),
								xtype		: 'popupfield',
								name		: 'drtr_name',
								pair		: 'drtr_idcd',
								width		: 185,
					...
					},{	fieldLabel	: Language.get('lott_idnf_code','LOT 식별'),
						width		: 370,
						xtype		: 'textfield',
						name		: 'lott_idnf_code',
						margin		: '0 0 5 0',
						...
						items		: [
							...
							},{	fieldLabel	: Language.get('','수입검사여부'),
								xtype		: 'lookupfield',
								name		: 'rcpt_insp_yorn',
								labelWidth	: 70,
								width		: 185,
