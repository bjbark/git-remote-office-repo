Ext.define('module.custom.komec.item.bommast.view.BomMastPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-komec-bommast-popup',
							...
							{	xtype : 'fieldset', layout: 'hbox', border		: 0,
								items : [
									{	fieldLabel	: Language.get('revs_numb', '리비전No' ),
										...
										value		: me.popup.param.revs_numb,
										readOnly	: true
									}
...
//							,{	xtype : 'fieldset', layout: 'hbox', border		: 0,
//								items : [
//									{	fieldLabel	: Language.get('befr_splr_name','(전)공급사'),
//										xtype		: 'textfield',
//										name		: 'befr_splr_name',
//										width		: 360,
//									}
...
//							},{	xtype : 'fieldset', layout: 'hbox', border		: 0,
//								items : [
//									{	fieldLabel	: Language.get('splr_name','(후)공급사'),
//										xtype		: 'textfield',
//										name		: 'splr_name',
//										width		: 360,
//									}
...
//							},{	xtype : 'fieldset', layout: 'hbox', border		: 0,
//								items : [
//									{	fieldLabel	: Language.get('usag_qntt_memo','사용량메모'),
//										xtype		: 'textfield',
//										name		: 'usag_qntt_memo',
//										width		: 360,
//									}
...
//							}
	...
	finishAction: function(){
		var me = this,
			...
			master	= Ext.ComponentQuery.query('module-komec-bommast-lister2')[0],
			lister	= Ext.ComponentQuery.query('module-komec-bommast-lister3')[0],
			record
		;
		if(!values.revs_numb){
