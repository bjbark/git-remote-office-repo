Ext.define('module.custom.komec.item.bomlist.view.BomListCstmLister3', { extend: 'Axt.grid.Panel',

	plugins		: [{ ptype:'gridcolumnconfig'  } ],

	alias		: 'widget.module-komec-bomlist-cstm-lister3',
	store		: 'module.custom.komec.item.bomlist.store.BomListCstmLister3',
