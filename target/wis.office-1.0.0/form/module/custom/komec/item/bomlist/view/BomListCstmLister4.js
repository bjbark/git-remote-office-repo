Ext.define('module.custom.komec.item.bomlist.view.BomListCstmLister4', { extend: 'Ext.tree.Panel',
	alias		: 'widget.module-komec-bomlist-cstm-lister4',
	store		: 'module.custom.komec.item.bomlist.store.BomListCstmLister4',
	border	: 0  ,
