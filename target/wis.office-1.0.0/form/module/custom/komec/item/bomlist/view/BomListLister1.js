Ext.define('module.custom.komec.item.bomlist.view.BomListLister1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-komec-bomlist-lister1',
	store		: 'module.custom.komec.item.bomlist.store.BomListLister1',
	border		: 0,
