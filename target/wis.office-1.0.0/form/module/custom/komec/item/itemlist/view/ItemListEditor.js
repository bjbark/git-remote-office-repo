Ext.define('module.custom.komec.item.itemlist.view.ItemListEditor', { extend: 'Axt.form.Editor',
		...
		var me = this,
			item = {
				...
				items	: [
					...
					{title : '포장정보',xtype: 'module-itemlist-pkgelister'},
				]
			}
		;
		return item;
	...
	createTab2 : function() {
		var me = this,
			item = {
				...
				name	: 'edit_tab2',
				region	: 'center',
				fieldDefaults	: { width : 360, labelWidth : 100, labelSeparator : '',margin:'0 0 0 0' , readOnly : true},
					items	: [
						{	xtype	: 'fieldset', layout: 'hbox' ,padding:'0', border: 0, margin:'10 0 5 0',
							items	: [
