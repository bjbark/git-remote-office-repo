Ext.define('module.custom.komec.sale.spts.sptsmast.view.SptsMastListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-komec-sptsmast-lister-detail',

	store: 'module.custom.komec.sale.spts.sptsmast.store.SptsMastDetail',
