Ext.define('module.custom.komec.sale.spts.sptsmast.view.SptsMastListerMaster2', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-komec-sptsmast-lister-master2',

	store		: 'module.custom.komec.sale.spts.sptsmast.store.SptsMastMaster2',
