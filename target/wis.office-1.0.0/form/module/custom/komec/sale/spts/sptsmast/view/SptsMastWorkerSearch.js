Ext.define('module.custom.komec.sale.spts.sptsmast.view.SptsMastWorkerSearch',{ extend: 'Axt.form.Search',
	store		: 'module.custom.komec.sale.spts.sptsmast.store.SptsMastWorkInvoice',
	alias: 'widget.module-komec-sptsmast-worker-search',
							...
							{	fieldLabel	: Language.get('acpt_numb','주문번호'),
								...
								popup: {
									...
									params : {
										...
										line_stat : '0',
										cstm_idcd : Ext.ComponentQuery.query('module-komec-sptsmast-worker-editor')[0].getValues().cstm_idcd,
										acpt_stat_dvcd : '0200'
									},
