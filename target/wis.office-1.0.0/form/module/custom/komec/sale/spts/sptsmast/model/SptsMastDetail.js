Ext.define('module.custom.komec.sale.spts.sptsmast.model.SptsMastDetail', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'prod_qntt'			, type: 'float'		//생산완료
		...
		},{	name: 'trst_qntt'			, type: 'float'		//중단수량
		},{	name: 'not_trst_qntt'		, type: 'float'		//중단수량
		},{	name: 'spts_qntt'			, type: 'float'		//의뢰수량
		...
		},{	name: '_invc_numb'			, type: 'string'	//신규로 생성할 Invoice 번호
		},{	name: '_drtr_idcd'			, type: 'string'	//신규로 생성할 Invoice 번호
		},{	name: '_ostt_schd_date'		, type: 'string', defaultValue : Ext.Date.format(new Date(),'Ymd'), convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr,
