Ext.define('module.custom.komec.sale.order.saleorder.view.SaleOrderFile', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-komec-saleorder-file'			,
	store		: 'module.custom.komec.sale.order.saleorder.store.SaleOrderFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),		// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-komec-saleorder-file')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
