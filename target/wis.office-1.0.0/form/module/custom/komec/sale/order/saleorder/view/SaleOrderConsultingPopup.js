Ext.define('module.custom.komec.sale.order.saleorder.view.SaleOrderConsultingPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-komec-saleorder-consulting-popup',
	...
	finishAction: function(){
		...
		mask.show();
		Ext.Ajax.request({
			url		: _global.location.http() + '/custom/komec/sale/order/saleorder/set/consulting.do',
			params	: {
