Ext.define('module.custom.komec.stock.isos.goodsosttwork.view.GoodsOsttWorkListerMaster1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-goodsosttwork-lister-master1',
	store		: 'module.custom.komec.stock.isos.goodsosttwork.store.GoodsOsttWorkMaster1',
...
//					},{ dataIndex: 'ostt_trnt_dvcd'	, text : Language.get('ostt_trnt_dvcd'	,'출고운송방법'	) , width : 100 , align : 'center', xtype : 'lookupcolumn', lookupValue : resource.lookup('ostt_trnt_dvcd'), hidden: true
//					},{ dataIndex: 'ostt_trnt_amnt'	, text : Language.get('ostt_trnt_amnt'	,'출고운송비용'	) , width : 120, align : 'right', xtype : 'numericcolumn', hidden: true
