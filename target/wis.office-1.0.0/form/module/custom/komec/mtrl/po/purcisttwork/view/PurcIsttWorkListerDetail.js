Ext.define('module.custom.komec.mtrl.po.purcisttwork.view.PurcIsttWorkListerDetail', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-purcisttwork-lister-detail',
	store		: 'module.custom.komec.mtrl.po.purcisttwork.store.PurcIsttWorkDetail',
