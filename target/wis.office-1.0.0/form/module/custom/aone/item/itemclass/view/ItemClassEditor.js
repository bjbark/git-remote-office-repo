Ext.define('module.custom.aone.item.itemclass.view.ItemClassEditor', {extend  : 'Axt.form.Editor',
		...
		var me = this,
			item = {
				...
				items		: [
					...
					},{	xtype: 'textfield'	, name : 'clss_name'	, fieldLabel : Language.get('clss_name','분류명'	),  allowBlank : false,
					},{	xtype: 'lookupfield', name : 'acct_bacd'	, fieldLabel : Language.get('acct_bacd','계정구분'	), lookupValue	: resource.lookup('acct_bacd'),  allowBlank : false,
					},{	xtype: 'textarea'	, name : 'user_memo'	, fieldLabel : Language.get('user_memo','메모사항'	)  , height	:  100,
					}
				]
			}
		;
