Ext.define('module.custom.aone.item.itemmast.model.ItemMast', { extend:'Axt.data.Model',
	fields: [
		{	name: 'item_idcd'			, type: 'string' },		//품목ID
		{	name: 'line_seqn'			, type: 'float'   , defaultValue : 1},		//순번
		{	name: 'item_code'			, type: 'string' },		//품목코드
		{	name: 'item_code_prefix'	, type: 'string' },		//품목코드
		{	name: 'item_code_subfix'	, type: 'string' },		//품목코드
		...
		{	name: 'lcls_code'			, type: 'string' },		//대분류id
		{	name: 'mcls_code'			, type: 'string' },		//중분류id
		{	name: 'scls_code'			, type: 'string' },		//소분류id
		...
		{	name: 'prts_type_name'		, type: 'string' },		//부품타입명
		{	name: 'mker_name'			, type: 'string' },		//브랜드명
		...
		{	name: 'dvrs_item_idcd'		, type: 'string' },		//전용품목
		{	name: 'dvrs_item_name'		, type: 'string' },		//전용품목
		...
		{	name: 'zone_name'			, type: 'string' },		//보관위치
