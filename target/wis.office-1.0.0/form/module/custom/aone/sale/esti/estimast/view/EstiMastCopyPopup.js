Ext.define('module.custom.aone.sale.esti.estimast.view.EstiMastCopyPopup', { extend: 'Axt.popup.Search',
					...
					items	: [
						{	xtype		: 'form-panel',
							...
							items		: [
								...
								},{	fieldLabel	:  Language.get( '' , '견적일자'),
									name		: 'invc_date',
									itemId		: 'invc_date',
									format		: Const.DATE_FORMAT_YMD_BAR,
									submitFormat: Const.DATE_FORMAT_YMD,
									value		: me.popup.params.invc_date,
									xtype		: 'datefield',
									hidden		: true
								}
							]
	...
	finishAction: function(){
		...
		mask.show();
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/aone/sale/estimast/set/copy.do',
				params	: {
