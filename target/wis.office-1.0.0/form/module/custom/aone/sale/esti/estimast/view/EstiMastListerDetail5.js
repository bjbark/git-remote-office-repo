Ext.define('module.custom.aone.sale.esti.estimast.view.EstiMastListerDetail5', { extend: 'Axt.form.Editor',
	alias		: 'widget.module-estimast-lister-detail5',
	store		: 'module.custom.aone.sale.esti.estimast.store.EstiMastDetail',
								...
								{	xtype		: 'form-panel',
									...
									items		: [
										{	xtype	: 'form-panel',
											...
											border	:  false,
											url		: 'system/custom/aone/sale/estimast/set/fileUpload.do',
											timeout	: 120000,
											method	: 'POST',
												...
												{    xtype : 'textfield',
													...
													listeners	: {
														change	: function (field) {
															...
															}Ext.ComponentQuery.query('module-estimast-worker-editor')[0].down('[name=modi_yorn]').setValue('Y');
														}
													}
													...
													listeners	: {
														change	: function (field) {
															...
															}Ext.ComponentQuery.query('module-estimast-worker-editor')[0].down('[name=modify]').setValue('Y');
														}
													}
