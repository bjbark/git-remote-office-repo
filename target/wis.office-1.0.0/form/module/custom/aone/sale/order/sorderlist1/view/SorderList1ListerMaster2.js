Ext.define('module.custom.aone.sale.order.sorderlist1.view.SorderList1ListerMaster2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sorderlist1-lister-master2',
	store		: 'module.custom.aone.sale.order.sorderlist1.store.SorderList1Master2'	,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'invc_numb'		, text : Language.get(''	,'AoneCode'	)	, width : 100 , align : 'left'
