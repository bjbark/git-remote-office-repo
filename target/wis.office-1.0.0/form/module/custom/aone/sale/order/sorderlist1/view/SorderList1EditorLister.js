Ext.define('module.custom.aone.sale.order.sorderlist1.view.SorderList1EditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-aone-sorderlist1-editorlister',
	store		: 'module.custom.aone.sale.order.sorderlist1.store.SorderList1File',
