Ext.define('module.custom.aone.sale.order.sordermast.view.SorderMastCalcPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-aone-sordermast-calc-popup',
	...
	*/
	...
	editorForm : function() {
		var me   = this,
			form = {
					...
					listeners:{
						afterrender : function(self, value){
							console.log('t?');
							me.calc();
						}
					},
										...
										{	xtype : 'fieldset', layout: 'hbox' ,padding:'0', border: 0, margin : '0 0 5 0',
											...
											items   : [
												{   fieldLabel  : Language.get('prts_repa_amnt','부품비 총액'),
													...
													labelWidth  : 100,
													margin      : '5 0 0 0',
													value       : me.params.prts_repa_amnt?me.params.prts_repa_amnt:0,
													labelStyle  : 'color:white',
													fieldCls    : 'requiredindex',
													readOnly    : true,
													listeners:{
	...
	finishAction: function(){
		var me = this,
			...
			store	= Ext.ComponentQuery.query('module-aone-sordermast-lister-master')[0].getStore()
		;
		...
		mask.show();
		Ext.Ajax.request({
			url     : _global.location.http() + '/custom/aone/sale/order/sordermast/set/repairCalc.do',
			params  : {
	...
	addCalc:function(){
			...
			resource.loadPopup({
				widget : 'module-aone-sordermast-popup',
				params : {
	...
	calc : function(){
		...
		var prts_repa_amnt = prts_repa_amnt?prts_repa_amnt:0;
