Ext.define('module.custom.aone.sale.order.sorderplan.view.SorderPlanImageLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-aone-sorderplan-image-lister'			,
	store		: 'module.custom.aone.sale.order.sorderplan.store.SorderPlanImage',
