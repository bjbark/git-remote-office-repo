Ext.define('module.custom.aone.sale.order.sordercofm.view.SorderCofmSearch', { extend: 'Axt.form.Search',


	alias: 'widget.module-sordercofm-search',
	/**
	 *
	 */
					...
					{	xtype	: 'fieldset',
						...
						items	: [
							{	xtype	: 'label'			,
								...
								xtype		: 'searchfield'	,
								flex		: 4				,
								emptyText	: '조회할 견적번호 또는 견적명을 입력하세요...',
