Ext.define('module.custom.aone.sale.order.sorderostt.view.SorderOsttPopupMans', { extend: 'Axt.grid.Panel',
	alias: 'widget.module-sorderostt-popup-mans',
	store: 'module.custom.aone.sale.order.sorderostt.store.SorderOsttPopupMans',
