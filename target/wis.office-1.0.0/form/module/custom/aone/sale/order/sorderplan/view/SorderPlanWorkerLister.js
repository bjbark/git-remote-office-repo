Ext.define('module.custom.aone.sale.order.sorderplan.view.SorderPlanWorkerLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-aone-sorderplan-worker-editorLister'			,
	store		: 'module.custom.aone.sale.order.sorderplan.store.SorderPlanFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-aone-sorderplan-worker-editorLister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
			...
			item = {
				...
				items : [
					{	dataIndex: 'line_seqn'		, text : Language.get('line_seqn'		,'순번'	)		, width : 80 , align : 'center',hidden:true
						...
						align : 'center'
					},{ dataIndex: 'upld_dttm'		, text : Language.get('upld_dttm'		,'업로드일시'	)	, width : 110 , align : 'center'
