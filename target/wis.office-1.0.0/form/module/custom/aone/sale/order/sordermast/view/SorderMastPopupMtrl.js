Ext.define('module.custom.aone.sale.order.sordermast.view.SorderMastPopupMtrl', { extend: 'Axt.grid.Panel',
	alias: 'widget.module-aone-sordermast-popup-mtrl',
	store: 'module.custom.aone.sale.order.sordermast.store.SorderMastPopupMtrl',
