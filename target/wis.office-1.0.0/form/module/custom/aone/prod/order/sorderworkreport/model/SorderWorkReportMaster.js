Ext.define('module.custom.aone.prod.order.sorderworkreport.model.SorderWorkReportMaster', { extend: 'Axt.data.Model',
	fields : [
		...
		},{	name: 'work_endd_dttm'		, type: 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.dateToStr,	//지시일정
		...
		},{	name: 'need_time'			, type: 'float'		//소요시간
		...
		},{	name: 'wkrpImage'			, type: 'string'	//수리이미지1
		},{	name: 'wkrpImage2'			, type: 'string'	//수리이미지2
		}
	]
});