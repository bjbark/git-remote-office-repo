Ext.define('module.custom.aone.prod.order.sorderworkreport.view.SorderWorkReportFile', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sorderworkreport-file',
	store		: 'module.custom.aone.prod.order.sorderworkreport.store.SorderWorkReportFile',
