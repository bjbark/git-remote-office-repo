Ext.define('module.custom.aone.prod.order.sorderworkreport.view.SorderWorkReportSearch', { extend: 'Axt.form.Search',

	alias: 'widget.module-sorderworkreport-search',
					...
					{	xtype : 'fieldset', layout: 'hbox',
						items : [
							{	fieldLabel	: Language.get('inqy_term','조회기간'),
								...
								xtype		: 'lookupfield',
								name		: 'acpt_stat_dvcd',
								lookupValue	: resource.lookup('search_all').concat( resource.lookup('acpt_stat_dvcd' ).slice(1,3) ),
								width		: 180,
								editable	: false
