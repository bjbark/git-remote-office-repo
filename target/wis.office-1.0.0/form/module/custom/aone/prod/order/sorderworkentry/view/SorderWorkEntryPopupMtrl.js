Ext.define('module.custom.aone.sale.order.sorderworkentry.view.SorderWorkEntryPopupMtrl', { extend: 'Axt.grid.Panel',
	alias: 'widget.module-sorderworkentry-popup-mtrl',
	store: 'module.custom.aone.prod.order.sorderworkentry.store.SorderWorkEntryPopupMtrl',
		...
		var me = this,
			item = {
				...
				items : [
								...
								handler	: function (grid, rowIndex, colIndex, item, e, record) {
									...
									result	: function(records) {
										...
										;
											...
											record.set('wrhs_idcd',parent.data.istt_wrhs_idcd);
											record.set('wrhs_name',parent.data.istt_wrhs_name);
					...
					},{	dataIndex:	'wrhs_name'		, width:  120 , align : 'center'	, text: Language.get('wrhs_name', '창고'),
					},{	dataIndex:	'zone_name'		, width:  100 , align : 'center'	, text: Language.get('zone_name', '구역'),
					},{	dataIndex:	'wrhs_idcd'		, width:  100 , align : 'center'	, text: Language.get('wrhs_idcd', '창고'), hidden : true,
...
//		}
	...
	lineInsert : function (config) {
		var me			= this,
			...
			record		= undefined,
			uper_seqn	= 0,
			mlister		= Ext.ComponentQuery.query('module-sorderworkentry-popup-mtrl')[0],
		...
		record = Ext.create( store.model.modelName , {
			line_seqn			: seq,
			work_invc_numb		: editor.down('[name=work_invc_numb]').getValue(),
		});
		store.add(record);
	},
	/**
