Ext.define('module.custom.inkopack.sale.order.saleorder.model.SaleOrderDetail2',{ extend:'Axt.data.Model',
	fields: [
		...
		{name: 'user_name',				type: 'string' , defaultValue : _global.login_nm},		//담당자명
