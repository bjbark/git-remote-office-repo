Ext.define('module.custom.inkopack.sale.order.saleorder.model.SaleOrderMaster', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'nutc_valu'			, type: 'string' 	//넛찌여부
		...
		},{	name: 'invc_amnt'			, type: 'float'		// 수량

		},{	name: 'dlvy_exps'			, type: 'float'		// 택배비
		},{	name: 'post_code'			, type: 'string'	// 우편번호
		},{	name: 'addr_1fst'			, type: 'string'	// 주소1
		},{	name: 'addr_2snd'			, type: 'string'	// 주소2
		},{	name: 'tele_numb_1fst'		, type: 'string'	// 전화번호1
		},{	name: 'tele_numb_2snd'		, type: 'string'	// 전화번호2
		},{	name: 'rctr_name'			, type: 'string'	// 수취인
		},{	name: 'send_hmlf'			, type: 'string' , defaultValue : '(주)인코팩'	// 발송인
		},{	name: 'dlvy_atcl'			, type: 'string'	// 전달사항
		},{	name: 'line_seqn2'			, type: 'float'		// 거래처배송처 마지막시퀀스
		},{	name: 'last_seqn'			, type: 'float'		// 거래처배송처 마지막시퀀스
		},{	name: 'dlvy_line_seqn'		, type: 'float'		// 거래처배송처 시퀀스
		},{	name: 'pric_burd_dvcd'		, type: 'string'	// 운임부담구분코드
		},{	name: 'pric_burd_dvcd1'		, type: 'string'	// 운임부담구분코드 자사
		},{	name: 'pric_burd_dvcd2'		, type: 'string'	// 운임부담구분코드 고객사
		}
