Ext.define('module.custom.inkopack.prod.workentry.view.WorkEntryUserPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-workentry-user-popup',
	alias	: 'widget.lookup-workentry-user-popup',
	store	: 'module.custom.inkopack.prod.workentry.store.WorkEntryUserPopup',
		...
		var me = this,
			grid = {
				...
				columns: [
					...
					},{	text: Language.get('user_name','사원명')		, dataIndex: 'user_name',   width  : 250,
						renderer: function(value, meta){
							meta.style = 'font-size:3em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						},
					},{ text: Language.get('dept_name'    , '부서'  )	, dataIndex: 'dept_name'	, width: 300,
						renderer: function(value, meta){
							meta.style = 'font-size:3em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						},
