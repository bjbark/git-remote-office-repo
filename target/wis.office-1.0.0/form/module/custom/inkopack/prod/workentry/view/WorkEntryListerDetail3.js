Ext.define('module.custom.inkopack.prod.workentry.view.WorkEntryListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workentry-detail3'			,
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-workentry-detailSearch'}];
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'prod_qntt'		, text : Language.get(''			,'생산수량'	) , width	: 85	, xtype:'numericcolumn'
