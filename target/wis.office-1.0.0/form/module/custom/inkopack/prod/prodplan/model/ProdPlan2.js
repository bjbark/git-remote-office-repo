Ext.define('module.custom.inkopack.prod.prodplan.model.ProdPlan2', { extend:'Axt.data.Model',
	fields : [

		{	name : 'hq_id'				, type : 'string'  , defaultValue : _global.hq_id
		},{	name : 'invc_numb'			, type : 'string'		//Invoice번호
		},{	name : 'line_seqn'			, type : 'string'		//순번
		},{	name : 'wkct_idcd'			, type : 'string'		//사업장ID
		...
		},{	name : 'plan_strt_dttm'		, type : 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.dateToStr		//시작시간
