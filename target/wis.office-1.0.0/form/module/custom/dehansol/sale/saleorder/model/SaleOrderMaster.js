Ext.define('module.custom.dehansol.sale.saleorder.model.SaleOrderMaster', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'asmt_code'			, type: 'string'	// 부자재관리코드
		},{	name: 'kor2_brcd'			, type: 'string'	// 코리아써키트2 바코드
