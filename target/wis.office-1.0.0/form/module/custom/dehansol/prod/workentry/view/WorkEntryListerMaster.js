Ext.define('module.custom.dehansol.prod.workentry.view.WorkEntryListerMaster', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-dehansol-workentry-lister'			,
	store		: 'module.custom.dehansol.prod.workentry.store.WorkEntry',
	...
	pagingItem : function () {
		var me		= this,
			item	= {
				...
				items	: [
					'->', '-' ,
					{text : '<span class="btnTemp" style="font-size:1.5em;">추가</span>', iconCls: Const.INSERT.icon, handler : me.insert  , cls: 'button-style',itemId : 'insert' ,width: 100, height : 35} ,
					...
					{text : '<span class="btnTemp" style="font-size:1.5em;">엑셀</span>', iconCls: Const.EXPORT.icon, action  : Const.EXPORT.action, cls: 'button-style',itemId : 'master' ,width: 100, height : 35},
	...
	columnItem : function () {
		var me		= this,
			item	= {
				...
				items	: [
					{	dataIndex : 'work_strt_time'	, width : 70, align : 'center'	, text : Language.get( 'work_strt_time'	, '시작시간'			),
						renderer:function(a){
							var value = a.substring(0,2)+':'+a.substring(2,4);
							return value;
						}
					},{	dataIndex : 'work_endd_dttm'	, width : 170, align : 'center'	, text : Language.get( 'work_endd_dttm'	, '종료일자'			), hidden:true
					},{	dataIndex :	'wk_time'			, width :  70, align : 'left'	, text : Language.get( 'wk_time'		, '소요시간'			), align:'center'
					},{	dataIndex :	'item_code'			, width : 120, align : 'center'	, text : Language.get( 'item_code'		, 'TOOL CODE'		)
					},{	dataIndex : 'wkct_name'			, width :  80, align : 'left'	, text : Language.get( 'wkct_name'		, '공정'				), hidden:true
				...
				{	text	: '<span class="btnTemp" style="font-size:3em">확인</span>',
					...
					handler	: function() {
						...
						if(param.invc_date==null || param.invc_date ==''){
							...
							var invc_numb,succ_qntt,work_strt_time,work_endd_time
							;
