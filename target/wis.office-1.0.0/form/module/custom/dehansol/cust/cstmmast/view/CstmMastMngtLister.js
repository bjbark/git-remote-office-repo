Ext.define('module.custom.dehansol.cust.cstmmast.view.CstmMastMngtLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-cstmmast-mngtlister'			,
	store		: 'module.custom.dehansol.cust.cstmmast.store.CstmMastMngt'	,
	...
	initComponent: function () {
		...
		if((_global.hq_id).toUpperCase()=='N1000HJSYS'){
			...
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/dehansol/cust/custmast/get/mngt.do',
				params	: {
