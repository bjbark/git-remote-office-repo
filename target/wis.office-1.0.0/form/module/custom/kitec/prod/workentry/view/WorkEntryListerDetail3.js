Ext.define('module.custom.kitec.prod.workentry.view.WorkEntryListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-kitec-workenty-detail3'			,
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-kitec-workenty-detailSearch'}];
		...
		var me = this,
			item = {
				...
				items : [
					{	dataIndex: 'prog_stat_dvcd'	, text : Language.get('prog_stat_dvcd'	,'상태'		) , width	:  90, xtype : 'lookupcolumn', lookupValue : resource.lookup('prog_stat_dvcd'), align : 'center'
					},{ dataIndex: 'wkct_name'		, text : Language.get('wkct'		,'공정'		) , width	: 120, align : 'center'
						...
						renderer: function(val,meta,rec) {
							var id     = Ext.id(),
								search = Ext.ComponentQuery.query('module-kitec-workenty-detailSearch')[0]
	...
	insert : function (rec) {
		var search = Ext.ComponentQuery.query('module-kitec-workenty-detailSearch')[0],
			store = this.getStore(),
