Ext.define('module.custom.kitec.prod.workentry.view.WorkEntryTapPopup', { extend: 'Axt.popup.Search',
	id 		: 'module-kitec-workenty-tap-popup',
	alias	: 'widget.module-kitec-workenty-tap-popup',
	store	: 'module.custom.kitec.prod.workentry.store.WorkEntryTapPopup',
	...
	finishAction: function(){
		...
		Ext.Ajax.request({
			url			: _global.api_host_info + '/' + _global.app_site + '/custom/kitec/prod/workentry/get/assy_seqn.do',
			method		: "POST",
			params		: {
