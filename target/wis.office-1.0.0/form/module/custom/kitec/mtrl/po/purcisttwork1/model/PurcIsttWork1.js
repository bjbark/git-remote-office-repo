Ext.define('module.custom.kitec.mtrl.po.purcisttwork1.model.PurcIsttWork1',{ extend:'Axt.data.Model',
	fields  : [
		{	name: 'invc_numb',					type: 'string'},		//발주INVOICE번호
		{	name: 'new_invc_numb',			type: 'string'},		//입고INVOICE번호
		...
		{	name: 'diff_qntt',						type: 'float' },		//미납잔량
		...
		{	name: 'offr_pric',						type: 'float' },		//발주금액
		...
		{	name: 'new_dlvy_qntt',			type: 'float' },		//납품수량
		...
		{	name: 'amnd_degr',				type: 'float' },		//발주AMD차수
