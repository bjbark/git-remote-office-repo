Ext.define('module.custom.kitec.mtrl.po.purcisttwork1.view.PurcIsttWork1ListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-purcisttwork1-lister-master',
	store		: 'module.custom.kitec.mtrl.po.purcisttwork1.store.PurcIsttWork1Master',
	...
	pagingItem : function () {
		var me = this,
			item = {
				...
				items	: [
					'->','-' ,
					{	text : '<span class="write-button">수입검사 필증 발행</span>', action : 'PrintAction', cls: 'button1-style'	,width: 110},
