Ext.define('module.custom.dhtec.prod.workentry.view.WorkEntryFailLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-dhtec-workenty-fail'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.custom.dhtec.prod.workentry.store.WorkEntryFailLister',
	border		: 0,
	...
	listeners:{
		afterrender:function(){
			var store = Ext.ComponentQuery.query('module-dhtec-workenty-fail')[0].getStore(),
