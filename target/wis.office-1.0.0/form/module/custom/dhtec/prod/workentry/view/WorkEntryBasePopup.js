Ext.define('module.custom.dhtec.prod.workentry.view.WorkEntryBasePopup', { extend: 'Axt.popup.Search',

	id		: 'module-dhtec-workenty-basepopup',
	alias	: 'widget.module-dhtec-workenty-basepopup',
	store	: 'module.custom.dhtec.prod.workentry.store.WorkEntryBasePopup',
	title	: '기초 코드 정보',
	closable: true,
	autoShow: true,
	width	: 500,
	...
	createGrid: function(){
		var me = this,
			grid = {
				...
				columns:[
					{	text : Language.get( 'base_code' , 'code'       )	, dataIndex: 'base_code'	, width: 100, align:'center',
						renderer: function(value, meta){
							meta.style = 'font-size:1.8em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						},
					},{	text : Language.get( 'base_name' , 'Code name'  )	, dataIndex: 'base_name'	, width: 150,
						renderer: function(value, meta){
							meta.style = 'font-size:1.8em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						},
