Ext.define('module.custom.dhtec.prod.workentry.view.WorkEntryListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-dhtec-workenty-detail3'			,
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-dhtec-workenty-detailSearch'}];
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex: 'prog_stat_dvcd'	, text : Language.get('prog_stat_dvcd'	,'상태'		) , width	:  90, xtype : 'lookupcolumn', lookupValue : resource.lookup('prog_stat_dvcd'), align : 'center'
					},{ dataIndex: 'wkod_numb'		, text : Language.get('ordr_numb'		,'지시번호'	) , width	: 120, align : 'center'
					},{ dataIndex: ''				, text : Language.get('work_sttm'		,'시작일시'	) , width	:  200, align : 'center',
					},{ dataIndex: ''				, text : Language.get('work_edtm'		,'종료일시'	) , width	:  200, align : 'center'
					},{ dataIndex: 'cstm_name'		, text : Language.get('lott_numb'		,'거래처명'	) , width	: 180, align : 'left'
					},{ dataIndex: 'invc_numb2'		, text : Language.get('invc_numb2'		,'수주번호'	) , width	: 120, align : 'center'
					...
					},{ dataIndex: 'modl_name'		, text : Language.get('item_spec'		,'모델명'		) , width	: 200, align : 'left'
						...
						renderer: function(val,meta,rec) {
							var id     = Ext.id(),
								search = Ext.ComponentQuery.query('module-dhtec-workenty-detailSearch')[0]
	...
	insert : function (rec) {
		var search = Ext.ComponentQuery.query('module-dhtec-workenty-detailSearch')[0],
			store = this.getStore(),
