Ext.define('module.custom.dhtec.prod.order.workentry.view.WorkEntryPoorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-dhtec-workenty-poor'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.custom.dhtec.prod.workentry.store.WorkEntryPoorLister',
	border		: 0,
	...
	listeners:{
		afterrender:function(){
			var store = Ext.ComponentQuery.query('module-dhtec-workenty-poor')[0].getStore(),
