Ext.define('module.custom.dhtec.sale.order.saleplanorder2.view.SalePlanOrder2Editor', { extend: 'Axt.form.Editor',

	alias: 'widget.module-saleplanorder2-editor',
