Ext.define('module.custom.dhtec.sale.order.saleplanorder.view.SalePlanOrderLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-saleplanorder-lister'			,
	store		: 'module.custom.dhtec.sale.order.saleplanorder.store.SalePlanOrder'	,
