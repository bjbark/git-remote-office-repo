Ext.define('module.custom.dhtec.sale.etc.smplmast.view.SmplMastLister', { extend: 'Axt.grid.Panel',
	 alias		: 'widget.module-smplmast-lister'			,
	store		: 'module.custom.dhtec.sale.etc.smplmast.store.SmplMast'	,
...
//					},{	dataIndex: 'amnd_degr'		, text : Language.get(''	,'변경찻수')	, width : 55	, align : 'center'
					...
					},{	dataIndex: 'item_memo'		, text : Language.get(''	,'품목메모')	, width : 200	, align : 'left'
