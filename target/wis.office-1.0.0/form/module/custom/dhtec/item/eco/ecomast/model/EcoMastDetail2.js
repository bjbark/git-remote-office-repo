Ext.define('module.custom.dhtec.item.eco.ecomast.model.EcoMastDetail2', { extend: 'Axt.data.Model',
	fields: [
		{	name: 'ecod_idcd'			, type: 'string'		//ECOID
		},{	name: 'ecod_idcd2'		, type: 'string'			//ECOID 복사
		...
		},{	name: 'wkfw_name'			, type: 'string'		//공정명
		},{	name: 'wkfw_idcd'			, type: 'string'		//공정명
