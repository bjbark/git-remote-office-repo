Ext.define('module.custom.dhtec.item.eco.ecomast.view.EcoMastListerDetail2', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-ecomast-lister-detail2',
	height		: 200,
	store: 'module.custom.dhtec.item.eco.ecomast.store.EcoMastDetail2',
