Ext.define('module.custom.dhtec.item.eco.ecomast.view.EcoMastWorkerSearch', { extend: 'Axt.form.Search',
	store	: 'module.custom.dhtec.item.eco.ecomast.store.EcoMastInvoice',
