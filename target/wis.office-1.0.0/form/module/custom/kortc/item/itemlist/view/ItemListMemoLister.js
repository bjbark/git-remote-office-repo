Ext.define('module.custom.kortc.item.itemlist.view.ItemListMemoLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemlist-memolister'			,
	store		: 'module.custom.kortc.item.itemlist.store.ItemListMemo'	,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex:	'memo_date'			, width: 100, align : 'left'	, text: Language.get( 'memo_date'	, '작성일자'		)
					},{	dataIndex:	'drtr_name'			, width: 100, align : 'left'	, text: Language.get( 'drtr_name'	, '담당자'		)
					},{	dataIndex:	'item_memo'			, flex : 1, align : 'left'	, text: Language.get( 'item_memo'		, '메모'	),
						tdCls : 'editingcolumn',
						editor	: {
							xtype		:'textfield',
							selectOnFocus: true,
