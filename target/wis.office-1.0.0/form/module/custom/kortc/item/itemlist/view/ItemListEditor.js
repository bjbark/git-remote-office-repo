Ext.define('module.custom.kortc.item.itemlist.view.ItemListEditor', { extend: 'Axt.form.Editor',
	...
	createwest : function () {
		var me = this,
			item = {
				...
				fieldDefaults	: { width : 340, labelWidth : 65, labelSeparator : '', readOnly : true},
				items			: [
								...
								{	name		: 'drtr_idcd', xtype : 'textfield' , hidden : true
									...
									items	: [
												{	fieldLabel	: Language.get('yorn','인수검사'),
													...
													width		: 200,
													lookupValue	: resource.lookup('yorn')
												},{	fieldLabel	: Language.get('puch_pric','안전납기'),
													xtype		: 'numericfield',
													name		: 'puch_pric',
													width		: 200,
												}
									...
									items	: [
										{	fieldLabel	: Language.get('ogin_bacd_name','색상'),
											xtype		: 'popupfield',
											editable	: true,
											enableKeyEvents : true,
											name		: 'colr_bacd_name',
									...
									items	: [
										{	fieldLabel	: Language.get('ogin_bacd_name','재질'),
											xtype		: 'popupfield',
											editable	: true,
											enableKeyEvents : true,
											name		: 'mtrl_bacd_name',
...
//											]
	...
	calc:function(){
		var me			= this,
			...
			store		= Ext.ComponentQuery.query('module-itemlist-lister')[0],
