Ext.define('module.custom.kortc.item.itemlist.view.ItemListLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemlist-lister'			,
	store		: 'module.custom.kortc.item.itemlist.store.ItemList'	,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex:	'unit_name'			, width:  70, align : 'left'	, text: Language.get( 'unit_name'		, '단위'		)
					},{	dataIndex:	'acct_bacd_name'	, width: 120, align : 'left'	, text: Language.get( 'acct_bacd_name'	, '계정구분'	), hidden: _global.options.mes_system_type =='Frame',
					...
					},{	dataIndex:	'stok_mngt_yorn'	, width: 100, align : 'center'	, text: Language.get( 'stok_mngt_yorn'	, '재고관리'	), xtype: 'lookupcolumn' , lookupValue: resource.lookup( 'yorn' )
					},{	dataIndex:	'dvrs_item_idcd'	, width: 150, align : 'center'	, text: Language.get( 'dvrs_item_idcd'	, '전용품목'	)
