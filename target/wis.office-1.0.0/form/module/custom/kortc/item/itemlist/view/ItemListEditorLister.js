Ext.define('module.custom.kortc.item.itemlist.view.ItemListEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemlist-editorlister'			,
	store		: 'module.custom.kortc.item.itemlist.store.ItemListFile',
