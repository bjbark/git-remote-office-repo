Ext.define('module.custom.kortc.item.itemmast.view.ItemMastEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemmast-editorlister'			,
	store		: 'module.custom.kortc.item.itemmast.store.ItemMastFile',
