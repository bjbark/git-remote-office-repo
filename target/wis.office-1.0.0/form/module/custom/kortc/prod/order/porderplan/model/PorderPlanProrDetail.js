Ext.define('module.custom.kortc.prod.order.porderplan.model.PorderPlanProrDetail', { extend: 'Axt.data.Model',
	fields : [
		...
		},{	name : 'insp_wkct_yorn'		, type: 'boolean'	//검사공정여부
		},{	name : 'last_wkct_yorn'		, type: 'boolean'	//최종공정여부
		},{	name : 'cofm_yorn'			, type: 'boolean'	//확정여부
