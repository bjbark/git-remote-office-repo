Ext.define('module.custom.kortc.prod.order.prodinput.ProdInput', { extend : 'Axt.app.Controller',
	...
	models:[
		'module.custom.kortc.prod.order.prodinput.model.ProdInput',
		'module.custom.kortc.prod.order.prodinput.model.ProdInput'
	],
	stores:[
		'module.custom.kortc.prod.order.prodinput.store.ProdInput',
		'module.custom.kortc.prod.order.prodinput.store.ProdInput'
	],
	views : [
		'module.custom.kortc.prod.order.prodinput.view.ProdInputLayout',
		/* 현황 */
		'module.custom.kortc.prod.order.prodinput.view.ProdInputSearch',
		'module.custom.kortc.prod.order.prodinput.view.ProdInputLister'
		/* 작업 */
	],
...
//		this.joinPermission(workspace.down('module-porderlist2-lister-master menuitem[action=closeCancelAction]'), Const.PERMIT.MODIFY);
		this.joinPermission(workspace.down('module-prodinput-lister button[action=etcPrintAction]'),      Const.PERMIT.EXPORT);
	},
	init: function() {
		var me = this;
		me.control({
			'module-porderlist2-layout button[action=selectAction]'					: { click : me.selectAction		}, /* 조회		*/

			'module-porderlist2-lister-detail2 button[action=exportAction]'			: { click : me.exportDetailAction}, /* 엑셀		*/

//			'module-porderlist2-worker-lister button[action=updateAction]'			: { click : me.updateAction		}, /* 저장		*/
//			'module-porderlist2-worker-lister button[action=cancelAction]'			: { click : me.cancelAction		}, /* 취소		*/
			'module-porderlist2-lister-master' : {
	...
	pocket : {
		...
		lister : {
			lister  : function () { return Ext.ComponentQuery.query('module-prodinput-lister')[0] },
		},
		popup : function () { return Ext.ComponentQuery.query('module-prodinput-copy-popup')[0] },
	},
