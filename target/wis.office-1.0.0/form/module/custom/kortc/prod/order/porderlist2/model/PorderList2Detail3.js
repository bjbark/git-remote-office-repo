Ext.define('module.custom.kortc.prod.order.porderlist2.model.PorderList2Detail3',{ extend:'Axt.data.Model',
	fields : [
		...
		{name: 'loss_resn_dvcd'			, type: 'string'},		//유실사유구분코드
		{name: 'sttm'					, type: 'string'},		//시작시간
		{name: 'edtm'					, type: 'string'},		//종료시간
		{name: 'loss_time'				, type: 'string'},		//유실시간
		{name: 'loss_pcnt'				, type: 'float' },		//유실인원
		{name: 'loss_mnhr'				, type: 'float' },		//유실공수
		{name: 'loss_name'				, type: 'string'},		//유실사유
		{name: 'runn_dsct_yorn'			, type: 'string'},		//가동중단여부
