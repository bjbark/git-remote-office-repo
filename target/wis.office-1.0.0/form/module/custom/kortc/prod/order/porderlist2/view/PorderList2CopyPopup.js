Ext.define('module.custom.kortc.prod.order.porderlist2.view.PorderList2CopyPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-kortc-porderlist2-copy-popup',
	...
	finishAction: function(){
		...
		mask.show();
		Ext.Ajax.request({
			url		: _global.location.http() + '/prod/plan/rsvdorder/set/copy.do',
			params	: {
