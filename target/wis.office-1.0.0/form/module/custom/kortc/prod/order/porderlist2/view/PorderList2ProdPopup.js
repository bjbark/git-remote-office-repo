Ext.define('module.custom.kortc.prod.order.porderlist2.view.PorderList2ProdPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-kortc-porderlist2-prod-popup',
