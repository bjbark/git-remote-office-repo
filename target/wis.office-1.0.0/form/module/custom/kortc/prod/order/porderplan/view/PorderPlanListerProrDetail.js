Ext.define('module.custom.kortc.prod.order.porderplan.view.PorderPlanListerProrDetail', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-porderplan-lister-pror-detail',
	store		: 'module.custom.kortc.prod.order.porderplan.store.PorderPlanProrDetail',
