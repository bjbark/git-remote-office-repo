Ext.define('module.custom.kortc.prod.order.porderlist.view.PorderListListerMaster', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-porderlist-lister-master',

	store		: 'module.custom.kortc.prod.order.porderlist.store.PorderListMaster',
