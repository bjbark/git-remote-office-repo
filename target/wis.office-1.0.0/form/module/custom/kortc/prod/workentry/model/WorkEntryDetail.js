Ext.define('module.custom.kortc.prod.workentry.model.WorkEntryDetail',{ extend:'Axt.data.Model',
	fields: [
		{name: 'invc_numb',				type: 'string'},		//invoice번호
		{name: 'acpt_numb',				type: 'string'},		//수주번호
		{name: 'invc_date',				type: 'string', convert : Ext.util.Format.dateToStr, serialize: Ext.util.Format.dateToStr},		//일자
		...
		{name: 'cycl_time',				type: 'float' },		// 표준C/T
		{name: 'work_cycl_time',		type: 'float' },		// 일지C/T
		{name: 'cvic_drtr_idcd',		type: 'string' },		//설비관리자
		{name: 'cvic_drtr_name',		type: 'string' },		//설비관리자명
