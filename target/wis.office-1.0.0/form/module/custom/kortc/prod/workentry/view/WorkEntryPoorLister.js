Ext.define('module.custom.kortc.prod.workentry.view.WorkEntryPoorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-kortc-workentry-poor'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.custom.kortc.prod.workentry.store.WorkEntryPoorLister',
	border		: 0,
	...
	listeners:{
		afterrender:function(){
			var store = Ext.ComponentQuery.query('module-kortc-workentry-poor')[0].getStore(),
