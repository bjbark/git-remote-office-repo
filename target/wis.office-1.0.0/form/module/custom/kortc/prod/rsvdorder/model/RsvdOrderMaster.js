Ext.define('module.custom.kortc.prod.rsvdorder.model.RsvdOrderMaster', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'updt_user_name'		, type: 'string' , defaultValue: _global.login_nm	// 수정사용자명
