Ext.define('module.custom.kortc.prod.rsvdorder.view.RsvdOrderWorkerLister', { extend: 'Axt.grid.Panel',
	alias: 'widget.module-rsvdorder-worker-lister',
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-rsvdorder-worker-search'}];
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex:	'item_name'	, flex : 1  , minWidth : 300, align : 'left'	, text: Language.get('item_name', '품명'		)
					},{	dataIndex:	'item_spec'	, width: 160, align : 'center'	, text: Language.get('item_spec', '규격'		)
					...
					},{	dataIndex:	'cstm_lott_numb'	, width: 160, align : 'left'	, text: Language.get('cstm_lott_numb', 'LOT번호'		)
						, tdCls : 'editingcolumn',
						editor	: {
							xtype        :'textfield',
							selectOnFocus: true,
