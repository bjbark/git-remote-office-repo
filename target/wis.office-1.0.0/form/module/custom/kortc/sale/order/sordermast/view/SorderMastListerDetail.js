Ext.define('module.custom.kortc.sale.order.sordermast.view.SorderMastListerDetail', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sordermast-lister-detail'			,
	store		: 'module.custom.kortc.sale.order.sordermast.store.SorderMastFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-sordermast-lister-detail')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'acpt_mast';		// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
		...
		var me = this,
			item = {
				...
				items : [
	                ...
	                },{	dataIndex: 'assi_seqn'		, text : Language.get('assi_seqn'		,'순번'	)		, width : 50 , align : 'center',hidden:true
