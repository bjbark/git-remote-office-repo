Ext.define('module.custom.kortc.sale.order.sordermast.view.SorderMastCopyPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-sordermast-copy-popup',
	...
	finishAction: function(){
		...
		if (values.deli_date == '') {
			...
			mask.show();
				Ext.Ajax.request({
					url		: _global.location.http() + '/custom/aone/sale/order/sordermast/set/copy.do',
					params	: {
