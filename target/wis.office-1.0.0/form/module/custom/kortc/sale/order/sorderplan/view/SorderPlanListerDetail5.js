Ext.define('module.custom.kortc.sale.order.sorderplan.view.SorderPlanListerDetail5', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-sorderplan-lister-detail5',
	store: 'module.custom.kortc.sale.order.sorderplan.store.SorderPlanDetail5',
	split		: true,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex:	'invc_numb'		, width:  80, align : 'center'	, text: Language.get('invc_numb'		, '발주번호'		), align : 'center',
					...
					},{	dataIndex:	'offr_date'		, width: 100, align : 'center'	, text: Language.get('offr_date'		, '발주일자'		),
					},{	dataIndex: 'deli_date2'		, width: 100, align : 'center'	, text: Language.get('deli_date2'		, '납기일자'		),
					}
				]
			};
		return item;
