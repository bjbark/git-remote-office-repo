Ext.define('module.custom.kortc.qc.insp.insplist.view.Insplistdetail', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-insplist-detail'			,
	store		: 'module.custom.kortc.qc.insp.insplist.store.InspListFile',
