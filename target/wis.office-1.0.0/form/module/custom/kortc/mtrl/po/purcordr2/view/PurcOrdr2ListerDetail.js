Ext.define('module.custom.kortc.mtrl.po.purcordr2.view.PurcOrdr2ListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-purcordr2-lister-detail',

	store: 'module.custom.kortc.mtrl.po.purcordr2.store.PurcOrdr2Detail',
