Ext.define('module.custom.hantop.item.itemcam.view.ItemCamListerMaster2', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-itemcam-lister-master2',
				...
				items   : [
					{	text: Language.get(''	,'자재</br>　'		), dataIndex : 'mtrl'	, align : 'center',
						columns: [
							...
							},{	dataIndex	:	'proc_item_name'		, width:  190, align : 'center'    , text: Language.get( 'proc_item_name'	, '가공자재명'		), sortable:true,filter:true, hidden : true,
								tdCls		: 'editingcolumn',
								editor		: {
									selectOnFocus	: true,
									allowBlank		: true,
					...
					},{	text: Language.get(''	,'레일유무</br>　'		), dataIndex : 'rail'	, align : 'center', hidden : true,
						columns: [
					...
					},{	text: Language.get(''	,'앙카홀</br>　'		), dataIndex : 'ank'	, align : 'center',hidden : true,
						columns: [
