Ext.define('module.custom.hantop.item.itemmast.model.ItemMast',{ extend:'Axt.data.Model',
	fields:
	[
		...
		{name: 'acct_bacd_name'			,type: 'string'},		//계정구분이름
		...
		{name: 'pkge_unit_qntt'			,type: 'float' },		//포장단위수량
		{name: 'pkge_qntt'				,type: 'float' },		//포장수량
