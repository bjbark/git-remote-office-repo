Ext.define('module.custom.hantop.item.itemmast.view.ItemMastDetail3', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-itemmast-detail3',
	store		: 'module.custom.hantop.item.itemmast.store.ItemMastDetail3',
	border		: 0,
	columnLines	: true,
	...
	columnItem : function () {
		var me   = this,
			item =  {
				...
				items   : [
					{	dataIndex:	''				, width:  50, align : 'center'   , text: Language.get( ''	, '사용'		),hidden : true,
						editor	: {
							maxLength		: 20,
							selectOnFocus	: true,
							allowBlank		: true
					...
					},{	dataIndex:	'vrbl_name'		, width: 130, align : 'left'   , text: Language.get( 'vrbl_name'	, '변수'		),
						editor		: {
							selectOnFocus	: true,
							allowBlank		: true,
					...
					},{	dataIndex:	'vrbl_valu'		, width : 130, align : 'right'   , text: Language.get( 'vrbl_valu'	, '변수값'	),
						editor		: {
							xtype		:'numericfield',
							selectOnFocus	: true,
							allowBlank		: true,
					...
					},{	dataIndex:	'prod_lcls_idcd', width : 100, align : 'left'   , text: Language.get( ''	, '제품대분류'	),
						editor		: {
							selectOnFocus	: true,
							allowBlank		: true,
							enableKeyEvents	: true,
					...
					},{	dataIndex:	'rela_item_idcd', width : 100, align : 'left'   , text: Language.get( ''	, '연관자재'	),
						editor		: {
							selectOnFocus	: true,
							allowBlank		: true,
							enableKeyEvents	: true,
					...
					},{	dataIndex:	'vrbl_desc'		, width : 160, align : 'left'   , text: Language.get( ''	, '변수설명'),
						editor		: {
							selectOnFocus	: true,
							allowBlank		: true,
							enableKeyEvents	: true,
	...
	lineInsert : function (config) {
		var me			= this,
			myform		= Ext.ComponentQuery.query('module-itemmast-detail3')[0],
			store		= me.getStore(),
			record		= undefined,
			max_seq		= 0,
			lastidx		= store.count(),
