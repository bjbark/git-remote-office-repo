Ext.define('module.custom.hantop.item.itemmast.view.ItemMastDetail5', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-itemmast-detail5',
	store		: 'module.custom.hantop.item.itemmast.store.ItemMastDetail5',
	border		: 0,
	columnLines	: true,
	...
	lineInsert : function (config) {
		var me			= this,
			myform		= Ext.ComponentQuery.query('module-itemmast-detail5')[0],
			store		= me.getStore(),
			record		= undefined,
			max_seq		= 0,
			lastidx		= store.count(),
