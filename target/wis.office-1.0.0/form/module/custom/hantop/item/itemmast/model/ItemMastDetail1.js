Ext.define('module.custom.hantop.item.itemmast.model.ItemMastDetail1',{ extend:'Axt.data.Model',
	fields:
	[
		...
		{name: 'cstm_idcd'				,type: 'string'},	//구매거래처ID
		{name: 'cstm_name'				,type: 'string'},	//구매거래처명
		{name: 'brnd_name'				,type: 'string'},	//브랜드분류코드
		{name: 'stnd_pric'				,type: 'float'},	//표준단가
		{name: 'cont_date'				,type: 'string', convert : Ext.util.Format.dateToStr, serialize: Ext.util.Format.dateToStr},//계약일자
