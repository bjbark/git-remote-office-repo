Ext.define('module.custom.hantop.item.cstmitemmap.view.CstmItemMapListerItem2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-cstmitemmap-lister-item2'			,
	store		: 'module.custom.hantop.item.cstmitemmap.store.CstmItemMapItem2'	,
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-cstmitemmap-lister-item3'}];
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'puch_pric'	, text : Language.get('puch_pric'	,'계약단가') , width :  80 , align : 'right', xtype : 'numericcolumn'
