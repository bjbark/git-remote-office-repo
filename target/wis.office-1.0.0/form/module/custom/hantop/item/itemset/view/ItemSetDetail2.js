Ext.define('module.custom.hantop.item.itemset.view.ItemSetDetail2', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-itemset-detail2',
	store		: 'module.custom.hantop.item.itemset.store.ItemSetDetail2',
	border		: 0,
	columnLines	: true,
	...
	lineInsert : function (config) {
		var me			= this,
			myform		= Ext.ComponentQuery.query('module-itemset-detail2')[0],
			store		= me.getStore(),
			record		= undefined,
			max_seq		= 0,
			lastidx		= store.count(),
