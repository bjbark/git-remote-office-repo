Ext.define('module.custom.hantop.item.cstmitemmast.view.CstmItemMastLister2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-cstmitemmast-lister2',
	store		: 'module.custom.hantop.item.cstmitemmast.store.CstmItemMast2',
