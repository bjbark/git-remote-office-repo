Ext.define('module.custom.hantop.sale.estientry2.view.EstiEntry2WorkerLister', { extend: 'Axt.grid.Panel',
	alias	: 'widget.module-estientry2-worker-lister',
		...
		var me = this,
			item = {
				...
				items : [
					...
					{	text : '<span class="write-button">색상일괄변경</span>'	, action : ''	, cls: 'button1-style'	} , '-',
					{	text : '<span class="write-button">브랜드별 견적금액 산출</span>'	, action : 'estiAction'	, width : 140, cls: 'button1-style'	} , '-',
					'->', '-',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex:	'ings_tick'			, width :  80, align : 'center'	, text: Language.get('ings_tick'			, '내부유리두께'	), xtype : 'numericcolumn' , format: '#,##0'
					},{	dataIndex:	'otgs_tick'			, width :  80, align : 'center'	, text: Language.get('otgs_tick'			, '외부유리두께'	), xtype : 'numericcolumn' , format: '#,##0'
					...
					},{	dataIndex:	'invc_pric'			, width :  60, align : 'right'	, text: Language.get('invc_pric'			, '단가'		), xtype : 'numericcolumn' , format: '#,##0'
					},{	dataIndex:	'invc_amnt'			, width :  60, align : 'right'	, text: Language.get('invc_amnt'			, '금액'		), xtype : 'numericcolumn' , format: '#,##0'
					...
					},{	dataIndex:	'esti_trff'			, width :  65, align : 'right'	, text: Language.get('esti_trff'			, '견적요율'	), xtype : 'numericcolumn' , format: '#,##0'
					...
					},{	dataIndex:	'wndw_dirt_dvcd'	, width : 200, align : 'left'	, text: Language.get('wndw_dirt_dvcd'		, '창방향구분코드'), hidden : true
					}
				]
			}
		;
