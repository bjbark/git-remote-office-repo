Ext.define('module.custom.hantop.sale.estientry2.view.EstiEntry2WorkerMtrlLister5', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-estientry2-mtrl-lister5',
	...
	finishAction : function(){
		...
		if(me.popup.params){
			...
			record = Ext.create( store.model.modelName , {
				...
				esti_trff		: values.esti_trff,			//견젹요율
