 ...
 * 파일 업로드 공통 팝업
 */
Ext.define('module.custom.hantop.sale.estientry2.view.FileUpload', { extend: 'Axt.popup.Upload',

	alias: 'widget.module-estientry2-upload',
	...
	*/
	...
	finishAction : function (button) {
		...
		form= me.down('[name=invc_numb]').getValue()
		;
		var param = {};
...
//				});
//				Ext.Ajax.request({
//					url			: _global.api_host_info + '/' + _global.app_site + '/custom/hntop/sale/estientry2/set/UploadEsti.do',
//					method		: "POST",
//					params		: {
