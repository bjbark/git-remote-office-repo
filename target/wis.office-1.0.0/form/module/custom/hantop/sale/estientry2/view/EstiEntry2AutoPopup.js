Ext.define('module.custom.hantop.sale.estientry2.view.EstiEntry2AutoPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-estientry2-auto-popup',
	...
	finishAction: function(){
		...
		mask.show();
		Ext.Ajax.request({
			url		: _global.location.http() + '/custom/hntop/sale/estientry2/set/auto.do',
			params	: {
