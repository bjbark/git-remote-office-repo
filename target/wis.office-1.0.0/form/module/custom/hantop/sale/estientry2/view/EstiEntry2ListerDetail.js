Ext.define('module.custom.hantop.sale.estientry2.view.EstiEntry2ListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-estientry2-lister-detail',
	store: 'module.custom.hantop.sale.estientry2.store.EstiEntry2Detail',
		...
		var me = this,
			item = {
				...
				items : [
					...
					{	text : '<span class="write-button">수동/자동 전환</span>'	, action : 'changeAction'		, cls: 'button1-style',width : 90 ,  hidden : true	},
