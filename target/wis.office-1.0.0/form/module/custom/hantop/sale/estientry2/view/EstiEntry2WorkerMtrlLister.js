Ext.define('module.custom.hantop.sale.estientry2.view.EstiEntry2WorkerMtrlLister', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-estientry2-mtrl-lister',
					...
					{	xtype	: 'fieldset', layout: 'hbox' , padding:'0', border: 0, margin : '0 0 0 0',
						items	: [
							{	xtype		: 'checkbox',
								...
								listeners	: {
									change : function(){
										var mtrl2 = Ext.ComponentQuery.query('module-estientry2-mtrl-lister2')[0],
											mtrl3 = Ext.ComponentQuery.query('module-estientry2-mtrl-lister3')[0],
											mtrl4 = Ext.ComponentQuery.query('module-estientry2-mtrl-lister4')[0],
										...
										mtrl4.down('[name=bfsf_dvcd]').setValue(this.value);
//										mtrl5.down('[name=bfsf_dvcd]').setValue(this.value);
								...
								listeners	: {
									change : function(){
										...
										mtrl4.down('[name=bfsf_dvcd1]').setValue(this.value);
//										mtrl5.down('[name=bfsf_dvcd1]').setValue(this.value);
								...
								listeners	: {
									change : function(){
										...
										mtrl4.down('[name=bfsf_dvcd2]').setValue(this.value);
//										mtrl5.down('[name=bfsf_dvcd2]').setValue(this.value);
								...
								listeners	: {
									change : function(){
										...
										mtrl4.down('[name=bfsf_dvcd3]').setValue(this.value);
