Ext.define('module.custom.hantop.sale.saleorder.view.SaleOrderListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-saleorder-lister-detail',

	store: 'module.custom.hantop.sale.saleorder.store.SaleOrderDetail',
