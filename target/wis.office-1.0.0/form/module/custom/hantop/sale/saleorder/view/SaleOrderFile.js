Ext.define('module.custom.hantop.sale.saleorder.view.SaleOrderFile', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-saleorder-file'			,
	store		: 'module.custom.hantop.sale.saleorder.store.SaleOrderFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),		// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-saleorder-file')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
