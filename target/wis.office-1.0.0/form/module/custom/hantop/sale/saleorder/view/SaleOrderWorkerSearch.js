Ext.define('module.custom.hantop.sale.saleorder.view.SaleOrderWorkerSearch', { extend: 'Axt.form.Search',
	store	: 'module.custom.hantop.sale.saleorder.store.SaleOrderInvoice',
