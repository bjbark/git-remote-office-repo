Ext.define('module.custom.hantop.prod.order.prodorder.view.ProdItemCancelPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-prodorder-cancel-popup',
	...
	callAction: function(){
		var me = this,
			...
			detail	= Ext.ComponentQuery.query('module-prodorder-lister-detail')[0],
		...
		mask.show();
		Ext.Ajax.request({
			url		: _global.location.http() + '/custom/hntop/prod/order/prodorder/set/cancel.do',
			params	: {
