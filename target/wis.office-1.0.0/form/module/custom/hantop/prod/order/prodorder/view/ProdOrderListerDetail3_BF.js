Ext.define('module.custom.hantop.prod.order.prodorder.view.ProdOrderListerDetail3_BF', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-prodorder-lister-detail3_bf',
