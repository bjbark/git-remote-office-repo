Ext.define('module.custom.hantop.prod.order.prodorder.model.ProdOrderMaster', { extend: 'Axt.data.Model',
	fields : [
		...
		},{	name: 'cofm_dttm'			, type: 'string', convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr	//유효일자
