Ext.define('module.custom.hantop.prod.order.prodorder.view.ProdOrderListerDetail3', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-prodorder-lister-detail3',
	store: 'module.custom.hantop.prod.order.prodorder.store.ProdOrderDetail3',
	border		: 0 ,
	columnLines	: true ,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex:	'bfsf_dvcd'				, text: Language.get('bfsf_dvcd'			, '틀짝망구분'			) , width :  90, align : 'center',xtype:'lookupcolumn',lookupValue:resource.lookup('bfsf_dvcd'),
						tdCls : 'editingcolumn',
						editor	: {
							xtype		:'lookupfield',
							selectOnFocus: true,
					...
					},{	dataIndex:	'hndl_incl_yorn'		, text: Language.get('hndl_incl_yorn'		, '핸들포함'			) , width :  90, align : 'center',xtype:'lookupcolumn',lookupValue:resource.lookup('yorn'),
						tdCls : 'editingcolumn',
						editor	: {
							xtype		:'lookupfield',
							selectOnFocus: true,
					...
					},{	dataIndex:	'hdho_pass_yorn'		, text: Language.get('hdho_pass_yorn'		, '핸드홀관통'		) , width : 100, align : 'center'	, xtype : 'lookupcolumn', lookupValue : resource.lookup('yorn'),
						tdCls : 'editingcolumn',
						editor	: {
							xtype		:'lookupfield',
							selectOnFocus: true,
					...
					},{	dataIndex:	'lkho_incl_yorn'		, text: Language.get('lkho_incl_yorn'		, '락킹홀포함'		) , width : 100, align : 'center'	, xtype : 'lookupcolumn', lookupValue : resource.lookup('yorn'),
						tdCls : 'editingcolumn',
						editor	: {
							xtype		:'lookupfield',
							selectOnFocus: true,
					...
					},{	dataIndex:	'rnpc_incl_yorn'		, text: Language.get('rnpc_incl_yorn'		, '고리펀칭포함'		) , width : 110, xtype:'numericcolumn',
						tdCls : 'editingcolumn',
						editor	: {
							xtype		:'numericfield',
							selectOnFocus: true,
					...
					},{	dataIndex:	'omhd_hole_incl_yorn'	, text: Language.get('omhd_hole_incl_yorn'	, '오목핸들홀포함'	) , width : 120, align : 'center'	, xtype : 'lookupcolumn', lookupValue : resource.lookup('yorn'),
						tdCls : 'editingcolumn',
						editor	: {
							xtype		:'lookupfield',
							selectOnFocus: true,
					...
					},{	dataIndex:	'rlho_incl_yorn'		, text: Language.get('rlho_incl_yorn'		, '롤러홀포함'		) , width : 100, xtype:'numericcolumn',
						tdCls : 'editingcolumn',
						editor	: {
							xtype		:'numericfield',
							selectOnFocus: true,
					...
					},{	dataIndex:	'rail_zero_yorn'		, text: Language.get('rail_zero_yorn'		, '레일0여부'			) , width :  80, xtype:'numericcolumn',
						tdCls : 'editingcolumn',
						editor	: {
							xtype		:'numericfield',
							selectOnFocus: true,
					...
					},{	dataIndex:	'rail_1fst_yorn'		, text: Language.get('rail_1fst_yorn'		, '레일1여부'			) , width :  80, xtype:'numericcolumn',
						tdCls : 'editingcolumn',
						editor	: {
							xtype		:'numericfield',
							selectOnFocus: true,
					...
					},{	dataIndex:	'rail_2snd_yorn'		, text: Language.get('rail_2snd_yorn'		, '레일2여부'			) , width :  80, xtype:'numericcolumn',
						tdCls : 'editingcolumn',
						editor	: {
							xtype		:'numericfield',
							selectOnFocus: true,
					...
					},{	dataIndex:	'flps_mkng_incl_yorn'	, text: Language.get('flps_mkng_incl_yorn'	, '필링피스마킹포함'	) , width : 130, align : 'center'	, xtype : 'lookupcolumn', lookupValue : resource.lookup('yorn'),
						tdCls : 'editingcolumn',
						editor	: {
							xtype		:'lookupfield',
							selectOnFocus: true,
