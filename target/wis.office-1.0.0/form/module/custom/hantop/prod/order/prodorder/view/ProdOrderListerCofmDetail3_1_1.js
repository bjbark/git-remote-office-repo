Ext.define('module.custom.hantop.prod.order.prodorder.view.ProdOrderListerCofmDetail3_1_1', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-prodorder-lister-cofmdetail3_1_1',
	store: 'module.custom.hantop.prod.order.prodorder.store.ProdOrderCofmDetail3_1_1',
	border		: 0 ,
	columnLines	: true ,
