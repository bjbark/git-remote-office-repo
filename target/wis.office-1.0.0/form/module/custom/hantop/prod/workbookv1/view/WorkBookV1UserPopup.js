Ext.define('module.custom.hantop.prod.workbookv1.view.WorkBookV1UserPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-workbookv1-user-popup',
	alias	: 'widget.lookup-workbookv1-user-popup',
	store	: 'module.custom.hantop.prod.workbookv1.store.WorkBookV1UserPopup',

	title	: Language.get('user_popup','작업자 선택'),
	closable: true,
	autoShow: true,
	width	: 825,
	height	: 563,
	...
	createGrid: function(){
		var me = this,
			grid = {
				...
				columns: [
					{	text: Language.get('user_idcd','사원ID')		, dataIndex: 'user_idcd',  width :  80,
						renderer: function(value, meta){
							meta.style = 'font-size:3em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						}, hidden	: true
					},{	text: Language.get('lgin_idcd','로그인ID')	, dataIndex: 'lgin_idcd',  width :  220,
						renderer: function(value, meta){
							meta.style = 'font-size:3em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						},
					},{	text: Language.get('user_name','사원명')		, dataIndex: 'user_name',   width  : 300,
						renderer: function(value, meta){
							meta.style = 'font-size:3em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						},
					},{ text: Language.get('dept_name'    , '부서'  )	, dataIndex: 'dept_name'	, width: 250,
						renderer: function(value, meta){
							meta.style = 'font-size:3em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						},
