Ext.define('module.custom.hantop.prod.workbookv1.view.WorkBookV1ListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workbookv1-lister'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.custom.hantop.prod.workbookv1.store.WorkBookV1',
	border		: 0,
...
//					},{ dataIndex: 'work_endd'		, text : Language.get('work_endd'		,'종료예정'		) , width : 100 , align : 'center'
					},{ dataIndex: 'invc_numb'		, text : Language.get('pror_numb'		,'지시번호'		) , width : 155 , align : 'center'
//					},{ dataIndex: 'lott_numb'		, text : Language.get('lott_numb'		,'LOT번호'	) , width : 100 , align : 'center'
					...
					},{ dataIndex: 'item_name'		, text : Language.get('item_name'		,'품명'		) , width : 350
	...
	insert : function (rec) {
		...
		if(rec.get('prog_stat_dvcd')==2){
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/hantop/prod/workbookv1/get/pause.do',
				params	: {
