Ext.define('module.custom.hantop.mtrl.po.purcordr.model.PurcOrdrMaster', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'purc_stat_dvcd'		, type: 'string', defaultValue : '0010' 	/*발주구분*/
		},{	name: 'brnd_bacd'			, type: 'string'	/*브랜드분류코드*/
		},{	name: 'brnd_name'			, type: 'string'	/*브랜드명*/
		},{	name: 'mngt_bzpl_idcd'		, type: 'string'	/* 관리사업장	*/
