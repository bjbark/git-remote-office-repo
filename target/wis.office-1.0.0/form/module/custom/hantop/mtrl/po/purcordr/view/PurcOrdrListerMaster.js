Ext.define('module.custom.hantop.mtrl.po.purcordr.view.PurcOrdrListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-purcordr-lister-master',

	store		: 'module.custom.hantop.mtrl.po.purcordr.store.PurcOrdrMaster',
		...
		var me = this,
			item = {
				...
				items	: [
					...
					},{	text : '<span class="write-button">입고접수</span>'	, action : 'isttAction2' , cls: 'button1-style'
					} , '-',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'purc_stat_dvcd'	, width:  60, align: 'center', text: Language.get('purc_stat_dvcd'	, '진행상태'		) , xtype : 'lookupcolumn' , lookupValue : resource.lookup('acpt_stat_dvcd')
					...
					},{	dataIndex: 'mngt_bzpl_name'	, width: 80, align : 'left'	, text: Language.get( 'cstm_name'	, '관리사업장명'	)
