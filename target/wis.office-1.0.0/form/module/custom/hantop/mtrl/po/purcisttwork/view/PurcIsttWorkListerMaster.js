Ext.define('module.custom.hantop.mtrl.po.purcisttwork.view.PurcIsttWorkListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-purcisttwork-lister-master',
	store		: 'module.custom.hantop.mtrl.po.purcisttwork.store.PurcIsttWorkMaster',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'istt_qntt'		, text : Language.get('istt_qntt'		,'수량'		) , width : 60  , xtype : 'numericcolumn', align : 'right', summaryType: 'sum'
