Ext.define('module.custom.iypkg.eis.eisreport17.view.EisReport17Editor3', { extend: 'Axt.form.Editor',

	alias	: 'widget.module-eisreport17-editor3',
	header	: false,

	initComponent: function(config){
		var me = this;
		var toDay = Ext.Date.format(Ext.Date.add( new Date(), Ext.Date.MONTH, -2),'M');
