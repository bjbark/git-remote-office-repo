Ext.define('module.custom.iypkg.eis.eisreport.view.EisReportEditor3', { extend: 'Axt.form.Editor',
	alias		: 'widget.module-eisreport-editor3'			,
	border		: 0,
	...
	initComponent: function () {
		...
		window.shot31 = setInterval(function(){
			Ext.Ajax.request({
				url			: _global.api_host_info + '/' + _global.app_site + '/custom/iypkg/eis/eisreport/get/search.do',
				async		: false,
				method		: "POST",
										...
										listeners	: {
											render	:function(field){
												...
												if(wkod_numb != ''){
													...
													window.shot3 = setInterval(function(){
														Ext.Ajax.request({
															url			: _global.api_host_info + '/' + _global.app_site + '/custom/iypkg/eis/eisreport/get/plc_cnt.do',
															method		: "POST",
															async		: false,
