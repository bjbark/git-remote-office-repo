Ext.define('module.custom.iypkg.etc.trsfwork.view.TrsfWorkLister2', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-trsfwork-lister2',
	store		: 'module.custom.iypkg.etc.trsfwork.store.TrsfWorkLister2',
	...
	viewConfig: {
		getRowClass : function ( record , index ) {
			if(record.get('ostt_cstm') == '합계' || record.get('ostt_cstm') == '월계'){
				return 'text-warn';
			}else if(record.get('ostt_cstm') == '일계'){
				return 'text-blue';
			}
		}
	},
