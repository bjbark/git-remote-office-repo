 Ext.define('module.custom.iypkg.sale.order.slorlist2.view.SlorList2Editor', {extend  : 'Axt.form.Editor',
	alias		: 'widget.module-slorlist2-editor',
	height		: 374,
	layout		: { type: 'border' },
	title		: '거래처 정보',
	collapsible	: true,
			...
			item ={
				...
				items		: [
					{	name	: 'cstm_idcd', xtype : 'textfield' , hidden : true
						...
						listeners	: {
							change	: function(){
								Ext.ComponentQuery.query('module-slorlist2-editor')[0].down('[name=change]').setValue('Y');
							}
						}
	...
	createTabs : function () {
		var me = this,
			tabs = {
				...
				plain  : true,
				margin : 0 ,
				items  : [ me.createTab1(), me.createTab2(), me.createTab3(), me.createTab4(),{title : '첨부파일',xtype: 'module-slorlist2-editorlister'},  me.createTab5() ]
			}
		;
		return tabs;
	},
	...
	createTab3 : function() {
		...
		var item =
		{
			...
			xtype	: 'module-slorlist2-drtr-lister',
		};
		return item;
	},
	/**
	...
	createTab4 : function() {
		...
		var item =
		{
			...
			xtype	: 'module-slorlist2-deli-lister',
		};
		return item;
	},
