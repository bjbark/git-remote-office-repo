Ext.define('module.custom.iypkg.sale.order.saleorder.model.SaleOrderWkct', { extend : 'Axt.data.Model',
	fields: [
		{	name: 'invc_numb'			, type: 'string'	/* 수주번호          */
		},{	name: 'line_seqn'			, type: 'float ' 	/* 순번             */
		},{	name: 'wkct_idcd'			, type: 'string'	/* 공정ID          */
		},{	name: 'prod_name'			, type: 'string'	/* 공정ID          */
		},{	name: 'prod_code'			, type: 'string'	/* 공정ID          */
		...
		},{	name: 'plan_qntt'			, type: 'float' 	/* 계획수량         */, defaultValue : 0
