Ext.define('module.custom.iypkg.sale.order.estimast1.view.EstiMast1Lister2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-estimast1-lister2'			,
	store		: 'module.custom.iypkg.sale.order.estimast1.store.EstiMast1File',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-estimast1-lister2')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex: 'assi_seqn'		, text : Language.get('line_seqn'		,'순번'	)		, width : 50 , align : 'center'
