Ext.define('module.custom.iypkg.sale.order.estimast2.view.EstiMast2Lister2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-estimast2-lister2'			,
	store		: 'module.custom.iypkg.sale.order.estimast2.store.EstiMast2File',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-estimast2-lister2')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
