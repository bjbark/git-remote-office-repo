Ext.define('module.custom.iypkg.sale.sale.salelist.view.SaleListWorkerSearch2', { extend: 'Axt.form.Search',

	alias	: 'widget.module-salelist-worker-search2',
	height	: 85,
	header	: false,
				...
				{	xtype : 'fieldset', layout: 'hbox', border : 0, margin : '8 0 0 0',
					items : [
						{	xtype : 'fieldset', layout: 'vbox', border : 0,  margin : '3 0 5 0',
							items : [
								{	xtype	: 'fieldset', layout: 'hbox' ,padding:'0', border: 0,margin : '5 11 3 0',
									items	: [
										{	fieldLabel	: Language.get('','조회기간'),
											...
											text   : '<span class="write-button">일자별 매출 현황</span>' ,
											action : 'printAction'	,
											width  : 100,
											cls    : 'button1-style',
											margin : '0 0 0 10'
