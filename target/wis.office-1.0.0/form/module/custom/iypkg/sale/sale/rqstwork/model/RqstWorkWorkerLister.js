Ext.define('module.custom.iypkg.sale.sale.rqstwork.model.RqstWorkWorkerLister',{ extend:'Axt.data.Model',
	fields  : [
		...
		},{	name: 'new_colt_numb'		, type: 'string'	/* 새로운 수금번호	*/
		},{	name: 'new_colt_seqn'		, type: 'float' 	/* 새로운 수금순번	*/
		},{	name: 'new_txbl_numb'		, type: 'string'	/* 새로운 세금계산서번호	*/
		},{	name: 'new_txbl_seqn'		, type: 'float' 	/* 새로운 세금계산서순번	*/
	...
	recalculation: function(inv) {
		var row = this,
		baseamt = row.get('sale_qntt') + row.get('porm_qntt')
		;
		row.set('real_sale_qntt'		, baseamt  );
	}
});
