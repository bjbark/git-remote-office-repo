Ext.define('module.custom.iypkg.sale.sale.salelist.view.SaleListWorkerSearch', { extend: 'Axt.form.Search',

	alias	: 'widget.module-salelist-worker-search',
	height	: 85,
	header	: false,
