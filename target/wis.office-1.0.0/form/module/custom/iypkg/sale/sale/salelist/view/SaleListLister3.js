Ext.define('module.custom.iypkg.sale.sale.salelist.view.SaleListLister3', { extend: 'Axt.grid.Panel',
	alias	: 'widget.module-salelist-worker-lister3',
	store	: 'module.custom.iypkg.sale.sale.salelist.store.SaleListLister3',
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-salelist-worker-search3'}];
