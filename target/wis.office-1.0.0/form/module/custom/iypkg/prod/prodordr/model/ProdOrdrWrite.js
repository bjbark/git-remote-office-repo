Ext.define('module.custom.iypkg.prod.prodordr.model.ProdOrdrWrite', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'sum_indn_qntt'		, type: 'float'			//누적지시수량
		...
		},{	name: 'pdod_date'			, type: 'string' , defaultValue : Ext.Date.format(new Date(),'Ymd')		//생산지시일자
		...
		},{	name: 'item_ttln'			, type: 'string'		//장
		},{	name: 'item_ttwd'			, type: 'string'		//폭
		},{	name: 'item_fxqt'			, type: 'string'		//절수
