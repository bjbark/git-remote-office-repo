Ext.define('module.custom.iypkg.prod.workbookv1.view.WorkBookV1PoorPopup', { extend: 'Axt.popup.Search',
	...
	initComponent: function(config){
		...
		//불량 조회
		var store = Ext.ComponentQuery.query('module-workbookv1-poor')[0].getStore(),
		...
		var me = this,
			form = {
				...
				items			: [
					...
					},{	xtype : 'module-workbookv1-poor', region:'center' , flex : 1, height:500 ,margin: '0 0 0 0', itemId : 'grid1'
					}
				],
				buttons: [
