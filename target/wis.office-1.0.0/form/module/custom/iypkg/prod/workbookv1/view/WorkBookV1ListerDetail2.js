Ext.define('module.custom.iypkg.prod.workbookv1.view.WorkBookV1ListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workbookv1-detail2'			,
	selModel	: { selType: 'checkboxmodel', mode : 'SINGLE' },
	store		: 'module.custom.iypkg.prod.workbookv1.store.WorkBookV1Detail2',
	border		: 0,
...
//					},{ dataIndex: 'lott_numb'		, text : Language.get('lott_numb'		,'LOT번호'	) , width : 100 , align : 'center'
	...
	insert : function (rec) {
		...
		if(rec.get('prog_stat_dvcd')==2){
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/iypkg/prod/workbookv1/get/pause.do',
				params	: {
			...
			items:[
				{	fieldLabel	: Language.get('work_date','작업일자'),
					...
					popup: {
						...
						params : { stor_grp : _global.stor_grp,dept_idcd :'006' },
