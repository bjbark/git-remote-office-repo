Ext.define('module.custom.iypkg.prod.workbookv1.model.WorkBookV1Detail',{ extend:'Axt.data.Model',
	fields: [
		...
		{name: 'cvic_code',				type: 'string'},		//설비
		{name: 'cvic_name',				type: 'string'},		//설비
		{name: 'mold_idcd',				type: 'string'},		//금형
		{name: 'mold_code',				type: 'string'},		//금형
		{name: 'mold_name',				type: 'string'},		//금형
		{name: 'prod_idcd',				type: 'string'},		//품목
		{name: 'prod_code',				type: 'string'},		//품목
		{name: 'prod_name',				type: 'string'},		//품목
		...
		{	name: 'bxty_name'				, type: 'string' },		//
		{	name: 'prod_leng'				, type: 'float' },		//
		{	name: 'prod_widh'				, type: 'float' },		//
		{	name: 'prod_hght'				, type: 'float' },		//
		...
		{name: 'mtrl_name',				type: 'string'},		//LOT번호
		{name: 'istt_wrhs_name',		type: 'string'},		//입고창고
		...
		{name: 'totl_shot',				type: 'string'},		//shot
		{name: 'qc_poor_qntt',			type: 'float' },		//불량수량
