Ext.define('module.custom.iypkg.prod.prodordr2.view.ProdOrdr2DetailFabc', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prodordr2-detail-fabc',
	store		: 'module.custom.iypkg.prod.prodordr2.store.ProdOrdr2DetailFabc',
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex: 'dvcd'			, text : Language.get(''		,'구분'		) , width :  60 , align : 'center', xtype : 'lookupcolumn', lookupValue : resource.lookup('offr_path_dvcd')
