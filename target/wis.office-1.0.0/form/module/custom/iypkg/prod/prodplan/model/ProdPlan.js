Ext.define('module.custom.iypkg.prod.prodplan.model.ProdPlan', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'cvic_idcd'			, type: 'string'		//설비 ID
		},{	name: 'cvic_name'			, type: 'string'		//설비 명
