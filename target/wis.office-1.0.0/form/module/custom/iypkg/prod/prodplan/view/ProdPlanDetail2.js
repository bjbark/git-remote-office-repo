Ext.define('module.custom.iypkg.prod.prodplan.view.ProdPlanDetail2', { extend: 'Axt.form.Editor',

	alias		: 'widget.module-prodplan-detail2',
	width	: 430,
	layout : {
		type: 'border'
	},
								...
								{	fieldLabel	: Language.get('','수주번호'),
									...
									listeners	:{
										change:function(){
											...
											var results;
											Ext.Ajax.request({
												url		: _global.location.http() + '/custom/iypkg/prod/prodplan/get/detail2.do',
												params	: {
