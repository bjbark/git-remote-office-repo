Ext.define('module.custom.iypkg.prod.prodplan.view.ProdPlanDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prodplan-detail3',
	store		: 'module.custom.iypkg.prod.prodplan.store.ProdPlanDetail3',
//	height		: 250,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'ppln_dvcd', text : Language.get(''		,'골'		) , width :  70 , align : 'center', xtype : 'lookupcolumn' , lookupValue : resource.lookup('line_dvcd'),
