Ext.define('module.custom.iypkg.item.ppermast.view.PperMastEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-ppermast-editorlister'			,
	store		: 'module.custom.iypkg.item.ppermast.store.PperMastFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-ppermast-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'cstm_mast';											// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
