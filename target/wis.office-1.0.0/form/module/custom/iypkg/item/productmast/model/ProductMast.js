Ext.define( 'module.custom.iypkg.item.productmast.model.ProductMast', { extend : 'Axt.data.Model',
	fields: [
		{	name: 'prod_idcd'			, type: 'string'		/* 제품ID		*/
		},{	name: 'prod_code'			, type: 'string'		/* 제품코드		*/
		},{	name: 'acct_bacd'			, type: 'string'		/* 계정구분		*/, defaultValue : '4000'
		...
		},{	name: 'sets_qntt'			, type: 'float '		/* 세트수량		*/, defaultValue : 1



		},{	name: 'uper_seqn'			, type: 'float'		/* 상위순번		*/
		},{	name: 'disp_seqn'			, type: 'float'		/* 하위순번		*/
		},{	name: 'change'				, type: 'string' ,defaultValue : 'n'	/* 변경			*/
