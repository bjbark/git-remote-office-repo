Ext.define( 'module.custom.iypkg.mtrl.po.purcordr.model.PurcOrdr', { extend : 'Axt.data.Model',
	fields: [
		...
		},{	name: 'acpt_line_seqn'		, type: 'string'	/* 수주순번		*/
		...
		},{	name: 'invc_date'			, type: 'string'	/* 발주일		*/ , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr
