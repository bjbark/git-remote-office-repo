Ext.define('module.custom.iypkg.stock.close.mtrlstocklist2.MtrlStockList2', {  extend   : 'Axt.app.Controller',
	requires : [
		'lookup.popup.view.AsmtPopup',
		'lookup.popup.view.CstmPopup',
	],
	models	: [
		'module.custom.iypkg.stock.close.mtrlstocklist2.model.MtrlStockList2',
		'module.custom.iypkg.stock.close.mtrlstocklist2.model.MtrlStockList22',
	],
	stores	: [
		'module.custom.iypkg.stock.close.mtrlstocklist2.store.MtrlStockList2',
		'module.custom.iypkg.stock.close.mtrlstocklist2.store.MtrlStockList22',
	],
	views	: [
		'module.custom.iypkg.stock.close.mtrlstocklist2.view.MtrlStockList2Layout',
		'module.custom.iypkg.stock.close.mtrlstocklist2.view.MtrlStockList2Lister',
		'module.custom.iypkg.stock.close.mtrlstocklist2.view.MtrlStockList2Lister2',
		'module.custom.iypkg.stock.close.mtrlstocklist2.view.MtrlStockList2Search',
		'module.custom.iypkg.stock.close.mtrlstocklist2.view.MtrlStockList2WorkerSearch1',
		'module.custom.iypkg.stock.close.mtrlstocklist2.view.MtrlStockList2WorkerSearch2',
	],
	...
	init: function() {
		var me = this;
		me.control({
			'module-mtrlstocklist2-layout button[action=selectAction]' : { click : me.selectAction },
		});
		me.callParent(arguments);
	},
	pocket : {
		layout	: function () { return Ext.ComponentQuery.query('module-mtrlstocklist2-layout')[0] },
		search	: function () { return Ext.ComponentQuery.query('module-mtrlstocklist2-search')[0] },
		editor	: function () { return Ext.ComponentQuery.query('module-mtrlstocklist2-editor')[0] },
		lister1	: function () { return Ext.ComponentQuery.query('module-mtrlstocklist2-lister')[0] },
		lister2	: function () { return Ext.ComponentQuery.query('module-mtrlstocklist2-lister2')[0] },
	},
