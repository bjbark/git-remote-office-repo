Ext.define('module.custom.iypkg.stock.isos.isttlist1.model.IsttList1Lister1', { extend:'Axt.data.Model',
	fields : [
		...
		},{	name: 'invc_date2'			, type: 'string'	/* 수주일자		*/ , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr
