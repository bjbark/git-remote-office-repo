Ext.define('module.custom.iypkg.stock.isos.isttlist1.model.IsttList1Lister5', { extend:'Axt.data.Model',
	fields : [
		{	name : 'invc_numb'			, type : 'string'		//Invoice번호
		},{	name : 'line_seqn'			, type : 'float'		//순번
		},{	name : 'invc_date'			, type : 'string', convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr		//입고일자
		},{	name : 'invc_date2'			, type : 'string', convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr		//발주일자
		},{	name : 'cstm_idcd'			, type : 'string'		//거래처id
		},{	name : 'cstm_name'			, type : 'string'		//거래처명
		},{	name : 'prod_idcd'			, type : 'string'		//상품ID
		},{	name : 'prod_code'			, type : 'string'		//상품코드
		},{	name : 'prod_name'			, type : 'string'		//상품명
		},{	name : 'prod_leng'			, type : 'string'		//상품 길이
		},{	name : 'prod_widh'			, type : 'string'		//상품 폭
