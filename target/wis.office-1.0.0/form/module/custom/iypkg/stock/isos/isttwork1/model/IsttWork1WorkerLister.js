Ext.define('module.custom.iypkg.stock.isos.isttwork1.model.IsttWork1WorkerLister',{ extend:'Axt.data.Model',
	fields  : [
		...
		},{	name: 'pcod_numb'			, tyep: 'string'	/* PO / NO	*/
		},{	name: 'wkun_dvcd'			, tyep: 'string'	/* 작업단위	*/
		},{	name: 'unit_name'			, tyep: 'string'	/* 단위	*/

		},{	name: 'rnum'				, type: 'string'
		},{	name: 'prgs_cont'			, type: 'string'	/* 팝업 수주 진행 상황	*/
		},{	name: 'item_fxqt'			, type: 'string'	/* 절/개수	*/
