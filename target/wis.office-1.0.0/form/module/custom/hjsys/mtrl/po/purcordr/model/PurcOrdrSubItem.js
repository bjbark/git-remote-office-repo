Ext.define('module.custom.hjsys.mtrl.po.purcordr.model.PurcOrdrSubItem',{ extend:'Axt.data.Model',
	fields:
		[
			...
			{name: 'invc_qntt',				type: 'string'},
			{name: 'item_name2',			type: 'string'},
			{name: 'item_leng2',			type: 'float'},
			{name: 'item_widh2',			type: 'float'},
