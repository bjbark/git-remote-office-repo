Ext.define('module.custom.hjsys.mtrl.po.purcordr.view.PurcOrdrLayout', { extend: 'Axt.form.Layout' ,
		...
		var	card = {
			...
			items	: [
				{	xtype:'module-purcordr-worker-editor2', region:'north'
					...
					border	: 0,
					items	: [
						{	xtype:'module-purcordr-worker-lister2',
							flex	: 2,
							split	: true,
							region	: 'north',
							style	: Const.borderLine.bottom
						},{	xtype:'module-purcordr-lister-subItem',
							region	: 'center',
							flex	: 1.5
						}
					]
