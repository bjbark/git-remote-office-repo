Ext.define('module.custom.hjsys.stock.goodsosttwork.view.GoodsOsttWorkWorkerSearch',{ extend: 'Axt.form.Search',
	store		: 'module.custom.hjsys.stock.goodsosttwork.store.GoodsOsttWorkInvoice',
	alias: 'widget.module-hjsys-goodsosttwork-worker-search',
							...
							{	fieldLabel	: Language.get('acpt_numb','주문번호'),
								...
								popup: {
									...
									params : {
										...
										line_stat : '0',
										cstm_idcd : Ext.ComponentQuery.query('module-hjsys-goodsosttwork-worker-editor')[0].getValues().cstm_idcd,
										acpt_stat_dvcd : '0200'
									},
								...
								listeners: {
									change : function(self, value) {
										Ext.ComponentQuery.query('module-hjsys-goodsosttwork-worker-lister')[0].getStore().clearData();
										Ext.ComponentQuery.query('module-hjsys-goodsosttwork-worker-lister')[0].getStore().loadData([],false);
									}
								}
