Ext.define('module.custom.hjsys.stock.goodsosttwork.view.GoodsOsttWorkListerMaster1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-hjsys-goodsosttwork-lister-master1',
	store		: 'module.custom.hjsys.stock.goodsosttwork.store.GoodsOsttWorkMaster1',
		...
		var me = this,
			item = {
				...
				items	: [
					...
					{	text : '<span class="write-button">라벨 발행</span>', action : 'labelAction',cls: 'button1-style', width: 80	},
