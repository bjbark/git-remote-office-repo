Ext.define('module.custom.hjsys.prod.workentry.view.WorkEntryLister2', { extend: 'Axt.grid.Panel',
	id			: 'module-workentry-lister2',
	alias		: 'widget.module-workentry-lister2',
	store		: 'module.custom.hjsys.prod.workentry.store.WorkEntryLister2',
						...
						{	xtype	: 'fieldset', layout: 'vbox' , border: 0, margin : '0 0 0 0',
							...
							items	: [
								{	xtype	: 'fieldset', layout: 'vbox' , border: 0, margin : '0 0 0 0', padding : 0,
									...
									margin	: '5 0 0 10',
									handler	: function(){
										var form = Ext.getCmp('module-workentry-lister2');
