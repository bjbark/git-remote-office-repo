Ext.define('module.custom.hjsys.prod.workentry.view.WorkEntryPoorLister', { extend: 'Axt.grid.Panel',
	id			: 'module-workentry-poor',
	alias		: 'widget.module-workentry-poor'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.custom.hjsys.prod.workentry.store.WorkEntryPoorLister',
	border		: 0,
	columnLines : false,
