Ext.define('module.custom.hjsys.prod.workentry.view.WorkEntryDetail', { extend: 'Axt.grid.Panel',
	id			: 'module-workentry-detail',
						...
						{	xtype	: 'fieldset', layout: 'vbox' , border: 0, margin : '0 0 0 0',
							...
							items	: [
								{	xtype	: 'fieldset', layout: 'vbox' , border: 0, margin : '0 0 0 0', padding : 0,
									...
									margin	: '5 0 0 10',
									handler : function(){
										var form = Ext.getCmp('module-workentry-detail');
										form.complete(rec, 1);
									}
								}
							]
