Ext.define('module.custom.hjsys.sale.order.saleorder.view.SaleOrderItem1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-saleorder-lister-item1',
	store		: 'module.custom.hjsys.sale.order.saleorder.store.SaleOrderItem1',
					...
					{	fieldLabel	: '생산라인',
						...
						popup		: {
							...
							result	: function(records, nameField, pairField){
								var editor = Ext.ComponentQuery.query('module-saleorder-worker-editor2')[0],
									editorMaster = Ext.ComponentQuery.query('module-saleorder-worker-editor')[0],
									values = editor.getValues(),
									masterval = editorMaster.getValues()
								;
								//TODO : 생산라인 선택시 공정 저장 서비스 만들어야함.
								Ext.Ajax.request({
									url		: _global.location.http() + '/custom/hjsys/sale/order/saleorder/set/wkfw.do',
									params	: {
