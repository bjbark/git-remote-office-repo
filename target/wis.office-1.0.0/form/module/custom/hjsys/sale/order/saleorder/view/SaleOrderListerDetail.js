Ext.define('module.custom.hjsys.sale.order.saleorder.view.SaleOrderListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-saleorder-lister-detail',

	store: 'module.custom.hjsys.sale.order.saleorder.store.SaleOrderDetail',
