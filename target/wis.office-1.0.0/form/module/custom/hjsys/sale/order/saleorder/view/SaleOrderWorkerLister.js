Ext.define('module.custom.hjsys.sale.order.saleorder.view.SaleOrderWorkerLister', { extend: 'Axt.grid.Panel',
	alias: 'widget.module-saleorder-worker-lister',
	store: 'module.custom.hjsys.sale.order.saleorder.store.SaleOrderInvoice',
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-saleorder-worker-search'}];
...
//							listeners	: {
////								blur	: function(field){
////									var lister = Ext.ComponentQuery.query('module-saleorder-worker-lister')[0],
...
////											Ext.Ajax.request({
////												url			: _global.api_host_info + '/' + _global.app_site + '/custom/hjsys/sale/order/saleorder/get/chkOrdr.do',
////												method		: "POST",
////												params		: {
				...
				success : function(response, request) {
					...
					if	(!result.success ){
						...
						if(result.records.length >0){
							...
							var acpt_qntt = Ext.ComponentQuery.query('module-saleorder-worker-editor')[0].down('[name=acpt_qntt]').getValue();
...
//		}
	...
	listeners: {
		...
		render: function(){
			var me = this;
			var editor = Ext.ComponentQuery.query('module-saleorder-worker-editor')[0];
			new Ext.util.KeyMap({
				target: me.getEl().dom,
				binding: [
					/* Ctrl + Delete */
...
//		도면등록 체크
	...
	plan : function (rec){
		var me		= this,
			...
			lister = Ext.ComponentQuery.query('module-saleorder-worker-lister')[0],
...
//		}
	...
	suIt : function (rec){
		...
		editor1 = Ext.ComponentQuery.query('module-saleorder-worker-editor')[0],
		lister = Ext.ComponentQuery.query('module-saleorder-worker-lister')[0],
		item1  = Ext.ComponentQuery.query('module-saleorder-lister-subItem')[0],
		layout = Ext.ComponentQuery.query('module-saleorder-layout')[0],
		check = 1, chk = 0
		;
		item1.getStore().loadData([],true);
