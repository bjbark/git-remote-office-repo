Ext.define('module.design.project.dsigplan2.model.DsigPlan2Detail1',{ extend:'Axt.data.Model',
	fields:
	[
		...
		{name: 'start',				type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr },		//START
		{name: 'duration',			type: 'float'},		//duration
		{name: 'end',				type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr},		//end
		...
		{name: 'dsig_cofm_yorn',	type: 'string'},		//설계확정여부
