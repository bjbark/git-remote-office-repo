Ext.define('module.design.project.stndbomwork.view.StndBomWorkSearch', { extend: 'Axt.form.Search',

	alias: 'widget.module-stndbomwork-search',
							...
							{	xtype	: 'label',
								...
								style	: 'text-align:center;color: #0000B7;font-size: 13px !important;font-weight:bold;',
									...
									popup: {
										...
										params : { stor_grp : _global.stor_grp , line_stat : '0', dvcd : 'stnd' },
