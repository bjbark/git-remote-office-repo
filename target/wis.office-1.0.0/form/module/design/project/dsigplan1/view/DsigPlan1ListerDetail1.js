Ext.define('module.design.project.dsigplan1.view.DsigPlan1ListerDetail1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-dsigplan1-lister-detail1',
	store		: 'module.design.project.dsigplan1.store.DsigPlan1Detail1',
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex: 'dsig_vsdt_cofm_yorn'	, text : Language.get('dsig_vsdt_cofm_yorn'	,'승인여부')	, width :  60 , xtype : 'lookupcolumn', lookupValue : resource.lookup('yorn'), align : 'center'
