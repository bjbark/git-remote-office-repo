Ext.define('module.design.project.bomwork.BomWork', { extend:'Axt.app.Controller',
	...
	models	: [
		'module.design.project.bomwork.model.BomWorkMaster',
		'module.design.project.bomwork.model.BomWorkDetail3',
		'module.design.project.bomwork.model.BomWorkTree',
		'module.design.project.bomwork.model.BomWorkTree2'
	],
	stores	: [
		'module.design.project.bomwork.store.BomWorkMaster',
		'module.design.project.bomwork.store.BomWorkDetail3',
		'module.design.project.bomwork.store.BomWorkTree',
		'module.design.project.bomwork.store.BomWorkTree2'
	],
	views	: [
		'module.design.project.bomwork.view.BomWorkLayout',
		'module.design.project.bomwork.view.BomWorkSearch',
		'module.design.project.bomwork.view.BomWorkListerMaster',
		'module.design.project.bomwork.view.BomWorkTree',
		'module.design.project.bomwork.view.BomWorkTree2',
		'module.design.project.bomwork.view.BomWorkListerDetail3',
		'module.design.project.bomwork.view.BomWorkFinder',
		'module.design.project.bomwork.view.BomWorkFinder2'
	],
