Ext.define('module.design.project.dsigfile.view.DsigFileFinder', { extend: 'Axt.form.Editor',

	alias: 'widget.module-dsigfile-finder',
					...
					{	name	: 'prjt_idcd', xtype : 'textfield' , hidden : true
							...
							{	fieldLabel	: Language.get('pjod_idcd', '금형번호'),
								...
								popup		: {
									...
									result	: function(records, nameField, pairField){
										...
										var editor = Ext.ComponentQuery.query('module-dsigfile-finder')[0],
										...
										var listertree = Ext.ComponentQuery.query('module-dsigfile-tree')[0];
						...
						listeners	:{
							change:function(){
								...
								var results;
								Ext.Ajax.request({
									url		: _global.location.http() + '/design/dsigfile/get/getcstm.do',
									params	: {
