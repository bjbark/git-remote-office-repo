Ext.define('module.design.project.dsigfile.view.DsigFileListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-dsigfile-lister-master',
	store		: 'module.design.project.dsigfile.store.DsigFileMaster',
