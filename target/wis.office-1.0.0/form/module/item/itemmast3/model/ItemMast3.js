Ext.define('module.item.itemmast3.model.ItemMast3', { extend:'Axt.data.Model',
	fields: [
		...
		{	name: 'stor_palc_idcd'		, type: 'string' },		//보관장소id
		{	name: 'stor_wrhs_idcd'		, type: 'string' },		//보관창고id
		{	name: 'json_data'			, type: 'string' },		//JSON 데이터
		{	name: 'stor_palc_name'		, type: 'string' },		//보관장소명
		...
		{	name: 'spgr_valu'			, type: 'string' },		//비중값
		{	name: 'rfct_valu'			, type: 'string' },		//굴절율값
