Ext.define('module.item.itemmast2.model.ItemMast2', { extend:'Axt.data.Model',
	fields: [
		...
		{	name: 'unit_wigt'			, type: 'float'  },		//단위당중량
		{	name: 'spgr_valu2'			, type: 'float'  },		//비중
		{	name: 'item_name'			, type: 'string' },		//품명
		{	name: 'item_spec'			, type: 'string' },		//품목규격
		{	name: 'item_mtrl'			, type: 'string' },		//재질명
		{	name: 'mtrl_bacd'			, type: 'string' },		//재질구분코드
...
//		{	name: 'cstm_idcd'			, type: 'string' },		//(item_adon)
		...
		{	name: 'item_pkge_01'		, type: 'float'  , defaultValue : 0},		//박스
		{	name: 'item_pkge_02'		, type: 'float'  , defaultValue : 0},		//박스
		{	name: 'item_pkge_03'		, type: 'float'  , defaultValue : 0},		//박스
		{	name: 'item_pkge_04'		, type: 'float'  , defaultValue : 0},		//박스
		{	name: 'item_pkge_05'		, type: 'float'  , defaultValue : 0},		//박스
		{	name: 'item_pkge_06'		, type: 'float'  , defaultValue : 0},		//박스
		{	name: 'item_pkge_07'		, type: 'float'  , defaultValue : 0},		//박스
		{	name: 'item_pkge_08'		, type: 'float'  , defaultValue : 0},		//박스
		{	name: 'item_pkge_09'		, type: 'float'  , defaultValue : 0},		//박스
		{	name: 'item_pkge_10'		, type: 'float'  , defaultValue : 0},		//박스
		{	name: 'item_pkge_11'		, type: 'float'  , defaultValue : 0},		//박스
		{	name: 'item_pkge_12'		, type: 'float'  , defaultValue : 0},		//박스
		{	name: 'item_pkge_13'		, type: 'float'  , defaultValue : 0},		//박스
		{	name: 'stok_sale_yorn'		, type: 'string' , defaultValue : 0},		//박스
		...
		{	name: 'bolt_unit_dvcd'	, type: 'string'  },   // 볼트단위구분코드
		{	name: 'bolt_dvcd'		, type: 'string'  },   // 볼트구분코드
		{	name: 'mtty_dvcd'		, type: 'string'  },   // 산형구분코드
		{	name: 'unit_idcd'		, type: 'string'  },   // 단위id
		{	name: 'unit_name'		, type: 'string'  },   // 단위명
		{	name: 'leng_unit'		, type: 'string'  },   // 길이단위
		{	name: 'leng_valu'		, type: 'float'   },   // 길이값
		{	name: 'leng_unit_2snd'	, type: 'string'  },   // 길이단위2
		{	name: 'leng_valu_2snd'	, type: 'float'  , defaultValue : 0 },   // 길이값2
		{	name: 'widh_unit'		, type: 'string'  },   // 폭단위
		{	name: 'widh_valu'		, type: 'float'   },   // 폭값
		{	name: 'widh_edge'		, type: 'float'   },   // 폭가장자리
		{	name: 'tick_unit'		, type: 'string'  },   // 두께단위
		{	name: 'tick_valu'		, type: 'float'  , defaultValue : 0 },   // 두께값
		{	name: 'dim_valu'		, type: 'float'  , defaultValue : 0 },   // dim값
		{	name: 'spgr_unit'		, type: 'string'  },   // 비중단위
		{	name: 'spgr_valu'		, type: 'float'  , defaultValue : 0 },   // 비중값
		{	name: 'item_wigt'		, type: 'float'  , defaultValue : 0 },   // 품목중량
		{	name: 'drwg_numb'		, type: 'string'  },   // 도면번호
		{	name: 'inch_name_code'	, type: 'string'  },   // 인치호칭코드
		{	name: 'inch_mtct'		, type: 'float'  , defaultValue : 0  },   // 인치산수
		{	name: 'inch_otsd_dimt'	, type: 'float'  , defaultValue : 0 },   // 인치외부경
		{	name: 'jiss_name'		, type: 'float'  , defaultValue : 0  },   // jis호칭
		{	name: 'jiss_pich'		, type: 'float'  , defaultValue : 0  },   // jis피치
		{	name: 'fixd_leng'		, type: 'float'  , defaultValue : 0 },   // 고정길이
		{	name: 'lead_angl'		, type: 'string'  },   // 리드각
		{	name: 'lead_angl_stte'	, type: 'float'  , defaultValue : 0 },   // 리드각도
		{	name: 'lead_angl_mint'	, type: 'float'  , defaultValue : 0 },   // 리드각분
		{	name: 'tper_dpth'		, type: 'float'  , defaultValue : 0 },   // taper깊이
		{	name: 'tper_leng'		, type: 'float'  , defaultValue : 0 },   // taper길이
		{	name: 'tper_angl'		, type: 'string'  },   // taper각
		{	name: 'tper_angl_stte'	, type: 'float'  , defaultValue : 0 },   // taper각도
		{	name: 'tper_angl_mint'	, type: 'float'  , defaultValue : 0 },   // taper각분
		{	name: 'half_pich'		, type: 'float'  , defaultValue : 0 },   // 반피치
		{	name: 'sinn_valu'		, type: 'float'  , defaultValue : 0 },   // sin값
		{	name: 'h_valu'			, type: 'float'  , defaultValue : 0 },   // h값
		{	name: 'a_valu'			, type: 'float'  , defaultValue : 0 },   // a값
		{	name: 'b_valu'			, type: 'float'  , defaultValue : 0 },   // b값
		{	name: 'ra_valu'			, type: 'float'  , defaultValue : 0 },   // ra값
		{	name: 'rb_valu'			, type: 'float'  , defaultValue : 0 },   // rb값
		{	name: 'h2_valu'			, type: 'float'  , defaultValue : 0 },   // H값
		{	name: 'bolt_dpth'		, type: 'float'  , defaultValue : 0 },   // 나사깊이
		{	name: 'mntn_dpth'		, type: 'float'  , defaultValue : 0 },   // 산깊이
		{	name: 'mtrl_dimt'		, type: 'float'  , defaultValue : 0 },   // 소재경
		{	name: 'otsd_dimt'		, type: 'float'  , defaultValue : 0 },   // 외부경
		{	name: 'a_valu_scpe'		, type: 'string'  },   // a값범위
		{	name: 'b_valu_scpe'		, type: 'string'  },   // b값범위
		{	name: 'h_valu_scpe'		, type: 'string'  },   // h값범위
		{	name: 'mntn_dpth_scpe'	, type: 'string'  },   // 산깊이범위
		{	name: 'plat_optn'		, type: 'string'  },   // 도금사양
		{	name: 'tolr_valu'		, type: 'string'  },   // 공차
		{	name: 'item_clss_bacd'	, type: 'string'  },   // 품목분류분류코드
		{	name: 'item_bacd'		, type: 'string'  },   // 품목분류코드
		{	name: 'make_bacd'		, type: 'string'  },   // 제조분류코드
		{	name: 'srfc_proc_yorn'	, type: 'string'  },   // 표면처리여부
		{	name: 'iput_qntt'		, type: 'float'  , defaultValue : 0 },   // 삽입수량
		{	name: 'hght_valu_1fst'	, type: 'float'  , defaultValue : 0 },   // 높이값1
		{	name: 'wdth_valu_11'	, type: 'float'  , defaultValue : 0 },   // 넓이값11
		{	name: 'wdth_valu_12'	, type: 'float'  , defaultValue : 0 },   // 넓이값12
		{	name: 'wdth_valu_13'	, type: 'float'  , defaultValue : 0 },   // 넓이값13
		{	name: 'wdth_valu_2snd'	, type: 'float'  , defaultValue : 0 },   // 넓이값2
		{	name: 'wdth_valu_3trd'	, type: 'float'  , defaultValue : 0 },   // 넓이값3
		...
		{	name: 'item_tick'				, type: 'float',
			convert : function(value){
				...
				if(value == ''){
					...
					str = Ext.util.Format.number(value, '0.0');
				}
				return str;
			}
		},		//품목두께
