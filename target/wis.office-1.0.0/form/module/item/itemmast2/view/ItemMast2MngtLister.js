Ext.define('module.item.itemmast2.view.ItemMast2MngtLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemmast2-mngtlister'			,
	store		: 'module.item.itemmast2.store.ItemMast2Mngt'	,
