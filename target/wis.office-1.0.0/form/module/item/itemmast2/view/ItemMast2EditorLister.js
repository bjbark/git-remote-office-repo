Ext.define('module.item.itemmast2.view.ItemMast2EditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemmast2-editorlister'			,
	store		: 'module.item.itemmast2.store.ItemMast2File',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-itemmast2-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
