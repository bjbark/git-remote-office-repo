Ext.define('module.item.itemprice.model.ItemPriceMaster', { extend:'Axt.data.Model',
	fields: [
...
//		{	name: 'cstm_idcd'			, type: 'string' },		//(item_adon)
		...
		{name: 'shpm_pric_1fst'			, type: 'float'  },		//출하단가1
		{name: 'shpm_pric_2snd'			, type: 'float'  },		//출하단가2
		{name: 'shpm_pric_3trd'			, type: 'float'  },		//출하단가3
		{name: 'shpm_pric_4frt'			, type: 'float'  },		//출하단가4
		{name: 'shpm_pric_5fit'			, type: 'float'  },		//출하단가5
		{name: 'cnsr_pric'				, type: 'float'  },		//소비자단가
