Ext.define('module.item.itemlist.view.ItemListLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemlist-lister'			,
	store		: 'module.item.itemlist.store.ItemList'	,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex:	'lcls_name'			, width:  80, align : 'left'	, text: Language.get( 'lcls_name'		, '대분류'		), hidden: _global.options.mes_system_type =='Frame' || _global.hq_id.toUpperCase() == 'N1000NBOLT',
					},{	dataIndex:	'mcls_name'			, width:  80, align : 'left'	, text: Language.get( 'mcls_name'		, '중분류'		), hidden: _global.options.mes_system_type =='Frame' || _global.hq_id.toUpperCase() == 'N1000NBOLT',
					},{	dataIndex:	'scls_name'			, width:  80, align : 'left'	, text: Language.get( 'scls_name'		, '소분류'		), hidden: _global.options.mes_system_type =='Frame' || _global.hq_id.toUpperCase() == 'N1000NBOLT',
					...
					},{	dataIndex:	'cont_cstm_name'	, width: 120, align : 'left'	, text: Language.get( 'cstm_name'		, '거래처'		), hidden: (_global.options.mes_system_type =='Frame' || _global.hq_id.toUpperCase() == 'N1000NBOLT' ? true : false)
