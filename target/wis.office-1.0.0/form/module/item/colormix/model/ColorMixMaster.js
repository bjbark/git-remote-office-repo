Ext.define('module.item.colormix.model.ColorMixMaster',{ extend:'Axt.data.Model',
	fields : [
		{name: 'prnt_item_idcd',		type: 'string'},		//부모품목ID
		{name: 'prnt_item_code',		type: 'string'},		//부모품목코드
		{name: 'prnt_item_name',		type: 'string'},		//부모품명
		{name: 'colr_bacd',				type: 'string'},		//컬러분류코드
		{name: 'colr_name',				type: 'string'},		//컬러명
		{name: 'change',				type: 'string'},		//컬러명
