			...
			loadComplete:function(){
				for (var i = 0; i < arrs.length; i++) {
					if(arss[i]){
						...
						$('#'+dataArray[i].pjod_idcd+' td:eq(0)').attr('style','background-color:white;color:white;text-align:center;');
					}
				}
			}
		});
...
<body>
	<jsp:include page="header.jsp">
		<jsp:param value="대기 금형 진행현황" name="name"/>
	</jsp:include>
		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					...
					<li class="active"><a href="#">대기 금형 진행현황 <span class="sr-only">(current)</span></a></li>
