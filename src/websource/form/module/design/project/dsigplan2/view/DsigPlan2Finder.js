Ext.define('module.design.project.dsigplan2.view.DsigPlan2Finder', { extend: 'Axt.form.Editor',

	alias: 'widget.module-dsigplan2-finder',
					...
					{	name	: 'prjt_idcd', xtype : 'textfield' , hidden : true
							...
							{	fieldLabel	: Language.get('pjod_idcd', '금형번호'),
								...
								popup		: {
									...
									result	: function(records, nameField, pairField){
										...
										var editor = Ext.ComponentQuery.query('module-dsigplan2-finder')[0],
										...
										var listerdetail1 = Ext.ComponentQuery.query('module-dsigplan2-lister-detail1')[0];
										var listerdetail3 = Ext.ComponentQuery.query('module-dsigplan2-lister-detail3')[0];
								...
								listeners	:{
									render:function(val){
										var lister = Ext.ComponentQuery.query('module-dsigplan2-lister-detail1')[0],
						...
						listeners	:{
							change:function(){
								...
								var results;
								Ext.Ajax.request({
									url		: _global.location.http() + '/design/dsigplan2/get/getcstm.do',
									params	: {
