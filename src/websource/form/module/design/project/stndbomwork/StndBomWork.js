Ext.define('module.design.project.stndbomwork.StndBomWork', { extend:'Axt.app.Controller',
	...
	models	: [
		'module.design.project.stndbomwork.model.StndBomWorkMaster',
		'module.design.project.stndbomwork.model.StndBomWorkDetail3',
		'module.design.project.stndbomwork.model.StndBomWorkTree',
		'module.design.project.stndbomwork.model.StndBomWorkTree2'
	],
	stores	: [
		'module.design.project.stndbomwork.store.StndBomWorkMaster',
		'module.design.project.stndbomwork.store.StndBomWorkDetail3',
		'module.design.project.stndbomwork.store.StndBomWorkTree',
		'module.design.project.stndbomwork.store.StndBomWorkTree2'
	],
	views	: [
		'module.design.project.stndbomwork.view.StndBomWorkLayout',
		'module.design.project.stndbomwork.view.StndBomWorkSearch',
		'module.design.project.stndbomwork.view.StndBomWorkListerMaster',
		'module.design.project.stndbomwork.view.StndBomWorkTree',
		'module.design.project.stndbomwork.view.StndBomWorkTree2',
		'module.design.project.stndbomwork.view.StndBomWorkListerDetail3',
		'module.design.project.stndbomwork.view.StndBomWorkFinder',
		'module.design.project.stndbomwork.view.StndBomWorkFinder2'
	],
	...
	init: function() {
		...
		me.control({
			// layout event
			'module-stndbomwork-layout button[action=selectAction]'			: { click : me.selectAction },	// 조회
			'module-stndbomwork-layout #mainpanel'							: { tabchange : me.selectAction },
			// lister detail event
			'module-stndbomwork-tree button[action=modifyAction]'	: { click : me.modifyAction },	// 수정
			'module-stndbomwork-tree button[action=insertAction]'	: { click : me.insertAction },	// 신규
			'module-stndbomwork-tree2 button[action=exportAction]'	: { click : me.exportAction },	// 엑셀
			'module-stndbomwork-tree2 button[action=deleteAction]'	: { click : me.deleteAction },	// 삭제
			'module-stndbomwork-tree2 button[action=updateAction]'	: { click : me.updateAction2 },	// 저장
			'module-stndbomwork-tree button[action=changeAction]'	: { click : me.changeAction1}, /* 설계일정 조정   */
			'module-stndbomwork-tree button[action=copyAction]'		: { click : me.copyAction   }, /* 설계일정 조정   */
			'module-stndbomwork-tree button[action=bomInsert]'		: { click : me.bomInsert    }, /* BOM작성   */
			'module-stndbomwork-tree button[action=testExcel]'		: { click : me.testExcel    }, /* testExcel   */
			'module-stndbomwork-tree button[action=approveAction]'	: { click : me.approveAction}, /* 승인   */
			'module-stndbomwork-tree button[action=approveCancel]'	: { click : me.approveCancel}, /* 승인취소   */
			// editer event
			'module-stndbomwork-editor button[action=updateAction]'	: { click : me.updateAction },	// 저장
			'module-stndbomwork-editor button[action=cancelAction]'	: { click : me.cancelAction },	// 취소
			'module-stndbomwork-finder button[action=updateAction]'	: { click : me.finderUpdateAction },	// 저장
//			'module-bomwork-finder button[action=bomReport]'	: { click : me.ReportUpdateAction },	// 부품식별표 발행 (리포트)
			'module-stndbomwork-finder2 button[action=updateAction]': { click : me.finderUpdateAction },	// 저장
	...
	pocket : {
		layout		: function () { return Ext.ComponentQuery.query('module-stndbomwork-layout')[0] },
		search		: function () { return Ext.ComponentQuery.query('module-stndbomwork-search')[0] },
		listermaster: function () { return Ext.ComponentQuery.query('module-stndbomwork-lister-master')[0] },
		listertree	: function () { return Ext.ComponentQuery.query('module-stndbomwork-tree')[0] },
		listertree2	: function () { return Ext.ComponentQuery.query('module-stndbomwork-tree2')[0] },
		listerdetail3: function () { return Ext.ComponentQuery.query('module-stndbomwork-lister-detail3')[0] },
		editor		: function () { return Ext.ComponentQuery.query('module-stndbomwork-editor')[0] },
		finder		: function () { return Ext.ComponentQuery.query('module-stndbomwork-finder')[0] },
		finder2		: function () { return Ext.ComponentQuery.query('module-stndbomwork-finder2')[0] }
	},
...
//							disables	: [me.pocket.layout().down('#itempanel')],
		...
		if(pjod_idcd){
			...
			Ext.Msg.show({ title: '확인', msg: msg, icon: Ext.Msg.QUESTION, buttons: Ext.Msg.YESNO, defaultFocus: 'no', scope: me,
				fn: function (button) {
					if (button=='yes') {
						Ext.Ajax.request({
							url		: _global.location.http() + '/design/stndbomwork/get/getPrint.do',
							params	: {
								token : _global.token_id,
								param : JSON.stringify({
									stor_id			: _global.stor_id,
	...
	selectDetail : function(grid, record) {
		...
		Ext.Ajax.request({
			url		:  _global.location.http() + '/design/stndbomwork/get/getImage.do',
			params	: {
				token : _global.token_id,
				param : JSON.stringify({
					stor_id		: _global.stor_id,
		...
		if(selected){
			Ext.Msg.show({ title: '확인', msg: '삭제하시겠습니까?', icon: Ext.Msg.QUESTION, buttons: Ext.Msg.YESNO, defaultFocus: 'no', scope: me,
				fn: function (button) {
					if (button=='yes') {
						Ext.Ajax.request({
							url		: _global.location.http() + '/design/stndbomwork/set/delete.do',
							params	: {
								token : _global.token_id,
								param : JSON.stringify({
									stor_id			: _global.stor_id,
		...
		if(select.get('line_clos') ==0){
			Ext.Msg.show({ title: '확인', msg: '승인하시겠습니까?', icon: Ext.Msg.QUESTION, buttons: Ext.Msg.YESNO, defaultFocus: 'no', scope: me,
				fn: function (button) {
					if (button=='yes') {
						Ext.Ajax.request({
							url		: _global.location.http() + '/design/stndbomwork/set/setApprove.do',
							params	: {
								token : _global.token_id,
								param : JSON.stringify({
									stor_id			: _global.stor_id,
	...
	testExcel:function(){
		...
		if(!pjod_idcd){
			...
			resource.loadPopup({
				...
				apiurl : {
					upload : _global.location.href + '/system/stnddesign/bomwork/get/excel.do', // url (필수)
				},
				params : {
				...
				buttons: [
					{	text: '<span class="btnTemp" style="font-size:1em">예</span>',
						...
						handler: function() {
							...
							if(param.standard){
								Ext.Ajax.request({
									url		: _global.location.http() + '/design/stndbomwork/set/setBom.do',
									params	: {
										token : _global.token_id,
										param : JSON.stringify({
											stor_id			: _global.stor_id,
