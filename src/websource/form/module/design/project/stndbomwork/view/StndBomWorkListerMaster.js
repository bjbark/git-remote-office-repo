Ext.define('module.design.project.stndbomwork.view.StndBomWorkListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-stndbomwork-lister-master',
	store		: 'module.design.project.stndbomwork.store.StndBomWorkMaster',
