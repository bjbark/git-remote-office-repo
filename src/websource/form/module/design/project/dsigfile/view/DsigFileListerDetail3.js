Ext.define('module.design.project.dsigfile.view.DsigFileListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-dsigfile-lister-detail3',
	store		: 'module.design.project.dsigfile.store.DsigFileDetail3',
