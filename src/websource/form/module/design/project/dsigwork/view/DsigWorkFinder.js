Ext.define('module.design.project.dsigwork.view.DsigWorkFinder', { extend: 'Axt.form.Editor',

	alias: 'widget.module-dsigwork-finder',
					...
					{	name	: 'prjt_idcd', xtype : 'textfield' , hidden : true
							...
							{	fieldLabel	: Language.get('pjod_idcd', '금형번호'),
								...
								popup		: {
									...
									result	: function(records, nameField, pairField){
										...
										var editor = Ext.ComponentQuery.query('module-dsigwork-finder')[0],
										...
										var listerdetail1 = Ext.ComponentQuery.query('module-dsigwork-lister-detail1')[0];
										var listerdetail3 = Ext.ComponentQuery.query('module-dsigwork-lister-detail2')[0];
						...
						listeners	:{
							change:function(){
								...
								var results;
								Ext.Ajax.request({
									url		: _global.location.http() + '/design/dsigwork/get/getcstm.do',
									params	: {
