Ext.define('module.design.project.dsigwork.view.DsigWorkListerMaster1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-dsigwork-lister-master1',
	store		: 'module.design.project.dsigwork.store.DsigWorkMaster1',
