Ext.define('module.design.project.dsigwork.view.DsigWorkListerDetail1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-dsigwork-lister-detail1',
	store		: 'module.design.project.dsigwork.store.DsigWorkDetail1',
	...
	pagingItem : function () {
		var me = this,
			item = {
				...
				items	: [
					'->', '-' ,
					{text : '<span class="write-button">실적보고</span>' , action : 'reportAction'	, cls: 'button1-style'	} , '-' ,
