Ext.define('module.design.project.dsigwork.view.DsigWorkListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-dsigwork-lister-detail2',
	store		: 'module.design.project.dsigwork.store.DsigWorkDetail2',
