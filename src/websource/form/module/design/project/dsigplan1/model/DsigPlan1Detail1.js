Ext.define('module.design.project.dsigplan1.model.DsigPlan1Detail1',{ extend:'Axt.data.Model',
	fields:
	[
		{name: 'prjt_idcd',			type: 'string' },		//프로젝트수주id
		...
		{name: 'dsig_vsdt_cofm_yorn',type: 'string'},		//승인여부
