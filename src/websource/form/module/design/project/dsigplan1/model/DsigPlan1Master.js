Ext.define('module.design.project.dsigplan1.model.DsigPlan1Master',{ extend:'Axt.data.Model',
	fields:
	[
		{name: 'pjod_idcd',			type: 'float' },		//프로젝트수주id
		{name: 'dsig_schd_dvcd',	type: 'string'},		//설계일정구분코드
		{name: 'id',				type: 'string'},		//id
		{name: 'seqn',				type: 'string'},		//seqn
		...
		{name: 'duration',			type: 'string'},		//duration
