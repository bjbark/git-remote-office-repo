Ext.define('module.workshop.sale.order.estimast.view.EstiMastFilePopup', { extend: 'Axt.popup.Search',
	alias	: 'widget.lookup-workshop-estimast-file-popup',
	store	: 'module.workshop.sale.order.estimast.store.EstiMastFilePopup',
				...
				paging		: {
					...
					items	: [
						...
						{	xtype			: 'form-panel',
							...
							border			:  false,
							url				: 'system/custom/hjsys/sale/order/estimast/set/fileUpload2.do',
							timeout			: 120000,
							method			: 'POST',
