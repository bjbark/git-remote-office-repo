Ext.define('module.workshop.sale.order.estimast.view.EstiMastConsultingPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-estimast-consulting-popup',
	...
	finishAction: function(){
		var me = this,
			...
			store = Ext.ComponentQuery.query('module-estimast-lister-detail2')[0].getStore()
		;
		var mask = new Ext.LoadMask(Ext.getBody(), {msg: Const.UPDATE.mask });
		mask.show();
		Ext.Ajax.request({
			url		: _global.location.http() + '/sale/order/estimast/set/consulting.do',
			params	: {
