Ext.define('module.workshop.sale.order.estimast.view.EstiMastEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workshop-estimast-editorlister'			,
	store		: 'module.workshop.sale.order.estimast.store.EstiMastFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-workshop-estimast-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
