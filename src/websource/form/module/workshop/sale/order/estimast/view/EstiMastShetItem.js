Ext.define('module.workshop.sale.order.estimast.view.EstiMastShetItem', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-estimast-lister-shetItem',
	store		: 'module.workshop.sale.order.estimast.store.EstiMastShetItem',
							...
							editor	: {
								...
								listeners	: {
									...
									var grid = self.up('grid');
										val = this.getValue();
										myform	= Ext.ComponentQuery.query('module-estimast-lister-shetItem')[0];
	...
	rowInsert: function(){
		...
		// ROW 추가
		store.add(record);
		Ext.ComponentQuery.query('module-estimast-worker-editor2')[0].down('[name=modify]').setValue('Y');
	...
	rowDelete: function(){
		...
		}Ext.ComponentQuery.query('module-workshop-estimast-editor2')[0].down('[name=modify]').setValue('Y');
	},
