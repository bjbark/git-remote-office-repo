Ext.define('module.workshop.sale.order.ordermast.view.OrderMastShetLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workshop-ordermast-shetlister'			,
	store		: 'module.workshop.sale.order.ordermast.store.OrderMastShetLister',
								...
								handler	: function (grid, rowIndex, colIndex, item, e, record) {
									...
									resource.loadPopup({
										...
										result	: function(records) {
											editor = Ext.ComponentQuery.query('module-workshop-ordermast-shetlister')[0];
											console.log(editor);
