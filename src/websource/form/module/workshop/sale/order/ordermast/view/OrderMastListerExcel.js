Ext.define('module.workshop.sale.order.ordermast.view.OrderMastListerExcel', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-ordermast-lister-excel',
	store		: 'module.workshop.sale.order.ordermast.store.OrderMastExcel',
