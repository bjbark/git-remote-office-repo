Ext.define('module.workshop.sale.order.ordermast.view.OrderMastBomListDetail', { extend: 'Ext.tree.Panel',
	alias	: 'widget.module-ordermast-bomlistdetail',
	store	: 'module.workshop.sale.order.ordermast.store.OrderMastBomListDetail',
	border	: 0  ,
