Ext.define('module.workshop.sale.order.ordermast.view.OrderMastCopyPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-ordermast-copy-popup',
	...
	finishAction: function(){
		...
		if(values.deli_date==''||values.deli_date==null){
			...
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/hjsys/sale/order/ordermast/set/acpt_copy.do',
				params	: {
