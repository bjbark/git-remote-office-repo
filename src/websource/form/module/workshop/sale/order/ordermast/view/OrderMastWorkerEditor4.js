Ext.define('module.workshop.sale.order.ordermast.view.OrderMastWorkerEditor4', { extend: 'Axt.form.Editor',

	alias	: 'widget.module-ordermast-worker-editor4',
	height	: 180,
	header	: false,
	getStore: function() {
		return Ext.getStore( 'module.workshop.sale.order.ordermast.store.vsInvoice' );
	},
