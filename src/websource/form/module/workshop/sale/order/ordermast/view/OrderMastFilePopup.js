Ext.define('module.workshop.sale.order.ordermast.view.OrderMastFilePopup', { extend: 'Axt.popup.Search',
	alias	: 'widget.lookup-workshop-ordermast-file-popup',
	store	: 'module.workshop.sale.order.ordermast.store.OrderMastFilePopup',
				...
				paging		: {
					...
					items	: [
						...
						{	xtype			: 'form-panel',
							...
							border			:  false,
							url				: 'system/custom/hjsys/sale/order/ordermast/set/fileUpload2.do',
							timeout			: 120000,
							method			: 'POST',
