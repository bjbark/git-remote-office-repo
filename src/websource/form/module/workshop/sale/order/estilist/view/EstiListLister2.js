Ext.define('module.workshop.sale.order.estilist.view.EstiListLister2', { extend: 'Axt.form.Editor',
	alias		: 'widget.module-workshop-estilist-lister2'			,
							...
							{	xtype : 'fieldset', layout: 'hbox', border : 0,  margin : '0 0 10 10',
								...
								items	: [
									{	fieldLabel	: Language.get('page_qntt','페이지'),
										...
										readOnly	: true,
										width		: 50,
									},{	fieldLabel	: Language.get('bkbd_kind_name','제본종류'),
										xtype		: 'lookupfield'	,
										name		: 'bkbd_kind_name',
										lookupValue	: resource.lookup('bkbd_kind_name'),
										labelWidth	: 50,
										width		: 180,
										readOnly	: true,
										margin		: '0 0 0 25',
