Ext.define('module.workshop.mtrl.purchase.pordermast.view.PorderMastWorkerLister', { extend: 'Axt.grid.Panel',
	alias: 'widget.module-pordermast-worker-lister',
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-pordermast-worker-search'}];
