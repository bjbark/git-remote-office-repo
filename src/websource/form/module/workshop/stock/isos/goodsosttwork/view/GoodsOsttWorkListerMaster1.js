Ext.define('module.workshop.stock.isos.goodsosttwork.view.GoodsOsttWorkListerMaster1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-goodsosttwork-lister-master1',
	store		: 'module.workshop.stock.isos.goodsosttwork.store.GoodsOsttWorkMaster1',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'invc_numb'		, text : Language.get('shpm_numb'		,'출고번호'	) , width : 70 , align : 'center'
