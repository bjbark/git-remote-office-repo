Ext.define('module.mtrl.isttcalc.purcbillwork.view.PurcBillWorkWorkerListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-purcbillwork-worker-lister-detail2',
	...
	pagingItem : function () {
		var me = this,
			item = {
				...
				items : [
					'-', '->', '-',
					{	text : '<span class="write-button">매입자료 생성</span>'	, action : 'InsertAction'		, cls: 'button1-style' ,width:  90,	} ,
				], pagingButton : true
			}
		;
		return item ;
