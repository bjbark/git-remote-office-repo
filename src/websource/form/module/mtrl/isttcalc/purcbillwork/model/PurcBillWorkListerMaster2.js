Ext.define( 'module.mtrl.isttcalc.purcbillwork.model.PurcBillWorkListerMaster2', { extend : 'Axt.data.Model',
	fields: [
		...
		},{	name: 'tele_numb'		, type: 'string'	/* 메일		*/
		},{	name: 'buss_numb'		, type: 'string'	/* 발행일자		*/
