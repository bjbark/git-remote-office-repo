Ext.define('module.mtrl.isttcalc.npayinit.NpayInit', {  extend   : 'Axt.app.Controller',
	...
	models	: [
		'module.mtrl.isttcalc.npayinit.model.NpayInit',
	],
	stores	: [
		'module.mtrl.isttcalc.npayinit.store.NpayInit',
	],
	views	: [
		'module.mtrl.isttcalc.npayinit.view.NpayInitLayout',
		'module.mtrl.isttcalc.npayinit.view.NpayInitLister',
		'module.mtrl.isttcalc.npayinit.view.NpayInitSearch',
