Ext.define('module.mtrl.isttcalc.purcpaywork.view.PurcPayWorkListerDetail2', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-purcpaywork-lister-detail2',
	store		: 'module.mtrl.isttcalc.purcpaywork.store.PurcPayWorkListerDetail2',
	border		: 0,
	columnLines	: true,
		...
		var me   = this,
			item =  {
				...
				items   : [
					...
					},{	dataIndex: 'pric'		, text : Language.get(''	,'단가'		) , width :  100 , xtype : 'numericcolumn'
