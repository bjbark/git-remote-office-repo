Ext.define('module.mtrl.project.prjtpurcorder.model.PrjtPurcOrderDetail', { extend: 'Axt.data.Model',
	fields: [
	...
	recalculation: function(inv) {
		...
		;
		row.set('offr_amnt'	, Math.trunc(row.get('offr_qntt') * row.get('offr_pric')));
