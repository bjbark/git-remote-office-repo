Ext.define('module.mtrl.project.prjtpurcorder.model.PrjtPurcOrderMaster', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'supl_dvcd'			, type: 'string'	/*조달구분*/, defaultValue : '1000'
		},{	name: 'pjod_idcd'			, type: 'string'	/*조달구분*/
		},{	name: 'stot_dvcd'			, type: 'string'	/*결제구분*/
		},{	name: 'deli_date'			, type: 'string', convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr	/*결제구분*/
		},{	name: 'max_deli'			, type: 'string', convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr	/*결제구분*/
		...
		},{	name: 'total_ttsm_amnt'		, type: 'float',defaultValue : 0		/*합계금액(editor)	*/
		},{	name: 'total_deli_date'		, type: 'string', convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr		/*발주일자(editor)	*/
