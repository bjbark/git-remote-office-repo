Ext.define('module.mtrl.po.purcordrlist.model.PurcOrdrList',{ extend:'Axt.data.Model',
	fields:
	[
		...
		{	name: 'purc_drtr_name',		type: 'string'},		//발주 담당자명
		{	name: 'user_name2',			type: 'string'},		//입고 담당자명
