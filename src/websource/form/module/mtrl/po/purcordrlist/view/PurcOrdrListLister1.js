Ext.define('module.mtrl.po.purcordrlist.view.PurcOrdrListLister1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-purcordrlist-lister1',
	store		: 'module.mtrl.po.purcordrlist.store.PurcOrdrList'	,
