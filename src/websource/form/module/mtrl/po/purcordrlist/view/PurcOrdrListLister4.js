Ext.define('module.mtrl.po.purcordrlist.view.PurcOrdrListLister4', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-purcordrlist-lister4',
	store		: 'module.mtrl.po.purcordrlist.store.PurcOrdrList4',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'user_name'	, text : Language.get('offr_drtr'		,'발주담당'	) , width : 80  , align : 'left'
					...
					},{ dataIndex: 'offr_qntt'	, text : Language.get('offr_qntt'		,'발주수량'	) , width : 90  , xtype : 'numericcolumn', align : 'right', summaryType: 'sum'
					},{ dataIndex: 'istt_qntt'	, text : Language.get('istt_qntt'		,'입고수량'	) , width : 90  , xtype : 'numericcolumn', align : 'right', summaryType: 'sum'
					...
					},{ dataIndex: 'invc_numb'	, text : Language.get('offr_numb'		,'발주번호'	) , width : 130 , align : 'center'
