Ext.define('module.mtrl.po.purcordr.view.PurcOrdrWorkerSearch', { extend: 'Axt.form.Search',
	store	: 'module.mtrl.po.purcordr.store.PurcOrdrInvoice',
							...
							{	text		: '품목코드' , xtype : 'label',	style : 'text-align:center;'
								...
								popup		: {
									...
									params	: {	stor_grp	: _global.stor_grp,
												...
												hq_id		: _global.hq_id,
												line_stat	: '0',
												acct_bacd	: _global.options.mes_system_type=='SJFLV'?'삼정(구매발주)':'자재',
												pric_dvcd	: '3000',
												add			: '1',
								...
								listeners: {
									change : function(self, value) {
										...
										if(resId == 'SJFLV'){
											...
											inv_amt = Math.floor((Number(value) * Number(panel.down('[name=offr_pric]').getValue()))/10)*10
										}
										;
								...
								listeners : {
									change : function(self, value) {
										...
										if(resId == 'SJFLV'){
											...
											inv_amt = Math.floor((Number(value) * Number(panel.down('[name=offr_qntt]').getValue()))/10)*10
										}
										panel.down('[name=offr_amnt]').setValue(inv_amt);
									},
