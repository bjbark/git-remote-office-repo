Ext.define('module.mtrl.po.poisttwork.view.PoIsttWorkWorkerLister', { extend: 'Axt.grid.Panel',
	alias: 'widget.module-poisttwork-worker-lister',
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-poisttwork-worker-search'}];
