...
Ext.define('module.mtrl.po.poisttwork.view.PoIsttWorkWorkerEditor', { extend: 'Axt.form.Editor',

	alias: 'widget.module-poisttwork-worker-editor',
	height : 180,
	header : false,
	getStore : function() {
		return Ext.getStore( 'module.mtrl.po.poisttwork.store.PoIsttWorkInvoice' );
	},
