Ext.define('module.mtrl.po.poisttwork.view.PoIsttWorkWorkerSearch', { extend: 'Axt.form.Search',

	alias	: 'widget.module-poisttwork-worker-search',
...
//											self.onTriggerClick();
								...
								popup		: {
									...
									create : function (self ) {
										var cstm_idcd = Ext.ComponentQuery.query('module-poisttwork-worker-editor')[0].getValues().cstm_idcd;
										console.debug('par  :  ', cstm_idcd)
