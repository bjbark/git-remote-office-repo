Ext.define('module.mtrl.po.purcisttwork.view.PurcIsttWorkExprMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-purcisttwork-expr-master',
	store		: 'module.mtrl.po.purcisttwork.store.PurcIsttWorkExprMaster',
