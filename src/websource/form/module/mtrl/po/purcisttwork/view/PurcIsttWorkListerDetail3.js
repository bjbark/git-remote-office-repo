Ext.define('module.mtrl.po.purcisttwork.view.PurcIsttWorkListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-purcisttwork-lister-detail3',
	store		: 'module.mtrl.po.purcisttwork.store.PurcIsttWorkDetail3',
