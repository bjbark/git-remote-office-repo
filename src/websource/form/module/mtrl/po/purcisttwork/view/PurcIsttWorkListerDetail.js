Ext.define('module.mtrl.po.purcisttwork.view.PurcIsttWorkListerDetail', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-purcisttwork-lister-detail',
	store		: 'module.mtrl.po.purcisttwork.store.PurcIsttWorkDetail',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'istt_qntt'	, text : Language.get('istt_qntt'	,'수량'		) , width : 80  , xtype : 'numericcolumn', align : 'right', summaryType: 'sum', format: _global.hq_id.toUpperCase()!='N1000SJUNG'?'#,##0.##':'#,##0.###',
