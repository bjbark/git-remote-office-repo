Ext.define('module.test.testusermast.view.TestUserMastLister4', {
	extend : 'Axt.form.Panel',
	alias : 'widget.module-testusermast-lister4',
...
//			title : 'My Daily Activities',
		...
		var chart = new google.visualization.PieChart(document.getElementById('test_chart4'));
