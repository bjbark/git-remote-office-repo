Ext.define('module.stock.isos.goodsosttwork.view.GoodsOsttWorkWorkerLister', { extend: 'Axt.grid.Panel',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'invc_date'		, text : Language.get('indn_date'		,'지시일자'		) , width : 80 , align : 'center'
