Ext.define('module.stock.isos.goodsosttlist.view.GoodsOsttListListerMaster4', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-goodsosttlist-lister-master4',
	store		: 'module.stock.isos.goodsosttlist.store.GoodsOsttListMaster4',
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-goodsosttlist-worker-search'}];
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'ostt_type'	, text : Language.get(''	,'구분'		) , width : 65  , align : 'center', xtype : 'lookupcolumn', lookupValue : [['1','출고'],['2','이월'],['3','반품'],['4','소계'],['5','합계']],
