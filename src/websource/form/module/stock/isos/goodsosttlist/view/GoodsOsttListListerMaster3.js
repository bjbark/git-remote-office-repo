Ext.define('module.stock.isos.goodsosttlist.view.GoodsOsttListListerMaster3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-goodsosttlist-lister-master3',
	store		: 'module.stock.isos.goodsosttlist.store.GoodsOsttListMaster3',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'cstm_name'		, text : Language.get('cstm_name'		,'거래처명'	) , width : 230
