Ext.define('module.stock.isos.mtrlisttwork.view.MtrlIsttWorkPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-mtrlisttwork-popup',
	...
	finishAction: function(){
		...
		var a = Ext.ComponentQuery.query('#istt_qntt')[0].getValue(); //납품수량
		var s = Ext.ComponentQuery.query('#insp_qntt')[0].getValue(); //검사수량
		var d = Ext.ComponentQuery.query('#poor_qntt')[0].getValue(); //불량수량
		var e = Ext.ComponentQuery.query('#pass_qntt')[0].getValue(); //합격수량
		var f = Ext.ComponentQuery.query('#judt_dvcd')[0].getValue(); //판정
			...
			if(f== null || f==''){
				...
				if(f == '1'){
					if(e<0||e== null || e==''){
						...
						Ext.Ajax.request({
							url		: _global.location.http() + '/qc/insp/mtrlisttwork/set/insp.do',
							params	: {
