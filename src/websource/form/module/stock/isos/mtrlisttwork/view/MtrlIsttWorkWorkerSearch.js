Ext.define('module.stock.isos.mtrlisttwork.view.MtrlIsttWorkWorkerSearch', { extend: 'Axt.form.Search',

	alias   : 'widget.module-mtrlisttwork-worker-search',
...
//											self.onTriggerClick();
								...
								popup		: {
									...
									create : function (self ) {
										var cstm_idcd = Ext.ComponentQuery.query('module-mtrlisttwork-worker-editor')[0].getValues().cstm_idcd;
