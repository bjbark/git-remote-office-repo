Ext.define('module.stock.isos.etcisttwork.view.EtcIsttWorkWorkerLister', { extend: 'Axt.grid.Panel',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'lott_numb'	, width: 150	, align:'left'	, text: Language.get('lott_numb', 'LOT번호')		, tdCls: 'editingcolumn'	,
						editor	: {
							maxLength		: 40,
	...
	cellEditAfter : function (editor, context) {
		...
		console.log(me.editor.getRecord());
