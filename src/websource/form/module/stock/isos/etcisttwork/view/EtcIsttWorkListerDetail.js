Ext.define('module.stock.isos.etcisttwork.view.EtcIsttWorkListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-etcisttwork-lister-detail',

	store: 'module.stock.isos.etcisttwork.store.EtcIsttWorkDetail',
