...
Ext.define('module.stock.isos.etcosttwork.EtcOsttWork', { extend : 'Axt.app.Controller',
	...
	models:[
		'module.stock.isos.etcosttwork.model.EtcOsttWorkInvoice',
		'module.stock.isos.etcosttwork.model.EtcOsttWorkMaster',
		'module.stock.isos.etcosttwork.model.EtcOsttWorkDetail'
	],
	stores:[
		'module.stock.isos.etcosttwork.store.EtcOsttWorkInvoice',
		'module.stock.isos.etcosttwork.store.EtcOsttWorkMaster',
		'module.stock.isos.etcosttwork.store.EtcOsttWorkDetail'
	],
	views : [
		'module.stock.isos.etcosttwork.view.EtcOsttWorkLayout',
		/* 현황 */
		'module.stock.isos.etcosttwork.view.EtcOsttWorkSearch',
		'module.stock.isos.etcosttwork.view.EtcOsttWorkListerMaster',
		'module.stock.isos.etcosttwork.view.EtcOsttWorkListerDetail',
		/* 작업 */
		'module.stock.isos.etcosttwork.view.EtcOsttWorkWorkerEditor',
		'module.stock.isos.etcosttwork.view.EtcOsttWorkWorkerSearch',
		'module.stock.isos.etcosttwork.view.EtcOsttWorkWorkerLister'
	...
	deleteAction:function() {
		...
		Ext.Msg.confirm("확인", "삭제하시겠습니까?", function(button) {
			if (button == 'yes') {
				...
				Ext.Ajax.request({
					url : _global.api_host_info + '/' + _global.app_site + '/stock/etcosttwork/set/del_yn.do',
					method : "POST",
					params : {
					 	token : _global.token_id,
						param : Ext.encode({
			...
			Ext.Msg.show({ title: '확인', msg: '선택하신 내역을 마감하시겠습니까?', icon: Ext.Msg.QUESTION, buttons: Ext.Msg.YESNO, defaultFocus: 'no', scope: me,
				fn: function (button) {
					if (button=='yes') {
						...
						Ext.each(select, function(record) {
							Ext.Ajax.request({
								url		: _global.location.http() + '/stock/etcosttwork/set/close.do',
								params	: {
									token : _global.token_id,
									param : JSON.stringify({
										invc_numb		: record.get('invc_numb'),
	...
	invReportAction:function(button) {
		...
		if(select.length === 1) {
			...
			resource.loadPrint({
				...
				requrl 			: {
					search : _global.api_host_info + '/' + _global.app_site +'/stock/etcosttwork/get/printing.do',
				},
