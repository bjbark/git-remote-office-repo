Ext.define('module.stock.isos.prodosttwork.view.ProdOsttWorkWorkerLister', { extend: 'Axt.grid.Panel',
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex: 'line_seqn'	, width:  50	, align:'center', text: '항번'		, xtype: 'numericcolumn' , format : '#,##0.##' },
