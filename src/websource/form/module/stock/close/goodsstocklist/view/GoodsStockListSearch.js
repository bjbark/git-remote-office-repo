Ext.define('module.stock.close.goodsstocklist.view.GoodsStockListSearch', { extend: 'Axt.form.Search',
					...
					{	xtype	: 'fieldset',
						...
						items	: [
							{	xtype		: 'label'			,
								...
								value 		: _global.options.mes_system_type.toUpperCase() == 'SJFLV' ? '제품창고' : ''
							},{	name : 'wrhs_idcd', xtype : 'textfield' , hidden : true, value : _global.options.mes_system_type.toUpperCase() == 'SJFLV' ? '01' : ''
							},{	name		: 'find_name'		,
								xtype		: 'searchfield'	,
								flex		: 4				,
								emptyText	: '',
							...
							},{	name		: 'acct_dvcd', xtype : 'textfield' , hidden : true,value:'2'
							}
						]
