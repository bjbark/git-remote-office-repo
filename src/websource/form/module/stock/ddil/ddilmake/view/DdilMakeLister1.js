Ext.define('module.stock.ddil.ddilmake.view.DdilMakeLister1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-ddilmake-lister1',
	store		: 'module.stock.ddil.ddilmake.store.DdilMake1',
