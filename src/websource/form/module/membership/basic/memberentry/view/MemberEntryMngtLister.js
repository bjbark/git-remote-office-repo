Ext.define('module.membership.basic.memberentry.view.MemberEntryMngtLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-memberentry-mngtlister'			,
	store		: 'module.membership.basic.memberentry.store.MemberEntryMngt'	,
