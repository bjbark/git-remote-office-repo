Ext.define('module.membership.basic.memberentry.view.MemberEntryInotLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-memberentry-inot-lister'			,
	store		: 'module.membership.basic.memberentry.store.MemberEntryInot'	,
...
//					},
					'->', '-' ,
					{xtype:'button',text : '<span class ="btnTemp" style="color:green; font-size : 13px;">추 가</span>', iconCls: Const.INSERT.icon, action : 'inotAction' } ,
					, '-',
					{xtype:'button',text : '<span class ="btnTemp" style="color:blue; font-size : 13px;">예약변경</span>', iconCls: Const.UPDATE.icon, action : 'inotModifyAction' } ,
					, '-',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'mmbr_idcd'		, width:  90, align : 'center'	, text: Language.get('mmbr_idcd'	, '회원ID'		),hidden : true,
