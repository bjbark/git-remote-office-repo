Ext.define('module.membership.basic.memberentry.view.MemberEntryEditor', { extend: 'Axt.form.Editor',

	alias: 'widget.module-memberentry-editor',
				...
				items			: [
					{	xtype	: 'fieldset', layout: 'hbox' ,padding:'0', border: 0,margin : '10 0 5 0',
						...
						items	: [
								...
								listeners	: {
									change : function() {
										var panel	= this.up('form'),
											...
											panel.down('[name=wedd_yorn]').setValue(tt);
									}
								}
							...
							},{ name		: 'wedd_yorn',xtype		: 'textfield', hidden		: true
		...
		var me = this,
			item = {
				...
				items	: [
					me.createTab1(),
					me.createTab5(),
					{title : '첨부파일'	, xtype: 'module-memberentry-editorlister'},
					{title : '메모'		, xtype: 'module-memberentry-memolister'},
					{title : '관리항목'	, xtype: 'module-memberentry-mngtlister'},
				]
			}
		;
		return item;
