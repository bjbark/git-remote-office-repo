Ext.define('module.project.projmenu.view.ProjMenuEditor', {  extend: 'Axt.form.Editor',
	alias: 'widget.module-projmenu-editor',
	height : 280,
	layout : {
		type: 'border'
	},
			...
			items : [
		 	 	{	xtype : 'fieldset', layout: 'hbox' ,padding:'0', border: 0,margin : '0 0 5 0',
		 	 		...
		 	 		lookupValue : [['Y','admin전용'],['N','일반사용자']],
 	 		 		width : 200
		 	 	},{	xtype : 'textarea'  , name : 'usr_memo'  , fieldLabel : '메모사항' ,height : 80
		 	 	}
		 	]
		};// , me.createTabs()
		return item;
