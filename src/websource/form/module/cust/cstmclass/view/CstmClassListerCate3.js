Ext.define('module.cust.cstmclass.view.CstmClassListerCate3', { extend: 'Axt.grid.Panel',

	plugins		: [{ ptype:'gridcolumnconfig'  } ],
	alias		: 'widget.module-cstmclass-lister-cate3',
	store		: 'module.cust.cstmclass.store.CstmClassCate3',
