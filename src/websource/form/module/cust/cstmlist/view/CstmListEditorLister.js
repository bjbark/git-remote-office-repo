Ext.define('module.cust.cstmlist.view.CstmListEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-cstmlist-editorlister'			,
	store		: 'module.cust.cstmlist.store.CstmListFile',
	border		: 0,
	columnLines : true,
