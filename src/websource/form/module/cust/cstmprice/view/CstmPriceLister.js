Ext.define('module.cust.cstmprice.view.CstmPriceLister', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-cstmprice-lister',
	store		: 'module.cust.cstmprice.store.CstmPriceMaster',
	border		: 0,
	columnLines	: true,
