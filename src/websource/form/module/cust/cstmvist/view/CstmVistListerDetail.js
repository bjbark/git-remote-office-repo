Ext.define('module.cust.cstmvist.view.CstmVistListerDetail', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-cstmvist-lister-detail',
	store		: 'module.cust.cstmvist.store.CstmVistDetail',
	border		: 0,
	columnLines	: true,
