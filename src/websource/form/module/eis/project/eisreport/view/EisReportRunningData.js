Ext.define('module.eis.project.eisreport.view.EisReportRunningData', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-eisreport-runndata',
	store		: 'module.eis.project.eisreport.store.EisReportRunningData',
	border		: 0,
	columnLines : false,
