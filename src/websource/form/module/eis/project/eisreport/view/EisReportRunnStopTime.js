Ext.define('module.eis.project.eisreport.view.EisReportRunnStopTime', { extend: 'Axt.form.Editor',

	alias: 'widget.module-eisreport-runnstop',
						...
						{	layout : 'hbox',
							...
							items :[
								{	text	: '가동시간',
									...
									readOnly : true,
									style	:'font-size:1.5em; line-height: 6; text-align:center',
									cls		:'textTemp'
								},{	xtype	: 'textfield',
									name	: 'runn_time',
									flex	: 1,
	...
	getSelect:function(){
		var me = this,
			store = Ext.getStore('module.eis.project.eisreport.store.EisReportRunnStopTime'),
			today = me.dateFormat(),
