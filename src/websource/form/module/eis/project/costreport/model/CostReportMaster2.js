Ext.define('module.eis.project.costreport.model.CostReportMaster2',{ extend:'Axt.data.Model',
	fields: [
		...
		{	name: 'deli_date',			type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr  },		//발주일자
