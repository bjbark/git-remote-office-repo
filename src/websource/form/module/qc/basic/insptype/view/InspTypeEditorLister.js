Ext.define('module.qc.basic.insptype.view.InspTypeEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-insptype-editorlister'			,
	store		: 'module.qc.basic.insptype.store.InspTypeFile',
	border		: 0,
	columnLines : true,
				...
				fbar	: [
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							params : { stor_grp : _global.stor_grp , line_stat : '0' ,invc_numb : 'insp_type_idcd' , orgn_dvcd : '', line_seqn : 0 },
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-insptype-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'insp_type_mast';											// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'line_seqn'		, text : Language.get('line_seqn'		,'순번')		, width : 280 , hidden : true
