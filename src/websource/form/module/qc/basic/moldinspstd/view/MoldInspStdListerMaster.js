Ext.define('module.qc.basic.moldinspstd.view.MoldInspStdListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-moldinspstd-lister-master',
	store		: 'module.qc.basic.moldinspstd.store.MoldInspStdMaster',
