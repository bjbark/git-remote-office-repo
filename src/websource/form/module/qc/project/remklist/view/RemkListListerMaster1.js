Ext.define('module.qc.project.remklist.view.RemkListListerMaster1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-remklist-lister-master1',
	store		: 'module.qc.project.remklist.store.RemkListMaster1',
