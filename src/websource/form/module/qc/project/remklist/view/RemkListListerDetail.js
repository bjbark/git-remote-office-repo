Ext.define('module.qc.project.remklist.view.RemkListListerDetail', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-remklist-lister-detail',
	store		: 'module.qc.project.remklist.store.RemkListDetail',
