Ext.define('module.qc.project.remklist.view.RemkListListerMaster2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-remklist-lister-master2',
	store		: 'module.qc.project.remklist.store.RemkListMaster2',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'user_memo'	, text : Language.get('user_memo'	,'비고'		) , width : 70  , align : 'left'
					}
				]
			}
		;
