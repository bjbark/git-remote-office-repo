Ext.define('module.qc.project.testprod.model.TestProdDetail',{ extend:'Axt.data.Model',
	fields : [
		...
		{name: 'item_name',				type: 'string'},		//공정명
		...
		{name: 'sttm1',					type: 'string' , defaultValue : Ext.Date.format(new Date(),'Ymd'),convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.dateToStr } ,		//시작시간
		...
		{name: 'edtm1',					type: 'string' , defaultValue : Ext.Date.format(new Date(),'Ymd'),convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.dateToStr } ,		//종료시간
