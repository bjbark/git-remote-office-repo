Ext.define('module.qc.project.remkwork.view.RemkWorkListerMaster1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-remkwork-lister-master1',
	store		: 'module.qc.project.remkwork.store.RemkWorkMaster1',
		...
		item = {
			defaults: {style: 'text-align: center'},
				items	: [
					...
					},{ dataIndex: 'pjod_idcd'		, text : Language.get('pjod_idcd'		,'금형번호'		) , width : 160 , align : 'center'
					...
					},{ dataIndex: 'cstm_item_code'	, text : Language.get('cstm_item_code'	,'고객품명'		) , width : 170 , align : 'left'
