Ext.define('module.qc.insp.inspreport.model.InspReportMaster', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'orig_invc_numb'		, type: 'string' 	/* 발주번호		*/
		},{	name: 'orig_seqn'			, type: 'string' 	/* 항번		*/
		...
		},{	name: 'line_clos'			, type: 'string' 	/* 합격수량		*/
