Ext.define('module.qc.insp.inspreport.model.InspReportLister1',{ extend:'Axt.data.Model',
	fields:
	[
		...
		{	name: 'prod_balan'			, type: 'float'  },		//생산잔량
		...
		{	name: 'poor_type_bacd'		, type: 'string' },		//불량유형구분코드
		...
		{	name: 'lott_numb2'			, type: 'string' },		//순번
		...
		{	name: 'msmt_valu_1fst'		, type: 'string' },		//품목코드
		{	name: 'msmt_valu_2snd'		, type: 'string' },		//검사장비
		{	name: 'insp_sbsc_name'		, type: 'string' },		//검사장비
