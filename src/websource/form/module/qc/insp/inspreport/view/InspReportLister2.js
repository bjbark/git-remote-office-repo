Ext.define('module.qc.insp.inspreport.view.InspReportLister2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-inspreport-lister2',
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.qc.insp.inspreport.store.InspReportLister2',
	border		: 0,
	columnLines : true,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'wrhs_name'		, text : Language.get('wrhs_name'		,'창고명')			, width : 80  , align : 'left', hidden : true
					...
					},{	dataIndex: 'insp_sbsc_name'	, text: Language.get( 'insp_sbsc_name'	,'검사항목')		, width:  120 , align : 'left'	, hidden : _global.hq_id.toUpperCase() == 'N1000KOMEC' ? false : true,
					...
					},{	dataIndex: 'judt_dvcd'		, text: Language.get( 'judt_dvcd'		,'판정구분')		, width:  80  , align : 'left'	, xtype: 'lookupcolumn'  , lookupValue: resource.lookup( 'judt_dvcd' )
