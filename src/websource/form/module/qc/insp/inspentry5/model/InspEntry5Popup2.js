Ext.define('module.qc.insp.inspentry5.model.InspEntry5Popup2',{ extend:'Axt.data.Model',
	fields:
	[
		...
		},{	name: 'invc_date'			, type: 'string', defaultValue : Ext.Date.format(new Date(),'Ymd') , serialize: Ext.util.Format.dateToStr	//검사일자
		},{	name: 'deli_date'			, type: 'string', defaultValue : Ext.Date.format(new Date(),'Ymd') , serialize: Ext.util.Format.dateToStr	//검사일자
		...
		},{	name: 'spts_qntt'			, type: 'float'		//
		},{	name: 'insp_strt_time'		, type: 'string', serialize: Ext.util.Format.dateToStr	//검사시간

		},{	name: 'spts_numb'			, type: 'string'
		},{	name: 'spts_seqn'			, type: 'string'
		},{	name: 'spts_date'			, type: 'string'
