Ext.define('module.qc.insp.inspentry5.view.InspEntry5Lister1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-inspentry5-lister1',
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.qc.insp.inspentry5.store.InspEntry5Lister1',
	border		: 0,
	columnLines : true,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'sale_unit'			, text : Language.get('sale_unit'		,'단위')			, width : 80  , hidden : _global.hq_id.toUpperCase() == 'N1000KOMEC' ? false : true,
					},{ dataIndex: 'unit_name'			, text : Language.get('unit_name'		,'단위')			, width : 80  , hidden : _global.hq_id.toUpperCase() != 'N1000KOMEC' ? false : true,
					...
					},{ dataIndex: 'sale_pric'			, text : Language.get('sale_pric'		,'판매단가')		, width : 80  , xtype:'numericcolumn', hidden : _global.hq_id.toUpperCase() == 'N1000KOMEC' ? true : false,
					...
					},{ dataIndex: 'sale_amnt'			, text : Language.get('sale_amnt'		,'판매금액')		, width : 80  , xtype:'numericcolumn', hidden : _global.hq_id.toUpperCase() == 'N1000KOMEC' ? true : false,
					},{ dataIndex: 'vatx_amnt'			, text : Language.get('vatx_amnt'		,'부가세')		, width : 80  , xtype:'numericcolumn' , hidden : _global.hq_id.toUpperCase() == 'N1000KOMEC' ? true : false,
					},{ dataIndex: 'ttsm_amnt'			, text : Language.get('ttsm_amnt'		,'합계금액')		, width : 80  , xtype:'numericcolumn', hidden : _global.hq_id.toUpperCase() == 'N1000KOMEC' ? true : false,
					...
					},{ dataIndex: 'insp_dvcd'			, text : Language.get('insp_dvcd'		,'검사구분')		, width : 100 , align : 'center', xtype : 'lookupcolumn', lookupValue : resource.lookup('insp_dvcd') , hidden : _global.hq_id.toUpperCase() == 'N1000KOMEC' ? true : false,
					},{ dataIndex: 'insp_date'			, text : Language.get('insp_date'		,'검사일자')		, width : 100 , align : 'center'
					},{ dataIndex: 'insp_sbsc_name'		, text : Language.get('insp_sbsc_name'	,'검사항목명')		, width : 150 , hidden : _global.hq_id.toUpperCase() == 'N1000KOMEC' ? false : true,
					},{ dataIndex: 'insp_cond'			, text : Language.get('insp_cond'		,'규격'	)		, width : 180 , hidden : _global.hq_id.toUpperCase() == 'N1000KOMEC' ? false : true,
					},{ dataIndex: 'msmt_valu'			, text : Language.get('msmt_valu'		,'검사값'	)		, width : 100 , hidden : _global.hq_id.toUpperCase() == 'N1000KOMEC' ? false : true,
					...
					},{ dataIndex: 'insp_mthd_dvcd'		, text : Language.get('insp_mthd_dvcd'	,'검사방법')		, width : 100 , align : 'center', xtype : 'lookupcolumn', lookupValue : resource.lookup('insp_mthd_dvcd'), hidden : _global.hq_id.toUpperCase() == 'N1000KOMEC' ? true : false,
