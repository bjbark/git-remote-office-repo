Ext.define('module.qc.insp.inspentry2.model.InspEntry2Lister1',{ extend:'Axt.data.Model',
	fields:
	[
		...
		{	name: 'msmt_valu_2snd'		, type: 'string'  },		//측정값2
		{	name: 'msmt_valu_3trd'		, type: 'string'  },		//측정값3
		{	name: 'msmt_valu_4frt'		, type: 'string'  },		//측정값4
		{	name: 'msmt_valu_5fit'		, type: 'string'  },		//측정값5
		{	name: 'msmt_valu_6six'		, type: 'string'  },		//측정값6
		{	name: 'msmt_valu_7svn'		, type: 'string'  },		//측정값7
		{	name: 'msmt_valu_8egh'		, type: 'string'  },		//측정값8
		{	name: 'msmt_valu_9nin'		, type: 'string'  },		//측정값9
		{	name: 'msmt_valu_10'		, type: 'string'  },		//측정값10
