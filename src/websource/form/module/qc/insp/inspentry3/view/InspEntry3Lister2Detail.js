Ext.define('module.qc.insp.inspentry3.view.InspEntry3Lister2Detail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-inspentry3-lister2-detail',

	store: 'module.qc.insp.inspentry3.store.InspEntry3Detail2',
	...
	pagingItem : function() {
		var me = this,
			item = {
				...
				items : [
					'->', '-',
					{ text : Const.EXPORT.text, iconCls : Const.EXPORT.icon, action : Const.EXPORT.action ,cls: 'button-style', itemId : 'detail2'}
				],
				pagingButton : false
			}
		;
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex:	'line_seqn'			, width:  40, align : 'center' , text: Language.get( 'line_seqn'		, '순번'		), xtype: 'numericcolumn'
					...
					},{	dataIndex:	'insp_drtr_name'	, width:  80, align : 'left'   , text: Language.get( 'insp_date'		, '검사담당'	)
