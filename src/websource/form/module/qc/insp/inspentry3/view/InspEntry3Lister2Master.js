Ext.define('module.qc.insp.inspentry3.view.InspEntry3Lister2Master', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-inspentry3-lister2-master',

	store		: 'module.qc.insp.inspentry3.store.InspEntry3Master2',
