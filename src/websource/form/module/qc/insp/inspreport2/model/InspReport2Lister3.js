Ext.define('module.qc.insp.inspreport2.model.InspReport2Lister3', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'insp_mthd_dvcd'		, type: 'string' 	/* 구분코드		*/
		},{	name: 'x1'					, type: 'string' 	/* 측정값1		*/
		},{	name: 'x2'					, type: 'string' 	/* 측정값2		*/
		},{	name: 'x3'					, type: 'string' 	/* 측정값3		*/
		},{	name: 'x4'					, type: 'string' 	/* 측정값4		*/
		},{	name: 'x5'					, type: 'string' 	/* 측정값5		*/
		},{	name: 'x6'					, type: 'string' 	/* 측정값6		*/
		},{	name: 'x7'					, type: 'string' 	/* 측정값7		*/
		},{	name: 'x8'					, type: 'string' 	/* 측정값8		*/
		},{	name: 'x9'					, type: 'string' 	/* 측정값9		*/
		},{	name: 'x10'					, type: 'string' 	/* 측정값10	*/
