Ext.define('module.qc.insp.inspentry6.model.InspEntry6Lister2',{ extend:'Axt.data.Model',
	fields:
	[
		...
		{	name: 'deli_date'			, type: 'float'  ,defaultValue : Ext.Date.format(new Date(),'Ymd'), convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr },//납기일자
		...
		{	name: 'rewk_qntt'			, type: 'float'  },		//불량수량
