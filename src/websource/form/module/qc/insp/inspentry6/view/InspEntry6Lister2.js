Ext.define('module.qc.insp.inspentry6.view.InspEntry6Lister2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-inspentry6-lister2',
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.qc.insp.inspentry6.store.InspEntry6Lister2',
	border		: 0,
	columnLines : true,
			...
			var me = this,
				item = {
					...
					items : [
							...
							},{ dataIndex: 'insp_qntt'		, text : Language.get('insp_qntt'		,'검사수량'		), width : 100 , align : 'right' , xtype : 'numericcolumn'
							...
							},{ dataIndex: 'work_indn_qntt'	, text : Language.get('work_indn_qntt'	,'작업지시량'		), width : 100 , align : 'right' , xtype : 'numericcolumn'
							},{ dataIndex: 'prod_qntt'		, text : Language.get('prod_qntt'		,'생산수량'		), width : 100 , align : 'right' , xtype : 'numericcolumn'
							},{ dataIndex: 'pass_qntt'		, text : Language.get('pass_qntt'		,'합격수량'		), width : 100 , align : 'right' , xtype : 'numericcolumn'
							},{ dataIndex: 'poor_qntt'		, text : Language.get('poor_qntt'		,'불량수량'		), width : 100 , align : 'right' , xtype : 'numericcolumn'
							...
							},{ dataIndex: 'pass_yorn'		, text : Language.get('pass_yorn'		,'합격여부'		), width : 60 , xtype : 'lookupcolumn' , lookupValue : resource.lookup('yorn')
							...
							},{ dataIndex: 'smor_pass_qntt'	, text : Language.get('smor_pass_qntt'	,'시료합격수량'	), width : 100 , align : 'right' , xtype : 'numericcolumn'
							},{ dataIndex: 'smor_poor_qntt'	, text : Language.get('smor_poor_qntt'	,'시료불합격수량'	), width : 100 , align : 'right' , xtype : 'numericcolumn'
							...
							},{	dataIndex: 'trtm_drtr_name'	, text: Language.get( 'trtm_drtr_name'	, '처리담당자'	), width:  80	, align : 'left'
							},{	dataIndex: 'trtm_date'		, text: Language.get( 'trtm_date'		, '처리일자'	),width: 100	, align : 'center'	,
