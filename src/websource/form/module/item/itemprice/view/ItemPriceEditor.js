Ext.define('module.item.itemprice.view.ItemPriceEditor', { extend: 'Axt.form.Editor',

	alias: 'widget.module-itemprice-editor',
					...
					{	xtype	: 'fieldset', layout: 'hbox' ,padding:'0', border: 0,margin : '10 0 5 0',
						...
						items		: [
							{	fieldLabel	: Language.get('insp_type_name','검사유형'),
								...
								pair		: 'insp_type_idcd',
								clearable	: false ,
								hidden		: ! _global.item_insp_type_yorn, /* 여기를 수정할 경우 금형 등록 Editor 부분을 수정하여야 한다.  */
								popup		: {
									select	: 'SINGLE',
