Ext.define('module.item.itemprice.view.ItemPriceListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemprice-lister-detail2'			,
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex: 'cstm_name'		, width: 160, align : 'center'	, text: Language.get('cstm'	, '판매거래처'	)
	...
	rowInsert: function(){
		var me			= this,
			myform		= Ext.ComponentQuery.query('module-itemprice-lister-detail2')[0],
	 ...
	 ******************************************************************/
	rowDelete: function(){
		var myform	= Ext.ComponentQuery.query('module-itemprice-lister-detail2')[0],
