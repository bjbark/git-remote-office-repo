Ext.define('module.item.itemlist.ItemList', { extend:'Axt.app.Controller',
	...
	models : [
		'module.item.itemlist.model.ItemList',
		'module.item.itemlist.model.ItemListIsos',
		'module.item.itemlist.model.ItemListRett'
	],
	stores : [
		'module.item.itemlist.store.ItemList',
		'module.item.itemlist.store.ItemListIsos',
		'module.item.itemlist.store.ItemListRett'
	],
	views: [
		'module.item.itemlist.view.ItemListLayout',
		'module.item.itemlist.view.ItemListSearch',
		'module.item.itemlist.view.ItemListLister',
		'module.item.itemlist.view.ItemListEditor',
		'module.item.itemlist.view.ItemListIsosLister',
		'module.item.itemlist.view.ItemListWorkSearch',
		'module.item.itemlist.view.ItemListRettLister'
	],
