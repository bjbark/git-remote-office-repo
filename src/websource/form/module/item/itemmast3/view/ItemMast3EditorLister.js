Ext.define('module.item.itemmast3.view.ItemMast3EditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemmast3-editorlister'			,
	store		: 'module.item.itemmast3.store.ItemMast3File',
