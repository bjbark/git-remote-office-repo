Ext.define('module.item.itemmast.model.ItemMast', { extend:'Axt.data.Model',
	fields: [
		...
		{	name: 'acct_bacd_name'		, type: 'string' },		//계정구분코드
...
//		{	name: 'cstm_idcd'			, type: 'string' },		//(item_adon)
		...
		{	name: 'wigt_info'			, type: 'float'  , defaultValue : 0},		//중량
		...
		{	name: 'tper_dprt'		, type: 'int'  , defaultValue : 1 },   // taper깊이율
