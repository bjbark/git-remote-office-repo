Ext.define('module.item.itemmast.ItemMast', { extend:'Axt.app.Controller',
	...
	models:
	[
	 	'module.item.itemmast.model.ItemMast',
	 	'module.item.itemmast.model.ItemMastMemo',
	 	'module.item.itemmast.model.ItemMastMngt',
	 	'module.item.itemmast.model.ItemMastPkge',
	 	'module.item.itemmast.model.ItemMastFile'
	],
	stores:
	[
	 	'module.item.itemmast.store.ItemMast',
	 	'module.item.itemmast.store.ItemMastMemo',
	 	'module.item.itemmast.store.ItemMastMngt',
	 	'module.item.itemmast.store.ItemMastPkge',
	 	'module.item.itemmast.store.ItemMastFile'
	],
	views:
	[
		'module.item.itemmast.view.ItemMastLayout',
		'module.item.itemmast.view.ItemMastSearch',
		'module.item.itemmast.view.ItemMastLister',
		'module.item.itemmast.view.ItemMastEditor',
		'module.item.itemmast.view.ItemMastEditorLister',
		'module.item.itemmast.view.ItemMastMemoLister',
		'module.item.itemmast.view.ItemMastMngtLister',
		'module.item.itemmast.view.ItemMastPkgeLister'
	],
