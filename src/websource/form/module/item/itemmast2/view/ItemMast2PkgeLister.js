Ext.define('module.item.itemmast2.view.ItemMast2PkgeLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemmast2-pkgelister'			,
	store		: 'module.item.itemmast2.store.ItemMast2Pkge'	,
	...
	initComponent: function () {
		...
		;
		Ext.Ajax.request({
			url		: _global.location.http() + '/item/itemmast2/get/pckg_bacd.do',
			params	: {
