Ext.define('module.item.itemmast2.view.ItemMast2MemoLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemmast2-memolister'			,
	store		: 'module.item.itemmast2.store.ItemMast2Memo'	,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex:	'item_idcd'			, width:  80, align : 'center'	, text: Language.get( 'item_idcd'	, '품목ID'	) ,hidden : false
