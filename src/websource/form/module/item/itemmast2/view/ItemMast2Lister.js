Ext.define('module.item.itemmast2.view.ItemMast2Lister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemmast2-lister'			,
	store		: 'module.item.itemmast2.store.ItemMast2'	,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex:	'mtrl_bacd_name'	, width: 180, align : 'left'	, text: Language.get( 'item_mtrl'		, '재질'			)
					},{	dataIndex:	'mtrl_bacd'			, width: 200, align : 'left'	, text: Language.get( 'mtrl_bacd'		, '재질구분'		), hidden : true,
					},{	dataIndex:	'item_spec'			, width: 200, align : 'left'	, text: Language.get( 'item_spec'		, '품목규격'		)
					},{	dataIndex:	'modl_name'			, width: 120, align : 'left'	, text: Language.get( 'modl_name'		, '모델명'		), hidden: _global.options.mes_system_type =='Frame',
					},{	dataIndex:	'unit_name'			, width:  70, align : 'left'	, text: Language.get( ''				, '수불단위'		)
					},{	dataIndex:	'lcls_name'			, width: 120, align : 'left'	, text: Language.get( 'lcls_name'		, '대분류'		), hidden: _global.options.mes_system_type =='Frame',
					},{	dataIndex:	'mcls_name'			, width: 120, align : 'left'	, text: Language.get( 'mcls_name'		, '중분류'		), hidden: _global.options.mes_system_type =='Frame',
					},{	dataIndex:	'scls_name'			, width: 120, align : 'left'	, text: Language.get( 'scls_name'		, '소분류'		), hidden: _global.options.mes_system_type =='Frame',
					},{	dataIndex:	'acct_bacd_name'	, width:  80, align : 'center'	, text: Language.get( 'acct_bacd_name'	, '계정구분'		)
					},{	dataIndex:	'cont_cstm_name'	, width: 120, align : 'left'	, text: Language.get( 'cstm_name'		, '거래처'		), hidden: _global.options.mes_system_type =='Frame',
					...
					},{	dataIndex:	'pkge_name'			, width: 100, align : 'left'	, text: Language.get( 'pkge_name'		, '포장정보'		) , hidden: _global.options.mes_system_type =='Frame',
					},{	dataIndex:	'item_stnm'			, width: 250, align : 'left'	, text: Language.get( 'item_stnm'		, '품목약칭'		) , hidden: _global.options.mes_system_type =='Frame',
					...
					},{	dataIndex:	'colr_bacd_name'	, width:  80, align : 'center'	, text: Language.get( 'colr_bacd_name'	, '컬러'			) , hidden: _global.options.mes_system_type =='Frame',
					...
					},{	dataIndex:	'lott_mngt_yorn'	, width:  60, align : 'center'	, text: Language.get( 'lott_mngt_yorn'	, 'LOT관리여부'	) , xtype: 'lookupcolumn'  , lookupValue: resource.lookup( 'yorn' ), hidden: _global.options.mes_system_type =='Frame',
					...
					},{	dataIndex:	'lott_idnf_code'	, width: 150, align : 'center'	, text: Language.get( 'lott_idnf_code'	, 'LOT식별'		), hidden: _global.options.mes_system_type =='Frame',
