Ext.define('module.basic.deptmast.view.DeptMastEditor', { extend: 'Axt.form.Editor',

	alias: 'widget.module-deptmast-editor',
		...
		var me = this,
			item = {
				...
				items			: [
					{	name	: 'dept_idcd', xtype : 'textfield' , hidden : true
						...
						popup		: {
							...
							result	: function(records, nameField, pairField) {
								...
								panel1.down('[name=prnt_dept_code]').setValue(records[0].get('dept_code'));
					...
					},{	name : 'prnt_dept_code', xtype : 'textfield' , hidden : true
					}
				]
			}
		;
