Ext.define('module.basic.deptmast.view.DeptMastLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-deptmast-lister'			,
	store		: 'module.basic.deptmast.store.DeptMast'	,
