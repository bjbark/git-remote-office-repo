Ext.define('module.basic.clssmast.view.ClssMastListerCate4', { extend: 'Axt.grid.Panel',


	plugins		: [{ ptype:'gridcolumnconfig'  } ],
	alias		: 'widget.module-clssmast-lister-cate4',
	store		: 'module.basic.clssmast.store.ClssMastCate4',
