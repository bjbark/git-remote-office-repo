Ext.define('module.basic.clssmast.view.ClssMastListerExcel', { extend: 'Axt.grid.Panel',

	plugins		: [{ ptype:'gridcolumnconfig'  } ],
	alias		: 'widget.module-clssmast-lister-excel',
	store		: 'module.basic.clssmast.store.ClssMastExcel',
	border 		: 0  ,
