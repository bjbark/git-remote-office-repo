Ext.define('module.basic.item.eco.bomlist.view.BomListLister', { extend: 'Ext.tree.Panel',
	alias	: 'widget.module-bomlist-lister',
	store	: 'module.basic.item.eco.bomlist.store.BomList',
	border	: 0  ,
		...
		var me = this,
			item = {
				...
				items		: [
					...
					},{ text : '투입공정'		, dataIndex: 'wkfw_name'		, width : 130
