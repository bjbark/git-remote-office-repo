Ext.define('module.custom.dehansol.prod.workentry.model.WorkEntry',{ extend:'Axt.data.Model',
	fields: [
		...
		{	name: 'wk_time'					, type: 'string' },		//작업소요시간
		{	name: 'work_strt_dttm'			, type: 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.datetimeToStr},		//작업시작일시
		{	name: 'work_endd_dttm'			, type: 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.datetimeToStr},		//작업종료일시
		...
		{	name: 'work_strt_date'			, type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr},		// 시작일자
		{	name: 'work_strt_time'			, type: 'string'}, 		// 시작시간
		{	name: 'work_endd_date'			, type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr},		// 종료일자
		{	name: 'work_endd_time'			, type: 'string'},		// 종료시간
