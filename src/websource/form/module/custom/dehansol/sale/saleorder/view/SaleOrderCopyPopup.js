Ext.define('module.custom.dehansol.sale.saleorder.view.SaleOrderCopyPopup', { extend: 'Axt.popup.Search',
	...
	finishAction: function(){
		...
		if(values.deli_date==''||values.deli_date==null){
			...
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/dahansol/sale/saleorder/set/copy.do',
				params	: {
