Ext.define('module.custom.dehansol.sale.saleorder.view.SaleOrderFile', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-saleorder-file'			,
	store		: 'module.custom.dehansol.sale.saleorder.store.SaleOrderFile',
				...
				fbar	: [
					{	fieldLabel	: Language.get('file_name','파일첨부'),				// temp
						...
						popup: {
							...
							params : { stor_grp : _global.stor_grp , line_stat : '0' ,invc_numb : '' , orgn_dvcd : '', line_seqn : 1 },
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-saleorder2-file')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'saleorder2';											// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
