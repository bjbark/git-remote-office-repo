Ext.define('module.custom.dehansol.cust.cstmmast.view.CstmMastEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-cstmmast-editorlister'			,
	store		: 'module.custom.dehansol.cust.cstmmast.store.CstmMastFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-cstmmast-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
