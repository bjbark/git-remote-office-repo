Ext.define('module.custom.dehansol.cust.cstmmast.view.CstmMastDrtrLister', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-cstmmast-drtr-lister',
	store		: 'module.custom.dehansol.cust.cstmmast.store.CstmMastDrtr',
	border		: 0,
	columnLines	: true,
