Ext.define('module.custom.sjflv.stock.isos.goodsosttwork.view.GoodsOsttWorkListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-goodsosttwork-lister-detail2',
	store		: 'module.custom.sjflv.stock.isos.goodsosttwork.store.GoodsOsttWorkDetail2',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'trst_qntt'	, text : Language.get('trst_qntt'	,'의뢰수량'		) , width : 80  , xtype : 'numericcolumn', summaryType: 'sum', format: _global.hq_id.toUpperCase()!='N1000SJUNG'?'#,##0.##':'#,##0.###',
					},{ dataIndex: 'ostt_qntt'	, text : Language.get('ostt_qntt'	,'출고수량'		) , width : 90  , xtype : 'numericcolumn', summaryType: 'sum', format: _global.hq_id.toUpperCase()!='N1000SJUNG'?'#,##0.##':'#,##0.###',
