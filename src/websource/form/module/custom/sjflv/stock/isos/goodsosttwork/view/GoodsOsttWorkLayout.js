Ext.define('module.custom.sjflv.stock.isos.goodsosttwork.view.GoodsOsttWorkLayout',{ extend: 'Axt.form.Layout',
...
//									border	: 0,
//									items	: [
//										{	xtype	: 'module-goodsosttwork-lister-master1-test',
//											flex	: 2,
//											split	: true,
//											region	: 'north',
//											style	: Const.borderLine.bottom
...
//													region	: 'center',
//													items	: [
//														{	xtype	: 'module-goodsosttwork-lister-detail1-test',
//															region	: 'center',
//															style	: Const.borderLine.top
//														}
//													]
...
//							border	: 0,
//							items	: [
//								{	xtype	: 'module-goodsosttwork-worker-editor-test',
//									height	: 44,
//									region	: 'north',
//								},{	xtype : 'module-goodsosttwork-worker-lister-test',
//									split	: false,
//									region	: 'center',
//									style	: Const.borderLine.top
//								}
