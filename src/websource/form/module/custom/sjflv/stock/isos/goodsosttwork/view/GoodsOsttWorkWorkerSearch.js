Ext.define('module.custom.sjflv.stock.isos.goodsosttwork.view.GoodsOsttWorkWorkerSearch',{ extend: 'Axt.form.Search',
	store		: 'module.custom.sjflv.stock.isos.goodsosttwork.store.GoodsOsttWorkInvoice',
