Ext.define('module.custom.sjflv.stock.isos.goodsosttwork.model.GoodsOsttWorkWorkerMaster',{ extend:'Axt.data.Model',
	fields  : [
		{	name: 'invc_numb',			type: 'string'},		//INVOICE번호
		{	name: 'line_seqn',			type: 'string'},		//순번
		{	name: 'new_invc_numb',		type: 'string'},		//새로운INVOICE번호
		{	name: 'bzpl_idcd',			type: 'string' , defaultValue: '001'},		//사업장ID
		...
		{	name: 'dely_cstm_name',		type: 'string'},		//납품처명
		{	name: 'dlvy_addr_1fst',		type: 'string'},		//납품처
		...
		{	name: 'sply_amnt',			type: 'float' },		//부가세금액
		{	name: 'vatx_amnt',			type: 'float' },		//부가세금액
		{	name: 'invc_amnt',			type: 'float' },		//부가세금액
		...
		{	name: 'lott_numb2',			type: 'string'},		//lot번호
		{	name: 'lott_numb_sum',		type: 'string'},		//lot번호 합계
		...
		{	name: 'prod_trst_dvcd',		type: 'string'},
