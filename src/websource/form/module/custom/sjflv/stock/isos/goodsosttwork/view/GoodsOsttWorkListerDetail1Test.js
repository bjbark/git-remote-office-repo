Ext.define('module.custom.sjflv.stock.isos.goodsosttwork.view.GoodsOsttWorkListerDetail1Test', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-goodsosttwork-lister-detail1-test',
	store		: 'module.custom.sjflv.stock.isos.goodsosttwork.store.GoodsOsttWorkDetail1Test',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'ostt_qntt'	, text : Language.get('ostt_qntt'	,'출고수량'	) , width :  80 , xtype : 'numericcolumn', align : 'right', summaryType: 'sum', format: _global.hq_id.toUpperCase()!='N1000SJUNG'?'#,##0.####':'#,##0.##9',
