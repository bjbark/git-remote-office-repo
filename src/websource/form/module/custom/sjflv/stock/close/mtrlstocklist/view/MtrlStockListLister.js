Ext.define('module.custom.sjflv.stock.close.mtrlstocklist.view.MtrlStockListLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-mtrlstocklist-lister',
	store		: 'module.custom.sjflv.stock.close.mtrlstocklist.store.MtrlStockList',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'base_amnt'		, text : Language.get('base_pric'		,'이월 금액'		) , width : 100 , xtype : 'numericcolumn', align : 'right', summaryType: 'sum', format: _global.options.mes_system_type.toUpperCase() != 'SJFLV'?'#,##0.##':'#,##0.##9',
