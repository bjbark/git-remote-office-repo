Ext.define('module.custom.sjflv.haccp.docmmast.view.DocmMastSearch', { extend: 'Axt.form.Search',
	alias: 'widget.module-sjflv-docmmast-search',
				...
				{	xtype : 'fieldset',
					items : [
						{	xtype		: 'popupfield',
							...
							fieldLabel	: Language.get('drtr_name','결제담당'),
