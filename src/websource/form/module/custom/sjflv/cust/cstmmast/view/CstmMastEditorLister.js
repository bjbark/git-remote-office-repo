Ext.define('module.custom.sjflv.cust.cstmmast.view.CstmMastEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-cstmmast-editorlister'			,
	store		: 'module.custom.sjflv.cust.cstmmast.store.CstmMastFile',
