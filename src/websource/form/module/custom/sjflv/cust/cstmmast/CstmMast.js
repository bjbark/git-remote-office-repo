Ext.define('module.custom.sjflv.cust.cstmmast.CstmMast', {  extend   : 'Axt.app.Controller',
	requires : [
	...
	models	: [
		'module.custom.sjflv.cust.cstmmast.model.CstmMastDrtr',
		'module.custom.sjflv.cust.cstmmast.model.CstmMastDeli',
		'module.custom.sjflv.cust.cstmmast.model.CstmMastBank',
		'module.custom.sjflv.cust.cstmmast.model.CstmMast',
		'module.custom.sjflv.cust.cstmmast.model.CstmMastMngt',
		'module.custom.sjflv.cust.cstmmast.model.CstmMastFile'
	],
	stores	: [
		'module.custom.sjflv.cust.cstmmast.store.CstmMastDrtr',
		'module.custom.sjflv.cust.cstmmast.store.CstmMastDeli',
		'module.custom.sjflv.cust.cstmmast.store.CstmMastBank',
		'module.custom.sjflv.cust.cstmmast.store.CstmMast',
		'module.custom.sjflv.cust.cstmmast.store.CstmMastMngt',
		'module.custom.sjflv.cust.cstmmast.store.CstmMastFile'
	],
	views	: [
		'module.custom.sjflv.cust.cstmmast.view.CstmMastLayout',
		'module.custom.sjflv.cust.cstmmast.view.CstmMastLister',
		'module.custom.sjflv.cust.cstmmast.view.CstmMastDrtrLister',
		'module.custom.sjflv.cust.cstmmast.view.CstmMastDeliLister',
		'module.custom.sjflv.cust.cstmmast.view.CstmMastBankLister',
		'module.custom.sjflv.cust.cstmmast.view.CstmMastSearch',
		'module.custom.sjflv.cust.cstmmast.view.CstmMastEditor',
		'module.custom.sjflv.cust.cstmmast.view.CstmMastEditorLister',
		'module.custom.sjflv.cust.cstmmast.view.CstmMastMngtLister',
		'module.custom.sjflv.cust.cstmmast.view.CstmMastDeliListerSearch'
	],
	...
	insertAction:function() {
		...
		if(_global.options.mes_system_type.toUpperCase()=='BOX'){
			url=_global.location.http() + '/custom/sjflv/cust/cstmmast/get/box_cstm_idcd.do';
		}
		editor.insertBefore({
			caller	: me,
			keygen	: {
	...
	updateAction:function() {
		...
		if(_global.options.cstm_buss_numb==1&&window.update_stat == 1){
			...
			Ext.Ajax.request({
				url : _global.location.http() + '/custom/sjflv/cust/cstmmast/get/buss_numb.do',
				object		: resource.keygen,
				params		: {
					token	: _global.token_id ,
					param	: JSON.stringify({
	...
	deleteAction : function() {
		...
		if (select) {
			Ext.Msg.confirm("확인", "삭제하시겠습니까?", function(button) {
				...
				mask.show();
					Ext.Ajax.request({
						url			: _global.api_host_info + '/' + _global.app_site + '/custom/sjflv/cust/cstmmast/set/del_yn.do',
						method		: "POST",
						params		: {
						 	token	: _global.token_id,
							param	: Ext.encode({
