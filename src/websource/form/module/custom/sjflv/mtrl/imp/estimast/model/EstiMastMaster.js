Ext.define('module.custom.sjflv.mtrl.imp.estimast.model.EstiMastMaster', { extend: 'Axt.data.Model',
	fields : [
		...
		},{	name: 'pric_cond_dvcd'		, type: 'string'	//환율변경여부
		},{	name: 'expt_dvcd'			, type: 'string'	//환율변경여부
		},{	name: 'paym_cond'			, type: 'string'	//지불조건
		},{	name: 'remk_text'			, type: 'string'	//비고
		},{	name: 'memo'				, type: 'string'	//메모
		},{	name: 'crny_dvcd'			, type: 'string'	//메모
