Ext.define('module.custom.sjflv.mtrl.imp.ordermast2.view.OrderMast2ListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-ordermast2-lister-detail',

	store: 'module.custom.sjflv.mtrl.imp.ordermast2.store.OrderMast2Detail',
	...
	pagingItem : function() {
		var me = this,
			item = {
				...
				items : [
					'->', '-',
					{	text : '<span class="write-button">선적서류 등록</span>'	, action : 'fileAction'		, cls: 'button-style', width: 100	} ,
