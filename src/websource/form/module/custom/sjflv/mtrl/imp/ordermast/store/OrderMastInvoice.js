Ext.define('module.custom.sjflv.mtrl.imp.ordermast.store.OrderMastInvoice', { extend:'Axt.data.Store',
	model: 'module.custom.sjflv.mtrl.imp.ordermast.model.OrderMastInvoice',
	autoLoad: false,
