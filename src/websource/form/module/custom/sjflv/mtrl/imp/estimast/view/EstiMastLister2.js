Ext.define('module.custom.sjflv.mtrl.imp.estimast.view.EstiMastLister2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-estimast-lister2'			,
	store		: 'module.custom.sjflv.mtrl.imp.estimast.store.EstiMastFile',
