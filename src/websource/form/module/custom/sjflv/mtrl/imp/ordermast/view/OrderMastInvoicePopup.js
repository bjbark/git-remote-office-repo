Ext.define('module.custom.sjflv.mtrl.imp.ordermast.view.OrderMastInvoicePopup', { extend: 'Axt.popup.Search',
	...
	finishAction: function(a,b,c){
		...
		if(values.invc_numb==''||values.invc_numb==null){
			...
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/sjflv/mtrl/imp/ordermast/set/invoicePopup.do',
				params	: {
