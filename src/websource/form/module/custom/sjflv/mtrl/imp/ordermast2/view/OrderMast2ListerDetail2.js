Ext.define('module.custom.sjflv.mtrl.imp.ordermast2.view.OrderMast2ListerDetail2', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-ordermast2-lister-detail2',

	store: 'module.custom.sjflv.mtrl.imp.ordermast2.store.OrderMast2Detail2',
	...
	pagingItem : function() {
		var me = this,
			item = {
				...
				items : [
					'->', '-',
					{	text : '<span class="write-button">입고서류 등록</span>', action : 'fileAction2'		, cls: 'button-style', width: 100	} ,
