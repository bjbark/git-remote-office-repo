Ext.define('module.custom.sjflv.mtrl.isttcalc.purcrettmast.view.PurcRettMastListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-purcrettmast-lister-master',
	store		: 'module.custom.sjflv.mtrl.isttcalc.purcrettmast.store.PurcRettMastMaster',
	...
	pagingItem : function () {
		var me = this,
			item = {
				...
				items	: [
					'-', '->',
					{text : '<span class="write-button">반품증</span>'	, action : Const.UPDATE.action , cls: 'button1-style'},
					'-',
