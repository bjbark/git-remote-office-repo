Ext.define('module.custom.sjflv.mtrl.isttcalc.purccstmlist1.view.PurcCstmList1WorkerSearch', { extend: 'Axt.form.Search',

	alias	: 'widget.module-purccstmlist1-worker-search',
	height	: 150,
	header	: false,
