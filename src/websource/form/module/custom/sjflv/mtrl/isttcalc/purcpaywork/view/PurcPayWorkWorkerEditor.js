Ext.define('module.custom.sjflv.mtrl.isttcalc.purcpaywork.view.PurcPayWorkWorkerEditor', { extend: 'Axt.form.Editor',

	alias	: 'widget.module-sjflv-purcpaywork-worker-editor',
	header	: false,
	height	: 50,
	...
	getStore: function() {
		return Ext.getStore( 'module.custom.sjflv.mtrl.isttcalc.purcpaywork.store.PurcPayWorkInvoice' );
	},
	createWest : function () {
		var me	= this,
			item = {
