Ext.define('module.custom.sjflv.mtrl.isttcalc.purcrettmast.model.PurcRettMastDetail',{ extend:'Axt.data.Model',
	fields : [
		{	name: 'invc_numb'				,type: 'string'		// INVOICE번호
		},{	name: 'line_seqn'				,type: 'float'		// 순번
		},{	name: 'purc_invc_numb'			,type: 'string'		//
		},{	name: 'istt_invc_numb'			,type: 'string'		//
		...
		},{	name: 'purc_invc_date'				,type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr		// 승인일자
		},{	name: 'istt_invc_date'				,type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr		// 승인일자
		},{	name: 'apvl_date'				,type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr		// 승인일자
