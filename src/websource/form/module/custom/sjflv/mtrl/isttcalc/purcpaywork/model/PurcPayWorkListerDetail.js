Ext.define( 'module.custom.sjflv.mtrl.isttcalc.purcpaywork.model.PurcPayWorkListerDetail', { extend : 'Axt.data.Model',
	fields: [
		{	name: 'iomy_dvcd'			, type: 'string'	/* 입출금구분코드	*/
		},{	name: 'invc_numb'			, type: 'string'	/* INVOICE번호	*/
		},{	name: 'line_seqn'			, type: 'float' 	/* 순번			*/
		},{	name: 'item_idcd'			, type: 'string'	/* 품목ID		*/
		},{	name: 'item_code'			, type: 'string'	/* 품목명		*/
		...
		},{	name: 'txbl_seqn'			, type: 'float'		/* 세금계산서순번	*/
