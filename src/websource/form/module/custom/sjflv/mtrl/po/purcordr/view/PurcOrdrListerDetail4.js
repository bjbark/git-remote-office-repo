Ext.define('module.custom.sjflv.mtrl.po.purcordr.view.PurcOrdrListerDetail4', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-purcordr-lister-detail4',

	store: 'module.custom.sjflv.mtrl.po.purcordr.store.PurcOrdrDetail4',
	...
	pagingItem : function() {
		var me = this,
			item = {
				...
				items : [
					'->', '-',
					{	text : '<span class="write-button">선적서류 등록</span>'	, action : 'fileAction2'		, cls: 'button-style', width: 100	},
