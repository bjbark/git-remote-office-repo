Ext.define('module.custom.sjflv.mtrl.po.purcordr.view.PurcOrdrListerDetail2', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-purcordr-lister-detail2',

	store: 'module.custom.sjflv.mtrl.po.purcordr.store.PurcOrdrDetail2',
	...
	pagingItem : function() {
		var me = this,
			item = {
				...
				items : [
					'->', '-',
					{	text : '<span class="write-button">입고서류 등록</span>', action : 'fileAction3'		, cls: 'button-style', width: 100	} ,
