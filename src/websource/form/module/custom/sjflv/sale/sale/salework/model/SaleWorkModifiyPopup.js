Ext.define( 'module.custom.sjflv.sale.sale.salework.model.SaleWorkModifiyPopup', { extend : 'Axt.data.Model',
	fields: [
		...
		},{	name: 'orig_invc_type'		, type: 'string'	/* sale,rett		*/
		},{	name: 'new_invc_numb'		, type: 'float'		/* 부가세포함여부		*/
		},{	name: 'new_invc_numb2'		, type: 'float'		/* 부가세포함여부		*/
		},{	name: 'orig_invc_numb'		, type: 'string'	/* orign번호		*/
		},{	name: 'orig_invc_seqn'		, type: 'float'		/* orign순번		*/
		},{	name: 'vatx_rate'			, type: 'float '	/* 부가세율			*/
		},{	name: 'qntt'				, type: 'float ',defaultValue:0	/* 수량				*/
		},{	name: 'sply_pric'			, type: 'float ',defaultValue:0	/* 단가				*/
		...
		},{	name: 'qntt2'				, type: 'float ',defaultValue:0	/* 공급가액			*/
		},{	name: 'sply_amnt2'			, type: 'float ',defaultValue:0	/* 공급가액			*/
		},{	name: 'vatx_amnt2'			, type: 'float ',defaultValue:0	/* 부가세액			*/
		},{	name: 'ttsm_amnt2'			, type: 'float ',defaultValue:0	/* 합계금액			*/
		...
		},{	name: 'lgin_idcd'			, type: 'string'	/* 수정ID		*/ , defaultValue: _global.login_pk
	...
	recalculation: function(inv) {
		var row = this
			baseamt = row.get('qntt') * row.get('sply_pric')
		;
		row.set('sply_amnt'	, Math.round(row.get('qntt') * row.get('sply_pric')));
