Ext.define('module.custom.sjflv.sale.sale.salecolt.view.SaleColtListerMaster2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-salecolt-lister-master2',
	store		: 'module.custom.sjflv.sale.sale.salecolt.store.SaleColtMaster2',
