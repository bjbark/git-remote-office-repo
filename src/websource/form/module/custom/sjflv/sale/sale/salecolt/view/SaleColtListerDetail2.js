Ext.define('module.custom.sjflv.sale.sale.salecolt.view.SaleColtListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-salecolt-lister-detail2',
	store		: 'module.custom.sjflv.sale.sale.salecolt.store.SaleColtDetail2',
