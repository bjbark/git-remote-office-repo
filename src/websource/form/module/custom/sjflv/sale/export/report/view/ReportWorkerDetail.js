Ext.define('module.custom.sjflv.sale.export.report.view.ReportWorkerDetail', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-report-worker-detail',
	split		: true,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'unpaid'			, text : Language.get(''		,'단가'		) , width : 100  , xtype : 'numericcolumn'
