Ext.define('module.custom.sjflv.sale.export.nego.view.NegoSearch', { extend: 'Axt.form.Search',

	alias: 'widget.module-sjflv-nego-search',
	store		: 'module.custom.sjflv.sale.export.nego.store.NegoSearch',
