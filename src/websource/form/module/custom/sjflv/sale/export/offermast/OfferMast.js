Ext.define('module.custom.sjflv.sale.export.offermast.OfferMast', { extend : 'Axt.app.Controller',
	...
	models:[
		'module.custom.sjflv.sale.export.offermast.model.OfferMastInvoice',
		'module.custom.sjflv.sale.export.offermast.model.OfferMastMaster',
		'module.custom.sjflv.sale.export.offermast.model.OfferMastDetail',
	],
	stores:[
		'module.custom.sjflv.sale.export.offermast.store.OfferMastInvoice',
		'module.custom.sjflv.sale.export.offermast.store.OfferMastMaster',
		'module.custom.sjflv.sale.export.offermast.store.OfferMastDetail',
	],
	views : [
		'module.custom.sjflv.sale.export.offermast.view.OfferMastLayout',
		/* 현황 */
		'module.custom.sjflv.sale.export.offermast.view.OfferMastSearch',
		'module.custom.sjflv.sale.export.offermast.view.OfferMastListerMaster',
		'module.custom.sjflv.sale.export.offermast.view.OfferMastListerDetail',
		/* 작업 */
		'module.custom.sjflv.sale.export.offermast.view.OfferMastWorkerEditor',
		'module.custom.sjflv.sale.export.offermast.view.OfferMastWorkerSearch',
		'module.custom.sjflv.sale.export.offermast.view.OfferMastWorkerLister',
		'module.custom.sjflv.sale.export.offermast.view.OfferMastInexPopup'
	],
	initPermission: function(workspace, permission) {
		...
		this.joinPermission(workspace.down('module-offermast-lister-master button[action=etcPrintAction]'),      Const.PERMIT.EXPORT);
	},
	init: function() {
		var me = this;
		me.control({
			'module-offermast-layout button[action=selectAction]'					: { click : me.selectAction       }, /* 조회 */

			'module-offermast-lister-master menuitem[action=closeActiveAction]'	: { click : me.closeAction        }, /* 마감 */
			'module-offermast-lister-master menuitem[action=closeCancelAction]'	: { click : me.closeAction        }, /* 마감취소 */
			'module-offermast-lister-master menuitem[action=okAction]'				: { click : me.okAction           }, /* 승인 */
			'module-offermast-lister-master menuitem[action=okCancelAction]'		: { click : me.okCancelAction     }, /* 승인취소 */

			'module-offermast-lister-master menuitem[action=closeAction]'			: { click : me.closeAction        }, /* 마감 */
			'module-offermast-lister-master menuitem[action=closeCancelAction]'	: { click : me.closeCancelAction  }, /* 마감해지 */
			'module-offermast-lister-master button[action=copyAction]'				: { click : me.copyAction         }, /* 수주복사 */
			'module-offermast-lister-master button[action=orderAction]'			: { click : me.orderAction        }, /* 출고지시 */
			'module-offermast-lister-master button[action=etcPrintAction]'			: { click : me.invReportAction    }, /* 명세서 발행 */
			'module-offermast-lister-master button[action=insertAction]'			: { click : me.insertAction       }, /* 등록 */
			'module-offermast-lister-master button[action=modifyAction]'			: { click : me.modifyAction       }, /* 수정 */
			'module-offermast-lister-master button[action=exportAction]'			: { click : me.exportAction       }, /* 엑셀 */
			'module-offermast-lister-master button[action=deleteAction]'			: { click : me.deleteAction       }, /* 삭제 */
			'module-offermast-lister-master button[action=ganttAction]'			: { click : me.ganttAction        }, /* 일정보기 */
			'module-offermast-lister-detail button[action=deleteAction2]'			: { click : me.deleteAction2      }, /* 삭제 */
			'module-offermast-lister-detail button[action=exportAction]'			: { click : me.exportDetailAction }, /* 엑셀 */
			'module-offermast-lister-detail button[action=prorAction]'				: { click : me.prorAction         }, /* 생산지시 */
			'module-offermast-lister-detail button[action=prorAction2]'			: { click : me.prorAction2        }, /* 생산지시일괄*/
			'module-offermast-lister-master button[action=uploadAction]'			: { click : me.excelUploadAction  },
			'module-offermast-lister-master button[action=pasteUploadAction]'		: { click : me.pasteUploadAction  }, /* 엑셀 붙여 넣기 액션 */
			'module-offermast-lister-master button[action=inexAction]'			 : { click : me.inexAction		},		//

			'module-offermast-worker-lister button[action=updateAction]'			: { click : me.updateAction }, /* 저장 */
			'module-offermast-worker-lister button[action=cancelAction]'			: { click : me.cancelAction }, /* 취소 */
			'module-offermast-worker-search button[action=inputAction]'			: { click : me.itemInputAction }, /* 취소 */
			'module-offermast-lister-master' : {
	...
	pocket : {
		layout : function () { return Ext.ComponentQuery.query('module-offermast-layout')[0] },
		search : function () { return Ext.ComponentQuery.query('module-offermast-search')[0] },
		worker : {
			editor : function () { return Ext.ComponentQuery.query('module-offermast-worker-editor')[0] },
			lister : function () { return Ext.ComponentQuery.query('module-offermast-worker-lister')[0] },
			search : function () { return Ext.ComponentQuery.query('module-offermast-worker-search')[0] }
		},

		lister : {
			master  : function () { return Ext.ComponentQuery.query('module-offermast-lister-master')[0] },
			detail  : function () { return Ext.ComponentQuery.query('module-offermast-lister-detail')[0] },
		},
		popup : function () { return Ext.ComponentQuery.query('module-offermast-inex-popup')[0] }
	},
			...
			Ext.Msg.show({ title: '확인', msg: '선택하신 오더를 승인하시겠습니까?', icon: Ext.Msg.QUESTION, buttons: Ext.Msg.YESNO, defaultFocus: 'no', scope: me,
				fn: function (button) {
					if (button=='yes') {
						...
						Ext.each(select, function(record) {
							Ext.Ajax.request({
								url		: _global.location.http() + '/custom/sjflv/sale/export/offermast/set/ok.do',
								params	: {
									token : _global.token_id,
									param : JSON.stringify({
										invc_numb		: record.get('invc_numb'),
					...
					{	text: '<span class="btnTemp" style="font-size:1em">예</span>',
						...
						handler: function() {
							...
							if(param.strt_date==''||param.strt_date==null){
								...
								Ext.Ajax.request({
									url		: _global.location.http() + '/custom/sjflv/sale/export/offermast/set/pror.do',
									params	: {
										token : _global.token_id,
										param : JSON.stringify({
											stor_id		: _global.stor_id,
								...
								Ext.Ajax.request({
									url		: _global.location.http() + '/custom/sjflv/sale/export/offermast/set/workbook.do',
									params	: {
										token : _global.token_id,
										param : JSON.stringify({
											stor_id		: _global.stor_id,
	...
	prorAction2:function(){																	//TODO pror2
		...
		if(pdsd_yorn == 1){
			...
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/sjflv/sale/export/offermast/set/pror2.do',
				params	: {
					token : _global.token_id,
					param : JSON.stringify({
						stor_id		: _global.stor_id,
...
//					mask.hide();
//			}, scope:me
//		}, Ext.merge( {stor_id : _global.stor_id , line_seqn : record[0].get('line_seqn')}));
...
//			search.down('[name=mtrl_bacd]').setValue('0005');
	...
	copyAction:function() {
		...
		if (!records || records.length!=1) {
			Ext.Msg.alert("알림", "Offer를 선택 후 진행하십시오.");
			return;
		}
		var me = this
		resource.loadPopup({
		...
		Ext.Msg.confirm("확인", "삭제하시겠습니까?", function(button) {
			if (button == 'yes') {
				...
				for (var i = 0; i < records.length; i++) {
					Ext.Ajax.request({
						url			: _global.api_host_info + '/' + _global.app_site + '/custom/sjflv/sale/export/offermast/set/record.do',
						method		: "POST",
						params		: {
							token	: _global.token_id,
							param	: Ext.encode({
...
//				stor_id		: _global.stor_id
	...
	inexAction:function() {
		...
		var me = this
		resource.loadPopup({
			widget : 'module-offermast-inex-popup',
		});
	},
