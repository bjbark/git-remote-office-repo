Ext.define('module.custom.sjflv.sale.export.report.view.ReportWorkerEditor', { extend: 'Axt.form.Editor',

	alias	: 'widget.module-sjflv-report-worker-editor',
	header	: false,
	getStore: function() {
		return Ext.getStore( 'module.custom.sjflv.sale.export.report.store.ReportInvoice' );
	},
