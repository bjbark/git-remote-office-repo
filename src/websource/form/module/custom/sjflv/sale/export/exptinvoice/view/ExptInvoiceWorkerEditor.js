Ext.define('module.custom.sjflv.sale.export.exptinvoice.view.ExptInvoiceWorkerEditor', { extend: 'Axt.form.Editor',

	alias	: 'widget.module-sjflv-exptinvoice-worker-editor',
	header	: false,
	getStore: function() {
		return Ext.getStore( 'module.custom.sjflv.sale.export.exptinvoice.store.ExptInvoiceInvoice' );
	},
