Ext.define('module.custom.sjflv.sale.export.blmast.view.BlMastListerMaster1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-blmast-lister-master1',
	store		: 'module.custom.sjflv.sale.export.blmast.store.BlMastMaster1',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'invc_numb'		, text : Language.get(''		,'BL No'		) , width : 100  ,
					},{ dataIndex: 'invc_date'		, text : Language.get(''		,'BL 일자'		) , width : 100  , align : 'center'
					...
					},{ dataIndex: 'stot_time_dvcd'		, text : Language.get(''		,'결제기한'		) , width : 80, align : 'center', xtype : 'lookupcolumn', lookupValue : resource.lookup('line_stat')
					},{	dataIndex: 'mney_unit'		, text : Language.get(''		,'화폐단위'		) , width : 80
					},{ dataIndex: 'mney_unit'		, text : Language.get(''		,'통화'			) , width : 80
