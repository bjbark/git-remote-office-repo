Ext.define('module.custom.sjflv.sale.export.blmast.view.BlMastSearch', { extend: 'Axt.form.Search',

	alias: 'widget.module-sjflv-blmast-search',
	store		: 'module.custom.sjflv.sale.export.blmast.store.BlMastSearch',
