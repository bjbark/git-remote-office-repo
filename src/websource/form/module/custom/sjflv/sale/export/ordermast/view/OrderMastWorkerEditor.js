	Ext.define('module.custom.sjflv.sale.export.ordermast.view.OrderMastWorkerEditor', { extend: 'Axt.form.Editor',

		alias	: 'widget.module-sjflv-ordermast-worker-editor',
		height	: 230,
		header	: false,
		getStore: function() {
			return Ext.getStore( 'module.custom.sjflv.sale.export.ordermast.store.OrderMastInvoice' );
		},
			...
			items		: [
				{	xtype  : 'fieldset', layout: 'hbox',
					...
					items  : [
						...
						},{	fieldLabel	: Language.get('po_numb', 'P/O No' ),
							xtype		: 'textfield',
							name		: 'po_numb',
							margin		: '0 0 0 5',
							labelWidth	: 100,
							width		: 230
						},{	fieldLabel	: Language.get('invc_date', 'P/O Date' ),
							name		: 'invc_date',
							xtype		: 'datefield',
							margin		: '0 0 0 5',
							format		: Const.DATE_FORMAT_YMD_BAR,
					...
					margin : '5 0 0 0',
					items  : [
						{	fieldLabel	: Language.get('mney_unit_name', '화폐단위' ),
							name		: 'mney_unit_name',
							pair		: 'mney_unit',
							xtype		: 'popupfield',
							editable	: true,
							...
							width		: 230
						},{	name : 'mney_unit', xtype	: 'textfield', hidden : true,
