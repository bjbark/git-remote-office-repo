Ext.define('module.custom.sjflv.sale.export.exptpayment.view.ExptPaymentWorkerLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-exptpayment-worker-lister',
	store		: 'module.custom.sjflv.sale.export.exptpayment.store.ExptPaymentWorkerLister',
	split		: true,
