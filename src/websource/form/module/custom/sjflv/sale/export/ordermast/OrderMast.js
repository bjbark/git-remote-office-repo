Ext.define('module.custom.sjflv.sale.export.ordermast.OrderMast', { extend : 'Axt.app.Controller',
	...
	models:[
		'module.custom.sjflv.sale.export.ordermast.model.OrderMastInvoice',
		'module.custom.sjflv.sale.export.ordermast.model.OrderMastMaster',
		'module.custom.sjflv.sale.export.ordermast.model.OrderMastDetail',
	],
	stores:[
		'module.custom.sjflv.sale.export.ordermast.store.OrderMastInvoice',
		'module.custom.sjflv.sale.export.ordermast.store.OrderMastMaster',
		'module.custom.sjflv.sale.export.ordermast.store.OrderMastDetail',
	],
	views : [
		'module.custom.sjflv.sale.export.ordermast.view.OrderMastLayout',
		/* 현황 */
		'module.custom.sjflv.sale.export.ordermast.view.OrderMastSearch',
		'module.custom.sjflv.sale.export.ordermast.view.OrderMastListerMaster',
		'module.custom.sjflv.sale.export.ordermast.view.OrderMastListerDetail',
		/* 작업 */
		'module.custom.sjflv.sale.export.ordermast.view.OrderMastWorkerEditor',
		'module.custom.sjflv.sale.export.ordermast.view.OrderMastWorkerSearch',
		'module.custom.sjflv.sale.export.ordermast.view.OrderMastWorkerLister',
		'module.custom.sjflv.sale.export.ordermast.view.OrderMastCostPopup',
		'module.custom.sjflv.sale.export.ordermast.view.OrderMastColtPopup',
		'module.custom.sjflv.sale.export.ordermast.view.OrderMastInvoicePopup',
		'module.custom.sjflv.sale.export.ordermast.view.OrderMastReportPopup',
		'module.custom.sjflv.sale.export.ordermast.view.OrderMastBlPopup',
		'module.custom.sjflv.sale.export.ordermast.view.OrderMastNegoPopup'
	],
	initPermission: function(workspace, permission) {
		this.callParent([workspace, permission]);
		this.joinPermission(workspace.down('module-sjflv-ordermast-lister-master menuitem[action=closeAction]'),       Const.PERMIT.MODIFY);
		this.joinPermission(workspace.down('module-sjflv-ordermast-lister-master menuitem[action=closeCancelAction]'), Const.PERMIT.MODIFY);
		this.joinPermission(workspace.down('module-sjflv-ordermast-lister-master button[action=etcPrintAction]'),      Const.PERMIT.EXPORT);
	},
	init: function() {
		var me = this;
		me.control({
			'module-sjflv-ordermast-layout button[action=selectAction]'					: { click : me.selectAction       }, /* 조회 */

			'module-sjflv-ordermast-lister-master menuitem[action=closeActiveAction]'	: { click : me.closeAction        }, /* 마감 */
			'module-sjflv-ordermast-lister-master menuitem[action=closeCancelAction]'	: { click : me.closeAction        }, /* 마감취소 */
			'module-sjflv-ordermast-lister-master menuitem[action=okAction]'			: { click : me.okAction           }, /* 승인 */
			'module-sjflv-ordermast-lister-master menuitem[action=okCancelAction]'		: { click : me.okCancelAction     }, /* 승인취소 */

			'module-sjflv-ordermast-lister-master menuitem[action=closeAction]'			: { click : me.closeAction        }, /* 마감 */
			'module-sjflv-ordermast-lister-master menuitem[action=closeCancelAction]'	: { click : me.closeCancelAction  }, /* 마감해지 */
			'module-sjflv-ordermast-lister-master button[action=copyAction]'			: { click : me.copyAction         }, /* 수주복사 */
			'module-sjflv-ordermast-lister-master button[action=orderAction]'			: { click : me.orderAction        }, /* 출고지시 */
			'module-sjflv-ordermast-lister-master button[action=etcPrintAction]'		: { click : me.invReportAction    }, /* 명세서 발행 */
			'module-sjflv-ordermast-lister-master button[action=insertAction]'			: { click : me.insertAction       }, /* 등록 */
			'module-sjflv-ordermast-lister-master button[action=modifyAction]'			: { click : me.modifyAction       }, /* 수정 */
			'module-sjflv-ordermast-lister-master button[action=exportAction]'			: { click : me.exportAction       }, /* 엑셀 */
			'module-sjflv-ordermast-lister-master button[action=deleteAction]'			: { click : me.deleteAction       }, /* 삭제 */
			'module-sjflv-ordermast-lister-master button[action=ganttAction]'			: { click : me.ganttAction        }, /* 일정보기 */
			'module-sjflv-ordermast-lister-detail button[action=deleteAction2]'			: { click : me.deleteAction2      }, /* 삭제 */
			'module-sjflv-ordermast-lister-detail button[action=exportAction]'			: { click : me.exportDetailAction }, /* 엑셀 */
			'module-sjflv-ordermast-lister-detail button[action=prorAction]'			: { click : me.prorAction         }, /* 생산지시 */
			'module-sjflv-ordermast-lister-detail button[action=prorAction2]'			: { click : me.prorAction2        }, /* 생산지시일괄*/
			'module-sjflv-ordermast-lister-master button[action=uploadAction]'			: { click : me.excelUploadAction  },
			'module-sjflv-ordermast-lister-master button[action=pasteUploadAction]'		: { click : me.pasteUploadAction  }, /* 엑셀 붙여 넣기 액션 */
			'module-sjflv-ordermast-lister-master button[action=costAction]'			: { click : me.costAction         }, /* 부대비용등록 */
			'module-sjflv-ordermast-lister-master button[action=coltAction]'			: { click : me.coltAction         }, /* 수출 Payment등록 */
			'module-sjflv-ordermast-lister-master button[action=invoiceAction]'			: { click : me.invoiceAction      }, /* Invoice 등록 */
			'module-sjflv-ordermast-lister-master button[action=reportpopupAction]'		: { click : me.reportpopupAction  }, /* 수출신고필증등록 */
			'module-sjflv-ordermast-lister-master button[action=blpopupAction]'			: { click : me.blpopupAction      }, /* B/L등록 */
			'module-sjflv-ordermast-lister-master button[action=negopopupAction]'		: { click : me.negopopupAction    }, /* Nego등록 */

			'module-sjflv-ordermast-worker-lister button[action=updateAction]'			: { click : me.updateAction }, /* 저장 */
			'module-sjflv-ordermast-worker-lister button[action=cancelAction]'			: { click : me.cancelAction }, /* 취소 */
			'module-sjflv-ordermast-worker-search button[action=inputAction]'			: { click : me.itemInputAction }, /* 취소 */
			'module-sjflv-ordermast-lister-master' : {
	...
	pocket : {
		layout : function () { return Ext.ComponentQuery.query('module-sjflv-ordermast-layout')[0] },
		search : function () { return Ext.ComponentQuery.query('module-sjflv-ordermast-search')[0] },
		worker : {
			editor : function () { return Ext.ComponentQuery.query('module-sjflv-ordermast-worker-editor')[0] },
			lister : function () { return Ext.ComponentQuery.query('module-sjflv-ordermast-worker-lister')[0] },
			search : function () { return Ext.ComponentQuery.query('module-sjflv-ordermast-worker-search')[0] }
		},

		lister : {
			master  : function () { return Ext.ComponentQuery.query('module-sjflv-ordermast-lister-master')[0] },
			detail  : function () { return Ext.ComponentQuery.query('module-sjflv-ordermast-lister-detail')[0] }
		},
	},
			...
			Ext.Msg.show({ title: '확인', msg: '선택하신 오더를 승인하시겠습니까?', icon: Ext.Msg.QUESTION, buttons: Ext.Msg.YESNO, defaultFocus: 'no', scope: me,
				fn: function (button) {
					if (button=='yes') {
						...
						Ext.each(select, function(record) {
							Ext.Ajax.request({
								url		: _global.location.http() + '/custom.sjflv.sale.export.ordermast/set/ok.do',
								params	: {
									token : _global.token_id,
									param : JSON.stringify({
										invc_numb		: record.get('invc_numb'),
					...
					{	text: '<span class="btnTemp" style="font-size:1em">예</span>',
						...
						handler: function() {
							...
							if(param.strt_date==''||param.strt_date==null){
								...
								Ext.Ajax.request({
									url		: _global.location.http() + '/custom.sjflv.sale.export.ordermast/set/pror.do',
									params	: {
										token : _global.token_id,
										param : JSON.stringify({
											stor_id		: _global.stor_id,
								...
								Ext.Ajax.request({
									url		: _global.location.http() + '/custom.sjflv.sale.export.ordermast/set/workbook.do',
									params	: {
										token : _global.token_id,
										param : JSON.stringify({
											stor_id		: _global.stor_id,
	...
	prorAction2:function(){																	//TODO pror2
		...
		if(pdsd_yorn == 1){
			...
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom.sjflv.sale.export.ordermast/set/pror2.do',
				params	: {
					token : _global.token_id,
					param : JSON.stringify({
						stor_id		: _global.stor_id,
...
//							detail.getStore().loadData(record.product().data.items, false);
			...
			Ext.ComponentQuery.query('module-sjflv-ordermast-worker-search')[0].getForm().reset();
	...
	copyAction:function() {
		...
		var me = this
		resource.loadPopup({
			widget : 'module-sjflv-ordermast-copy-popup',
		});
	...
	coltAction:function() {
		...
		var me = this
		resource.loadPopup({
			widget : 'module-ordermast-colt-popup',
		});
	},
	...
	negopopupAction:function() {
		...
		var me = this
		resource.loadPopup({
			widget : 'module-ordermast-nego-popup',
		});
	},
	...
	orderAction:function() {
		...
		if(!select){
			...
			Ext.Msg.confirm("확인", "출고지시 하시겠습니까?", function(button) {
				if (button == 'yes') {
					Ext.Ajax.request({
						url			: _global.api_host_info + '/' + _global.app_site + '/custom.sjflv.sale.export.ordermast/set/stps.do',
						method		: "POST",
						params		: {
							token	: _global.token_id,
							param	: Ext.encode({
	...
	deleteAction:function() {
		...
		Ext.Msg.confirm("확인", "삭제하시겠습니까?", function(button) {
			if (button == 'yes') {
				...
				Ext.Ajax.request({
					url			: _global.api_host_info + '/' + _global.app_site + '/custom.sjflv.sale.export.ordermast/set/del_yn.do',
					method		: "POST",
					params		: {
					 	token	: _global.token_id,
						param	: Ext.encode({
		...
		Ext.Msg.confirm("확인", "삭제하시겠습니까?", function(button) {
			if (button == 'yes') {
				...
				for (var i = 0; i < records.length; i++) {
					Ext.Ajax.request({
						url			: _global.api_host_info + '/' + _global.app_site + '/custom.sjflv.sale.export.ordermast/set/del_yn2.do',
						method		: "POST",
						params		: {
							token	: _global.token_id,
							param	: Ext.encode({
	...
	excelUploadAction : function () {
		...
		resource.loadPopup({
			...
			apiurl : {
				upload : _global.location.href + '/system/custom.sjflv.sale.export.ordermast/excel.do', // url (필수)
			},
			params : {
//				token	: _global.token_id,
//				hq_id		: _global.hq_id,
//				stor_id		: _global.stor_id
	...
	reportAction : function(button) {
		...
		Ext.widget('popup-report',{
			title	: '마감리포트',
			url		: _global.api_host_info + '/system/custom.sjflv.sale.export.ordermast/get/report.do',
			params	: { param :
				JSON.stringify({
	...
	invReportAction:function(button) {
		...
		if(select.length === 1) {
			...
			resource.loadPrint({
				...
				requrl 			: {
					search		: _global.api_host_info + '/' + _global.app_site +'/custom.sjflv.sale.export.ordermast/get/printing.do',
				},
