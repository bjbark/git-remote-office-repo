Ext.define('module.custom.sjflv.sale.export.exptpayment.view.ExptPaymentListerMaster1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-exptpayment-lister-master1',
	store		: 'module.custom.sjflv.sale.export.exptpayment.store.ExptPaymentMaster1',
	split		: true,
	...
	pagingItem : function () {
		var me = this,
			item = {
				xtype	: 'grid-paging',
				items	: [
					{	text : '<span class="write-button">부대비용 등록</span>'	, action : ''		, cls: 'button-style'	},
					'-', '->', '-',
