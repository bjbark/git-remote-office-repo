Ext.define('module.custom.sjflv.sale.export.exptinvoice.view.ExptInvoiceListerDetail1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-exptinvoice-lister-detail1',
	store		: 'module.custom.sjflv.sale.export.exptinvoice.store.ExptInvoiceDetail1',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'acpt_numb'	, text : Language.get(''	,'Order No'	) , width : 120 , align : 'center'
					},{ dataIndex: 'ostt_qntt'	, text : Language.get(''	,'Order Seq') , width :  75 , xtype : 'numericcolumn', align : 'right', summaryType: 'sum'
					...
					},{ dataIndex: 'item_spec'	, text : Language.get(''	,'단위'		) , width :  80
					...
					},{ dataIndex: 'item_spec'	, text : Language.get(''	,'납기일자'	) , width : 100
					}
				]
			}
		;
