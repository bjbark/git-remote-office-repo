Ext.define('module.custom.sjflv.sale.order.oemmast.view.OemMastSearch', { extend: 'Axt.form.Search',


	alias: 'widget.module-sjflv-oemmast-search',
	/**
	 *
	 */
						...
						items : [
							{	fieldLabel	: Language.get('deli_date','납기일자'),
								...
								popup: {
									...
									params : { stor_grp : _global.stor_grp , line_stat : '0', acct_bacd:'삼정품목' },
									result : function(records, nameField, pairField) {
...
//								text		: '출고완료',
//								width		: 80,
//								style		: { color: 'black', backgroundColor : '#99ccff', textAlign : 'center'},
//								margin		: '2 0 0 0',
//								padding		: 2
//							}
						]
