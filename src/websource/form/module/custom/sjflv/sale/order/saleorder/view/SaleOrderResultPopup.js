Ext.define('module.custom.sjflv.sale.order.saleorder.view.SaleOrderResultPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-sjflv-saleorder-result-popup',
	...
	finishAction: function(){
		var me = this,
			...
			store	= Ext.ComponentQuery.query('module-sjflv-saleorder-lister-detail2')[0].getStore(),
			select	= Ext.ComponentQuery.query('module-sjflv-saleorder-lister-detail2')[0].getSelectionModel().getSelection()[0]
		;
		var mask = new Ext.LoadMask(Ext.getBody(), {msg: Const.UPDATE.mask });
		mask.show();
		Ext.Ajax.request({
			url		: _global.location.http() + '/custom/sjflv/sale/order/saleorder/set/result.do',
			params	: {
