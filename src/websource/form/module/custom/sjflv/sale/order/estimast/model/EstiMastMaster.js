Ext.define('module.custom.sjflv.sale.order.estimast.model.EstiMastMaster', { extend: 'Axt.data.Model',
	fields : [
		...
		},{	name: 'revs_numb'			, type: 'float'		//리비전
		},{	name: 'line_seqn'			, type: 'float'		//순번
		},{	name: 'mtrl_yeld'			, type: 'float'		//수율
		},{	name: 'make_cost'			, type: 'float'		//가공비
		},{	name: 'yeld_add_pric'		, type: 'float'		//수율반영가격
		},{	name: 'cost_pric'			, type: 'float'		//가공비 + 반영가격
		},{	name: 'pfit_rate'			, type: 'float'		//마진
		},{	name: 'esti_pric'			, type: 'float'		//최종가격
		},{	name: 'line_seqn'			, type: 'float'	, defaultValue: 1	//순번
		},{	name: 'item_count'			, type: 'float'	, defaultValue: 1	//순번
