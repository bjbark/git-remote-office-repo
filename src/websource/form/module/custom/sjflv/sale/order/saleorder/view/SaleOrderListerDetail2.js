Ext.define('module.custom.sjflv.sale.order.saleorder.view.SaleOrderListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-saleorder-lister-detail2',
	store		: 'module.custom.sjflv.sale.order.saleorder.store.SaleOrderDetail2',
