Ext.define('module.custom.sjflv.sale.order.estimast.view.EstiMastCopyPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-sjflv-estimast-copy-popup',
	...
	finishAction: function(){
		...
		mask.show();
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/sjflv/sale/order/estimast/set/copy.do',
				params	: {
