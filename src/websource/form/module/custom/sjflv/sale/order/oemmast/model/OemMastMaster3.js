Ext.define('module.custom.sjflv.sale.order.oemmast.model.OemMastMaster3', { extend:'Axt.data.Model',
	fields: [
		...
		},{	name: 'os_qntt'			, type: 'float'		, defaultValue: '0'
		...
		},{	name: 'invc_numb'		, type: 'string'	// 계정구분
		},{	name: 'acct_name'		, type: 'string'	// 계정구분
		},{	name: 'acct_bacd'		, type: 'string'	// 계정분류코드
		},{	name: 'wrhs_name'		, type: 'string'	// 계정분류코드
		},{	name: 'wrhs_idcd'		, type: 'string'	// 계정분류코드
