Ext.define('module.custom.sjflv.sale.order.estimast.view.EstiMastLister2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-estimast-lister2'			,
	store		: 'module.custom.sjflv.sale.order.estimast.store.EstiMastFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-sjflv-estimast-lister2')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
