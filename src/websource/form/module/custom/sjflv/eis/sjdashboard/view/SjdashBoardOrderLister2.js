Ext.define('module.custom.sjflv.eis.sjdashboard.view.SjdashBoardOrderLister2', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-sjdashboard-order-lister2',
	store		: 'module.custom.sjflv.eis.sjdashboard.store.SjdashBoardOrderLister2',
	border		: 0 ,
	columnLines	: true ,
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items	: [
					{	dataIndex: 'invc_date'		, text : Language.get('invc_date'		,'발주일자'			) , width :  80, align : 'center'
