Ext.define('module.custom.sjflv.eis.sjdashboard.view.SjdashBoardProdLister2', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-sjdashboard-prod-lister2',
	store		: 'module.custom.sjflv.eis.sjdashboard.store.SjdashBoardProdLister2',
	border		: 0 ,
	columnLines	: true ,
