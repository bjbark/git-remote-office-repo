Ext.define('module.custom.sjflv.item.bomlist.view.BomListCstmLister4', { extend: 'Ext.tree.Panel',
	alias		: 'widget.module-sjflv-bomlist-cstm-lister4',
	store		: 'module.custom.sjflv.item.bomlist.store.BomListCstmLister4',
	border	: 0  ,
