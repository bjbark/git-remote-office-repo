Ext.define( 'module.custom.sjflv.item.itemspeclist.model.ItemSpecList', { extend : 'Axt.data.Model',
	fields: [
		...
		{	name: 'brix_yorn'			, type: 'string' , defaultValue: '0'},		//Brix 여부
		{	name: 'ph_yorn'				, type: 'string' , defaultValue: '0'},		//PH 여부
		{	name: 'ecil_yorn'			, type: 'string' , defaultValue: '0'},		//알레르기 여부
		{	name: 'ingd_yorn'			, type: 'string' , defaultValue: '0'},		//첨부 여부
