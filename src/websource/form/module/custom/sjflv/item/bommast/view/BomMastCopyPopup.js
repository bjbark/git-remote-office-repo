Ext.define('module.custom.sjflv.item.bommast.view.BomMastCopyPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-sjflv-bommast-copy-popup',
									...
									{	fieldLabel	: Language.get('item_name','품명'),
										...
										popup: {
											...
											result : function(records, nameField, pairField) {
												...
												me.down('[name=item_revs_numb]').setValue(records[0].get('revs_numb'));
												me.down('[name=item_revs_dvcd]').setValue(records[0].get('revs_dvcd'));
											}
										}
