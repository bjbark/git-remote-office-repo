Ext.define('module.custom.sjflv.item.bommast.view.BomMastLister3', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-sjflv-bommast-lister3',
	store		: 'module.custom.sjflv.item.bommast.store.BomMastLister3',
					...
					items	: [
						{	iconCls	: Const.SELECT.icon,
							...
							handler	: function (grid, rowIndex, colIndex, item, e, record) {
								var revs		= Ext.ComponentQuery.query('module-sjflv-bommast-lister2')[0]
...
//		context.record.recalculation( me.editor.getRecord() );
	...
	rowInsert: function(){
		var me			= this,
			...
			revs		= Ext.ComponentQuery.query('module-sjflv-bommast-lister2')[0],
