Ext.define('module.custom.sjflv.item.bomprint.model.BomPrintLister3', { extend:'Axt.data.Model',
	fields: [
		...
		},{	name: 'levl'			, type: 'float'
		},{	name: 'has_child'		, type: 'float'
		},{	name: 'levl_str'		, type: 'string'
