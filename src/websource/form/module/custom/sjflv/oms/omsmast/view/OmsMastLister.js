Ext.define('module.custom.sjflv.oms.omsmast.view.OmsMastLister', { extend: 'Axt.grid.Panel',
	 alias		: 'widget.module-sjflv-omsmast-lister'			,
	store		: 'module.custom.sjflv.oms.omsmast.store.OmsMast'	,
