Ext.define('module.custom.sjflv.prod.order.workbook.view.WorkBookListerDetail4', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sjflv-workbook-lister-detail4',
	store		: 'module.custom.sjflv.prod.order.workbook.store.WorkBookDetail4',
