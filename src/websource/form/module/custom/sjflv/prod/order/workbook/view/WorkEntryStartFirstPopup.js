Ext.define('module.custom.sjflv.prod.order.workbook.view.WorkEntryStartFirstPopup', { extend: 'Axt.popup.Upload',
	alias		: 'widget.module-sjflv-workentry-popup-start-first'			,
	...
	*/
	...
	nextAction: function(){
		...
		resource.loadPopup({
			widget: 'module-sjflv-workentry-popup-start-second',
			params: {
