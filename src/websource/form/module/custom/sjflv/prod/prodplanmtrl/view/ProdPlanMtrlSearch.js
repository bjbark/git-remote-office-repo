Ext.define('module.custom.sjflv.prod.prodplanmtrl.view.ProdPlanMtrlSearch', { extend: 'Axt.form.Search',
	alias: 'widget.module-sjflv-prodplanmtrl-search',
