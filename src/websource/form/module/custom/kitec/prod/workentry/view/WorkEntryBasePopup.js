Ext.define('module.custom.kitec.prod.workentry.view.WorkEntryBasePopup', { extend: 'Axt.popup.Search',

	id		: 'module-kitec-workenty-basepopup',
	alias	: 'widget.module-kitec-workenty-basepopup',
	store	: 'module.custom.kitec.prod.workentry.store.WorkEntryBasePopup',
	title	: '기초 코드 정보',
	closable: true,
	autoShow: true,
	width	: 500,
