Ext.define('module.custom.kitec.prod.workentry.view.WorkEntryEditor', { extend: 'Axt.form.Editor',

	alias: 'widget.module-kitec-workenty-editor',
	layout : {
	type: 'border'
	},
	title			: Language.get('',''),
	...
	getProd_qntt : function() {
		...
		if(!param.invc_numb){
			...
			if(!param.work_date){
				...
				Ext.Ajax.request({
					url		: _global.location.http() + '/custom/kitec/prod/workentry/get/prod.do',
					params	: {
