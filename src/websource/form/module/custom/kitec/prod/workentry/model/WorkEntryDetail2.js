Ext.define('module.custom.kitec.prod.workentry.model.WorkEntryDetail2',{ extend:'Axt.data.Model',
	fields: [
		...
		{name: 'acum_qntt_l',			type: 'float' },		//누적수량
		{name: 'acum_qntt_r',			type: 'float' },		//누적수량
