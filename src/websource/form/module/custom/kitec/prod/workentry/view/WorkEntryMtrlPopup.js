Ext.define('module.custom.kitec.prod.workentry.view.WorkEntryMtrlPopup', { extend: 'Axt.popup.Search',
	id 		: 'module-kitec-workenty-mtrl-popup',
	alias	: 'widget.module-kitec-workenty-mtrl-popup',
	store	: 'module.custom.kitec.prod.workentry.store.WorkEntryMtrlPopup',
...
//					}
	...
	finishAction: function(){
		var me			= this,
			...
			lister		= Ext.ComponentQuery.query('module-kitec-workenty-detail')[0],
		...
		;
		Ext.Ajax.request({
			url			: _global.location.http() + '/custom/kitec/prod/workentry/get/mtrlseqn.do',
			method		: "POST",
			params		: {
