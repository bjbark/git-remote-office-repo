Ext.define('module.custom.kitec.prod.prodplanv2.model.ProdPlanV2Entry',{ extend:'Axt.data.Model',
	fields: [
		...
		{	name: 'used_qntt'				, type: 'float' },		//금형명
		{	name: 'ostt_qntt'				, type: 'float' },		//사용할수량
		{	name: 'prod_qntt_1fst'			, type: 'float' },		//생산수량(R)
		{	name: 'used_qntt_1fst'			, type: 'float' },		//사용한 수량 (R)
		{	name: 'stok_qntt_1fst'			, type: 'float' },		//재고 수량 (R)
		{	name: 'ostt_qntt_1fst'			, type: 'float' },		//사용할 수량 (R)
