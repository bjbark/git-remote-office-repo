Ext.define('module.custom.kitec.prod.prodplanv2.ProdPlanV2', { extend : 'Axt.app.Controller',
	...
	models	: [
		'module.custom.kitec.prod.prodplanv2.model.ProdPlanV21',
		'module.custom.kitec.prod.prodplanv2.model.ProdPlanV22',
		'module.custom.kitec.prod.prodplanv2.model.ProdPlanV2Entry',
	],
	stores	: [
		'module.custom.kitec.prod.prodplanv2.store.ProdPlanV21',
		'module.custom.kitec.prod.prodplanv2.store.ProdPlanV22',
		'module.custom.kitec.prod.prodplanv2.store.ProdPlanV2Entry',
		'module.custom.kitec.prod.prodplanv2.store.ProdPlanV2Write'
	],
	views	: [
		'module.custom.kitec.prod.prodplanv2.view.ProdPlanV2Layout',
		'module.custom.kitec.prod.prodplanv2.view.ProdPlanV2Lister1',
		'module.custom.kitec.prod.prodplanv2.view.ProdPlanV2Lister2',
		'module.custom.kitec.prod.prodplanv2.view.ProdPlanV2Search',
		'module.custom.kitec.prod.prodplanv2.view.ProdPlanV2Cancel',
		'module.custom.kitec.prod.prodplanv2.view.ProdPlanV2WritePopup'
	],
	...
	onePlanAction:function() {
		...
		for(var i=0;i <select.length;i++){
			if(select[0].data.rpst_item_idcd != select[i].data.rpst_item_idcd){
				Ext.Msg.alert("알림","대표품목이 동일하지 않습니다.");
				return;
			}else{
				a.push(select[i].data.invc_numb);
				b.push(select[i].data.line_seqn);
				c.push(select[i].data.rpst_item_idcd);
			}
		}
		if(typeof record != "undefined") {
			...
			Ext.Msg.alert("알림","수주 리스트에서 생산계획 할 항목을 선택해주십시오.");
		}
	},
