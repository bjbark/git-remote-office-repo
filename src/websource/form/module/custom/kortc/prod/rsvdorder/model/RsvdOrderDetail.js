Ext.define('module.custom.kortc.prod.rsvdorder.model.RsvdOrderDetail', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'deli_date2'			, type: 'string', convert : Ext.util.Format.strToDate//납기일자 grid용
