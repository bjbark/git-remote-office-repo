Ext.define('module.custom.kortc.prod.workentry.view.WorkEntryCvicPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-workentry-cvic-popup',
	alias	: 'widget.lookup-workentry-cvic-popup',
	store	: 'module.custom.kortc.prod.workentry.store.WorkEntryCvicPopup',
	...
	createGrid: function(){
		var me = this,
			grid = {
				...
				columns: [
					{	dataIndex:	'cvic_code'      	, width:  150, align : 'center' , text: Language.get( 'cvic_code'      , '설비코드'           ),
						renderer: function(value, meta){
							meta.style = 'font-size:3em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						},
					},{	dataIndex:	'cvic_idcd'      	, flex: 100, align : 'left'   , text: Language.get( 'cvic_idcd'      , '설비ID'             ),hidden : true
					},{	dataIndex:	'cvic_name'      	, flex: 100, align : 'left'   , text: Language.get( 'cvic_name'      , '설비명'             ),
						renderer: function(value, meta){
							meta.style = 'font-size:3em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						},
					},{	dataIndex:	'cvic_spec'      	, width: 150, align : 'left'   , text: Language.get( 'cvic_spec'      , '설비규격'           ),
						renderer: function(value, meta){
							meta.style = 'font-size:3em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						},
					},{	dataIndex:	'modl_name'      	, width: 180, align : 'left'   , text: Language.get( 'modl_name'      , '모델명'             ),
						renderer: function(value, meta){
							meta.style = 'font-size:3em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						},
