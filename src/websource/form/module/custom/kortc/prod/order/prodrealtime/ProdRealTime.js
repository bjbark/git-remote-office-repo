Ext.define('module.custom.kortc.prod.order.prodrealtime.ProdRealTime', { extend : 'Axt.app.Controller',
	...
	models:[
		'module.custom.kortc.prod.order.prodrealtime.model.ProdRealTime'
	],
	stores:[
		'module.custom.kortc.prod.order.prodrealtime.store.ProdRealTime'
	],
	views : [
		'module.custom.kortc.prod.order.prodrealtime.view.ProdRealTimeLayout',
		/* 현황 */
		'module.custom.kortc.prod.order.prodrealtime.view.ProdRealTimeSearch',
		'module.custom.kortc.prod.order.prodrealtime.view.ProdRealTimeLister'
		/* 작업 */
	],
...
//		this.joinPermission(workspace.down('module-porderlist2-lister-master menuitem[action=closeCancelAction]'), Const.PERMIT.MODIFY);
		this.joinPermission(workspace.down('module-prodrealtime-lister button[action=etcPrintAction]'),      Const.PERMIT.EXPORT);
	},
	init: function() {
		var me = this;
		me.control({
			...
			'module-prodrealtime-lister-detail2 button[action=exportAction]'			: { click : me.exportDetailAction}, /* 엑셀		*/
