Ext.define('module.custom.kortc.sale.order.sorderplan.model.SorderPlanDetail4', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'need_qntt'			, type: 'float', defaultValue:0
		},{	name: 'norm_sale_pric'		, type: 'float'
		},{	name: 'sale_stnd_pric'		, type: 'float'
		},{	name: 'krwn_ttsm_amnt'		, type: 'float'
		},{	name: 'offr_date'			, type: 'string' , serialize: Ext.util.Format.dateToStr
