Ext.define('module.custom.kortc.mtrl.po.purcordr2.view.PurcOrdr2WorkerEditor', { extend: 'Axt.form.Editor',
	...
	header	: false,
	getStore: function() {
		return Ext.getStore( 'module.custom.kortc.mtrl.po.purcordr2.store.PurcOrdr2Invoice' );
	},
