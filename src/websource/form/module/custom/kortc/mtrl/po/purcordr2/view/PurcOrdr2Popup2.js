Ext.define('module.custom.kortc.mtrl.po.purcordr2.view.PurcOrdr2Popup2', { extend: 'Axt.popup.Search',

	alias	: 'widget.module-purcordr2-popup2',
	store	: 'module.custom.kortc.mtrl.po.purcordr2.store.PurcOrdr2Popup2',
	requires: [
