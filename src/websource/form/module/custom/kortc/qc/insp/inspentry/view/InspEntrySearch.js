Ext.define('module.custom.kortc.qc.insp.inspentry.view.InspEntrysearch', { extend: 'Axt.form.Search',
	alias: 'widget.module-inspentry-search',
										...
										{	fieldLabel	: Language.get('item','입고창고'),
											...
											popup: {
												...
												result : function(records, nameField, pairField) {
													...
													pairField.setValue(records[0].get('user_Lidcd'));
												}
											}
