Ext.define('module.custom.hantop.item.itemcam.view.ItemCamListerMaster3', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-itemcam-lister-master3',
				...
				items   : [
					{	text: Language.get(''	,'자재</br>　'		), dataIndex : 'mtrl'	, align : 'center',
						columns: [
							...
							},{	dataIndex	:	'open_widh'		, width:  60, align : 'right'    , text: Language.get( 'open_widh'	, '개공폭'		), xtype: 'numericcolumn', sortable:true,filter:true,hidden : true,
								tdCls		: 'editingcolumn',
								editor		: {
									selectOnFocus	: true,
									allowBlank		: true,
							...
							},{	dataIndex	:	'dbwd_yorn'		, width:  60, align : 'center'    , text: Language.get( 'dbwd_yorn'	, '이중창'		), xtype : 'lookupcolumn' , lookupValue : resource.lookup('yorn'), sortable:true,filter:true, hidden : true,
								tdCls		: 'editingcolumn',
								editor		: {
									selectOnFocus	: true,
									allowBlank		: true,
							...
							},{	dataIndex	:	'cmbf_yorn'		, width:  60, align : 'center'    , text: Language.get( 'cmbf_yorn'	, '공들'		), xtype : 'lookupcolumn' , lookupValue : resource.lookup('yorn'), sortable:true,filter:true,hidden : true,
								tdCls		: 'editingcolumn',
								editor		: {
									selectOnFocus	: true,
									allowBlank		: true,
					...
					},{	text: Language.get(''	,'바코드 프린팅</br>　'		), dataIndex : 'barcode'	, align : 'center',hidden : true,
						columns: [
