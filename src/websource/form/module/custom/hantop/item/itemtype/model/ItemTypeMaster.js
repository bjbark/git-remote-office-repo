Ext.define('module.custom.hantop.item.itemtype.model.ItemTypeMaster',{ extend:'Axt.data.Model',
	fields : [
		...
		{name: 'imge_chek3'				, type: 'string'},			//이미지체크3
		{name: 'imge_chek4'				, type: 'string'},			//이미지체크4
		{name: 'imge_chek5'				, type: 'string'},			//이미지체크5
		{name: 'imge_chek6'				, type: 'string'},			//이미지체크6
		{name: 'imge_chek7'				, type: 'string'},			//이미지체크7
