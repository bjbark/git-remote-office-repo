Ext.define('module.custom.hantop.item.itemset.view.ItemSetEditor', { extend: 'Axt.form.Editor',

	alias: 'widget.module-itemset-editor',
			...
			item = {
				...
				items			: [
					{	name	: 'item_idcd', xtype : 'textfield' , hidden : true
						...
						items		: [
							{	fieldLabel	: Language.get('acct_dvcd','계정구분'),
								xtype		: 'lookupfield',
								name		: 'acct_dvcd',
								width		: 180,
