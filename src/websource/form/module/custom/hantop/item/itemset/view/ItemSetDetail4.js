Ext.define('module.custom.hantop.item.itemset.view.ItemSetDetail4', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-itemset-detail4',
	store		: 'module.custom.hantop.item.itemset.store.ItemSetDetail4',
	border		: 0,
	columnLines	: true,
...
//		}
	...
	lineInsert : function (config) {
		var me			= this,
			myform		= Ext.ComponentQuery.query('module-itemset-detail4')[0],
			store		= me.getStore(),
			record		= undefined,
			max_seq		= 0,
			lastidx		= store.count(),
