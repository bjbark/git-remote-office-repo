Ext.define('module.custom.hantop.item.bommast.view.BomMastDetail3', { extend: 'Ext.tree.Panel',
	alias		: 'widget.module-bommast-detail3',
	selModel	: { selType: 'checkboxmodel', mode : 'SINGLE' },
	store		: 'module.custom.hantop.item.bommast.store.BomMastDetail3',
	border	: 0  ,
