Ext.define('module.custom.hantop.item.cstmitemmast.view.CstmItemMastLister1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-cstmitemmast-lister1',
	store		: 'module.custom.hantop.item.cstmitemmast.store.CstmItemMast1',
