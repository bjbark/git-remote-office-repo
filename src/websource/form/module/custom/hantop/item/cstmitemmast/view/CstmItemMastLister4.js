Ext.define('module.custom.hantop.item.cstmitemmast.view.CstmItemMastLister4', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-cstmitemmast-lister4',
	store		: 'module.custom.hantop.item.cstmitemmast.store.CstmItemMast4',
