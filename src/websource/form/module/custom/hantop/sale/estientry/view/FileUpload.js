 ...
 * 파일 업로드 공통 팝업
 */
Ext.define('module.custom.hantop.sale.estientry.view.FileUpload', { extend: 'Axt.popup.Upload',

	alias: 'widget.module-estientry-upload',
...
//				});
//				Ext.Ajax.request({
//					url			: _global.api_host_info + '/' + _global.app_site + '/custom/hntop/sale/estientry/set/UploadEsti.do',
//					method		: "POST",
//					params		: {
