Ext.define('module.custom.hantop.sale.estientry.view.EstiEntryListerDetail2', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-estientry-lister-detail2',
	store: 'module.custom.hantop.sale.estientry.store.EstiEntryDetail2',
