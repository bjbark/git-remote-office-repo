Ext.define('module.custom.hantop.sale.estientry.view.EstiEntryWorkPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-estientry-work-popup',
	...
	finishAction: function(){
		var me = this,
			...
			store	= Ext.getStore('module.custom.hantop.sale.estientry.store.EstiEntryWorkPopup'),
			record	= master.getSelectionModel().getSelection(),
			select	= master.getSelectionModel().getSelection()[0],
			param	=''
		;

//		if(values.lott_numb==''||values.lott_numb==null){
