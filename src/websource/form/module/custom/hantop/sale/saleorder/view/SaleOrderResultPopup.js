Ext.define('module.custom.hantop.sale.saleorder.view.SaleOrderResultPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-saleorder-result-popup',
	...
	finishAction: function(){
		var me = this,
			...
			select	= Ext.ComponentQuery.query('module-saleorder-lister-detail2')[0].getSelectionModel().getSelection()[0]
		;
