Ext.define('module.custom.hantop.sale.saleorder.view.SaleOrderListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-saleorder-lister-detail2',
	store		: 'module.custom.hantop.sale.saleorder.store.SaleOrderDetail2',
