Ext.define('module.custom.hantop.prod.order.prodorder2.model.ProdOrder2Detail', { extend: 'Axt.data.Model',
	fields: [
		{	name: 'invc_numb'			, type: 'string'		//invoice번호
		},{	name: 'amnd_degr'			, type: 'float' , defaultValue : 1	//amd차수
		},{	name: 'line_seqn'			, type: 'float'			//순번
		},{	name: 'ispl_name'			, type: 'string'		//설치위치명
		},{	name: 'cofm_dttm'			, type: 'string', convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr		//지시일자(확정일자)
...
//		},{	name: 'prod_trst_seqn'		, type: 'string'		//생산의뢰순번
