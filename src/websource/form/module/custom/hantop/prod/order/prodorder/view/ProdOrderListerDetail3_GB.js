Ext.define('module.custom.hantop.prod.order.prodorder.view.ProdOrderListerDetail3_GB', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-prodorder-lister-detail3_gb',
	store: 'module.custom.hantop.prod.order.prodorder.store.ProdOrderDetail3_2',
	border		: 0 ,
	columnLines	: true ,
