Ext.define('module.custom.hantop.prod.order.prodorder.view.ProdOrderCofmPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-prodorder-cofm-popup',
	...
	callAction: function(){
		var me		= this,
			...
			cofm	= Ext.ComponentQuery.query('module-prodorder-lister-cofm')[0]
		;
		console.log(params);
