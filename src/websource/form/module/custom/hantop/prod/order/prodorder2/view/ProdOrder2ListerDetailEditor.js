Ext.define('module.custom.hantop.prod.order.prodorder2.view.ProdOrder2ListerDetailEditor', { extend: 'Axt.form.Editor',

	alias	: 'widget.module-prodorder2-lister-detaileditor',
	header	: false,
