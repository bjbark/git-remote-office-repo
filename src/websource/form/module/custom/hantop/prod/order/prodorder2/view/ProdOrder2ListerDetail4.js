Ext.define('module.custom.hantop.prod.order.prodorder2.view.ProdOrder2ListerDetail4', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-prodorder2-lister-detail4',
	store: 'module.custom.hantop.prod.order.prodorder2.store.ProdOrder2Detail4',
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex: 'invc_numb'			, width: 90, align : 'center'	, text: Language.get('invc_numb'		, '견적번호'		)
