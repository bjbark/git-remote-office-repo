Ext.define('module.custom.hantop.prod.order.prodorder2.view.ProdOrder2OptmPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-prodorder2-optm-popup',
	...
	callAction: function(){
		var me		= this,
			...
			detail	= Ext.ComponentQuery.query('module-prodorder2-lister-cofmdetail2')[0]
		;
