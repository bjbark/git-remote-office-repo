Ext.define('module.custom.hantop.prod.workbookv1.view.WorkBookV1ListerDetail', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workbookv1-detail'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.custom.hantop.prod.workbookv1.store.WorkBookV1Detail',
	border		: 0,
...
//						Ext.ComponentQuery.query('#fail')[0].up('window').destroy();
	...
	poorupdate : function (param) {
		...
		if(poor_qntt==0||poor_qntt==''||poor_qntt==null){
			...
			//line_seqn count
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/hantop/prod/workbookv1/get/poorseqn.do',
				params	: {
			...
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/hantop/prod/workbookv1/set/poor.do',
				params	: {
					token : _global.token_id,
					param : JSON.stringify({
						_set			: 'insert',
	...
	failupdate : function (param) {
		...
		if(sttm1==null||sttm1==''){
			...
			//line_seqn count
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/hantop/prod/workbookv1/get/failseqn.do',
				params	: {
					token : _global.token_id,
					param : JSON.stringify({
						stor_id			: _global.stor_id,
			...
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/hantop/prod/workbookv1/set/fail.do',
				params	: {
					token : _global.token_id,
					param : JSON.stringify({
						_set			: 'insert',
