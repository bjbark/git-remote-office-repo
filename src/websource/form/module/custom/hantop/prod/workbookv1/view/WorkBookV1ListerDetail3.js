Ext.define('module.custom.hantop.prod.workbookv1.view.WorkBookV1ListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workbookv1-detail3'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.custom.hantop.prod.workbookv1.store.WorkBookV1Detail3',
	border		: 0,
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-workbookv1-detailSearch'}];
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex: 'prog_stat_dvcd'	, text : Language.get('prog_stat_dvcd'	,'상태'		) , width	: 70	, xtype : 'lookupcolumn', lookupValue : resource.lookup('prog_stat_dvcd'), align : 'center'
					},{ dataIndex: 'wkct_name'		, text : Language.get('wkct_name'		,'공정'		) , width	: 145	, align : 'center'
					},{ dataIndex: 'orig_invc_numb'	, text : Language.get('acpt_numb'		,'수주번호'		) , width	: 165	, align : 'center'
					},{ dataIndex: 'wkod_numb'		, text : Language.get('wkod_numb'		,'지시번호'		) , flex	: 2		, align : 'center',hidden:true
					},{ dataIndex: 'wkod_seqn'		, text : Language.get('wkod_seqn'		,'지시순번'		) , flex	: 2		, align : 'center',hidden:true
					},{ dataIndex: 'work_sttm'		, text : Language.get('work_sttm'		,'시작시간'		) , width	: 75	, align : 'center',
					},{ dataIndex: 'work_edtm'		, text : Language.get('work_edtm'		,'종료시간'		) , width	: 75	, align : 'center'
					},{ dataIndex: 'wkod_numb'		, text : Language.get('wkod_numb'		,'지시번호'		) , width	: 220	, hidden : true
						...
						renderer: function(val,meta,rec) {
							var id     = Ext.id(),
								search = Ext.ComponentQuery.query('module-workbookv1-detailSearch')[0]
	...
	insert : function (rec) {
		var search = Ext.ComponentQuery.query('module-workbookv1-detailSearch')[0],
			store = this.getStore(),
