Ext.define('module.custom.hantop.prod.workbookv1.view.WorkBookV1ListerDetailSearch',{ extend: 'Axt.form.Search',
	store	: 'module.custom.hantop.prod.workbookv1.store.WorkBookV1Detail3',
	alias	: 'widget.module-workbookv1-detailSearch',
...
//								emptyText	: '지시번호',
								...
								popup		: {
									select	: 'SINGLE',
									widget	: 'lookup-workbookv1-pror-popup',
									params	: { stor_grp : _global.stor_grp , line_stat : '0' },
									result	: function(records, nameField, pairField) {
