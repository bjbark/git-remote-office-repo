Ext.define('module.custom.hantop.mtrl.po.purcordr.view.PurcOrdrWorkerSearch', { extend: 'Axt.form.Search',
	store	: 'module.custom.hantop.mtrl.po.purcordr.store.PurcOrdrInvoice',
						...
						items	: [
							{	text	: '단가', xtype : 'label', style:'text-align:center;'
								...
								listeners : {
									change : function(self, value) {
										var panel = self.up('form')
											inv_amt = Math.trunc(Number(value) * Number(panel.down('[name=offr_qntt]').getValue()))
										;
										panel.down('[name=offr_amnt]').setValue(inv_amt)
									},
									keydown : function(self, e) {
