Ext.define('module.custom.hantop.mtrl.po.purcordr.view.PurcOrdrListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-purcordr-lister-detail',

	store: 'module.custom.hantop.mtrl.po.purcordr.store.PurcOrdrDetail',
