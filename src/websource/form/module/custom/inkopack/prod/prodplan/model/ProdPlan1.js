Ext.define('module.custom.inkopack.prod.prodplan.model.ProdPlan1', { extend:'Axt.data.Model',
	fields : [
		...
		},{	name : 'sum_indn_qntt'		, type : 'float'		//총지시수량
		},{	name : 'sum_indn_etc'		, type : 'float'		//총지시잔량
		},{	name : 'sum_prod_qntt'		, type : 'float'		//총생산수량
		},{	name : 'sum_prod_etc'		, type : 'float'		//총생산잔량
