Ext.define('module.custom.inkopack.prod.workentry.view.WorkEntryFailLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workentry-fail'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.custom.inkopack.prod.workentry.store.WorkEntryFailLister',
	border		: 0,
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex: 'loss_resn_dvcd'	, text : Language.get('loss_resn_dvcd'	,'유실코드'		) , width : 110  , align : 'center', xtype : 'lookupcolumn', lookupValue : resource.lookup('loss_resn_dvcd')
