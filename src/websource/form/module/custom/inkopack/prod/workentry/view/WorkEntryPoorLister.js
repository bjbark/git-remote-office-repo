Ext.define('module.custom.inkopack.prod.workentry.view.WorkEntryPoorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workentry-poor'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.custom.inkopack.prod.workentry.store.WorkEntryPoorLister',
	border		: 0,
	...
	initComponent: function () {
		...
		console.log(_global.options.work_book_tema);
		me.callParent();
	},
