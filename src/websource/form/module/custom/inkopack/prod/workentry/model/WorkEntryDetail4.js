Ext.define('module.custom.inkopack.prod.workentry.model.WorkEntryDetail4',{ extend:'Axt.data.Model',
	fields : [
		...
		{name: 'total_qntt',			type: 'float' },		//누적수량
		...
		{name: 'lott_numb',				type: 'string'},		//lot번호
		{name: 'work_strt_dttm',		type: 'string' , serialize: Ext.util.Format.dateToStr},		//
		{name: 'work_endd_dttm',		type: 'string' , serialize: Ext.util.Format.dateToStr},		//
		{name: 'plan_strt_dttm',		type: 'string' , serialize: Ext.util.Format.dateToStr},		//
