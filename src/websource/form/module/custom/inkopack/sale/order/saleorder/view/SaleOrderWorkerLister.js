Ext.define('module.custom.inkopack.sale.order.saleorder.view.SaleOrderWorkerLister', { extend: 'Axt.grid.Panel',
	alias: 'widget.module-inkopack-saleorder-worker-lister',
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-inkopack-saleorder-worker-search'}];
...
//		editor.grid.view.getSelectionModel().onKeyDown();
	...
	listeners: {
		...
		render: function(){
			var me = this;
			var editor = Ext.ComponentQuery.query('module-inkopack-saleorder-worker-editor')[0];
			new Ext.util.KeyMap({
				target: me.getEl().dom,
				binding: [
					/* Ctrl + Delete */
