Ext.define('module.custom.inkopack.sale.order.saleorder.view.SaleOrderListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-inkopack-saleorder-lister-detail',

	store: 'module.custom.inkopack.sale.order.saleorder.store.SaleOrderDetail',
