Ext.define('module.custom.inkopack.sale.order.saleorder.view.SaleOrderWorkerSearch', { extend: 'Axt.form.Search',
	store	: 'module.custom.inkopack.sale.order.saleorder.store.SaleOrderInvoice',
	alias	: 'widget.module-inkopack-saleorder-worker-search',
							...
							{	text		: '품목코드' , xtype : 'label',	style : 'text-align:center;'
								...
								popup		: {
									...
									result	: function(records, nameField, pairField) {
										...
										var searchForm = Ext.ComponentQuery.query('module-inkopack-saleorder-worker-search')[0];
								...
								listeners : {
									...
									keydown : function(self, e) {
										if (e.keyCode == e.ENTER || e.keyCode == e.TAB) {
											...
											if ( Ext.isEmpty( self.up('form').down('[name=invc_pric]').getValue()) ){
												self.up('form').down('[name=invc_pric]').focus(true, 10);
											} else {
...
//			var deli = Ext.Date.format(Ext.ComponentQuery.query('module-inkopack-saleorder-worker-editor')[0].down('[name=deli_date]').getValue(),'Y-m-d');
