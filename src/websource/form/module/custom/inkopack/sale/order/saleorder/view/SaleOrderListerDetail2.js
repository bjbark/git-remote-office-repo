Ext.define('module.custom.inkopack.sale.order.saleorder.view.SaleOrderListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-inkopack-saleorder-lister-detail2',
	store		: 'module.custom.inkopack.sale.order.saleorder.store.SaleOrderDetail2',
	...
	pagingItem : function () {
		var me = this,
			item = {
				xtype	: 'grid-paging',
				items	: [
//					{ text : 'test' , action:'test' , cls: 'button-style'},
					'->', '->','->','->','->','->','->',
