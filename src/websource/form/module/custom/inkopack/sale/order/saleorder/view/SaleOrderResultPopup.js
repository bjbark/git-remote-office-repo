Ext.define('module.custom.inkopack.sale.order.saleorder.view.SaleOrderResultPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-inkopack-saleorder-result-popup',
	...
	finishAction: function(){
		var me = this,
			...
			store	= Ext.ComponentQuery.query('module-inkopack-saleorder-lister-detail2')[0].getStore(),
			select	= Ext.ComponentQuery.query('module-inkopack-saleorder-lister-detail2')[0].getSelectionModel().getSelection()[0]
		;
		var mask = new Ext.LoadMask(Ext.getBody(), {msg: Const.UPDATE.mask });
		mask.show();
		Ext.Ajax.request({
			url		: _global.location.http() + '/sale/order/saleorder/set/result.do',
			params	: {
