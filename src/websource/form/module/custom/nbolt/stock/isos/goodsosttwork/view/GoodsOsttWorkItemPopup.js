Ext.define('module.custom.nbolt.stock.isos.goodsosttwork.view.GoodsOsttWorkItemPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-nbolt-goodsosttwork-item-popup',
