Ext.define('module.custom.dhtec.prod.workentry.model.WorkEntryDetail',{ extend:'Axt.data.Model',
	fields: [
		...
		{name: 'prod_qntt',				type: 'float' },		//생산수량(L)
		{name: 'prod_qntt_1fst',		type: 'float' },		//생산수량(R)
