Ext.define('module.custom.dhtec.prod.bomwork.view.BomWorkTree2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-bomwork-tree2',
	store		: 'module.custom.dhtec.prod.bomwork.store.BomWorkTree2',
