Ext.define('module.custom.dhtec.prod.bomwork.view.BomWorkListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-bomwork-lister-detail3',
	store		: 'module.custom.dhtec.prod.bomwork.store.BomWorkDetail3',
