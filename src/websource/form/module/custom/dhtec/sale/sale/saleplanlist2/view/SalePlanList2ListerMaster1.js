Ext.define('module.custom.dhtec.sale.sale.saleplanlist2.view.SalePlanList2ListerMaster1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-saleplanlist2-lister-master1',
	store		: 'module.custom.dhtec.sale.sale.saleplanlist2.store.SalePlanList2Master1'	,
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex : 'invc_numb'	, text : Language.get('acpt_numb'	,'업체명'		), width: 150, align : 'center'
					},{	dataIndex : 'invc_numb'	, text : Language.get('acpt_numb'	,'품명'		), width: 150, align : 'center'
