Ext.define('module.custom.dhtec.sale.sale.saleplanlist.view.SalePlanListListerMaster1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-saleplanlist-lister-master1',
	store		: 'module.custom.dhtec.sale.sale.saleplanlist.store.SalePlanListMaster1'	,
