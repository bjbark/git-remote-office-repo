Ext.define('module.custom.dhtec.sale.sale.saleplanlist2.SalePlanList2', { extend:'Axt.app.Controller',
	requires:[
	...
	models	: [
		'module.custom.dhtec.sale.sale.saleplanlist2.model.SalePlanList2Master0',
		'module.custom.dhtec.sale.sale.saleplanlist2.model.SalePlanList2Master',
	],
	stores	: [
		'module.custom.dhtec.sale.sale.saleplanlist2.store.SalePlanList2Master0',
		'module.custom.dhtec.sale.sale.saleplanlist2.store.SalePlanList2Master1'
	],
	views	: [
		'module.custom.dhtec.sale.sale.saleplanlist2.view.SalePlanList2Layout',
		'module.custom.dhtec.sale.sale.saleplanlist2.view.SalePlanList2ListerMaster0',
		'module.custom.dhtec.sale.sale.saleplanlist2.view.SalePlanList2ListerMaster1',
		'module.custom.dhtec.sale.sale.saleplanlist2.view.SalePlanList2Search'
	],
	...
	init: function() {
		...
		me.control({
			// layout event
			'module-saleplanlist2-layout button[action=selectAction]'			: { click : me.selectAction },	// 조회
			'module-saleplanlist2-layout #mainpanel'							: { tabchange : me.selectAction },
			'module-saleplanlist2-layout #subpanel'								: { tabchange : me.selectAction },
			// master0 event
			'module-saleplanlist2-lister-master0 button[action=exportAction]'	: { click : me.exportAction0 },	// 엑셀
			// lister1 event
			'module-saleplanlist2-lister-master1 button[action=exportAction]'	: { click : me.exportAction1 },	// 엑셀

			'module-saleplanlist2-lister-master1' : {
//				itemdblclick : me.selectDetail1 ,
//				selectionchange : me.attachRecord
			},
			'module-saleplanlist2-lister-master2' : {
