Ext.define('module.custom.dhtec.item.eco.ecomast.EcoMast', { extend : 'Axt.app.Controller',
	...
	models:[
		'module.custom.dhtec.item.eco.ecomast.model.EcoMastInvoice',
		'module.custom.dhtec.item.eco.ecomast.model.EcoMastMaster',
		'module.custom.dhtec.item.eco.ecomast.model.EcoMastDetail2',
		'module.custom.dhtec.item.eco.ecomast.model.EcoMastDetail'
	],
	stores:[
		'module.custom.dhtec.item.eco.ecomast.store.EcoMastInvoice',
		'module.custom.dhtec.item.eco.ecomast.store.EcoMastMaster',
		'module.custom.dhtec.item.eco.ecomast.store.EcoMastPopup',
		'module.custom.dhtec.item.eco.ecomast.store.EcoMastDetail',
		'module.custom.dhtec.item.eco.ecomast.store.EcoMastDetail2'
	],
	views : [
		'module.custom.dhtec.item.eco.ecomast.view.EcoMastLayout',
		/* 현황 */
		'module.custom.dhtec.item.eco.ecomast.view.EcoMastSearch',
		'module.custom.dhtec.item.eco.ecomast.view.EcoMastListerMaster',
		'module.custom.dhtec.item.eco.ecomast.view.EcoMastListerDetail',
		'module.custom.dhtec.item.eco.ecomast.view.EcoMastListerDetail2',
		/* 작업 */
		'module.custom.dhtec.item.eco.ecomast.view.EcoMastWorkerEditor',
		'module.custom.dhtec.item.eco.ecomast.view.EcoMastWorkerSearch',
		'module.custom.dhtec.item.eco.ecomast.view.EcoMastWorkerLister',
		'module.custom.dhtec.item.eco.ecomast.view.EcoMastPopup'
	],
