Ext.define('module.custom.symct.sale.prjtmast.view.PrjtMastSearch', { extend: 'Axt.form.Search',

	alias: 'widget.module-prjtmast-search',
					...
					{	xtype		: 'fieldset',
						...
						items		:[
							{	xtype	: 'label',
								...
								xtype	: 'searchfield',
								flex	: 4,
								emptyText		: '조회할 프로젝트 코드 또는 프로젝트명을 입력하세요...',
		...
		var me = this,
			line = {
				...
				items : [
					...
					},{	xtype : 'fieldset', layout: 'hbox',border : 0 , padding : '0',margin : '5 0 0 0',
						items : [
