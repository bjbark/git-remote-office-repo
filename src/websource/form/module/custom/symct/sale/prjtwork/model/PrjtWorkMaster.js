Ext.define('module.custom.symct.sale.prjtwork.model.PrjtWorkMaster',{ extend:'Axt.data.Model',
	fields : [
		...
		{name: 'mold_mtrl',				type: 'string'},		//금형재질
		{name: 'work_rsps_idcd',		type: 'string'},		//작업책임자ID
		{name: 'work_rsps_name',		type: 'string'},		//작업책임자명
		{name: 'dsig_rsps_idcd',		type: 'string'},		//설계책임자ID
		{name: 'dsig_rsps_name',		type: 'string'},		//설계책임자명
		{name: 'modl_rsps_idcd',		type: 'string'},		//모델링책임자ID
		{name: 'modl_rsps_name',		type: 'string'},		//모델링책임자명
		{name: 'rela_pjod_idcd',		type: 'string'},		//관련금형
		...
		{name: 'imge_chek1',				type: 'string'},		//생성UI
		{name: 'imge_chek2',				type: 'string'},		//생성UI
	]
});
