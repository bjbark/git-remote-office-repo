Ext.define('module.custom.symct.sale.prjtwork.view.PrjtWorkPaySearch', { extend: 'Axt.form.Search',
	store	: 'module.custom.symct.sale.prjtwork.store.PrjtWorkInvoice',
