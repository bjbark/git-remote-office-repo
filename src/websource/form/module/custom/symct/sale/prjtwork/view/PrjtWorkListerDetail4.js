Ext.define('module.custom.symct.sale.prjtwork.view.PrjtWorkListerDetail4', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtwork-lister-detail4',
	store		: 'module.custom.symct.sale.prjtwork.store.PrjtWorkDetail4',
