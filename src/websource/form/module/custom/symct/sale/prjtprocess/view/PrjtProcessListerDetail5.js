Ext.define('module.custom.symct.sale.prjtprocess.view.PrjtProcessListerDetail5', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtprocess-lister-detail5',
	store		: 'module.custom.symct.sale.prjtprocess.store.PrjtProcessDetail5',
