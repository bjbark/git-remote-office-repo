Ext.define('module.custom.symct.sale.prjtlist.view.PrjtListListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtlist-lister-detail2',
	store		: 'module.custom.symct.sale.prjtlist.store.PrjtListDetail2',
