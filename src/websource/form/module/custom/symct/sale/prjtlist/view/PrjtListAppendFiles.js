Ext.define('module.custom.symct.sale.prjtlist.view.PrjtListAppendFiles', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtlist-editorlister'			,
	store		: 'module.custom.symct.sale.prjtlist.store.PrjtListFile',
