Ext.define('module.custom.symct.sale.prjtlist.view.PrjtListListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtlist-lister-detail3',
	store		: 'module.custom.symct.sale.prjtlist.store.PrjtListDetail3',
