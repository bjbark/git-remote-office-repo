Ext.define('module.custom.wontc.prod.order.workentry.view.WorkEntryMtrlPopup', { extend: 'Axt.popup.Search',
	id 		: 'module-hjsys-workenty-mtrl-popup',
	alias	: 'widget.module-hjsys-workenty-mtrl-popup',
	store	: 'module.custom.wontc.prod.order.workentry.store.WorkEntryMtrlPopup',
...
//					}
	...
	finishAction: function(){
		...
		for (var i = 0; i < changes; i++) {
			var seqn = 0;
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/wontc/prod/order/workentry/get/seqn.do',
				params	: {
