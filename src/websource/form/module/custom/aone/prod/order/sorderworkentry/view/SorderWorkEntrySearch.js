Ext.define('module.custom.aone.prod.order.sorderworkentry.view.SorderWorkEntrySearch', { extend: 'Axt.form.Search',

	alias: 'widget.module-sorderworkentry-search',
					...
					{	xtype : 'fieldset', layout: 'hbox',
						items : [
							{	fieldLabel	: Language.get('inqy_term','조회기간'),
								...
								xtype		: 'lookupfield',
								name		: 'acpt_stat_dvcd',
								lookupValue	: resource.lookup('search_all').concat( resource.lookup('acpt_stat_dvcd' ).slice(2,5) ),
