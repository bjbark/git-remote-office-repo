Ext.define('module.custom.aone.sale.order.sordercofm.view.SorderCofmListerDetail', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sordercofm-lister-detail'			,
	store		: 'module.custom.aone.sale.order.sordercofm.store.SorderCofmFile',
