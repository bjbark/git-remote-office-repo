Ext.define('module.custom.aone.sale.order.sordermast.view.SorderMastFilePopup', { extend: 'Axt.popup.Search',
	alias	: 'widget.module-aone-sordermast-file-popup',
	store	: 'module.custom.aone.sale.order.sordermast.store.SorderMastFilePopup',
		...
		var me = this,
			grid = {
				...
				paging		: {
					xtype	: 'grid-paging',
					items	: [
						{xtype: 'button' , text : '<span class="write-button">전체보기</span>', scope: me, handler: me.allView       , cls: 'button-style'
						},
						'->',
						{	xtype			: 'form-panel',
							name			: 'uploadForm',
				...
				columns: [
					...
					},{	dataIndex: 'uper_seqn'		, text : Language.get('uper_seqn'		,'상위순번'	)		, width : 80 , align : 'center',hidden:true
	...
	upload:function(){
		...
		param.prnt_idcd = prnt_idcd;
		param.file_dvcd_1fst = '3100'; //수정전자료
