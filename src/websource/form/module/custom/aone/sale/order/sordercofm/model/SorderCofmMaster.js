Ext.define('module.custom.aone.sale.order.sordercofm.model.SorderCofmMaster', { extend: 'Axt.data.Model',
	fields : [
		{	name: 'invc_numb'			, type: 'string'	//invoice번호
		},{	name: 'amnd_degr'			, type: 'float'  , defaultValue: 1		//amd차수
		},{	name: 'item_cnt'			, type: 'float'  	//품목수
		},{	name: 'sum_ttsm_amnt'		, type: 'float'  	//주문금액
		...
		},{	name: 'acpt_case_name'		, type: 'string'	//
