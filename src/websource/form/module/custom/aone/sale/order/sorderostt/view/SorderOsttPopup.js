Ext.define('module.custom.aone.sale.order.sorderostt.view.SorderOsttPopup', { extend: 'Axt.popup.Search',

	alias	: 'widget.module-sorderostt-popup',
	...
	createTabs : function () {
		...
		grid = {
				...
				items	: [
					{	title 	: '작업내역'	,
						xtype	: 'module-sorderostt-popup-mans' ,
						itemId		: 'sorderOsttAddGrid',
						name		: 'sorderOsttAddGrid',
					},me.createTab2(),
				]
			}
		;
	...
	createTab2 : function() {
		var me = this,
			item = {
				title	: '자재사용내역',
				xtype: 'module-sorderostt-popup-mtrl',
				itemId		: 'sorderOsttAddGrid2',
				name		: 'sorderOsttAddGrid2',
				}
			;
		return item;
	},
	...
	updateAction: function( records ){
		var me     = this,
			store  = me.down('#sorderOsttAddGrid').getStore(),
			store2 = me.down('#sorderOsttAddGrid2').getStore(),
