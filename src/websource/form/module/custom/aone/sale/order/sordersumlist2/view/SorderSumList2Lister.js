Ext.define('module.custom.aone.sale.order.sordersumlist2.view.SorderSumList2Lister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sordersumlist2-lister',
	store		: 'module.custom.aone.sale.order.sordersumlist2.store.SorderSumList2',
	split		: true,
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'cstm_name'		, text : Language.get('cstm_name'		,'거래처명'		) , width : 400 , align : 'left'
					},{	dataIndex: 'invc_numb'		, text : Language.get('offr_numb'		,'사업자등록번호'	) , width : 180 , align : 'center'
					},{	dataIndex: 'line_seqn'		, text : Language.get('line_seqn'		,'대표자명'		) , width : 180 , align : 'center'
					},{	dataIndex: 'orig_invc_numb'	, text : Language.get('orig_invc_numb'	,'연락처'		) , width : 180 , align : 'center',hidden	: (_global.options.haccp_item_yorn != 0),
					},{	dataIndex: 'cstm_idcd'		, text : Language.get('cstm_name'		,'거래처명'		) , width : 180 , align : 'left', hidden	: true
					},{	dataIndex: 'item_code'		, text : Language.get('item_code'		,'담당자명'		) , width : 180 , alsign : 'center'
					},{	dataIndex: 'item_name'		, text : Language.get('item_name'		,'공급가액'		) , width : 180 , align : 'left', xtype : 'numericcolumn', align : 'right', summaryType: 'sum'
					},{	dataIndex: 'item_spec'		, text : Language.get('item_spec'		,'부가세'		) , width : 175 , align : 'left', xtype : 'numericcolumn', align : 'right', summaryType: 'sum'
					},{	dataIndex: 'unit_name'		, text : Language.get('unit_name'		,'합계금액'		) , flex  :   1 , align : 'center', xtype : 'numericcolumn', align : 'right', summaryType: 'sum'
