Ext.define('module.custom.aone.sale.order.sorderosttview.model.SorderOsttViewMaster3', { extend: 'Axt.data.Model',
	fields : [
		...
		},{	name: 'invc_amnt'			, type: 'float'		//출고금액
		},{	name: 'ostt_qntt'			, type: 'float'		//출고건수
		},{	name: 'user_name'			, type: 'string'	//거래처코드
