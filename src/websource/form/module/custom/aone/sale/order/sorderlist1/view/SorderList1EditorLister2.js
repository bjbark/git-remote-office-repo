Ext.define('module.custom.aone.sale.order.sorderlist1.view.SorderList1EditorLister2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-aone-sorderlist1-editorlister2',
	store		: 'module.custom.aone.sale.order.sorderlist1.store.SorderList1File2',
