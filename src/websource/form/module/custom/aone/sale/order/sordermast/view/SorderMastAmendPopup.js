Ext.define('module.custom.aone.sale.order.sordermast.view.SorderMastAmendPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-aone-sordermast-amend-popup',
	...
	*/
				...
				{	xtype	: 'panel',
					...
					items	: [
						{	fieldLabel	:  Language.get( '' , '고장증상'),
							name		: 'amnd_resn',
							xtype		: 'textarea',
							value		: me.popup.param.remk_text,
							width		: 335,
							height		: 65,
						}
					]
	...
	finishAction: function(){
		var me = this,
			...
			master	= Ext.ComponentQuery.query('module-aone-sordermast-lister-master')[0],
			params	= me.param
		;
		if(values.amnd_resn==''||values.amnd_resn==null){
			...
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/aone/sale/order/sordermast/set/amend.do',
				params	: {
					...
					param : JSON.stringify({
						...
						prnt_idcd		: me.popup.param.prnt_idcd
					})
				},
				async	: false,
				method	: 'POST',
