Ext.define('module.custom.aone.sale.order.sorderostt.view.SorderOsttSearch', { extend: 'Axt.form.Search',
	alias: 'widget.module-sorderostt-search',
						...
						items : [
							...
							{	fieldLabel	: Language.get('repa_stat_dvcd','수리상태'),
								...
								popup: {
									...
									params : { stor_grp : _global.stor_grp , line_stat : '0', dept_idcd : '000025' },
