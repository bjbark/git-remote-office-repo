Ext.define('module.custom.aone.sale.order.sorderlist2.view.SorderList2ListerMaster1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sorderlist2-lister-master1',
	store		: 'module.custom.aone.sale.order.sorderlist2.store.SorderList2Master1'	,
