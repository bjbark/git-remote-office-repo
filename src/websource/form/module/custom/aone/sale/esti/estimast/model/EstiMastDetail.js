Ext.define('module.custom.aone.sale.esti.estimast.model.EstiMastDetail', { extend: 'Axt.data.Model',
	fields: [
		{	name: 'invc_numb'			, type: 'string'		//invoice번호
		},{	name: 'amnd_degr'			, type: 'float' , defaultValue : 1	//amd차수
		},{	name: 'new_amnd_degr'		, type: 'float'         //새로운 amd차수
		...
		},{	name: 'dsnt_amnt'			, type: 'float'			//할인금액
		},{	name: 'rwmt_nonn'			, type: 'float'			//재료비
		},{	name: 'make_cost'			, type: 'float'			//가공비
		},{	name: 'tech_feee_rate'		, type: 'float'			//기술료율
		},{	name: 'tech_feee'			, type: 'float'			//기술료
		},{	name: 'gnrl_mngt_cost_rate'	, type: 'float'			//일반관리비율
		},{	name: 'gfee_amnt'			, type: 'float'			//일반관리비
		},{	name: 'pfit_rate'			, type: 'float'			//이익율
		},{	name: 'calc_amnt'			, type: 'float'			//산출금액
		},{	name: 'esti_amnt'			, type: 'float'			//견적금액
		},{	name: 'esti_pric'			, type: 'float'			//판매단가
		},{	name: 'esti_dvcd'			, type: 'float'			//견적구분코드
