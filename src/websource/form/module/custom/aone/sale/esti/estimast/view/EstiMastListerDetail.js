Ext.define('module.custom.aone.sale.esti.estimast.view.EstiMastListerDetail', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-estimast-lister-detail'			,
	store		: 'module.custom.aone.sale.esti.estimast.store.EstiMastFile',
				...
				fbar	: [
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							params : { stor_grp : _global.stor_grp , line_stat : '0' ,invc_numb : '' , orgn_dvcd : '' , line_seqn : '0', uper_seqn : '' },
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-estimast-lister-detail')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
											...
											Ext.Ajax.request({
												...
												params	: {
													...
													param : JSON.stringify({
														...
														amnd_degr		: params.data.amnd_degr,
														line_seqn		: params.data.line_seqn,
														assi_seqn		: params.data.assi_seqn,
														uper_seqn		: params.data.uper_seqn
													})
												},
												async	: false,
												method	: 'POST',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'assi_seqn'		, text : Language.get('assi_seqn'		,'항번' )		, width : 50 , align : 'center', hidden :true
					},{	dataIndex: 'uper_seqn'		, text : Language.get('uper_seqn'		,'' )		, width : 50 , align : 'center', hidden :true
					...
					},{ dataIndex: 'file_name'		, text : Language.get('file_name'		,'파일명')		, width : 350,
