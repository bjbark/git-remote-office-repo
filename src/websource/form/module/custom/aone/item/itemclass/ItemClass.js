Ext.define( 'module.custom.aone.item.itemclass.ItemClass', { extend:'Axt.app.Controller',
	models: [
	 	'module.custom.aone.item.itemclass.model.ItemClass',
	 	'module.custom.aone.item.itemclass.model.ItemClassExcel'
	],
	stores: [
		'module.custom.aone.item.itemclass.store.ItemClassCate1',
		'module.custom.aone.item.itemclass.store.ItemClassCate2',
		'module.custom.aone.item.itemclass.store.ItemClassCate3',
		'module.custom.aone.item.itemclass.store.ItemClassCate4',
		'module.custom.aone.item.itemclass.store.ItemClassExcel'
	],
	views : [
		'module.custom.aone.item.itemclass.view.ItemClassLayout',
		'module.custom.aone.item.itemclass.view.ItemClassListerExcel',
		'module.custom.aone.item.itemclass.view.ItemClassListerCate1',
		'module.custom.aone.item.itemclass.view.ItemClassListerCate2',
		'module.custom.aone.item.itemclass.view.ItemClassListerCate3',
		'module.custom.aone.item.itemclass.view.ItemClassListerCate4',
		'module.custom.aone.item.itemclass.view.ItemClassEditor',
		'module.custom.aone.item.itemclass.view.ItemClassSearch'
	],
		...
		editor.insertBefore({
			...
			callback : function (keygen){
				if (keygen.success){
					var code = "000";
					Ext.Ajax.request({
						url		: _global.location.http() + '/custom/aone/item/itemclss/get/maxCode.do',
						method		: "POST",
						params		: {
							token	: _global.token_id,
							param	: JSON.stringify({
