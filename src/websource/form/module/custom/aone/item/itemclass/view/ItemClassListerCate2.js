Ext.define('module.custom.aone.item.itemclass.view.ItemClassListerCate2', { extend: 'Axt.grid.Panel',

	plugins		: [{ ptype:'gridcolumnconfig'  } ],
	alias		: 'widget.module-itemclass-lister-cate2',
	store		: 'module.custom.aone.item.itemclass.store.ItemClassCate2',
