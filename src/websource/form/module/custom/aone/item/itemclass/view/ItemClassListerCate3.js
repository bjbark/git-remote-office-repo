Ext.define('module.custom.aone.item.itemclass.view.ItemClassListerCate3', { extend: 'Axt.grid.Panel',

	plugins		: [{ ptype:'gridcolumnconfig'  } ],
	alias		: 'widget.module-itemclass-lister-cate3',
	store		: 'module.custom.aone.item.itemclass.store.ItemClassCate3',

	border : 0  ,
	title  : Language.get('clss_3','소 분류'),
	header : {
		titleAlign: 'center',
	...
	columnItem : function () {
		var me = this, item =
		{
			...
			items	: [
				{	text : Language.get('smll_clss_code'	, '코드'		) , dataIndex: 'clss_code'	, width: 70 , align : 'center'
				},{	text : Language.get('smll_clss_name'	, '분류명'	) , dataIndex: 'clss_name'	, flex :  1
