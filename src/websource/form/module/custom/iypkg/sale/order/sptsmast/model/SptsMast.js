Ext.define('module.custom.iypkg.sale.order.sptsmast.model.SptsMast', { extend: 'Axt.data.Model',

	fields: [
		{	name: 'invc_numb'			, type: 'string' 	/* 출하계획번호	*/
		},{	name: 'line_seqn'			, type: 'float' 	/* 출하계획순번	*/
		},{	name: 'invc_date'			, type: 'string' 	/* 출하계획날짜	*/ , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr
