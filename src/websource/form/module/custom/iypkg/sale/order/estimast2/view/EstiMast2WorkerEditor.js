Ext.define('module.custom.iypkg.sale.order.estimast2.view.EstiMast2WorkerEditor', { extend: 'Axt.form.Editor',

	alias	: 'widget.module-estimast2-worker-editor',
	height	: 235,
	header	: false,
	getStore: function() {
		return Ext.getStore( 'module.custom.iypkg.sale.order.estimast2.store.EstiMast2Invoice' );
	},
