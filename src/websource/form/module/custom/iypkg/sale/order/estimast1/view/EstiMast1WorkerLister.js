Ext.define('module.custom.iypkg.sale.order.estimast1.view.EstiMast1WorkerLister', { extend: 'Axt.grid.Panel',
	alias: 'widget.module-estimast1-worker-lister',
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-estimast1-worker-search'}];
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex:	'item_code'		, width: 80 , align : 'center'	, text: Language.get('item_code'	, '품목코드'	), tdCls : 'editingcolumn',
					},{	xtype	: 'actioncolumn',
						header	: '',
						tdCls : 'editingcolumn',
						width	: 20,
