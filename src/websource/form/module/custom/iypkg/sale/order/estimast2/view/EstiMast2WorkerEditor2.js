Ext.define('module.custom.iypkg.sale.order.estimast2.view.EstiMast2WorkerEditor2', { extend: 'Axt.form.Editor',

	alias	: 'widget.module-estimast2-worker-editor2',
	height	: 235,
	header	: false,
	getStore: function() {
		return Ext.getStore( 'module.custom.iypkg.sale.order.estimast2.store.EstiMast2Invoice2' );
	},
	...
	createTab1 : function() {
		...
		var item	=
			{	title	: Language.get( '' , '견적내역'),
				xtype	: 'module-estimast2-editor-lister1',
			};
		return item;
	},
