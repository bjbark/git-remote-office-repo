Ext.define('module.custom.iypkg.sale.order.slorlist3.view.SlorList3ListerMaster3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-slorlist3-lister-master3',
	store		: 'module.custom.iypkg.sale.order.slorlist3.store.SlorList3Master3'	,
