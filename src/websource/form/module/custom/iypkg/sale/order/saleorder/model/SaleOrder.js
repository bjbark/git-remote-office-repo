Ext.define('module.custom.iypkg.sale.order.saleorder.model.SaleOrder', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'item_code'			, type: 'string'	//담당자ID
		},{	name: 'item_idcd'			, type: 'string'	//담당자ID
		...
		},{	name: 'base_qntt'			, type: 'float ', defaultValue : 0 	//품목높이
		...
		},{	name: 'sets_qntt'			, type: 'float ' , defaultValue : 1 	//m2당수량
		...
		},{	name: 'child_change'		, type: 'string'	/* 부모변경			*/
