Ext.define('module.custom.iypkg.sale.order.estimast1.view.EstiMast1WorkerEditor', { extend: 'Axt.form.Editor',

	alias	: 'widget.module-estimast1-worker-editor',
	height	: 235,
	header	: false,
	getStore: function() {
		return Ext.getStore( 'module.custom.iypkg.sale.order.estimast1.store.EstiMast1Invoice' );
	},
