Ext.define('module.custom.iypkg.sale.order.estimast1.view.EstiMast1ListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-estimast1-lister-detail',

	store: 'module.custom.iypkg.sale.order.estimast1.store.EstiMast1Detail',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex:	'item_line'		, width:  80, align : 'left'	, text: Language.get('item_line'	, '골'		), xtype : 'lookupcolumn', lookupValue : resource.lookup('line_dvcd')
					...
					},{	dataIndex:	'esti_qntt'		, width:  60, align : 'right'	, text: Language.get('esti_qntt'	, '수량'		), xtype: 'numericcolumn' , summaryType: 'sum', format: '#,##0'
					},{	dataIndex:	'mxm2_qntt'		, width:  80, align : 'right'	, text: Language.get('mxm2_qntt'	, 'm2/개'	), xtype: 'numericcolumn' , format: '#,##0', summaryType: 'sum',
					...
					},{	dataIndex:	'vatx_amnt'		, width:  80, align : 'right'	, text: Language.get('vatx_amnt'	, '부가세액'	), xtype: 'numericcolumn'
					...
					},{	dataIndex:	'ordr_cstm_name', width: 170, align : 'right'	, text: Language.get('ordr_cstm_name', '매입처명'	)
