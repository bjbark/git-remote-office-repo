Ext.define('module.custom.iypkg.sale.order.slorlist2.SlorList2', {  extend   : 'Axt.app.Controller',
	requires : [
	...
	models	: [
		'module.custom.iypkg.sale.order.slorlist2.model.SlorList2',
	],
	stores	: [
		'module.custom.iypkg.sale.order.slorlist2.store.SlorList2',
	],
	views	: [
		'module.custom.iypkg.sale.order.slorlist2.view.SlorList2Layout',
		'module.custom.iypkg.sale.order.slorlist2.view.SlorList2Lister',
		'module.custom.iypkg.sale.order.slorlist2.view.SlorList2Search',
	],
	...
	init: function() {
		var me = this;
		me.control({
			'module-slorlist2-layout button[action=selectAction]' : { click : me.selectAction },

//			'module-slorlist2-lister button[action=modifyAction]' : { click : me.modifyAction },
//			'module-slorlist2-lister button[action=insertAction]' : { click : me.insertAction },
			'module-slorlist2-lister button[action=exportAction]' : { click : me.exportAction },
//			'module-slorlist2-lister button[action=deleteAction]' : { click : me.deleteAction },

//			'module-slorlist2-editor button[action=updateAction]' : { click : me.updateAction },
//			'module-slorlist2-editor button[action=cancelAction]' : { click : me.cancelAction },
	...
	pocket : {
		...
		editor	: function () { return Ext.ComponentQuery.query('module-slorlist2-editor')[0] },
		lister	: function () { return Ext.ComponentQuery.query('module-slorlist2-lister')[0] },
	},
