Ext.define('module.custom.iypkg.sale.order.estimast1.view.EstiMast1ListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-estimast1-lister-detail2',
	store: 'module.custom.iypkg.sale.order.estimast1.store.EstiMast1Detail2',
