Ext.define('module.custom.iypkg.sale.sale.salecolt.view.SaleColtDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-iypkg-salecolt-detail2',
	store		: 'module.custom.iypkg.sale.sale.salecolt.store.SaleColtDetail2',
