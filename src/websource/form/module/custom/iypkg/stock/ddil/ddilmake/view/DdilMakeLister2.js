Ext.define('module.custom.iypkg.stock.ddil.ddilmake.view.DdilMakeLister2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-iypkg-ddilmake-lister2',
	store		: 'module.custom.iypkg.stock.ddil.ddilmake.store.DdilMake2',
	split		: true,
						...
						items	: [
							{	iconCls	: Const.SELECT.icon,
								...
								handler	: function (grid, rowIndex, colIndex, item, e, record) {
									var wrhs_idcd = Ext.ComponentQuery.query('module-iypkg-ddilmake-search')[0].down('[name=wrhs_idcd]').getValue();
	...
	rowInsert: function(){
		var me			= this,
			myform		= Ext.ComponentQuery.query('module-iypkg-ddilmake-lister2')[0],
	 ...
	 ******************************************************************/
	rowDelete: function(){
		var myform	= Ext.ComponentQuery.query('module-iypkg-ddilmake-lister2')[0],
