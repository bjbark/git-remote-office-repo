Ext.define('module.custom.iypkg.stock.close.mtrlstocklist2.view.MtrlStockList2WorkerSearch1', { extend: 'Axt.form.Search',

	alias	: 'widget.module-mtrlstocklist2-worker-search1',
	height	: 45,
	header	: false,
