Ext.define('module.custom.iypkg.stock.isos.osttwaitlist.view.OsttWaitListSearch', { extend: 'Axt.form.Search',

	alias: 'widget.module-osttwaitlist-search',
					...
					{	xtype	: 'fieldset',
						...
						items	: [
							{	xtype	: 'label'			,
								...
								xtype		: 'searchfield'	,
								flex		: 4				,
								emptyText	: '조회할 거래처명 또는 품명을 입력하세요.',
							...
							{	xtype : 'fieldset',
								...
								items : [
									{	xtype : 'fieldset',
										...
										margin: '5 0 0 313',
										items : [
											{	fieldLabel	: Language.get('prod_name','품목코드'),
												xtype		: 'popupfield',
												name		: 'prod_name',
												pair		: 'prod_idcd',
												clearable	: true,
