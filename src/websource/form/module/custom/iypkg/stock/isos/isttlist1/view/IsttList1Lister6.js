Ext.define('module.custom.iypkg.stock.isos.isttlist1.view.IsttList1Lister6', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-isttlist1-lister6',
	store		: 'module.custom.iypkg.stock.isos.isttlist1.store.IsttList1Lister6',
	border		: 0 ,
	columnLines : true ,
	...
	columnItem : function () {
		var me = this,
			...
			items : [
				...
				},{	dataIndex: 'prod_leng'		, width:  40, text: Language.get('', '장'	), align : 'right'
				},{	dataIndex: 'prod_widh'		, width:  40, text: Language.get('', '폭'	), align : 'right'
				},{	dataIndex: 'prod_hght'		, width:  40, text: Language.get('', '고'	), align : 'right'
				...
				},{	dataIndex: 'unistt'			, width:  80, text: Language.get('', '미입고잔량') , xtype: 'numericcolumn', summaryType: 'sum', format: '#,##0', align : 'right'
