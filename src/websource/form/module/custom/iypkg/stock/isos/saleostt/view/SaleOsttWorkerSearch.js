Ext.define('module.custom.iypkg.stock.isos.saleostt.view.SaleOsttWorkerSearch',{ extend: 'Axt.form.Search',
	alias	: 'widget.module-saleostt-worker-search',
							...
							{	fieldLabel	: Language.get(' ','체크된값'),
								...
								popup		: {
									...
									result	: function(records, nameField, pairField ) {
										...
										setTimeout(function(){
											me.down('[name=ostt_date]').focus(true , 10);
										},100);
									}
								}
