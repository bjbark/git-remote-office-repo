Ext.define('module.custom.iypkg.stock.isos.sptslist1.view.SptsList1Lister3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-sptslist1-lister3',
	store		: 'module.custom.iypkg.stock.isos.sptslist1.store.SptsList1Lister3',
