Ext.define('module.custom.iypkg.stock.isos.saleostt2.view.SaleOstt2AddPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-iypkg-saleostt2-add-popup',
	...
	finishAction: function(){
		...
		record = Ext.create( lister.getStore().model.modelName , values);
...
//		lister.getStore().commitChanges();
		...
		at.set('acpt_qntt',values.acpt_qntt);
		at.set('cstm_idcd',values.cstm_idcd);
		at.set('cstm_name',values.cstm_name);
		at.set('sale_amnt',sale_amnt);
		at.set('vatx_amnt',vatx_amnt);
		at.set('ttsm_amnt',sale_amnt+vatx_amnt);
