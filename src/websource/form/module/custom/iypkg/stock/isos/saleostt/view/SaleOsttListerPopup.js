/**
 */
Ext.define('module.custom.iypkg.stock.isos.saleostt.view.saleosttListerPopup', { extend: 'Axt.popup.Search',
	id		: 'module-saleostt-lister-lookup-popup',
	alias	: 'widget.module-saleostt-lister-lookup-popup',
	store	: 'module.custom.iypkg.stock.isos.saleostt.store.SaleOsttListerPopup',
	requires: [
				...
				{	xtype	: 'fieldset', layout: 'hbox' ,padding:'0', border: 0, margin : '2 0 2 22',
					items	: [
						{	fieldLabel	: Language.get('', '수주번호'),
							xtype		: 'textfield',
							name		: 'invc_numb',
							value		: me.popup.params.records.acpt_numb,
