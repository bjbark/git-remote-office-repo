Ext.define('module.custom.iypkg.basic.boxtype.view.BoxTypeMemoLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-boxtype-memolister'			,
	store		: 'module.custom.iypkg.basic.boxtype.store.BoxTypeMemo'	,
	...
	listeners:{
		edit:function(){
			Ext.ComponentQuery.query('module-boxtype-editor')[0].down('[name=modify]').setValue('Y');
		}
	},
	/******************************************************************
