Ext.define('module.custom.iypkg.basic.boxtype.view.BoxTypeEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-boxtype-editorlister'			,
	store		: 'module.custom.iypkg.basic.boxtype.store.BoxTypeFile',
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),			// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-boxtype-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
