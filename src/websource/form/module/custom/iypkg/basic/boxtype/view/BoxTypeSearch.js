Ext.define('module.custom.iypkg.basic.boxtype.view.BoxTypeSearch', { extend: 'Axt.form.Search',

	alias: 'widget.module-boxtype-search',
					...
					{	xtype		: 'fieldset',
						...
						items		:[
							{	xtype	: 'label',
								...
								xtype	: 'searchfield',
								flex	: 4,
								emptyText		: '조회할 형식코드 또는 형식명을 입력하세요...',
