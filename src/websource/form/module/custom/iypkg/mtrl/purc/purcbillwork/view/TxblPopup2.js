Ext.define('module.custom.iypkg.mtrl.purc.purcbillwork.view.TxblPopup2', { extend: 'Axt.popup.Search',
	alias: 'widget.module-purcbillwork-popup2',
						...
						{	fieldLabel	: Language.get('stot_dvcd','결제구분'),
							...
							listeners	: {
								change : function(val,val2,val3){
									var popup = Ext.ComponentQuery.query('module-purcbillwork-popup2')[0],
