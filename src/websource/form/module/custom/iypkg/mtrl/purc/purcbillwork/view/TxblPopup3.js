Ext.define('module.custom.iypkg.mtrl.purc.purcbillwork.view.TxblPopup3', { extend: 'Axt.popup.Search',
	alias: 'widget.module-purcbillwork-popup3',
	...
	editorForm : function () {
		...
		item = {
			...
			items			: [
						...
						{	fieldLabel	: Language.get('stot_dvcd','결제구분'),
							...
							listeners	: {
								change : function(val,val2,val3){
									var popup = Ext.ComponentQuery.query('module-purcbillwork-popup3')[0],
				...
				},{ xtype	: 'textfield', name : 'txbl_path_dvcd', hidden : true
				}
			]
		}
	;
