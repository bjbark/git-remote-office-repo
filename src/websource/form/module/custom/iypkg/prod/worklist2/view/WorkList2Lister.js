Ext.define('module.custom.iypkg.prod.worklist2.view.WorkList2Lister', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-worklist2-lister',
	store		: 'module.custom.iypkg.prod.worklist2.store.WorkList2',
	border		: 0,
	columnLines	: true,
		...
		var me   = this,
			item =  {
				...
				items	: [
					...
					},{	dataIndex:	''	, width: 100, align : 'right'	, text: Language.get( ''	, 'm2/총'	),xtype:'numericcolumn'
					}
				]
			};
		return item;
