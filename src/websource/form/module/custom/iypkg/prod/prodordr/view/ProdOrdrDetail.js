Ext.define('module.custom.iypkg.prod.prodordr.view.ProdOrdrDetail', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prodordr-detail',
	store		: 'module.custom.iypkg.prod.prodordr.store.ProdOrdrDetail',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'item_leng'	, text : Language.get(''	,'장'		) , width :  80 , align : 'right', xtype : 'numericcolumn' , format: '#,##0'
					},{ dataIndex: 'item_widh'	, text : Language.get(''	,'폭'		) , width :  80 , align : 'right', xtype : 'numericcolumn' , format: '#,##0'
					},{ dataIndex: 'item_fxqt'	, text : Language.get(''	,'절수'		) , width :  80 , align : 'right', xtype : 'numericcolumn' , format: '#,##0'
					},{ dataIndex: 'fdat_spec'	, text : Language.get(''	,'재단규격'		) , width : 120 , align : 'left'
