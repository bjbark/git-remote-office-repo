Ext.define('module.custom.iypkg.prod.prodordr.view.ProdOrdrDetail3', { extend: 'Axt.form.Editor',

	alias		: 'widget.module-prodordr-detail3',
	width	: 430,
	layout : {
		type: 'border'
	},
								...
								{	fieldLabel	: Language.get('','수주번호')	,
									...
									listeners	:{
										change:function(){
											...
											var results;
											Ext.Ajax.request({
												url		: _global.location.http() + '/custom/iypkg/prod/prodordr/get/detail3.do',
												params	: {
											...
											if(results){
												var editor = Ext.ComponentQuery.query('module-prodordr-detail3')[0],
