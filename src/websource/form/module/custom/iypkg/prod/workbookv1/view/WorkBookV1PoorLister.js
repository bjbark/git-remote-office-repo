Ext.define('module.custom.iypkg.prod.workbookv1.view.WorkBookV1PoorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workbookv1-poor'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.custom.iypkg.prod.workbookv1.store.WorkBookV1PoorLister',
	border		: 0,
