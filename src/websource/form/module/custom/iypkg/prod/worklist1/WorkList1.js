Ext.define('module.custom.iypkg.prod.worklist1.WorkList1', {  extend   : 'Axt.app.Controller',
	requires : [
		'lookup.popup.view.WkctPopup',
		'lookup.popup.view.CstmPopup'
	],
	models	: [
		'module.custom.iypkg.prod.worklist1.model.WorkList1',
	],
	stores	: [
		'module.custom.iypkg.prod.worklist1.store.WorkList1',
	],
	views	: [
		'module.custom.iypkg.prod.worklist1.view.WorkList1Layout',
		'module.custom.iypkg.prod.worklist1.view.WorkList1Lister',
		'module.custom.iypkg.prod.worklist1.view.WorkList1Search',
	],
	...
	init: function() {
		var me = this;
		me.control({
			'module-worklist1-layout button[action=selectAction]' : { click : me.selectAction },
			'module-worklist1-lister button[action=exportAction]' : { click : me.exportAction },
		});
		me.callParent(arguments);
	},
	pocket : {
		layout	: function () { return Ext.ComponentQuery.query('module-worklist1-layout')[0] },
		search	: function () { return Ext.ComponentQuery.query('module-worklist1-search')[0] },
		editor	: function () { return Ext.ComponentQuery.query('module-worklist1-editor')[0] },
		lister	: function () { return Ext.ComponentQuery.query('module-worklist1-lister')[0] },
	},
