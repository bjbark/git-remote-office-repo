Ext.define('module.custom.iypkg.prod.dailyworklist.view.DailyWorkListDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-dailyworklist-detail2'			,
	store		: 'module.custom.iypkg.prod.dailyworklist.store.DailyWorkListDetail2',
