Ext.define('module.custom.iypkg.prod.workentry.view.WorkEntryPoorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workentry-poor'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.custom.iypkg.prod.workentry.store.WorkEntryPoorLister',
	border		: 0,
