Ext.define('module.custom.iypkg.prod.workentry.view.WorkEntryDetail1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workentry-detail1',
	store		: 'module.custom.iypkg.prod.workentry.store.WorkEntryDetail1',
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	features	: [{ ftype : 'grid-summary' }],
	plugins		: [{ ptype:'gridcolumnmenu' } , { ptype:'gridcolumnconfig' }, { ptype:'filterbar', renderHidden : false  } ],
	columnLines : true,
