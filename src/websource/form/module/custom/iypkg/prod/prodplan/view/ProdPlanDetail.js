Ext.define('module.custom.iypkg.prod.prodplan.view.ProdPlanDetail', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prodplan-detail',
	store		: 'module.custom.iypkg.prod.prodplan.store.ProdPlanDetail',
