Ext.define('module.custom.iypkg.prod.workentry2.view.WorkEntry2WorkerSearch2', { extend: 'Axt.form.Search',

	alias	: 'widget.module-workentry2-worker-search2',
	height	: 110,
	header	: false,
	...
	createWest : function () {
		var me	= this,
			...
			items		: [
				{	xtype : 'fieldset', layout: 'vbox', border : 0,  margin : '7 0 5 0',
					items : [
						{	xtype	: 'fieldset', layout: 'hbox' ,padding:'0', border: 0,margin : '5 11 5 0',
							...
							items	: [
								{	fieldLabel	: Language.get('prod','제품'),
									xtype		: 'textfield',
									name		: 'prod_code',
									labelWidth	: 60,
									width		: 150,
