Ext.define('module.custom.iypkg.prod.prodordr2.view.ProdOrdr2Search', { extend: 'Axt.form.Search',

	alias: 'widget.module-prodordr2-search',
						...
						items : [
							{	fieldLabel	: Language.get('', '수주번호' ),
								...
								popup		: {
									...
									select	: 'SINGLE',
									params : { stor_grp : _global.stor_grp , line_stat : '0', acct_bacd : '3000'},
									result	: function(records, nameField, pairField) {
