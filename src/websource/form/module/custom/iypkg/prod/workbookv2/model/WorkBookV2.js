Ext.define('module.custom.iypkg.prod.workbookv2.model.WorkBookV2',{ extend:'Axt.data.Model',
	fields: [
		...
		{	name: 'prod_mtrl'				, type: 'string' },		//품목재질
		...
		{	name: 'pause_dvcd'				, type: 'string' },		//일시정지여부
		...
		{	name: 'scre_spec_frml'			, type: 'string' },		//스코어 규격
		{	name: 'fabc_name'				, type: 'string' },		//원단명
		{	name: 'ppln_dvcd'				, type: 'string' },		//지골코드
		{	name: 'pcod_numb'				, type: 'string' },		//pono numb


		{	name: 'pkg_qntt'				, type: 'float' , defaultValue: '1'},		//포장단위수량
		{	name: 'bom_spec'				, type: 'string'},
