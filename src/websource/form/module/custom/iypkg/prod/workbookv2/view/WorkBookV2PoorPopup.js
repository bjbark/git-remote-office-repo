Ext.define('module.custom.iypkg.prod.workbookv2.view.WorkBookV2PoorPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-bookv2-poor-popup',
	alias	: 'widget.lookup-bookv2-poor-popup',
	...
	initComponent: function(config){
		...
		//불량 조회
		var store = Ext.ComponentQuery.query('module-workbookv2-poor')[0].getStore(),
		...
		var me = this,
			form = {
				...
				items			: [
					...
					},{	xtype : 'module-workbookv2-poor', region:'center' , flex : 1, height:500 ,margin: '0 0 0 0', itemId : 'grid1'
					}
				],
				buttons: [
...
//							});
	...
	poorupdate : function (val, val2, param) {
		var me = this,
			...
			poor      = Ext.ComponentQuery.query('module-workbookv2-poor')[0],
			store     = poor.getStore(),
