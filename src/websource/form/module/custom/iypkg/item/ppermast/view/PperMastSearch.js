Ext.define('module.custom.iypkg.item.ppermast.view.PperMastSearch', { extend: 'Axt.form.Search',
	alias: 'widget.module-ppermast-search',
					...
					{	xtype	: 'fieldset',
						...
						items	: [
							{	xtype	: 'label'			,
								...
								xtype		: 'searchfield'	,
								flex		: 4				,
								emptyText	: '조회할 원지코드 또는 원지명을 입력하세요...',
