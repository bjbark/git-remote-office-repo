Ext.define('module.custom.iypkg.eis.eisreport17.EisReport17', {  extend   : 'Axt.app.Controller',
	models	: [
		'module.custom.iypkg.eis.eisreport17.model.EisReport17',
	],
	stores	: [
		'module.custom.iypkg.eis.eisreport17.store.EisReport17',
	],
	views	: [
		'module.custom.iypkg.eis.eisreport17.view.EisReport17Lister1',
		'module.custom.iypkg.eis.eisreport17.view.EisReport17Editor1',
		'module.custom.iypkg.eis.eisreport17.view.EisReport17Lister2',
		'module.custom.iypkg.eis.eisreport17.view.EisReport17Editor2',
		'module.custom.iypkg.eis.eisreport17.view.EisReport17Lister3',
		'module.custom.iypkg.eis.eisreport17.view.EisReport17Editor3',
		'module.custom.iypkg.eis.eisreport17.view.EisReport17Lister4',
		'module.custom.iypkg.eis.eisreport17.view.EisReport17Editor4',
		'module.custom.iypkg.eis.eisreport17.view.EisReport17Lister5',
		'module.custom.iypkg.eis.eisreport17.view.EisReport17Editor5',
		'module.custom.iypkg.eis.eisreport17.view.EisReport17Layout',
		'module.custom.iypkg.eis.eisreport17.view.EisReport17Search',
		'module.custom.iypkg.eis.eisreport17.view.EisReport17Search1',
	],
	...
	init: function() {
		var me = this;
		me.control({
			'module-eisreport17-layout button[action=selectAction]' : { click : me.selectAction },
			'module-eisreport17-lister button[action=exportAction]' : { click : me.exportAction },
		});
