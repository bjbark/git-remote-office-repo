Ext.define('module.custom.iypkg.eis.eisreport17.view.EisReport17Editor2', { extend: 'Axt.form.Editor',

	alias	: 'widget.module-eisreport17-editor2',
	header	: false,

	initComponent: function(config){
		var me = this;
		var toDay = Ext.Date.format(Ext.Date.add( new Date(), Ext.Date.MONTH, -1),'M');
