Ext.define('module.custom.iypkg.eis.eisreport11.model.EisReportDetail111',{ extend:'Axt.data.Model',
	fields : [
		...
		{	name: 'sw_code'	,			type: 'float'  },		//원단지종구분코드 값 sw, tw
		{	name: 'dw_code'	,			type: 'float'  },		//원단지종구분코드 값 dw
