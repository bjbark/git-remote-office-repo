Ext.define('module.custom.iypkg.eis.eisreport1.model.EisReport1Master',{ extend:'Axt.data.Model',
	fields : [
		...
		{name: 'dlvy_cstm_name'			, type: 'string' },		//공정흐름ID
		{name: 'prod_name'				, type: 'string' },		//공정흐름ID
		{name: 'pcod_numb'				, type: 'string' },		//공정흐름ID
		{name: 'acpt_qntt'				, type: 'float' },		//수주량
		{name: 'istt_pric'				, type: 'float' },		//단가
		{name: 'stnd_pric'				, type: 'float' },		//단가
		{name: 'stnd_pric2'				, type: 'float' },		//단가
		{name: 'item_leng'				, type: 'float' },		//공정흐름ID
		{name: 'item_widh'				, type: 'float' },		//공정흐름ID
		{name: 'item_hght'				, type: 'float' },		//공정흐름ID
		{name: 'ttsm_amnt'				, type: 'float' },		//공급가액
		{name: 'item'					, type: 'string' },		//공정흐름ID
		{name: 'vatx_rate'				, type: 'float' },		//공정흐름ID
		...
		{name: 'invc1_date'				, type: 'string' },		//금액
		{name: 'invc2_date'				, type: 'string' },		//금액
