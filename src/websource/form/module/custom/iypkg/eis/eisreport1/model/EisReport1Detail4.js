Ext.define('module.custom.iypkg.eis.eisreport1.model.EisReport1Detail4',{ extend:'Axt.data.Model',
	fields: [
	 	{name: 'invc_date'			, type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr},//일자
	 	{name: 'invc_numb',		type: 'string' },		//유실코드
		{name: 'loss_resn_dvcd',		type: 'string' },		//유실코드
		{name: 'wkct_idcd',				type: 'string' },		//작업공정
		{name: 'wkun_dvcd',				type: 'string' },		//작업단위
		{name: 'plan_qntt',				type: 'float' },		//수량
		{name: 'qntt_unit_idcd',		type: 'string' },		//단위
		{name: 'need_qntt',				type: 'string' },		//단위
		{name: 'stnd_pric',				type: 'float' },		//유실명
		{name: 'ttsm_amnt',				type: 'float' },		//공급가
		{name: 'remk_text',				type: 'string' },		//유실명
