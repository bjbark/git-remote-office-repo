Ext.define('module.custom.iypkg.eis.eisreport.view.EisReportEditor2', { extend: 'Axt.form.Editor',
	alias		: 'widget.module-eisreport-editor2'			,
	border		: 0,
	...
	initComponent: function () {
		...
		window.shot21 = setInterval(function(){
			Ext.Ajax.request({
				url			: _global.api_host_info + '/' + _global.app_site + '/custom/iypkg/eis/eisreport/get/search.do',
				method		: "POST",
				async		: false,
										...
										listeners	: {
											render	:function(field){
												...
												if(wkod_numb != ''){
													...
													window.shot2 = setInterval(function(){
														Ext.Ajax.request({
															url			: _global.api_host_info + '/' + _global.app_site + '/custom/iypkg/eis/eisreport/get/plc_cnt.do',
															method		: "POST",
															async		: false,
