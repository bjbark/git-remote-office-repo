Ext.define('module.custom.hjsys.prod.workentry.view.WorkEntryPoorLister2', { extend: 'Axt.grid.Panel',
	id			: 'module-workentry-poor2',
	alias		: 'widget.module-workentry-poor2'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.custom.hjsys.prod.workentry.store.WorkEntryPoorLister2',
	border		: 0,
	columnLines : false,
