Ext.define('module.custom.hjsys.prod.workentry.view.WorkEntryEditor', { extend: 'Axt.form.Editor',
	alias		: 'widget.module-workentry-editor',
	layout : {
		type: 'border'
	},
	columnLines : true,
...
//		me.items = me.createwest();
									...
									{	xtype	: 'fieldset', layout: 'hbox' ,padding:'0', border: 0, margin : '0 0 0 0', width : '100%', minWidth : 975,
										items	: [
											{	xtype	: 'fieldcontainer'  ,
												...
												margin	: '0 0 2 0',
												items	: [
													{	text	: '모델명', xtype : 'label', style : 'text-align:center; font-size : 1.2em !important;border-bottom : none !important;', margin : '8 0 0 0'
													}
												]
											},{	xtype	: 'fieldcontainer'  ,
												layout	: { type: 'vbox', align: 'stretch' } ,
												...
												margin	: '0 0 2 0',
												items	: [
													{	text	: '수주량', xtype : 'label', style : 'text-align:center; font-size : 1.2em !important;', margin : '8 0 0 0'
													}
												]
											},{	xtype	: 'fieldcontainer'  ,
												layout	: { type: 'vbox', align: 'stretch' } ,
												...
												items	: [
													{	xtype		: 'numericfield',
														...
														height		: 35,
														readOnly	: true,
														fieldStyle	: 'font-size:1.2em !important; text-align : right; font-weight:bold; border-color : #99bce8; border-left : none !important; border-right : none !important;',
													}
												]
											},{	xtype	: 'fieldcontainer'  ,
												layout	: { type: 'vbox', align: 'stretch' } ,
										...
										items	: [
											{	xtype	: 'fieldcontainer'  ,
												...
												margin	: '0 0 0 0',
												items	: [
													{	text	: '소요량', xtype : 'label', style : 'text-align:center; font-size : 1.2em !important;', margin : '8 0 0 0'
													}
												]
											},{	xtype	: 'fieldcontainer'  ,
												layout	: { type: 'vbox', align: 'stretch' } ,
												...
												items	: [
													{	xtype		: 'numericfield',
														...
														height		: 35,
														readOnly	: true,
														fieldStyle	: 'font-size:1.2em !important; text-align : right; font-weight:bold; border-color : #99bce8; border-left : none !important; border-right : none !important; border-top : none !important;',
													}
												]
											},{	xtype	: 'fieldcontainer'  ,
												layout	: { type: 'vbox', align: 'stretch' } ,
										...
										items	: [
											...
											},{xtype : 'textfield', name : 'unit_name', hidden : true
											}
										]
									}
								]
	...
	image : function(){
		var me = this,
			myform = Ext.ComponentQuery.query('module-workentry-editor')[0],
			check = '1',
