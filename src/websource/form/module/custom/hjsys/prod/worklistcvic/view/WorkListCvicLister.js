Ext.define('module.custom.hjsys.prod.worklistcvic.view.WorkListCvicLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-worklistcvic-lister',
	store		: 'module.custom.hjsys.prod.worklistcvic.store.WorkListCvic',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'need_time'		, text : Language.get('need_time'		, '소요시간'		) , width :  70 , align : 'right'
					},{	dataIndex: 'invc_date'		, text : Language.get('prod_date'		, '지시일자'		) , width :  90 , align : 'center'
					...
					},{ dataIndex: 'item_spec'		, text : Language.get('item_spec'		, '품목규격'		) , width : 110 , align : 'left'
					},{	dataIndex: 'wkct_name'		, text : Language.get('wkct_name'		, '공정'			) , width :  90 , align : 'left', hidden : true
