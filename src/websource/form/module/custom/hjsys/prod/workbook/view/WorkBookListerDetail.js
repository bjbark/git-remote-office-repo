Ext.define('module.custom.hjsys.prod.workbook.view.WorkBookListerDetail', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-hjsys-workbook-lister-detail',
	store		: 'module.custom.hjsys.prod.workbook.store.WorkBookDetail',
