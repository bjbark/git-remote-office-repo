Ext.define('module.custom.hjsys.sale.order.saleorder.view.SaleOrderListerExcel', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-saleorder-lister-excel',
	store		: 'module.custom.hjsys.sale.order.saleorder.store.SaleOrderExcel',
