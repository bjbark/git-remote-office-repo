Ext.define('module.custom.hjsys.sale.order.saleorder.view.SaleOrderCopyPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-saleorder-copy-popup',
	...
	finishAction: function(){
		...
		if(values.deli_date==''||values.deli_date==null){
			...
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/hjsys/sale/order/saleorder/set/acpt_copy.do',
				params	: {
