Ext.define('module.custom.hjsys.sale.order.saleorder.view.SaleOrderBomListDetail', { extend: 'Ext.tree.Panel',
	alias	: 'widget.module-saleorder-bomlistdetail',
	store	: 'module.custom.hjsys.sale.order.saleorder.store.SaleOrderBomListDetail',
	border	: 0  ,
