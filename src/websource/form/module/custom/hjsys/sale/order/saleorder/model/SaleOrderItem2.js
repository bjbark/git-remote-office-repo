Ext.define('module.custom.hjsys.sale.order.saleorder.model.SaleOrderItem2',{ extend:'Axt.data.Model',
	fields:
		[
			...
			{name: 'mtrl_cost_prog_rate',	type: 'float'},							//재료비진척율
			{name: 'labo_cost_prog_rate',	type: 'float'},							//노무비진척율
			{name: 'expn_prog_rate',		type: 'float'},							//경비진척율
