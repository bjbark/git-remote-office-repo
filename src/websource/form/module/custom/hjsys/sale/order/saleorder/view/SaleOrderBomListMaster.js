Ext.define('module.custom.hjsys.sale.order.saleorder.view.SaleOrderBomListMaster', { extend: 'Ext.tree.Panel',
	alias	: 'widget.module-saleorder-bomlistmaster',
	store	: 'module.custom.hjsys.sale.order.saleorder.store.SaleOrderBomListMaster',
	border	: 0  ,
