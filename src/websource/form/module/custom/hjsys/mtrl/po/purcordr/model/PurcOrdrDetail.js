Ext.define('module.custom.hjsys.mtrl.po.purcordr.model.PurcOrdrDetail', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'puch_qntt'			, type: 'float'		/* 발주수량		*/
		},{	name: 'need_qntt'			, type: 'float'		/* 소요수량		*/
		},{	name: 'stok_used_qntt'		, type: 'float'		/* 자재소요수량		*/
