Ext.define('module.custom.hjsys.mtrl.po.purcordr.model.PurcOrdrMaster', { extend: 'Axt.data.Model',
	fields: [
		{	name: 'invc_numb'			, type: 'string'	/*invoice번호*/
		},{	name: 'amnd_degr'			, type: 'float'		/* amd차수	*/, defaultValue : 1
		},{	name: 'bzpl_idcd'			, type: 'string'	/*사업장ID	*/
		},{	name: 'acct_bacd'			, type: 'string'	/*계정분류	*/
		...
		},{	name: 'acpt_numb'			, type: 'string'	/*결제구분*/
