Ext.define('module.custom.hjsys.stock.goodsosttwork.view.GoodsOsttWorkItemPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-hjsys-goodsosttwork-item-popup',
