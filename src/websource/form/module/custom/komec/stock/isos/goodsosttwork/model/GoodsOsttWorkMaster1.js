Ext.define('module.custom.komec.stock.isos.goodsosttwork.model.GoodsOsttWorkMaster1',{ extend:'Axt.data.Model',
	fields : [
		...
		{	name: 'line_seqn'				, type: 'string' },		//line_seqn
		...
		{	name: 'ostt_qntt'				, type: 'float'  },		//ROW순서
		{	name: 'ostt_qntt2'				, type: 'float'  },		//ROW순서
