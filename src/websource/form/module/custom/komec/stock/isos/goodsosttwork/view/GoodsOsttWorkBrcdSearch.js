Ext.define('module.custom.komec.stock.isos.goodsosttwork.view.GoodsOsttWorkBrcdSearch', { extend: 'Axt.form.Search',


	alias: 'widget.module-goodsosttwork-brcd-search',
