Ext.define('module.custom.komec.stock.isos.prodosttwork.view.ProdOsttWorkListerDetail', { extend: 'Axt.grid.Panel',

	alias: 'widget.module-prodosttwork-lister-detail',

	store: 'module.custom.komec.stock.isos.prodosttwork.store.ProdOsttWorkDetail',
