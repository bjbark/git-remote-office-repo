...
Ext.define('module.custom.komec.stock.isos.prodosttwork.view.ProdOsttWorkWorkerEditor', { extend: 'Axt.form.Editor',

	alias: 'widget.module-prodosttwork-worker-editor',
	height : 160,
	header : false,
	getStore : function() {
		return Ext.getStore( 'module.custom.komec.stock.isos.prodosttwork.store.ProdOsttWorkInvoice' );
	},
