Ext.define('module.custom.komec.stock.isos.goodsosttwork.model.GoodsOsttWorkDetail2',{ extend:'Axt.data.Model',
	fields : [
			...
			{	name: 'stok_qntt'				, type: 'float'  },		//미납잔량
			...
			{	name: 'cstm_idcd'			, type: 'string' },		//창고ID
			...
			{	name: 'ostt_qntt2'			, type: 'float'  },		//출고수량
