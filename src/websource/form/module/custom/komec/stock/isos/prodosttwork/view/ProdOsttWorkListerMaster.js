Ext.define('module.custom.komec.stock.isos.prodosttwork.view.ProdOsttWorkListerMaster', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-prodosttwork-lister-master',

	store		: 'module.custom.komec.stock.isos.prodosttwork.store.ProdOsttWorkMaster',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'orig_invc_numb'	, width: 120, text: Language.get('ostt_indn_numb'	, '지시번호'		), align:'center',hidden:true
