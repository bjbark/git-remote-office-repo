Ext.define('module.custom.komec.stock.isos.goodsosttwork.view.GoodsOsttWorkExcelPopup', { extend: 'Axt.popup.Upload',
	alias		: 'widget.module-komec-goodsosttwork-excel-popup'			,
			...
			items	: [
				{
					...
					border			:  false,
					url				: 'system/custom/komec/stock/isos/goodsosttwork/set/excel.do',
					timeout			: 120000,
					method			: 'POST',
					layout			: { type: 'vbox', align: 'stretch' } ,
					padding			: 10 ,
