Ext.define('module.custom.komec.sale.order.saleorder.SaleOrder', { extend : 'Axt.app.Controller',
	...
	models:[
		'module.custom.komec.sale.order.saleorder.model.SaleOrderInvoice',
		'module.custom.komec.sale.order.saleorder.model.SaleOrderMaster',
		'module.custom.komec.sale.order.saleorder.model.SaleOrderDetail2',
		'module.custom.komec.sale.order.saleorder.model.SaleOrderDetail',
		'module.custom.komec.sale.order.saleorder.model.SaleOrderFile'
	],
	stores:[
		'module.custom.komec.sale.order.saleorder.store.SaleOrderInvoice',
		'module.custom.komec.sale.order.saleorder.store.SaleOrderMaster',
		'module.custom.komec.sale.order.saleorder.store.SaleOrderDetail2',
		'module.custom.komec.sale.order.saleorder.store.SaleOrderDetail',
		'module.custom.komec.sale.order.saleorder.store.SaleOrderFile'
	],
	views : [
		'module.custom.komec.sale.order.saleorder.view.SaleOrderLayout',
		/* 현황 */
		'module.custom.komec.sale.order.saleorder.view.SaleOrderSearch',
		'module.custom.komec.sale.order.saleorder.view.SaleOrderListerMaster',
		'module.custom.komec.sale.order.saleorder.view.SaleOrderListerDetail2',
		'module.custom.komec.sale.order.saleorder.view.SaleOrderListerDetail',
		/* 작업 */
		'module.custom.komec.sale.order.saleorder.view.SaleOrderWorkerEditor',
		'module.custom.komec.sale.order.saleorder.view.SaleOrderWorkerSearch',
		'module.custom.komec.sale.order.saleorder.view.SaleOrderWorkerLister',
		'module.custom.komec.sale.order.saleorder.view.SaleOrderCopyPopup',
		'module.custom.komec.sale.order.saleorder.view.SaleOrderFile',
		'module.custom.komec.sale.order.saleorder.view.SaleOrderConsultingPopup',
		'module.custom.komec.sale.order.saleorder.view.SaleOrderResultPopup'
	],
	initPermission: function(workspace, permission) {
		this.callParent([workspace, permission]);
		this.joinPermission(workspace.down('module-komec-saleorder-lister-master menuitem[action=closeAction]'),       Const.PERMIT.MODIFY);
		this.joinPermission(workspace.down('module-komec-saleorder-lister-master menuitem[action=closeCancelAction]'), Const.PERMIT.MODIFY);
		this.joinPermission(workspace.down('module-komec-saleorder-lister-master button[action=etcPrintAction]'),      Const.PERMIT.EXPORT);
	},
	init: function() {
		var me = this;
		me.control({
			'module-komec-saleorder-layout button[action=selectAction]'					: { click : me.selectAction       }, /* 조회 */
			'module-komec-saleorder-layout #mainpanel'									: { tabchange : me.selectAction  },

			'module-komec-saleorder-lister-master menuitem[action=closeActiveAction]'		: { click : me.closeAction        }, /* 마감 */
			'module-komec-saleorder-lister-master menuitem[action=closeCancelAction]'		: { click : me.closeAction        }, /* 마감취소 */
			'module-komec-saleorder-lister-master menuitem[action=okAction]'				: { click : me.okAction           }, /* 승인 */
			'module-komec-saleorder-lister-master menuitem[action=okCancelAction]'		: { click : me.okCancelAction     }, /* 승인취소 */

			'module-komec-saleorder-lister-master menuitem[action=closeAction]'			: { click : me.closeAction        }, /* 마감 */
			'module-komec-saleorder-lister-master menuitem[action=closeCancelAction]'		: { click : me.closeCancelAction  }, /* 마감해지 */
			'module-komec-saleorder-lister-master button[action=copyAction]'				: { click : me.copyAction         }, /* 수주복사 */
			'module-komec-saleorder-lister-master button[action=orderAction]'				: { click : me.orderAction        }, /* 출고지시 */
			'module-komec-saleorder-lister-master button[action=etcPrintAction]'			: { click : me.invReportAction    }, /* 명세서 발행 */
			'module-komec-saleorder-lister-master button[action=insertAction]'			: { click : me.insertAction       }, /* 등록 */
			'module-komec-saleorder-lister-master button[action=modifyAction]'			: { click : me.modifyAction       }, /* 수정 */
			'module-komec-saleorder-lister-master button[action=exportAction]'			: { click : me.exportAction       }, /* 엑셀 */
			'module-komec-saleorder-lister-master button[action=deleteAction]'			: { click : me.deleteAction       }, /* 삭제 */
			'module-komec-saleorder-lister-master button[action=ganttAction]'				: { click : me.ganttAction        }, /* 일정보기 */
			'module-komec-saleorder-lister-master button[action=uploadAction]'			: { click : me.excelUploadAction },
			'module-komec-saleorder-lister-master button[action=pasteUploadAction]'		: { click : me.pasteUploadAction }, /* 엑셀 붙여 넣기 액션 */
			'module-komec-saleorder-lister-master button[action=printAction]'				: { click : me.printAction       }, /* 인수증발행 */
			'module-komec-saleorder-lister-master button[action=printAction2]'			: { click : me.printAction2       }, /* 거래명세서발행 */

			'module-komec-saleorder-lister-detail2 button[action=consultingAction]'		: { click : me.consultingAction},	// 상담입력
			'module-komec-saleorder-lister-detail2 button[action=resultAction]'			: { click : me.resultAction},		// 결과입력

			'module-komec-saleorder-lister-detail2 button[action=test]'					: { click : me.test},		// test

			'module-komec-saleorder-worker-lister button[action=updateAction]'			: { click : me.updateAction }, /* 저장 */
			'module-komec-saleorder-worker-lister button[action=deleteAction]'			: { click : me.deleteAction2 }, /* 디테일삭제 */
			'module-komec-saleorder-worker-lister button[action=cancelAction]'			: { click : me.cancelAction }, /* 취소 */
		});
		me.callParent(arguments);
	},
	pocket : {
		layout : function () { return Ext.ComponentQuery.query('module-komec-saleorder-layout')[0] },
		search : function () { return Ext.ComponentQuery.query('module-komec-saleorder-search')[0] },
		worker : {
			editor : function () { return Ext.ComponentQuery.query('module-komec-saleorder-worker-editor')[0] },
			lister : function () { return Ext.ComponentQuery.query('module-komec-saleorder-worker-lister')[0] }
		},
		lister : {
			master  : function () { return Ext.ComponentQuery.query('module-komec-saleorder-lister-master')[0] },
			detail  : function () { return Ext.ComponentQuery.query('module-komec-saleorder-lister-detail')[0] },
			detail2 : function () { return Ext.ComponentQuery.query('module-komec-saleorder-lister-detail2')[0] }
		},
		popup : function () { return Ext.ComponentQuery.query('module-komec-saleorder-copy-popup')[0] },
		file  : function () { return Ext.ComponentQuery.query('module-komec-saleorder-file')[0] },
		consultingpopup	: function () { return Ext.ComponentQuery.query('module-komec-saleorder-consulting-popup')[0] },
	},
			...
			Ext.Msg.show({ title: '확인', msg: '선택하신 오더를 승인하시겠습니까?', icon: Ext.Msg.QUESTION, buttons: Ext.Msg.YESNO, defaultFocus: 'no', scope: me,
				fn: function (button) {
					if (button=='yes') {
						...
						Ext.each(select, function(record) {
							Ext.Ajax.request({
								url		: _global.location.http() + '/custom/komec/sale/order/saleorder/set/ok.do',
								params	: {
									token : _global.token_id,
									param : JSON.stringify({
										invc_numb		: record.get('invc_numb'),
	...
	updateAction:function() {
		...
		if (editor.down('[name=prod_trst_dvcd]').getValue() != "2000") {
...
//			}
		...
		editor.updateRecord({
			...
			Ext.ComponentQuery.query('module-komec-saleorder-worker-search')[0].getForm().reset();
			}
		});
	},
	...
	copyAction:function() {
		...
		var me = this
		resource.loadPopup({
			widget : 'module-komec-saleorder-copy-popup',
		});
		...
		if(select.length == '0'){
			...
			Ext.Msg.confirm("확인", "출고 하시겠습니까?", function(button) {
				if (button == 'yes') {
					...
					Ext.Ajax.request({
						url			: _global.api_host_info + '/' + _global.app_site + '/custom/komec/sale/order/saleorder/set/stps.do',
						method		: "POST",
						params		: {
							token	: _global.token_id,
							param : JSON.stringify({
	...
	deleteAction:function() {
		...
		Ext.Msg.confirm("확인", "삭제하시겠습니까?", function(button) {
			if (button == 'yes') {
				...
				Ext.Ajax.request({
					url			: _global.api_host_info + '/' + _global.app_site + '/custom/komec/sale/order/saleorder/set/del_yn.do',
					method		: "POST",
					params		: {
					 	token	: _global.token_id,
						param	: Ext.encode({
	...
	excelUploadAction : function () {
		...
		resource.loadPopup({
			...
			apiurl : {
				upload : _global.location.href + '/custom/komec/system/sale/order/saleorder/excel.do', // url (필수)
			},
			params : {
				stor_id	: _global.stor_id,
				table_nm: 'acpt_mast'
	...
	consultingAction:function() {
		...
		Ext.Ajax.request({
			url		: _global.location.http() + '/custom/komec/sale/order/saleorder/get/seqn.do',
			params	: {
				token : _global.token_id,
				param : JSON.stringify({
		...
		var me = this
		resource.loadPopup({
			widget : 'module-komec-saleorder-consulting-popup',
		});
	...
	resultAction:function() {
		...
		var me = this
		resource.loadPopup({
			widget : 'module-komec-saleorder-result-popup',
		});
		var numb = Ext.ComponentQuery.query('#invc_numb')[0].setValue(records[0].data.invc_numb);
	...
	invReportAction:function(button) {
		...
		if(select.length === 1) {
			...
			resource.loadPrint({
				...
				requrl 			: {
					search		: _global.api_host_info + '/' + _global.app_site +'/custom/komec/sale/order/saleorder/get/printing.do',
				},
