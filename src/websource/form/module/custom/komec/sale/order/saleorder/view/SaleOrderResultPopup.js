Ext.define('module.custom.komec.sale.order.saleorder.view.SaleOrderResultPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-komec-saleorder-result-popup',
	...
	finishAction: function(){
		var me = this,
			...
			store	= Ext.ComponentQuery.query('module-komec-saleorder-lister-detail2')[0].getStore(),
			select	= Ext.ComponentQuery.query('module-komec-saleorder-lister-detail2')[0].getSelectionModel().getSelection()[0]
		;
		var mask = new Ext.LoadMask(Ext.getBody(), {msg: Const.UPDATE.mask });
		mask.show();
		Ext.Ajax.request({
			url		: _global.location.http() + '/custom/komec/sale/order/saleorder/set/result.do',
			params	: {
