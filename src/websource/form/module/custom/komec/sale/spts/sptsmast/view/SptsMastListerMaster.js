Ext.define('module.custom.komec.sale.spts.sptsmast.view.SptsMastListerMaster', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-komec-sptsmast-lister-master',

	store		: 'module.custom.komec.sale.spts.sptsmast.store.SptsMastMaster',
