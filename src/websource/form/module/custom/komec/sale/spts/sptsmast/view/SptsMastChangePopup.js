Ext.define('module.custom.komec.sale.spts.sptsmast.view.SptsMastChangePopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-komec-sptsmast-change-popup',
	...
	finishAction: function(){
		var me = this,
			...
			master	= Ext.ComponentQuery.query('module-komec-sptsmast-lister-master2')[0],
...
//		{
		...
		Ext.each(select, function(record) {
			Ext.Ajax.request({
				url		: _global.location.http() + '/custom/komec/sale/spts/sptsmast/set/change.do',
				params	: {
