Ext.define('module.custom.komec.qc.insp.inspentry5.view.InspEntry5Popup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-komec-inspentry5-popup',
					...
					Ext.Ajax.request({
						...
						params	: {
							...
							param : JSON.stringify({
								...
								acpt_numb		: values.acpt_numb,
								acpt_seqn		: values.acpt_seqn,
								spts_numb		: values.invc_numb,
								spts_seqn		: values.line_seqn,
								item_idcd		: values.item_idcd,
								insp_drtr_idcd	: values.insp_drtr_idcd,
								spts_qntt		: values.spts_qntt,
