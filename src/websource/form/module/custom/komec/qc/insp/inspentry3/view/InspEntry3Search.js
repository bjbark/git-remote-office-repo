Ext.define('module.custom.komec.qc.insp.inspentry3.view.InspEntry3Search', { extend: 'Axt.form.Search',

	alias: 'widget.module-komec-inspentry3-search',
