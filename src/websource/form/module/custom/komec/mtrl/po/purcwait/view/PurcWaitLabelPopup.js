Ext.define('module.custom.komec.mtrl.po.purcwait.view.PurcWaitLabelPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-komec-purcwait-label-popup',
	...
	finishAction: function(){
		var me = this,
			...
			master	= Ext.ComponentQuery.query('module-komec-purcwait-lister')[0],
