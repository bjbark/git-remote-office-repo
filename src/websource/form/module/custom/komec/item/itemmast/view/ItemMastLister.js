Ext.define('module.custom.komec.item.itemmast.view.ItemMastLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemmast-lister'			,
	store		: 'module.custom.komec.item.itemmast.store.ItemMast'	,
...
//					},
					'->', '-',
//					{	text : '<span class="write-button">원료성분조회</span>', action : 'popupAction',cls: 'button1-style', width: 90	,itemId : 'print' },
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex:	'drtr_idcd'			, width: 100, align : 'left'	, text: Language.get( 'drtr_idcd'		, '생산담당코드'		) , hidden : true
					},{	dataIndex:	'drtr_name'			, width: 100, align : 'left'	, text: Language.get( 'drtr_name'		, '생산담당이름'		) , hidden : true
					}
				]
			}
		;
