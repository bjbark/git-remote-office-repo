Ext.define('module.custom.komec.item.itemlist.view.ItemListEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-itemlist-editorlister'			,
	store		: 'module.custom.komec.item.itemlist.store.ItemListFile',
