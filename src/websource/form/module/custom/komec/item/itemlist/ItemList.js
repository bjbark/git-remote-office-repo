Ext.define('module.custom.komec.item.itemlist.ItemList', { extend:'Axt.app.Controller',
	...
	models : [
		'module.custom.komec.item.itemlist.model.ItemList',
		'module.custom.komec.item.itemlist.model.ItemListIsos',
		'module.custom.komec.item.itemlist.model.ItemListRett',
		'module.custom.komec.item.itemlist.model.ItemListMemo',
	 	'module.custom.komec.item.itemlist.model.ItemListMngt',
	 	'module.custom.komec.item.itemlist.model.ItemListPkge',
	 	'module.custom.komec.item.itemlist.model.ItemListFile'
	],
	stores : [
		'module.custom.komec.item.itemlist.store.ItemList',
		'module.custom.komec.item.itemlist.store.ItemListIsos',
		'module.custom.komec.item.itemlist.store.ItemListRett',
		'module.custom.komec.item.itemlist.store.ItemListMemo',
	 	'module.custom.komec.item.itemlist.store.ItemListMngt',
	 	'module.custom.komec.item.itemlist.store.ItemListPkge',
	 	'module.custom.komec.item.itemlist.store.ItemListFile'
	],
	views: [
		'module.custom.komec.item.itemlist.view.ItemListLayout',
		'module.custom.komec.item.itemlist.view.ItemListSearch',
		'module.custom.komec.item.itemlist.view.ItemListLister',
		'module.custom.komec.item.itemlist.view.ItemListEditor',
		'module.custom.komec.item.itemlist.view.ItemListEditorLister',
		'module.custom.komec.item.itemlist.view.ItemListIsosLister',
		'module.custom.komec.item.itemlist.view.ItemListMemoLister',
		'module.custom.komec.item.itemlist.view.ItemListMngtLister',
		'module.custom.komec.item.itemlist.view.ItemListPkgeLister',
		'module.custom.komec.item.itemlist.view.ItemListWorkSearch',
		'module.custom.komec.item.itemlist.view.ItemListRettLister'
	],
