Ext.define('module.custom.komec.item.bommast.model.BomMastLister3', { extend:'Axt.data.Model',
	fields: [
		...
		},{	name: 'wkct_idcd'		, type: 'string' // popup용
		},{	name: 'wkct_name'		, type: 'string' // popup용
