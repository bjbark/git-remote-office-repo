Ext.define('module.custom.komec.item.bomlist.view.BomListMtrlLister1', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-komec-bomlist-mtrl-lister1',
	store		: 'module.custom.komec.item.bomlist.store.BomListMtrlLister1',
