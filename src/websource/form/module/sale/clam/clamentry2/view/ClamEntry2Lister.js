Ext.define('module.sale.clam.clamentry2.view.ClamEntry2Lister', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-clamentry2-lister',
	store		: 'module.sale.clam.clamentry2.store.ClamEntry2Lister',
	border		: 0,
	columnLines	: true,
		...
		var  me   = this,
			item = {
				...
				items : [
					...
					'-', '->', '-',
					{	text : '<span class="write-button">원인규명서 발행</span>'	, action : 'printAction'		, cls: 'button1-style' ,width:100,	} , '->',
