Ext.define('module.sale.clam.clamentry1.view.ClamEntry2EditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-clamentry2-editorlister'			,
	store		: 'module.sale.clam.clamentry2.store.ClamEntry2File',
