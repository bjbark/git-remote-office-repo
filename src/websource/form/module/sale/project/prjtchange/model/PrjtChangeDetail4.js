Ext.define('module.sale.project.prjtchange.model.PrjtChangeDetail4',{ extend:'Axt.data.Model',
	fields: [
		...
		{name: 'rply_dttm',				type: 'string' , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr } ,		//회신일시
