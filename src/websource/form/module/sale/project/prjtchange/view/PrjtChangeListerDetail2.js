Ext.define('module.sale.project.prjtchange.view.PrjtChangeListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtchange-lister-detail2',
	store		: 'module.sale.project.prjtchange.store.PrjtChangeDetail2',
