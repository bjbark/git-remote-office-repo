Ext.define('module.sale.project.prjtchange.view.PrjtChangeListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtchange-lister-detail3',
	store		: 'module.sale.project.prjtchange.store.PrjtChangeDetail3',
