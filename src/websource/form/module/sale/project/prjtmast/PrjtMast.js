Ext.define('module.sale.project.prjtmast.PrjtMast', { extend:'Axt.app.Controller',
	...
	models	: [
		'module.sale.project.prjtmast.model.PrjtMastMaster'
	],
	stores	: [
		'module.sale.project.prjtmast.store.PrjtMastMaster'
	],
	views	: [
		'module.sale.project.prjtmast.view.PrjtMastLayout',
		'module.sale.project.prjtmast.view.PrjtMastSearch',
		'module.sale.project.prjtmast.view.PrjtMastListerMaster',
		'module.sale.project.prjtmast.view.PrjtMastEditor'
	],
