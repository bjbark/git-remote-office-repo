Ext.define('module.sale.project.salecolt.view.SaleColtListerPopup', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-salecolt-lister-popup',
	store		: 'module.sale.project.salecolt.store.SaleColtListerPopup',
