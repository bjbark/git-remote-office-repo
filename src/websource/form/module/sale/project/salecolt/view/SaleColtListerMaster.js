Ext.define('module.sale.project.salecolt.view.SaleColtListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-salecolt-lister-master',
	store		: 'module.sale.project.salecolt.store.SaleColtMaster',
	...
	iteminfo : function () {
		var	me			= this
			listermaster  = Ext.ComponentQuery.query('module-salecolt-lister-master')[0],
		...
		if(record){
			...
			var form = Ext.widget('form', {
				...
				items:[
					...
					},{	xtype : 'module-salecolt-lister-popup', region:'center' , flex : 1,
						listeners:{
							afterrender:function(){
								listerpopup = Ext.ComponentQuery.query('module-salecolt-lister-popup')[0] ;   // 렌더 후 진행해야 lister을 찾아올 수 있음
								listerpopup.select({
