Ext.define('module.sale.project.prjtchangelist.view.PrjtChangeListSearch', { extend: 'Axt.form.Search',

	alias: 'widget.module-prjtchangelist-search',
	...
	createLine1 : function(){
		var me = this,
			line = {
				...
				collapsed	: true	,
				items : [
					{	xtype	: 'fieldset', layout: 'hbox' ,padding:'0', border: 0, margin : '5 0 0 30',
						items	: [
							{	fieldLabel	: Language.get('regi_date','변경등록일자'),
								xtype		: 'betweenfield',
								name		: 'regi_date1',
								pair		: 'regi_date2',
								width		: 180,
					...
					},{	xtype : 'fieldset', layout: 'hbox',border : 0 , padding : '0',margin : '2 0 0 30',
						items : [
							{	fieldLabel	: Language.get('deli_date','조정납기일자'),
								xtype		: 'betweenfield',
								name		: 'deli_date1',
								pair		: 'deli_date2',
								width		: 180,
							...
							},{	fieldLabel	: Language.get('apvl_drtr','승인담당'),
								xtype		: 'popupfield',
								editable	: true,
								enableKeyEvents : true,
								name		: 'user_name',
