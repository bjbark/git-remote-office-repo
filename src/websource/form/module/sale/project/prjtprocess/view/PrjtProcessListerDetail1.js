Ext.define('module.sale.project.prjtprocess.view.PrjtProcessListerDetail1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtprocess-lister-detail1',
	store		: 'module.sale.project.prjtprocess.store.PrjtProcessDetail1',
	plugin		: [{ ptype  :'cellediting-directinput', clicksToEdit: 1 } ,{ ptype : 'gridcolumnmenu' },{ ptype: 'gridcolumnconfig'}],
