Ext.define('module.sale.project.salework.view.SaleWorkSearch', { extend: 'Axt.form.Search',
		...
		var	line = {
				...
				items : [
					{	xtype	: 'fieldset', layout: 'hbox' ,padding:'0', border: 0, margin : '5 0 0 0',
						items	: [
							{	fieldLabel	: Language.get('st_dt','납기일자'),
								xtype		: 'betweenfield',
								name		: 'st_dt',
								pair		: 'ed_dt',
								root		: true,
...
//								value		: Ext.Date.add( new Date(), Ext.Date.DAY, -14),
							...
							},{	fieldLabel	: Language.get('modl_name','차종명'),
								xtype		: 'popupfield',
								editable	: true,
								enableKeyEvents : true,
								name		: 'modl_name',
								...
								popup: {
									select : 'SINGLE',
									widget : 'module-salework-modl-popup',
