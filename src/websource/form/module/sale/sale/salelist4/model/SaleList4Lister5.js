Ext.define('module.sale.sale.salelist4.model.SaleList4Lister5', { extend:'Axt.data.Model',
	fields : [
		...
		},{	name: 'dept_name'			, type: 'string'	/* 거래처명		*/
		},{	name: 'user_code'			, type: 'string'	/* 거래처코드	*/
		},{	name: 'user_name'			, type: 'string'	/* 품목명		*/
		},{	name: 'sale_pric'			, type: 'float' 	/* 평균단가		*/
		},{	name: 'sale_qntt'			, type: 'float' 	/* 수량		*/
		},{	name: 'ttsm_amnt'			, type: 'float' 	/* 합계금액		*/
		},{	name: 'ranking'				, type: 'float' ,	//순위
		},{	name: 'rate'				, type: 'float' ,	//점유율
