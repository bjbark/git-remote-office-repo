	...
	columnItem : function () {
		var me = this,
			...
			items : [
				...
				},{	dataIndex: 'ttsm_amnt'	, width: 130, text: Language.get('ttsm_amnt',	'매출액'	), xtype : 'numericcolumn', summaryType: 'sum', align : 'right', format: _global.hq_id.toUpperCase()!='N1000SJUNG'?'#,##0.###':'#,##0.###',
				},{	dataIndex: 'rate'		, width: 100, text: Language.get(''			,	'점유율'	), align : 'right'
				}
			]
		};
		return item;
