Ext.define('module.sale.sale.initbond.view.InitBondSearch.js', { extend: 'Axt.form.Search',
	alias: 'widget.module-initbond-search',
										...
										items : [
											{	fieldLabel	: Language.get('cstm_name','거래처'),
												...
												popup: {
													...
													params : { stor_grp : _global.stor_grp , line_stat : '0',  sale_cstm_yorn : '1', puch_cstm_yorn : '' },
