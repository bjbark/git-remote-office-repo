Ext.define('module.sale.sale.newitemsale.view.NewItemSaleSearch', { extend: 'Axt.form.Search',

	alias: 'widget.module-newitemsale-search',
			...
			line = {
				...
				items			: [
					{	xtype : 'fieldset', layout: 'hbox',
						...
						items : [
							{	fieldLabel	: Language.get('oem_cstm','OEM거래처'),
								xtype		: 'popupfield',
								editable	: true,
								enableKeyEvents : true,
								name		: 'oem_cstm_name',
							...
							},{	name		: 'oem_cstm_idcd', xtype : 'textfield' , hidden : true
