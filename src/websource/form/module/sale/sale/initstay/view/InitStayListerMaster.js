Ext.define('module.sale.sale.initstay.view.InitStayListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-initstay-lister-master',
	store		: 'module.sale.sale.initstay.store.InitStayMaster',
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	xtype: 'rownumberer'  , width:40, text: Language.get(''	, 'No'), align : 'center'
					...
					},{	dataIndex:	'ostt_qntt'		, width:  70, align : 'right'	, text: Language.get('ostt_qntt'	, '수량'		), xtype: 'numericcolumn'
					},{	dataIndex:	'sale_pric'		, width:  80, align : 'right'	, text: Language.get('sale_pric'	, '단가'		), xtype: 'numericcolumn' , format: '#,##0.###'
					},{	dataIndex:	'sale_amnt'		, width: 100, align : 'right'	, text: Language.get('sale_amnt'	, '금액'		), xtype: 'numericcolumn' , format: '#,##0.###'
					},{	dataIndex:	'vatx_amnt'		, width:  90, align : 'right'	, text: Language.get('vatx_amnt'	, '부가세'	), xtype: 'numericcolumn' , format: '#,##0.###'
					},{	dataIndex:	'ttsm_amnt'		, width: 110, align : 'right'	, text: Language.get('ttsm_amnt'	, '합계금액'	), xtype: 'numericcolumn' , format: '#,##0.###'
...
//					},{	dataIndex:	'user_memo'		, flex :   1, align : 'left'	, text: Language.get('user_memo'	, '비고'		)
			...
			sjflv_item = {
					...
					items : [
						...
						},{	dataIndex:	'invc_date'		, width: 85, align : 'center'	, text: Language.get('invc_date'	, '출고일자'	)
						...
						},{	dataIndex:	'lott_numb'		, width: 100, align : 'center'	, text: Language.get('lott_numb'	, 'Batch No')
...
//						},{	dataIndex:	'user_memo'		, flex :   1, align : 'left'	, text: Language.get('user_memo'	, '비고'		)
		...
		return _global.options.mes_system_type.toUpperCase()=='SJFLV'? sjflv_item : item;
	}
});
