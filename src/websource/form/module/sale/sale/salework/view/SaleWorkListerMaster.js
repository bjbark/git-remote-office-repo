Ext.define('module.sale.sale.salework.view.SaleWorkListerMaster', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-salework-lister-master',
	store		: 'module.sale.sale.salework.store.SaleWorkListerMaster',
	border		: 0,
	columnLines	: true,
		...
		var me   = this,
			item =  {
				...
				items   : [
					...
					},{	dataIndex:	''			, width:  60, align : 'center'	, text: Language.get( ''		, '전송여부'	)
					},{	dataIndex:	''			, width:  90, align : 'center'	, text: Language.get( ''		, '전송일자'	)
