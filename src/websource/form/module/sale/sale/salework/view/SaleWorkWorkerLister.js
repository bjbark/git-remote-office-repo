Ext.define('module.sale.sale.salework.view.SaleWorkWorkerLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-salework-worker-lister',
	store		: 'module.sale.sale.salework.store.SaleWorkWorkerLister',
			...
			item = {
				...
				items : [
					{	dataIndex:	'chk'			, width:  35, align : 'center'	, text: Language.get('chk'	, '선택'		), xtype:'checkcolumn',
						},{	dataIndex:	''			, width: 90, align : 'left'		, text: Language.get( ''	, '출고일자'	)
						},{	dataIndex:	''			, width: 40, align : 'center'	, text: Language.get( ''	, '항번'		)
						...
						},{	dataIndex:	''			, width:  60, align : 'right'	, text: Language.get( ''	, '단위'		)
						},{	dataIndex:	''			, width:  90, align : 'right'	, text: Language.get( ''	, '출고수량'	)
						},{	dataIndex:	''			, width:  90, align : 'right'	, text: Language.get( ''	, '발행수량'	)
						},{	dataIndex:	''			, width:  90, align : 'right'	, text: Language.get( ''	, '대기수량'	)
						},{	dataIndex:	''			, width:  90, align : 'right'	, text: Language.get( ''	, '발행할 수량'	)
