Ext.define('module.sale.order.estimast.view.EstiMastWorkerLister', { extend: 'Axt.grid.Panel',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex:	'deli_date2'	, width: 120, align : 'center'	, text: Language.get('deli_date2'	, '납기일자'	),
						tdCls	: 'editingcolumn',
						editor	: {
							xtype		:'datefield',
