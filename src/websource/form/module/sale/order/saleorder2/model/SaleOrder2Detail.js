Ext.define('module.sale.order.saleorder2.model.SaleOrder2Detail', { extend: 'Axt.data.Model',
	fields: [
		...
		},{	name: 'cstm_deli_date'		, type: 'string', convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr,		//(협력사)납기일자
