Ext.define('module.sale.order.saleorder3.view.SaleOrder3File', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-saleorder3-file'			,
	store		: 'module.sale.order.saleorder3.store.SaleOrder3File',
