Ext.define('module.sale.order.slorlist1.view.SlorList1ListerDetail', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-slorlist1-lister-detail',
	store		: 'module.sale.order.slorlist1.store.SlorList1Detail',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'invc_qntt'		, text : Language.get('invc_qntt'		,'주문수량'		) , width :  80 , xtype : 'numericcolumn', align : 'right', summaryType: 'sum', format: _global.hq_id.toUpperCase()!='N1000SJUNG'?'#,##0.##':'#,##0.###',
					},{ dataIndex: 'ostt_qntt'		, text : Language.get('ostt_qntt'		,'출고수량'		) , width :  80 , xtype : 'numericcolumn', align : 'right', summaryType: 'sum', format: _global.hq_id.toUpperCase()!='N1000SJUNG'?'#,##0.##':'#,##0.###',
