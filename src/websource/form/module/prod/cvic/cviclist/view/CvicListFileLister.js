Ext.define('module.prod.cvic.cviclist.view.CvicListFileLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-cviclist-filelist',
	store		: 'module.prod.cvic.cviclist.store.CvicListFile',
	border		: 0,
	columnLines : true,
