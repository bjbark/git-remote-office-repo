Ext.define('module.prod.cvic.cvicanal.view.CvicAnalChart11', { extend: 'Axt.form.Panel',
	alias		: 'widget.module-cvicanal-chart1',
	store		: 'module.prod.cvic.cvicanal.store.CvicChart1',
	...
	drawChart:function() {
		var store = Ext.getStore('module.prod.cvic.cvicanal.store.CvicChart1');
