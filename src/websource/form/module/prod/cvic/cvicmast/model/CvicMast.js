Ext.define('module.prod.cvic.cvicmast.model.CvicMast', { extend:'Axt.data.Model',
	fields: [
		...
		{	name: 'used_year'			, type: 'float'  },		//사용년한
		...
		{	name: 'mngt_drtr_name'		, type: 'string' },		//관리담당자이름
		{	name: 'mngt_drtr_idcd'		, type: 'string' },		//담당자ID
		...
		{	name: 'clss_desc'			, type: 'string' },		//설비분류기준
		{	name: 'cvic_stnm'			, type: 'string' },		//설비약칭

//		{	name: 'lcls_name'			, type: 'string' },		//분류명
//		{	name: 'mcls_name'			, type: 'string' },		//분류명
//		{	name: 'scls_name'			, type: 'string' },		//분류명
