Ext.define('module.prod.cvic.cvicmast.view.CvicMastEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-cvicmast-editorlister'			,
	store		: 'module.prod.cvic.cvicmast.store.CvicMastFile',
	border		: 0,
	columnLines : true,
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-cvicmast-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'cvic_mast';											// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{	dataIndex: 'assi_seqn'		, text : Language.get('line_seqn'		,'순번'	)		, width : 80 , align : 'center'
