Ext.define('module.prod.basic.bopwork.view.BopWorkListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-bopwork-lister-master',
	store		: 'module.prod.basic.bopwork.store.BopWorkMaster',
