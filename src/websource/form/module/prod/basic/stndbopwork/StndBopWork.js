Ext.define('module.prod.basic.stndbopwork.StndBopWork', { extend:'Axt.app.Controller',
	...
	models	: [
		'module.prod.basic.stndbopwork.model.StndBopWorkMaster',
		'module.prod.basic.stndbopwork.model.StndBopWorkDetail3',
		'module.prod.basic.stndbopwork.model.StndBopWorkTree'
	],
	stores	: [
		'module.prod.basic.stndbopwork.store.StndBopWorkMaster',
		'module.prod.basic.stndbopwork.store.StndBopWorkDetail3',
		'module.prod.basic.stndbopwork.store.StndBopWorkTree'
	],
	views	: [
		'module.prod.basic.stndbopwork.view.StndBopWorkLayout',
		'module.prod.basic.stndbopwork.view.StndBopWorkSearch',
		'module.prod.basic.stndbopwork.view.StndBopWorkListerMaster',
		'module.prod.basic.stndbopwork.view.StndBopWorkTree',
		'module.prod.basic.stndbopwork.view.StndBopWorkListerDetail3',
		'module.prod.basic.stndbopwork.view.StndBopWorkFinder',
	],
	...
	init: function() {
		...
		me.control({
			// layout event
			'module-stndbopwork-layout button[action=selectAction]'			: { click : me.selectAction },	// 조회
			// lister detail event
			'module-stndbopwork-tree button[action=modifyAction]'	: { click : me.modifyAction },	// 수정
			'module-stndbopwork-tree button[action=insertAction]'	: { click : me.insertAction },	// 신규
			'module-stndbopwork-tree button[action=exportAction]'	: { click : me.exportAction },	// 엑셀
			'module-stndbopwork-tree button[action=deleteAction]'	: { click : me.deleteAction },	// 삭제
			'module-stndbopwork-tree button[action=changeAction]'	: { click : me.changeAction1}, /* 설계일정 조정   */
			'module-stndbopwork-tree button[action=copyAction]'		: { click : me.copyAction   }, /* 설계일정 조정   */
			'module-stndbopwork-tree button[action=bopInsert]'		: { click : me.bopInsert    }, /* BOP작성   */
			'module-stndbopwork-tree button[action=testExcel]'		: { click : me.testExcel    }, /* testExcel   */
			'module-stndbopwork-tree button[action=approveAction]'	: { click : me.approveAction}, /* 승인   */
			'module-stndbopwork-tree button[action=approveCancel]'	: { click : me.approveCancel}, /* 승인취소   */
			// editer event
			'module-stndbopwork-tree button[action=updateAction]'	: { click : me.updateAction },	// 저장
			'module-stndbopwork-tree button[action=bopCopy]'		: { click : me.bopCopy      },	// 작업일정작성
			'module-stndbopwork-editor button[action=cancelAction]' : { click : me.cancelAction },	// 취소
			// lister master event
			'module-stndbopwork-lister-master' : {
	...
	pocket : {
		layout		: function () { return Ext.ComponentQuery.query('module-stndbopwork-layout')[0] },
		search		: function () { return Ext.ComponentQuery.query('module-stndbopwork-search')[0] },
		listermaster: function () { return Ext.ComponentQuery.query('module-stndbopwork-lister-master')[0] },
		listertree	: function () { return Ext.ComponentQuery.query('module-stndbopwork-tree')[0] },
		listerdetail3: function () { return Ext.ComponentQuery.query('module-stndbopwork-lister-detail3')[0] },
		editor		: function () { return Ext.ComponentQuery.query('module-stndbopwork-editor')[0] },
		finder		: function () { return Ext.ComponentQuery.query('module-stndbopwork-finder')[0] }
	},
