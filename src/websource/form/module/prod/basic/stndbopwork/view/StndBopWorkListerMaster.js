Ext.define('module.prod.basic.stndbopwork.view.StndBopWorkListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-stndbopwork-lister-master',
	store		: 'module.prod.basic.stndbopwork.store.StndBopWorkMaster',
