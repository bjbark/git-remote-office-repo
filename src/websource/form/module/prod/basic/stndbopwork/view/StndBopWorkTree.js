Ext.define('module.prod.basic.stndbopwork.view.StndBopWorkTree', { extend: 'Ext.tree.Panel',
	alias		: 'widget.module-stndbopwork-tree',
	store		: 'module.prod.basic.stndbopwork.store.StndBopWorkTree',
	border	: 0  ,
