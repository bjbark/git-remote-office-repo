Ext.define('module.prod.basic.wkctmast.view.WkctMastOtodLister', { extend     : 'Axt.grid.Panel',
	alias		: 'widget.module-wkctmast-otod-lister',
	store		: 'module.prod.basic.wkctmast.store.WkctMastOtod',
	border		: 0,
	columnLines	: true,
		...
		var me   = this,
			item =  {
				...
				items   : [
					...
					},{	dataIndex:	''				, width: 170, align : 'left'     , text: Language.get( ''	, '외주처'		),
					},{	xtype	: 'actioncolumn',
						header	: '',
						width	: 20,
						align	: 'center',
					...
					},{	dataIndex:	''				, width: 100, align : 'right'    , text: Language.get( ''	, '외주단가'	),
					...
					},{	dataIndex:	''				, width: 110, align : 'left'     , text: Language.get( ''	, '적용일자'	),
						editor	: {
							xtype	: 'datefield',
							selectOnFocus	: true,
							allowBlank		: true
						}
					},{	dataIndex:	''				, width: 100, align : 'left'     , text: Language.get( ''	, '이전단가'	),
						editor	: {
							selectOnFocus	: true,
							allowBlank		: true
						}
					},{	dataIndex:	''				, width: 110, align : 'left'     , text: Language.get( ''	, '변경일자'	),
						editor	: {
							xtype	: 'datefield',
							selectOnFocus	: true,
							allowBlank		: true
						}
					},{	dataIndex:	''				, width: 164, align : 'left'     , text: Language.get( ''	, '비고'		),
						editor	: {
							selectOnFocus	: true,
							allowBlank		: true
						}
