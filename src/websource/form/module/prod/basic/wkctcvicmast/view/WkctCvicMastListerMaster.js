Ext.define('module.prod.basic.wkctcvicmast.view.WkctCvicMastListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-wkctcvicmast-lister-master',
	store		: 'module.prod.basic.wkctcvicmast.store.WkctCvicMast',
