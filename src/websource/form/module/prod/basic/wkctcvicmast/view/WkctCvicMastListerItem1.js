Ext.define('module.prod.basic.wkctcvicmast.view.WkctCvicMastListerItem1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-wkctcvicmast-lister-item1',
	store		: 'module.prod.basic.wkctcvicmast.store.WkctCvicMastItem1',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'cvic_code'		, text : Language.get('cvic_code'		,'설비코드') , flex  :1    , minWidth : 130  , align : 'center'
					...
					},{ dataIndex: 'puch_date'		, text : Language.get('puch_date'		,'구매일자') , flex  : 100 , minWidth:80, align : 'center'					}
				]
			}
		;
		return item;
