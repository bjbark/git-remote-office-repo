Ext.define('module.prod.plan.rsvdorder.RsvdOrder', { extend : 'Axt.app.Controller',
	...
	requires:[
		...
		'module.prod.plan.rsvdorder.view.RsvdOrderProdPopup',
		'module.prod.plan.rsvdorder.view.RsvdOrderCopyPopup'
	],

	models:[
		'module.prod.plan.rsvdorder.model.RsvdOrderInvoice',
		'module.prod.plan.rsvdorder.model.RsvdOrderMaster',
		'module.prod.plan.rsvdorder.model.RsvdOrderDetail'
	],
	stores:[
		'module.prod.plan.rsvdorder.store.RsvdOrderInvoice',
		'module.prod.plan.rsvdorder.store.RsvdOrderMaster',
		'module.prod.plan.rsvdorder.store.RsvdOrderDetail'
	],
	views : [
		'module.prod.plan.rsvdorder.view.RsvdOrderLayout',
		/* 현황 */
		'module.prod.plan.rsvdorder.view.RsvdOrderSearch',
		'module.prod.plan.rsvdorder.view.RsvdOrderListerMaster',
		'module.prod.plan.rsvdorder.view.RsvdOrderListerDetail',
		/* 작업 */
		'module.prod.plan.rsvdorder.view.RsvdOrderWorkerEditor',
		'module.prod.plan.rsvdorder.view.RsvdOrderWorkerSearch',
		'module.prod.plan.rsvdorder.view.RsvdOrderWorkerLister',
		'module.prod.plan.rsvdorder.view.RsvdOrderCopyPopup'
	],
	...
	init: function() {
		...
		me.control({
			...
			'module-rsvdorder-lister-master menuitem[action=closeActiveAction]'		: { click : me.closeAction		}, /* 마감		*/
			'module-rsvdorder-lister-master menuitem[action=closeCancelAction]'		: { click : me.closeAction		}, /* 마감취소	*/
			...
			'module-rsvdorder-lister-master button[action=insertAction]'			: { click : me.insertAction		}, /* 등록		*/
			'module-rsvdorder-lister-master button[action=modifyAction]'			: { click : me.modifyAction		}, /* 수정		*/
			'module-rsvdorder-lister-master button[action=exportAction]'			: { click : me.exportAction		}, /* 엑셀		*/
			'module-rsvdorder-lister-master button[action=deleteAction]'			: { click : me.deleteAction		}, /* 삭제		*/
			'module-rsvdorder-lister-detail button[action=exportAction]'			: { click : me.exportDetailAction}, /* 엑셀		*/
			'module-rsvdorder-lister-detail button[action=prorAction]'				: { click : me.prorAction		}, /* 생산지시	*/
