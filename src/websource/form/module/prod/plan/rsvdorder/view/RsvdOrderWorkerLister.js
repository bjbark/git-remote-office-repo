Ext.define('module.prod.plan.rsvdorder.view.RsvdOrderWorkerLister', { extend: 'Axt.grid.Panel',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex:	'deli_date'	, width: 120, align : 'center'	, text: Language.get('deli_date', '납기일자'	),
						tdCls : 'editingcolumn',
						editor	: {
							xtype		:'datefield',
							selectOnFocus: true,
					...
					},{	dataIndex:	'cstm_lott_numb', width: 130, align : 'center', text: Language.get('cstm_lott_numb', 'LOT번호')
						, tdCls : 'editingcolumn',
						editor	: {
							xtype		:'textfield',
							selectOnFocus: true,
