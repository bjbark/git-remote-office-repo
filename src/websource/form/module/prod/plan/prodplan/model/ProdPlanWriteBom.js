Ext.define('module.prod.plan.prodplan.model.ProdPlanWriteBom', { extend:'Axt.data.Model',
	fields : [
		...
		},{	name : 'plan_sttm1'			, type : 'string' , convert : Ext.util.Format.strToDate8			//시작시간
		},{	name : 'plan_sttm2'			, type : 'string' , convert : Ext.util.Format.strToTime4 			//시작시간
		},{	name : 'plan_sttm3'			, type : 'string' 		//시작시간
		},{	name : 'plan_sttm4'			, type : 'string' 		//시작시간
		},{	name : 'work_strt_dttm'		, type : 'string'		//시작시간
		},{	name : 'plan_edtm1'			, type : 'string' , serialize: Ext.util.Format.dateToStr		//완료시간
