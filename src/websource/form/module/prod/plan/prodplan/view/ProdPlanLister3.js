Ext.define('module.prod.plan.prodplan.view.ProdPlanLister3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prodplan-lister3',
	store		: 'module.prod.plan.prodplan.store.ProdPlan3',
	border		: 0 ,
	columnLines : true ,
		...
		var me = this,
			item = {
				...
				items : [
					...
					{	text: Const.UPDATE.text , iconCls: Const.UPDATE.icon , action : Const.UPDATE.action ,cls: 'button-style',hidden   : !_global.auth.auth_prod_1001 },
