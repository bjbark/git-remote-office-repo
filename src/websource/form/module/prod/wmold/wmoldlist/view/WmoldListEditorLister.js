Ext.define('module.prod.wmold.wmoldlist.view.WmoldListEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-wmoldlist-editorlister'			,
	store		: 'module.prod.wmold.wmoldlist.store.WmoldListFile',
	border		: 0,
	columnLines : true,
				...
				fbar	: [
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							params : { stor_grp : _global.stor_grp , row_sts : '0' ,invc_numb : '' , orgn_dvcd : '' },
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-wmoldlist-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
