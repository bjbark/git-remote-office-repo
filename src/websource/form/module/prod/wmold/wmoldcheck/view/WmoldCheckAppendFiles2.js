Ext.define('module.prod.wmold.wmoldcheck.view.WmoldCheckAppendFiles2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-wmoldcheck-file2'			,
	store		: 'module.prod.wmold.wmoldcheck.store.WmoldCheckFile2',
	border		: 0,
	columnLines : true,
				...
				fbar	: [
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							params : { stor_grp : _global.stor_grp , row_sts : '0' ,invc_numb : '' , orgn_dvcd : '', line_seqn : '' },
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-moldcheck-file2')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'moldcheck2';											// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
