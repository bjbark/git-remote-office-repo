Ext.define('module.prod.wmold.wmoldcheck.view.WmoldCheckAppendFiles1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-wmoldcheck-file1'			,
	store		: 'module.prod.mold.moldcheck.store.WmoldCheckFile1',
	border		: 0,
	columnLines : true,
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-moldcheck-file1')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'moldcheck1';											// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
