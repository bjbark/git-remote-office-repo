Ext.define('module.prod.wmold.wmoldmast.view.WmoldMastLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-wmoldmast-lister'			,
	selModel	: { selType: 'checkboxmodel', mode : 'SINGLE' },
	store		: 'module.prod.wmold.wmoldmast.store.WmoldMast',
	border		: 0,
	columnLines : true,
	...
	pagingItem : function () {
		var me = this,
			item = {
				...
				items	: [
					'->', '-' ,
					{text : '<span class="write-button">이력카드</span>', action : 'historyAction', cls: 'button1-style' , hidden : true   }, '-',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'used_tons'		, text : Language.get('used_tons'		,'사출기(TON)'	) , width : 90  , xtype : 'numericcolumn',align : 'right', hidden : true
