Ext.define('module.prod.wmold.wmoldmast.view.WmoldMastEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-wmoldmast-editorlister'			,
	store		: 'module.prod.wmold.wmoldmast.store.WmoldMastFile',
	border		: 0,
	columnLines : true,
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-wmoldmast-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'mold_mast';											// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
