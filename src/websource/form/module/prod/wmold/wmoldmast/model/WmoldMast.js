Ext.define('module.prod.wmold.wmoldmast.model.WmoldMast', { extend:'Axt.data.Model',
	fields: [
		...
		{	name: 'imge_chek3'			, type: 'string' },		//생성UI
		{	name: 'imge_chek4'			, type: 'string' },		//생성UI
		{	name: 'imge_chek5'			, type: 'string' },		//생성UI
