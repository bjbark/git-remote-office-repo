Ext.define('module.prod.wmold.wmoldmast.WmoldMast', { extend:'Axt.app.Controller',
...
//		'lookup.popup.view.MakePopup',
	...
	models:[
		'module.prod.wmold.wmoldmast.model.WmoldMast',
		'module.prod.wmold.wmoldmast.model.WmoldMastFile',
		'module.prod.wmold.wmoldmast.model.WmoldMastMove',
		'module.prod.wmold.wmoldmast.model.WmoldMastInvoice',
	],
	stores:[
		'module.prod.wmold.wmoldmast.store.WmoldMast',
		'module.prod.wmold.wmoldmast.store.WmoldMastFile',
		'module.prod.wmold.wmoldmast.store.WmoldMastMove',
		'module.prod.wmold.wmoldmast.store.WmoldMastInvoice',
	],
	views:
	[
		'module.prod.wmold.wmoldmast.view.WmoldMastLayout',
		'module.prod.wmold.wmoldmast.view.WmoldMastSearch',
		'module.prod.wmold.wmoldmast.view.WmoldMastLister',
		'module.prod.wmold.wmoldmast.view.WmoldMastEditor',
		'module.prod.wmold.wmoldmast.view.WmoldMastEditorLister',
		'module.prod.wmold.wmoldmast.view.WmoldMastMoveLister',
		'module.prod.wmold.wmoldmast.view.WmoldMastMoveSearch',
	],
	...
	init: function() {
		...
		me.control({
			// layout event
			'module-wmoldmast-layout button[action=selectAction]' : { click : me.selectAction },	// 조회
			// editer event
			'module-wmoldmast-editor button[action=updateAction]' : { click : me.updateAction },	// 저장
			'module-wmoldmast-editor button[action=cancelAction]' : { click : me.cancelAction },	// 취소
			// lister event
			'module-wmoldmast-lister button[action=modifyAction]' : { click : me.modifyAction },	// 수정
			'module-wmoldmast-lister button[action=test]' : { click : me.test },	// 수정
			'module-wmoldmast-lister button[action=insertAction]' : { click : me.insertAction },	// 신규
			'module-wmoldmast-lister button[action=exportAction]' : { click : me.exportAction },	// 엑셀
			'module-wmoldmast-lister button[action=deleteAction]' : { click : me.deleteAction },	// 삭제
			'module-wmoldmast-lister button[action=historyAction]': { click : me.historyAction },	// 이력카드
			// lister event
			'module-wmoldmast-lister' : {
	...
	pocket :
		{
		layout : function () { return Ext.ComponentQuery.query('module-wmoldmast-layout')[0] },
		search : function () { return Ext.ComponentQuery.query('module-wmoldmast-search')[0] },
		lister : function () { return Ext.ComponentQuery.query('module-wmoldmast-lister')[0] },
		editor : function () { return Ext.ComponentQuery.query('module-wmoldmast-editor')[0] },
		filelister : function () { return Ext.ComponentQuery.query('module-wmoldmast-editorlister')[0] },
		upload : function () { return Ext.ComponentQuery.query('module-wmoldmast-upload')[0] },
		movelister : function () { return Ext.ComponentQuery.query('module-wmoldmast-movelister')[0] },
		},
	...
	selectAction:function()
		...
		;
			...
			}, Ext.merge( param, {stor_id : _global.stor_id, hqof_idcd : _global.hqof_idcd}) );
	},
	test:function(){
		Ext.Ajax.request({
	...
	modifyAction:function() {
		...
		if(mrecord){
			editor.modifyRecord({
				caller	: me,
				action	: 'invoice',
				params	: {param:JSON.stringify({ mold_idcd : mrecord.get('mold_idcd'), hqof_idcd : _global.hqof_idcd})},
				lister	: movelister,
				callback: function( results ) {
					if (results.success){
						results.feedback( {success : true } );
			...
			callback : function (keygen){
				if (keygen.success){
					editor.insertRecord({
						caller		: me,
						action		: 'invoice',
						record		: Ext.create( 'module.prod.wmold.wmoldmast.model.WmoldMastInvoice',{
	...
	updateAction:function() {
		...
		editor.updateRecord({
			...
			callback : function(results, record, store ) {
				...
				Ext.ComponentQuery.query('module-wmoldmast-movesearch')[0].getForm().reset();
