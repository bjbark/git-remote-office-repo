Ext.define('module.prod.mold.moldlist.view.MoldListEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-moldlist-editorlister'			,
	store		: 'module.prod.mold.moldlist.store.MoldListFile',
	border		: 0,
	columnLines : true,
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-moldlist-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
