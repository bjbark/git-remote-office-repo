Ext.define('module.prod.mold.moldlist.view.MoldListShotLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-moldlist-shot-lister',
	store		: 'module.prod.mold.moldlist.store.MoldListShot',
