Ext.define('module.prod.mold.moldmast.view.MoldMastEditor', { extend: 'Axt.form.Editor',

	alias: 'widget.module-moldmast-editor',
	height : 480,
	layout : {
	type: 'border'
	},
	...
	collapsed		: true	,
	getStore: function() {
		return Ext.getStore( 'module.prod.mold.moldmast.store.MoldMastInvoice' );
	},
	...
	createTabs : function () {
		var me = this,
			item = {
				...
				margin	: 0,
				plain	: true,
				items	: [ me.createTab1(), me.createTab2(),{title : '첨부파일',xtype: 'module-moldmast-editorlister'},{title : '이동정보',xtype: 'module-moldmast-movelister'},me.createTab3()]
			}
		;
		return item;
	},
