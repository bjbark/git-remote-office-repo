Ext.define('module.prod.mold.moldmast.view.MoldMastLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-moldmast-lister'			,
	selModel	: { selType: 'checkboxmodel', mode : 'SINGLE' },
	store		: 'module.prod.mold.moldmast.store.MoldMast',
	border		: 0,
	columnLines : true,
	...
	pagingItem : function () {
		var me = this,
			item = {
				...
				items	: [
					'->', '-' ,
					{text : '<span class="write-button">이력카드</span>', action : 'historyAction', cls: 'button1-style'   }, '-',
					{text : 'test', iconCls: Const.INSERT.icon, action : 'test', cls: 'button-style', hidden : true } ,
	...
	columnItem : function () {
		var me = this,
			item = {
				...
				items : [
					{ dataIndex: 'mold_code'		, text : Language.get('acpt_numb'		,'금형코드'		) , width : 90  , align : 'center'
					},{ dataIndex: 'mold_name'		, text : Language.get('acpt_case_name'	,'금형명'		) , width : 170 , align : 'left'
					...
					},{ dataIndex: 'used_tons'		, text : Language.get('used_tons'		,'사출기(TON)'	) , width : 90  , xtype : 'numericcolumn',align : 'right'
					},{ dataIndex: 'mold_spec'		, text : Language.get('mold_spec'		,'금형규격'		) , width : 130 , align : 'left',
					...
					},{ dataIndex: 'user_memo'		, text : Language.get('user_memo'		,'금형상태'		) , width : 150 , align : 'left'
					}
				]
			}
		;
