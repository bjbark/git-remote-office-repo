Ext.define('module.prod.mold.moldcheck.view.MoldCheckAppendFiles1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-moldcheck-file1'			,
	store		: 'module.prod.mold.moldcheck.store.MoldCheckFile1',
	border		: 0,
	columnLines : true,
