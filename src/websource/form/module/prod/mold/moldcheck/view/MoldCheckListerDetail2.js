Ext.define('module.prod.mold.moldcheck.view.MoldCheckListerDetail2', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-moldcheck-lister-detail2',
	store		: 'module.prod.mold.moldcheck.store.MoldCheckDetail2',
