Ext.define('module.prod.jig.jiglist.view.JigListEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-jiglist-editorlister'			,
	store		: 'module.prod.jig.jiglist.store.JigListFile',
	border		: 0,
	columnLines : true,
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-jiglist-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
