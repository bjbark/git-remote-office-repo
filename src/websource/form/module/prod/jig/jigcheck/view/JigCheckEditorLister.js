Ext.define('module.prod.jig.jigcheck.view.JigCheckEditorLister', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-jigcheck-editorlister'			,
	store		: 'module.prod.jig.jigcheck.store.JigCheckFile',
	border		: 0,
	columnLines : true,
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-jigcheck-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'jigg_chck';											// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
