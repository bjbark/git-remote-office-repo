Ext.define('module.prod.jig.jigmast.view.JigMastEditorLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-jigmast-editorlister'			,
	store		: 'module.prod.jig.jigmast.store.JigMastFile',
	border		: 0,
	columnLines : true,
					...
					{	fieldLabel	: Language.get('file_name','파일첨부'),					// temp
						...
						popup: {
							...
							result : function(records, nameField, pairField) {
								var store = Ext.ComponentQuery.query('module-jigmast-editorlister')[0].getStore();
								store.reload();
							}
						},listeners:{
							render:function(){
								this.popup.params.orgn_dvcd = 'jigg_mast';											// table name이 필요하다
							}
						},
					},{	xtype:'button',
						text :'삭제',
