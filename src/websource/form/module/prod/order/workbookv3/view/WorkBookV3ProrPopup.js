Ext.define('module.prod.order.workbookv3.view.WorkBookV3ProrPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-workbookv3-pror-popup',
	alias	: 'widget.lookup-workbookv3-pror-popup',
	store	: 'module.prod.order.workbookv3.store.WorkBookV3ProrPopup',
