Ext.define('module.prod.order.workbookv3.view.WorkBookV3WkctPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-workbookv3-wkct-popup',
	alias	: 'widget.lookup-workbookv3-wkct-popup',
	store	: 'module.prod.order.workbookv3.store.WorkBookV3WkctPopup',
