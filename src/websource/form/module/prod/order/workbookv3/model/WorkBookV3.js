Ext.define('module.prod.order.workbookv3.model.WorkBookV3',{ extend:'Axt.data.Model',
	fields: [
		{	name: 'invc_numb'				, type: 'string'},		//invoice번호
		{	name: 'work_numb'				, type: 'string'},		//일지번호
		...
		{	name: 'work_strt_dttm'			, type: 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.datetimeToStr},		//예정시작시간
		{	name: 'work_endd_dttm'			, type: 'string' , convert : Ext.util.Format.strToDateTime, serialize: Ext.util.Format.datetimeToStr},		//예정종료시간
		...
		{name: 'pitch'						, type: 'float'  },		//Pitch
		{name: 'lead_angl'					, type: 'string' },		//리드각
		{name: 'h_valu'						, type: 'float'  },		//h
		{name: 'a_valu'						, type: 'float'  },		//a
		{name: 'b_valu'						, type: 'float'  },		//b
		{name: 'tick_valu'					, type: 'float'  },		//T
		{name: 'widh_valu'					, type: 'float'  },		//W
		{name: 'val'						, type: 'string' },
		{name: 'long_valu'					, type: 'float' },
		{name: 'make_name'					, type: 'string' },		//경도
