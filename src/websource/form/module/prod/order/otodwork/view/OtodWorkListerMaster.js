Ext.define('module.prod.order.otodwork.view.OtodWorkListerMaster', { extend: 'Axt.grid.Panel',

	alias		: 'widget.module-otodwork-lister-master',

	store		: 'module.prod.order.otodwork.store.OtodWorkMaster',
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{	dataIndex: 'offr_qntt'		, width:  80, align : 'right'	, text: Language.get( 'offr_qntt'		, '합계수량'	), xtype: 'numericcolumn' , summaryType: 'sum' , format: '#,##0'
