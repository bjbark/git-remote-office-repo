Ext.define('module.prod.order.workbookv4.view.WorkBookV4FailLister', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workbookv4-fail'			,
	selModel	: { selType: 'checkboxmodel', mode : 'MULTI' },
	store		: 'module.prod.order.workbookv4.store.WorkBookV4FailLister',
	border		: 0,
	...
	listeners:{
		afterrender:function(){
			var store = Ext.ComponentQuery.query('module-workbookv4-fail')[0].getStore(),
