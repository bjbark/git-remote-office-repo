Ext.define('module.prod.order.workbookv4.view.WorkBookV4ProrPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-workbookv4-pror-popup',
	alias	: 'widget.lookup-workbookv4-pror-popup',
	store	: 'module.prod.order.workbookv4.store.WorkBookV4ProrPopup',
