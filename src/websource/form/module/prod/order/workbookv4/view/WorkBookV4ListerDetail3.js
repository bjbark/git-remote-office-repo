Ext.define('module.prod.order.workbookv4.view.WorkBookV4ListerDetail3', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workbookv4-detail3'			,
	...
	initComponent: function () {
		var me = this;
		me.dockedItems = [{xtype: 'module-workbookv4-detailSearch'}];
		...
		var me = this,
			item = {
				...
				items : [
					...
					},{ dataIndex: 'cvic_name'		, text : Language.get(''			,'설비'		) , width	: 75	, align : 'center',	sortable	: false
					...
					},{ dataIndex: 'dayn_dvcd'		, text : Language.get(''			,'주/야'		) , width	: 50	, xtype : 'lookupcolumn', lookupValue : resource.lookup('dayn_dvcd'), align : 'center',	sortable	: false
					...
					},{ dataIndex: 'work_endd_dttm'	, text : Language.get(''			,'종료(정지)일시'	) , width	: 110	, align : 'center',	sortable	: false
					},{ dataIndex: 'lott_numb'		, text : Language.get(''			,'LOT번호'	) , width	: 100,	sortable	: false
					},{ dataIndex: 'mold_code'		, text : Language.get(''			,'금형코드'	) , width	: 80,	sortable	: false,align:'center'
					},{ dataIndex: 'pckg_cotr_name'	, text : Language.get(''			,'포장용기'	) , width	: 100,	sortable	: false
					...
					},{ dataIndex: 'prod_qntt'		, text : Language.get(''			,'생산수량'	) , width	: 95	, xtype:'numericcolumn',	sortable	: false
