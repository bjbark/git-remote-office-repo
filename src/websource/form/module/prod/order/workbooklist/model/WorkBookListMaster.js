Ext.define('module.prod.order.workbooklist.model.WorkBookListMaster', { extend: 'Axt.data.Model',
	fields : [
		...
		{name: 'acpt_remk_text'			, type: 'string' },		//후공정부서및거래처
		{name: 'deli_date'				, type: 'string'  , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr},		//협력사납기일자
		{name: 'updt_date'				, type: 'string'  , convert : Ext.util.Format.strToDate, serialize: Ext.util.Format.dateToStr},		//최종변경일자
