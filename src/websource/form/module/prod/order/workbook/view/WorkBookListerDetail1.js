Ext.define('module.prod.order.workbook.view.WorkBookListerDetail1', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workbook-lister-detail1',
	store		: 'module.prod.order.workbook.store.WorkBookDetail1',
