Ext.define('module.prod.order.workbook.view.WorkBookListerDetail5', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-workbook-lister-detail5',
	store		: 'module.prod.order.workbook.store.WorkBookDetail5',
