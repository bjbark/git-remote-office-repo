Ext.define('module.prod.order.prodorderlist.view.ProdOrderListLabelPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-prodorderlist-label-popup',
...
//			a+= '{\'invc_numb\':\''+record[i].get('invc_numb')+'\',\'line_seqn\':'+ record[i].get('line_seqn')+'}';
		...
		Ext.Ajax.request({
			url		: _global.location.http() + '/prod/order/prodorderlist/get/report_kind.do',
			params	: {
