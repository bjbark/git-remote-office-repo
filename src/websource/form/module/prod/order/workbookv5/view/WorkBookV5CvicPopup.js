Ext.define('module.prod.order.workbookv5.view.WorkBookV5CvicPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-workbookv5-cvic-popup',
	alias	: 'widget.lookup-workbookv5-cvic-popup',
	store	: 'module.prod.order.workbookv5.store.WorkBookV5CvicPopup',
