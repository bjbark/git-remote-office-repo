Ext.define('module.prod.order.workbookv5.view.WorkBookV5WkctPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-workbookv5-wkct-popup',
	alias	: 'widget.lookup-workbookv5-wkct-popup',
	store	: 'module.prod.order.workbookv5.store.WorkBookV5WkctPopup',

	title	: Language.get('user_popup','공정 선택'),
	closable: true,
	autoShow: true,
	width	: 825,
	height	: 563,
	...
	createGrid: function(){
		var me = this,
			grid = {
				...
				columns: [
					{	dataIndex:	'wkct_code'      	, width:  150, align : 'center' , text: Language.get( 'cvic_code'      , '설비코드'           ),
						renderer: function(value, meta){
							meta.style = 'font-size:3em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						},
					},{	dataIndex:	'wkct_idcd'      	, flex: 100, align : 'left'   , text: Language.get( 'cvic_idcd'      , '설비ID'             ),hidden : true
					},{	dataIndex:	'wkct_name'      	, flex: 100, align : 'left'   , text: Language.get( 'cvic_name'      , '설비명'             ),
						renderer: function(value, meta){
							meta.style = 'font-size:3em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						},
					},{	dataIndex:	'cvic_spec'      	, width: 150, align : 'left'   , text: Language.get( 'wkct_spec'      , '설비규격'           ),
						renderer: function(value, meta){
							meta.style = 'font-size:3em !important;height:50px;line-height:50px;'; // applied style for DIV element
							return value;
						},
