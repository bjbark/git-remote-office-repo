Ext.define('module.prod.order.workbookv5.view.WorkBookV5UserPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-workbookv5-user-popup',
	alias	: 'widget.lookup-workbookv5-user-popup',
	store	: 'module.prod.order.workbookv5.store.WorkBookV5UserPopup',
