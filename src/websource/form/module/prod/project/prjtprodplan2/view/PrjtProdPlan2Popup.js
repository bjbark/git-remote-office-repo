Ext.define('module.prod.project.prjtprodplan2.view.PrjtProdPlanPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.module-prjtprodplan2-popup',
					...
					items	: [
						{	fieldLabel	: '종료일시',
							...
							listeners	: {
								blur: function() {
									var panel = this.up('form'),
										sttm1 = panel.down('[name=sttm]').getValue();
	...
	finishAction: function(){
		var me = this,
			...
			set		= null,
			lister	= Ext.ComponentQuery.query('module-prjtprodplan2-lister-detail1')[0],
		...
		Ext.Ajax.request({
			...
			params	: {
				...
				param : JSON.stringify({
						...
						work_schd_dvcd	: select.data.work_schd_dvcd
					}]
				})
			},
			async	: false,
