Ext.define('module.prod.project.prjtprodplan2.model.PrjtProdPlan2Detail3',{ extend:'Axt.data.Model',
	fields:
	[
		...
		{name: 'user_name'		,	type: 'string'},		//작업자1
		{name: 'user_name2'		,	type: 'string'},		//작업자2
		{name: 'user_name3'		,	type: 'string'},		//작업자3
		{name: 'mold_name'		,	type: 'string'},		//
