Ext.define('module.prod.project.prjtworkentry.view.PrjtWorkCvicPopup', { extend: 'Axt.popup.Search',
	id		: 'lookup-prjt-cvic-popup',
	alias	: 'widget.lookup-prjt-wkctcvic-popup',
	store	: 'module.prod.project.prjtworkentry.store.PrjtWorkCvicPopup',
