Ext.define('module.prod.project.prjtprodplan1.view.PrjtProdPlan1ListerMaster', { extend: 'Axt.grid.Panel',
	alias		: 'widget.module-prjtprodplan1-lister-master',
	store		: 'module.prod.project.prjtprodplan1.store.PrjtProdPlan1Master',
