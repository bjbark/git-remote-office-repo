Ext.define('system.popup.itembonsa.model.ItemBonsaPopup', { extend:'Axt.data.Model', 
	fields: [
	    ...
	    {   name: 'owner_id'			, type: 'string'  , defaultValue : _global.stor_id },
	    {   name: 'share_gp'			, type: 'string'  },
	    {   name: 'share_yn'			, type: 'string'  }, /* 공통상품 여부 0:매장, 1:공통 */
