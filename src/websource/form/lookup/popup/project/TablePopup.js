Ext.define('lookup.popup.project.TabledPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.lookup-table-popup',
	store: 'lookup.popup.project.store.TablePopup',
    title: 'Data Base Table Search' ,
