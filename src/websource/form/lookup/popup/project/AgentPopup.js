/**
 */
Ext.define('lookup.popup.project.AgentPopup', { extend: 'Axt.popup.Search',
	alias: 'widget.lookup-agent-popup',
	store: 'lookup.popup.project.store.AgentPopup',
    title: '관리채널 선택' ,
    ...
    createGrid: function(){
        var me   = this ,
        	grid = {
        		...
        		columns:
        		[
        		 	{ text : '관리채널'  , dataIndex: 'mngt_chnl_nm'  , width: 150 } ,
        		 	{ text : '영업채널'  , dataIndex: 'distr_nm'  , width: 150 } ,
        		 	{ text : '메모사항'  , dataIndex: 'user_memo' , flex: 1 },
        		 	{ text : '식별코드'  , dataIndex: 'agent_id'  , width: 150 }
        		],
        		listeners: {
