/**
 */
Ext.define('lookup.popup.project.StorePopup', { extend: 'Axt.popup.Search',


	alias: 'widget.lookup-store-popup',
	store: 'lookup.popup.project.store.StorePopup',
    title: '사업장 선택',
        ...
        var me   = this ,
        	grid = {
        		...
        		columns: [
        		 	...
        		 	{ text : '청약명칭'  , dataIndex: 'contr_nm'  , width: 150 } ,
        		 	{ text : '청약상태'  , dataIndex: 'ctrl_sts' , width:  70  , xtype : 'lookupcolumn' , lookupValue : resource.getList('ctrl_sts') , align : 'center'},
        		 	{ text : '구분'    , dataIndex: 'stor_gb'  , width:  40  , xtype : 'lookupcolumn' , lookupValue : resource.getList('stor_gb') , align : 'center'}
        		],
        		listeners: {
