Ext.define('lookup.popup.project.UserInfoPopup', { extend: 'Axt.popup.Search',

    id      : 'lookup-userinfo-popup',
    alias   : 'widget.lookup-userinfo-popup',
    store   : 'lookup.popup.project.store.UserInfoPopup',
    title   : Language.get('usr_popup','User search'),
    width   : 700,
    height  : 500,
    layout  : {
    	type: 'border'
    ...
    createGrid: function(){
        var me = this,
        	grid = {
	            ...
	            columns:[
	                { text: Language.get('emp_nm'  , 'employee name'   )   , dataIndex: 'emp_nm'  ,   width: 100 },
	                { text: Language.get('dept_nm'  , 'department'   )   , dataIndex: 'dept_nm'  ,   width: 100 },
	             	{ text: Language.get('login_id' , 'login ID')  , dataIndex: 'login_id'  ,   width: 180 }
	            ],
	            listeners: {
