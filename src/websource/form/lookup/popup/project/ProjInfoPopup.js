/**
 */
Ext.define('lookup.popup.project.ProjInfoPopup', { extend: 'Axt.popup.Search',

    alias: 'widget.lookup-projinfo-popup',
    store: 'lookup.popup.project.store.ProjInfoPopup',

    title:  Language.get('project_popup','Project Search'),
    closable: true,
    autoShow: true,
    width: 700,
    height: 500,
    ...
    createGrid: function(){
        var me = this,
        	grid = {
	            ...
	            columns:[
	                { text: Language.get('pjt_id'      , 'Project Code'   )   , dataIndex: 'pjt_id'  ,   width: 100 },
	                { text: Language.get('pjt_cd'      , 'Project Name'   )   , dataIndex: 'proj_cd'  ,   width: 100 },
	             	{ text: Language.get('pjt_nm'      , 'Solution Name'   )  , dataIndex: 'pjt_nm'  ,   width: 180 }
	            ],
	            listeners: {
