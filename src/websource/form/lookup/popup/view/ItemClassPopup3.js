/**
 */
Ext.define('lookup.popup.view.ItemClassPopup3', { extend: 'Axt.popup.Search',

	id		: 'lookup-class-popup3',
	alias	: 'widget.lookup-item-clss-popup3',
    store	: 'lookup.popup.store.ItemPopup3',
	...
	createGrid: function(){
		var me = this,
			grid = {
				...
				columns:[
					{ dataIndex	: 'shet_name'		, text : Language.get('clss_name'	,'소분류명'	) , width : 120	, align : 'left'
					},{ dataIndex: 'horz_leng'		, text : Language.get(''	,'가로'	) , width : 120	, align : 'right'
					},{ dataIndex: 'vrtl_leng'		, text : Language.get(''	,'세로'	) , width : 120	, align : 'right'
					},{ dataIndex: 'shet_idcd'		, text : Language.get(''	,'세로'	) , width : 120	, align : 'right',hidden: true
					}
				],
				listeners: {
