Ext.define('lookup.popup.view.ItemPopupKortc', { extend: 'Axt.popup.Search',

	alias	: 'widget.lookup-item-popup-kortc',
	store	: 'lookup.popup.store.ItemPopupKortc',
	requires: [
...
//					,{	dataIndex:	'dely_cstm_modl'	, width:  80, align : 'left'   , text: Language.get( 'dely_cstm_modl'      , '납품처모델명'	)
//					},{	dataIndex:	'cstm_spec'	, width:  80, align : 'left'   , text: Language.get( 'cstm_spec'      , '거래처규격'	),
//						renderer: function(value, meta){
//							if(me.popup.params.tema){
//								this.columns[8].width = 500;
//								meta.style = 'font-size:2em !important;height:30px;line-height:30px'; // applied style for DIV element
//							}
//							return value;
//						}
