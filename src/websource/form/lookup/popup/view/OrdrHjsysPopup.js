/**
 */
Ext.define('lookup.popup.view.OrdrHjsysPopup', { extend: 'Axt.popup.Search',

	alias	: 'widget.lookup-ordr-hjsys-popup',
	store	: 'lookup.popup.store.OrdrHjsysPopup',
	requires: [
...
//			fieldDefaults: { height : 22, width : 260, labelWidth : 60, labelSeparator : '' },
			items :	[
				{	xtype : 'fieldset', layout: 'hbox',
						items : [
							{	fieldLabel	: Language.get('invc_date','수주기간'),
								xtype		: 'betweenfield',
								name		: 'invc1_date',
								pair		: 'invc2_date',
								width		: 165,
