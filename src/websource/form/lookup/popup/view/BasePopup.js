Ext.define('lookup.popup.view.BasePopup', { extend: 'Axt.popup.Search',

	id		: 'lookup-base-popup',
	alias	: 'widget.lookup-base-popup',
	store	: 'lookup.popup.store.BasePopup',
	title	: '기초 코드 정보',
	closable: true,
	autoShow: true,
	width	: 400,
	...
	lookupTitle : [
		...
		,['3101'	, 'N1000HJSYS'	, Language.get('mtrl_bacd_popup'		, ' 재질 찾기'			)]
		,['9001'	, 'N1000KORTC'	, Language.get('crty_bacd_popup'		, ' 차종 찾기'			)]
	],
	...
	createGrid: function(){
		var me = this,
			grid = {
				...
				columns:[
					{	text : Language.get( 'base_code' , 'code'       )	, dataIndex: 'base_code'	, width: 100
					},{	text : Language.get( 'base_name' , 'Code name'  )	, dataIndex: 'base_name'	, width: 100
