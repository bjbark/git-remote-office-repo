/**
 */
Ext.define('lookup.popup.view.OrdrPopup', { extend: 'Axt.popup.Search',

	alias	: 'widget.lookup-ordr-popup',
	store	: 'lookup.popup.store.OrdrPopup',
	requires: [
	 ...
	 createGrid: function(){
			...
			grid = {
				...
				columns: [
					...
					},{	dataIndex: 'drtr_name'		, width: 110, align : 'left'	, text: Language.get('sale_drtr_name'	, '영업담당'	)
