Ext.define('lookup.popup.view.HntopItemGroupPopup', { extend: 'Axt.popup.Search',

	alias	: 'widget.lookup-hntop-group-popup',
	store	: 'lookup.popup.store.HntopItemGroupPopup',

	title	: Language.get('item_group_popup','창호 그룹 찾기'),
	closable: true,
	autoShow: true,
