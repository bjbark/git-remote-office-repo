Ext.define('lookup.popup.view.HntopItemPopup', { extend: 'Axt.popup.Search',

	alias	: 'widget.lookup-hntopitem-popup',
	store	: 'lookup.popup.store.HntopItemPopup',
	requires: [
	 ...
	 createGrid: function(){
			...
			grid = {
				...
				paging	: {
					xtype	: 'grid-paging',
					items	: [
//						{	text	: '<span class="write-button">추가</span>',hidden	: true,
//									name	: 'inputBtn',
//									xtype	: 'button',
//
//									width	: 50,
...
//								},'-',
				...
				columns: [
					...
					},{	dataIndex:	'item_spec'	, width: 80, align : 'left'   , text: Language.get( 'item_spec'      , '품목규격'),
						renderer: function(value, meta){
							if(me.popup.params.tema){
					...
					},{	dataIndex:	'item_leng'	, width:  80, align : 'left'   , text: Language.get( 'item_leng'      , '길이'	),
						renderer: function(value, meta){
							if(me.popup.params.tema){
					...
					},{	dataIndex:	'item_widh'	, width:  80, align : 'left'   , text: Language.get( 'item_widh'      , '폭'	),
						renderer: function(value, meta){
							if(me.popup.params.tema){
					...
					},{	dataIndex:	'item_hght'	, width:  80, align : 'left'   , text: Language.get( 'item_hght'      , '높이'	),
						renderer: function(value, meta){
							if(me.popup.params.tema){
