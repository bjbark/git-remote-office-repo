Ext.define('lookup.popup.view.MmbrPopup', { extend: 'Axt.popup.Search',
	id		: 'lookup-mmbr-popup',
	alias	: 'widget.lookup-mmbr-popup',
	store	: 'lookup.popup.store.MmbrPopup',
	title	: Language.get( 'mmbr' , '회원 찾기') ,
	closable: true,
	autoShow: true,
	width	: 700,
	height	: 500,
	...
	createGrid: function(){
		var me = this,
			grid = {
				...
				columns:[
					{	dataIndex: 'mail_addr'		, text : Language.get('mail_addr'	,'이메일'	) , width : 100	, align : 'center'
					...
					},{ dataIndex: 'tele_numb'		, text : Language.get('tele_numb'	,'연락처'	) , width : 130	, align : 'center'
