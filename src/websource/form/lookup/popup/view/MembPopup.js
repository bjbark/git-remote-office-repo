/**
 */
Ext.define('lookup.popup.view.MembPopup', { extend: 'Axt.popup.Search',

	alias   : 'widget.lookup-memb-popup',
	store   : 'lookup.popup.store.MembPopup',
	title   : Language.get('mmb_popup','회원 찾기'),
	closable: true,
	autoShow: true,
	width   : 700,
	height  : 500,
        ...
        var  me = this,
        	 grid = {
        		...
        		[
        		 	...
        		 	{   text : Language.get( 'member_nm' ,'회원명'   ),   dataIndex: 'mmb_nm',   width: 120 },
        		 	{   text : Language.get( 'memb_tel_no','회원 전화번호' ),   dataIndex: 'memb_tel_no',width: 100 },
        		 	{   text : Language.get( 'addr'      	 ,'회원 주소'  ),      dataIndex: 'memb_addr_1',   width: 200 },
