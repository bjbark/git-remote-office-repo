/**
 */
Ext.define('lookup.popup.view.VendPopup', { extend: 'Axt.popup.Search',

	id      : 'lookup-vend-popup',
	alias   : 'widget.lookup-vend-popup',
	store   : 'lookup.popup.store.VendPopup',
	title   : Language.get( 'pur_vend_popup' , '매입처 찾기'),
	closable: true,
	autoShow: true,
	width   : 700,
	height  : 500,
    ...
    initComponent: function(config){
        ...
        if (me.popup.params.pack_vend_yn) {
        	...
        	me.title = Language.get( 'scm_vend_popup' , '직납업체 선택')  ;
        }
     ...
     createGrid: function(){
        var  me   = this,
        	 grid = {
        		...
        		columns:[
        		 	 { text: Language.get('vend_cd'     , '매입처코드' )  , dataIndex: 'vend_cd',  	  width : 100 },
