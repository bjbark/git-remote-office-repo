/**
 */
Ext.define('lookup.popup.view.WindItemPopup', { extend: 'Axt.popup.Search',

	alias	: 'widget.lookup-wind-item-popup',
	store	: 'lookup.popup.store.WindItemPopup',
	 ...
	 createGrid: function(){
			...
			grid = {
				...
				columns: [
					...
					},{	dataIndex:	'acct_bacd'	, width: 150, align : 'left'   , text: Language.get( 'acct_bacd'      , '계정구분'),hidden:true,
						renderer: function(value, meta){
							if(me.popup.params.tema){
