/**
 */
Ext.define('lookup.popup.view.WmoldPopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-wmold-popup',
	alias	: 'widget.lookup-wmold-popup',
	store	: 'lookup.popup.store.MoldPopup',

	title	: Language.get('acpt_numb','목형 코드')+'찾기',
	closable: true,
	autoShow: true,
	width	: 700,
	height	: 500,
		...
		var me = this,
			grid = {
				...
				columns: [
					...
					},{	text: Language.get('acpt_numb'		, '목형코드')		, dataIndex: 'mold_code'	, width :  80, align	: 'center',
						renderer: function(value, meta){
							if(me.popup.params.tema){
					...
					},{	text: Language.get('acpt_case_name'		, '목형명')		, dataIndex: 'mold_name'	, flex  : 1,
						renderer: function(value, meta){
							if(me.popup.params.tema){
					...
					},{	text: Language.get('cstm_name'		, '구매처명')		, dataIndex: 'cstm_name'	, width : 120,
						renderer: function(value, meta){
							if(me.popup.params.tema){
