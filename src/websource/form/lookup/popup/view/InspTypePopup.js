/**
 */
Ext.define('lookup.popup.view.InspTypePopup', { extend: 'Axt.popup.Search',
	id 		: 'lookup-insptype-popup',
	alias	: 'widget.lookup-insptype-popup',
	store	: 'lookup.popup.store.InspTypePopup',

	title	: Language.get('insptype_popup','검사유형 코드 찾기'),
	closable: true,
	autoShow: true,
	width	: 700,
	height	: 500,
	...
	createGrid: function(){
		var me = this,
			grid = {
				...
				columns: [
					{	text: Language.get('insp_type_code'	, '검사유형코드')	, dataIndex: 'insp_type_idcd'	,  width : 150
					},{	text: Language.get('insp_type_name'	, '검사유형명')	, dataIndex: 'insp_type_name'	,  width : 180
					},{	text: Language.get('insp_mthd_dvcd'	, '검사방법')		, dataIndex: 'insp_mthd_dvcd'	,  width : 120, xtype :'lookupcolumn', lookupValue : resource.lookup('insp_mthd_dvcd'),align : 'center'
					},{	text: Language.get('insp_cond'		, '검사조건')		, dataIndex: 'insp_cond'		,  flex  : 1
					}
				],
				listeners: {
