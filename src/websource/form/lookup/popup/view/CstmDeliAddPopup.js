/**
 */
Ext.define('lookup.popup.view.CstmDeliAddPopup', { extend: 'Axt.popup.Search',
	id   : 'lookup-cstm-deli-add-popup',
	alias: 'widget.lookup-cstm-deli-add-popup',
	...
	finishAction: function(){
		...
		var dlvy_tele_numb = values.dlvy_tele_numb;
		...
		if(dlvy_tele_numb == null || dlvy_tele_numb == '') {
			Ext.Msg.alert("알림","전화번호를 입력해주십시오.");
			return;
		}

		Ext.Ajax.request({
			url		: _global.api_host_info + '/system/cust/cstmmast/set/deliveryaddress.do',
			params	: {
				...
				param : JSON.stringify({
					...
					dlvy_tele_numb	: values.dlvy_tele_numb,
