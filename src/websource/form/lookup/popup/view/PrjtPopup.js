/**
 */
Ext.define('lookup.popup.view.PrjtPopup', { extend: 'Axt.popup.Search',
	id: 'lookup-prjt-popup',
	alias: 'widget.lookup-prjt-popup',
	store: 'lookup.popup.store.PrjtPopup',
	title: Language.get('','Project 선택'),
	closable: true,
	autoShow: true,
	width: 680,
	height: 500,
	...
	createGrid: function(){
		var me = this,
			...
			columns:[
				...
				},{ dataIndex: 'prjt_idcd', text : Language.get('prjt_idcd', '프로젝트ID'	), width : 110 , align : 'center', hidden : true
				...
				},{ dataIndex: 'item_spec', text : Language.get('item_spec', '품목규격'		), width : 180 , align : 'left'
