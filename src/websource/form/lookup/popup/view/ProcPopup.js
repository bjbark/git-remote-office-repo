/**
 */
Ext.define('lookup.popup.view.ProcPopup', { extend: 'Axt.popup.Search',

	id		: 'lookup-proc-popup',
	alias	: 'widget.lookup-proc-popup',
    store	: 'lookup.popup.store.ProcPopup',

    title: Language.get('proc_popup','후가공 용지'),
    closable: true,
    autoShow: true,
    width: 500,
    height: 500,
	...
	createGrid: function(){
		var me = this,
			grid = {
				...
				columns:[
					{ dataIndex	: 'shet_wght'		, text : Language.get(''	,'무게'	) , width : 50	, align : 'left'
					},{ dataIndex: 'colr_bacd'		, text : Language.get(''	,'컬러'	) , width : 80	, align : 'center'
					},{ dataIndex: 'puch_pric'		, text : Language.get(''	,'구매단가'	) , width : 100	, align : 'right', xtype:'numericcolumn'
					},{ dataIndex: 'esti_pric'		, text : Language.get(''	,'견적단가'	) , width : 100	, align : 'right', xtype:'numericcolumn'
					},{ dataIndex: 'shet_idcd'		, text : Language.get(''	,''	) , width : 120	, align : 'right',hidden: true
					}
				],
				listeners: {
