/**
 */
Ext.define('lookup.popup.view.ItemClassPopup2', { extend: 'Axt.popup.Search',

	id		: 'lookup-class-popup2',
	alias	: 'widget.lookup-item-clss-popup2',
	...
	createGrid: function(){
		var me = this,
			grid = {
				...
				columns:[
					{ dataIndex: 'clss_name'		, text : Language.get('clss_name'	,'분류명'	) , width : 120	, align : 'left'
					}
				],
				listeners: {
