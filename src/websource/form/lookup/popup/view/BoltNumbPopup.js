/**
 */
Ext.define('lookup.popup.view.BoltNumbPopup', { extend: 'Axt.popup.Search',
	id		: 'lookup-bolt-numb-popup',
	alias	: 'widget.lookup-bolt-numb-popup',
	store	: 'lookup.popup.store.BoltNumbPopup',
	title	: Language.get('boltnumb_popup','볼트호칭 선택'),
	closable: true,
	autoShow: true,
	width	: 480,
	height	: 500,
		...
		if (selects.length === 0) {
			...
			if (me.popup.apiurl && me.popup.apiurl.master) {
				...
				Ext.each( selects , function( eachrow ){
					request.push({
						btno_name : eachrow.get('btno_name'),
						otsd_dimt : eachrow.get('otsd_dimt'),
					});
				});
