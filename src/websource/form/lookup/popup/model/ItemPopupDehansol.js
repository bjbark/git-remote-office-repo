Ext.define('lookup.popup.model.ItemPopupDehansol',{ extend:'Axt.data.Model',
	fields: [
		...
		},{	name: 'rpst_item_idcd'		, type: 'string'
		...
		},{	name: 'item_make_dvcd'		, type: 'string'
		},{	name: 'item_type_dvcd'		, type: 'string'
		},{	name: 'mesh_kind'			, type: 'string'
		},{	name: 'diag_sqre'			, type: 'string'
		},{	name: 'plmk_size_horz'		, type: 'string'
		},{	name: 'plmk_size_vrtl'		, type: 'string'
		},{	name: 'mesh_name'			, type: 'string'
		},{	name: 'dict_yorn'			, type: 'string'
		},{	name: 'shpm_pric_1fst'		, type: 'float', defaultValue : 0
