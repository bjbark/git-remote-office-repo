Ext.define('lookup.popup.model.ShetPopup',{ extend:'Axt.data.Model',
	fields: [
		...
		{name: 'mixx_colr_dprt_pric',	type: 'float'},		//
		{name: 'mixx_blwt_dprt_pric',	type: 'float'},		//
		{name: 'mixx_colr_sprt_pric',	type: 'float'},		//
		{name: 'mixx_blwt_sprt_pric',	type: 'float'},		//
