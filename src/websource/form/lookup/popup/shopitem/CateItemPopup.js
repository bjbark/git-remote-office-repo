/**
 */
Ext.define('lookup.popup.shopitem.CateItemPopup', { extend: 'Axt.popup.Search',
	alias   : 'widget.lookup-cateitem-popup',
	requires:
	[
	 	'lookup.popup.view.ClassPopup',
	 	'lookup.popup.view.BasePopup',
	 	'lookup.popup.view.VendPopup'
//	 	'lookup.popup.view.ItemBonsaPopup'
	],
	title   : '전시 품목 정보',
	closable: true,
	autoShow: true,
...
//   			me.selectAction();
//		}
//   		if (me.popup.values && me.popup.values.item_name && me.popup.values.item_name != '') {
//   			me.selectAction();
//		}
...
//    		 	 		 			params 	: { prnt_id : '7103' , row_sts : ( me.popup.params.row_sts && me.popup.params.row_sts != '')? me.popup.params.row_sts : '' },
...
//    	console.debug('selects', selects.xtype );
