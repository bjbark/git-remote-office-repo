...
//        console.debug( me)
		...
		var ajaxConfig = Ext.apply({}, me._ajaxConfig),
			...
			language   = _global.lang_gbcd,
			path       = me._tpl.replace('{locale}', language),
			decoder    = me._decoder,
//            params     = ajaxConfig.params || {},
//            params     = ajaxConfig.params || {lang_gbcd : _global.lang_gbcd},
//            params     = { param : JSON.stringify({pjt_id : _global.solution, lang_gbcd : _global.lang_gbcd }) },
			params     = { param : JSON.stringify({pjt_id : _global.solution, lang_gbcd : _global.lang_gbcd , hq_id : _global.hq_id}) },
			json;
...
//		console.log('in get', res , key ,defaultText );
		if (plural) {
