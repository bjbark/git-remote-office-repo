    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            leftPanel: function (element) {
                ...
                ganttLeftPanel.append($('<div class="row spacer highbar" style="position:absolute; width:274px;"/>').css("height",tools.getCellSize() * element.headerRows))
                var entries = [];
            ...
            rightPanel: function (element, leftPanel /* <- never used? */) {
                ...
                case "hours":
                    ...
                    var headerPanel = $('<div class="headerPanel" style="width: '
                    ...
                    if (i >= element.pageNum * settings.itemsPerPage &&
                        ...
                        $.each(entry.values, function (j, day) {
                            ...
                            default:
                                ...
                                if(_bar[0].className.indexOf('topClass') != -1){
                                	_bar.css({
                                        top: top+5,
                                        left: Math.floor(cFrom),
                                        width: dp + '%'
