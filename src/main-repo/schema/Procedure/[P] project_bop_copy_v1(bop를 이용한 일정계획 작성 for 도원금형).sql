...
drop procedure if exists `project_bop_copy_v1`;


CREATE  PROCEDURE `project_bop_copy_v1`(
...
with recursive cte as (																								
    select pjod_idcd      , work_ordr_dvcd , ordr_degr
	...
	and    work_ordr_dvcd = _work_ordr_dvcd
	and    ordr_degr      = _ordr_degr
	and    line_levl = 1
    union all 
    select a.pjod_idcd      , a.work_ordr_dvcd , a.ordr_degr
...
--		 , case b.line_levl when 2 then a.work_cont else null end as work_cont      
    ...
    from   pjod_bop a																								
    inner join cte b on a.prnt_idcd = b.work_item_idcd and a.pjod_idcd = b.pjod_idcd and a.work_ordr_dvcd = b.work_ordr_dvcd and a.ordr_degr = b.ordr_degr
