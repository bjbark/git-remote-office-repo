...
drop procedure if exists `auto_acpt_copy`;

create  procedure `auto_acpt_copy`(
     _stor       varchar(50),
...
select     _new_invc_numb    , 1                 , a.line_seqn       , a.item_idcd       , a.unit_idcd
         , a.orig_invc_numb  , a.orig_seqn       , a.orig_invc_qntt  , a.optn_dvcd       , a.optn_psbl_yorn
         , a.optn_adtn       , a.pric_adpt       , a.norm_sale_pric  , a.sale_stnd_pric  , a.invc_qntt
         , a.invc_pric       , a.vatx_incl_yorn  , a.vatx_rate       , a.sply_amnt       , a.vatx_amnt
         , a.invc_amnt       , a.krwn_amnt       , a.krwn_vatx       , a.krwn_ttsm_amnt  , a.stnd_unit
         , a.stnd_unit_qntt  , a.wrhs_idcd       , a.dlvy_cstm_idcd  , _deli_date        , a.dlvy_date
         , a.dlvy_hhmm       , a.remk_text       , a.ostt_dvcd       , a.dsct_qntt       , a.dlvy_memo
...
select     _new_invc_numb    , 1                 , a.bzpl_idcd       , a.invc_date       , a.ordr_dvcd
         , a.orig_invc_numb  , a.expt_dvcd       , a.pcod_nmbr       , _deli_date        , a.cstm_idcd
         , a.mdtn_prsn       , a.cont_date       , a.drtr_idcd       , a.dept_idcd       , a.crny_dvcd
         , a.excg_rate       , a.ostt_wrhs_idcd  , a.trut_dvcd       , a.dlvy_cond_dvcd  , a.crdt_exce_yorn
         , a.amnt_lack_yorn  , a.sale_stor_yorn  , a.remk_text       , a.memo            , a.cofm_yorn
         , a.cofm_dttm       , a.cofm_drtr_idcd  , '0010'  
         , null              , 'copyed Order '   , a.prnt_idcd       , a.line_levl       , a.line_ordr
         , '0'               , '0'               , a.find_name 
         , null              , null              , null              , null              , null
         , a.crte_user_name  , a.crte_ipad       , date_format(now(), '%Y%m%d%H%i%s')    , a.crte_idcd 
