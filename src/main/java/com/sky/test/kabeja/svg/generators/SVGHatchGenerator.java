...
import com.sky.test.kabeja.dxf.DXFHatch;
import com.sky.test.kabeja.dxf.DXFHatchPattern;
import com.sky.test.kabeja.dxf.helpers.HatchBoundaryLoop;
import com.sky.test.kabeja.dxf.helpers.HatchLineFamily;
import com.sky.test.kabeja.dxf.helpers.HatchLineIterator;
import com.sky.test.kabeja.dxf.helpers.HatchLineSegment;
...
public class SVGHatchGenerator extends AbstractSVGSAXGenerator {
     ...
     * (non-Javadoc)
     *
     * @see com.sky.test.kabeja.svg.SVGGenerator#toSAX(org.xml.sax.ContentHandler,
     *      java.util.Map)
     */
