...
public class DXFShape extends DXFEntity {
    ...
    /* (non-Javadoc)
     * @see com.sky.test.kabeja.dxf.DXFEntity#toSAX(org.xml.sax.ContentHandler, java.util.Map)
     */
    ...
    /* (non-Javadoc)
     * @see com.sky.test.kabeja.dxf.DXFEntity#getBounds()
     */
    ...
    /* (non-Javadoc)
     * @see com.sky.test.kabeja.dxf.DXFEntity#getType()
     */
