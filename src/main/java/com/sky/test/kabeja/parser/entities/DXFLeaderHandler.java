...
public class DXFLeaderHandler extends AbstractEntityHandler {
    ...
    /* (non-Javadoc)
     * @see com.sky.test.kabeja.parser.entities.AbstractEntityHandler#getDXFEntityName()
     */
    ...
    /* (non-Javadoc)
     * @see com.sky.test.kabeja.parser.entities.DXFEntityHandler#parseGroup(int, com.sky.test.kabeja.parser.DXFValue)
     */
