package com.sky.system.cust.custmast;
...
public class CustMast extends DefaultControlHandler{
	...
	// 조회
	@RequestMapping(value="cust/cstmmast/get/search.do"  )
	...
	// 룩업
	@RequestMapping(value="cust/cstmmast/get/lookup.do"  )
	...
	// 룩업2
	@RequestMapping(value="cust/cstmmast/get/lookup2.do"  )
	...
	// 룩업3
	@RequestMapping(value="cust/cstmmast/get/lookup3.do"  )
	...
	// 룩업4
	@RequestMapping(value="cust/cstmmast/get/lookup4.do"  )
	public String getLookup4( HttpMessage http, Map<String, Object> model,
			@RequestParam(value="page" , required=true, defaultValue="1" ) int page,
			@RequestParam(value="limit", required=true, defaultValue="10") int rows,
			@RequestParam(value="sort" , required=false, defaultValue = "" ) String sort) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.getLookup4(http.argument, page, rows, sort));
		return http.writer;
	}

	// 배송지
	@RequestMapping(value="cust/cstmmast/get/cstmdeli.do"  )
	...
	// 배송지 추가 등록
		@RequestMapping(value="cust/cstmmast/set/deliveryaddress.do"  )
	...
	//
	@RequestMapping(value="cust/cstmmast/get/buss_numb.do"  )
	...
	@RequestMapping(value="cust/cstmmast/get/box_cstm_idcd.do"  )
	...
	// 저장
	@RequestMapping(value="cust/cstmmast/set/record.do"  )
	public String setRecord(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setRecord(http.argument));
		return http.writer;
	}

	@RequestMapping(value="cust/cstmmast/set/add.do"  )
	...
	// 조회
	@RequestMapping(value="cust/cstmmast/get/drtr.do"  )
	...
	// 룩업
	@RequestMapping(value="cust/cstmmast/get/drtrlookup.do"  )
	...
	// 저장
	@RequestMapping(value="cust/cstmmast/set/drtr.do"  )
	...
	// 조회
	@RequestMapping(value="cust/cstmmast/get/addr.do"  )
	...
	// 조회
	@RequestMapping(value="cust/cstmmast/get/bank.do"  )
	...
	// 룩업
	@RequestMapping(value="cust/cstmmast/get/addrlookup.do"  )
	...
	// 저장
	@RequestMapping(value="cust/cstmmast/set/addr.do"  )
	...
	// 저장
	@RequestMapping(value="cust/cstmmast/set/bank.do"  )
	...
	//
	@RequestMapping(value="/cust/cstmmast/get/isos.do"  )
	...
	@RequestMapping(value="/cust/cstmmast/get/rett.do"  )
	...
	@RequestMapping(value="/cust/cstmmast/get/order.do"  )
	...
	// 조회
	@RequestMapping(value="cust/cstmmast/get/deli.do"  )
	...
	// 룩업
	@RequestMapping(value="cust/cstmmast/get/delilookup.do"  )
	...
	// 저장
	@RequestMapping(value="cust/cstmmast/set/deli.do"  )
	...
	// 관리항목 조회
	@RequestMapping(value="cust/cstmmast/get/cstm_mngt.do"  )
	...
	// 관리항목 조회
	@RequestMapping(value="cust/cstmmast/get/mngt.do"  )
	...
	// 관리항목 저장
	@RequestMapping(value="cust/cstmmast/set/cstm_mngt.do"  )
	...
	// 계약내역조회
	@RequestMapping(value="cust/cstmmast/get/itempric.do"  )
