...
@Controller
public class CstmClass  extends DefaultControlHandler{

	@Autowired
	private CstmClassService service;

	@RequestMapping(value="/cust/cstmclass/get/search.do"  )
	...
	@RequestMapping(value="/cust/cstmclass/get/search/excel.do"  )
	...
	// 룩업
	@RequestMapping(value="/cust/cstmclass/get/lookup.do")
	...
	@RequestMapping(value="/cust/cstmclass/set/record.do"  )
