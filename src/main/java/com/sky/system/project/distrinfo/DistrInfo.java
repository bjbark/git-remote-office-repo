...
@Controller
public class DistrInfo extends DefaultControlHandler{

	@Autowired
	private DistrInfoService service;

	// 조회
	@RequestMapping(value="/project/distrinfo/get/search.do")
	...
	// 조회
	@RequestMapping(value="/project/distrinfo/get/lookup.do")
	...
	// 저장
	@RequestMapping(value="/project/distrinfo/set/record.do")
