...
@Controller
public class CAgentInfo extends DefaultControlHandler{

	@Autowired
	private CAgentInfoService service;

	// 조회
	@RequestMapping(value="/project/cagentinfo/get/search.do")
	...
	// 조회
	@RequestMapping(value="/project/cagentinfo/get/lookup.do")
	...
	// 저장
	@RequestMapping(value="/project/cagentinfo/set/record.do")
