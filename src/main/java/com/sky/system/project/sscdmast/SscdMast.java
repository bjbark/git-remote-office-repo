package com.sky.system.project.sscdmast;
...
//sscdmast source를 변경할 경우 basic폴더의 csscdmast 내용도 함께 변경해 주어야 한다.

@Controller
public class SscdMast {

	@Autowired
	private SscdMastService service;


	@RequestMapping(value="/project/sscdmast/get/search.do")
	...
	@RequestMapping(value="/project/sscdmast/set/master.do")
	...
	// 싱크
	@RequestMapping(value="/project/sscdmast/set/copy.do" )
