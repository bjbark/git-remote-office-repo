...
@Controller
public class DaemonInfo extends DefaultControlHandler{

	@Autowired
	private DaemonInfoService service;

	// 조회
	@RequestMapping(value="/project/daemoninfo/get/search.do"  )
	...
	// 저장
	@RequestMapping(value="/project/daemoninfo/set/record.do" )
