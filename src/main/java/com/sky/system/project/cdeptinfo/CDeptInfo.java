...
@Controller
public class CDeptInfo extends DefaultControlHandler {

	@Autowired
	private CDeptInfoService service;

	// 조회
	@RequestMapping(value="/project/cdeptinfo/get/search.do"  )
	...
	// 팝업
	@RequestMapping(value="/project/cdeptinfo/get/lookup.do"  )
	...
	// 저장
	@RequestMapping(value="/project/cdeptinfo/set/record.do"  )
