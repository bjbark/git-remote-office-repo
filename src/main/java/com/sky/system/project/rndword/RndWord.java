...
@Controller
public class RndWord extends DefaultControlHandler{

	@Autowired
	private RndWordService service;

	// 조회
	@RequestMapping(value="/project/rndword/get/search.do")
	...
	// 조회
	@RequestMapping(value="/project/rndword/get/lookup.do")
	...
	// 저장
	@RequestMapping(value="/project/rndword/set/record.do")
