...
@Controller
public class ModuleInfo extends DefaultControlHandler {

	Logger LOGGER = LoggerFactory.getLogger(ModuleInfo.class);

	@Autowired
	private ModuleInfoService service;

	// 조회
	@RequestMapping(value="/project/moduleinfo/get/search.do"  )
...
//		TreeHash tree = new TreeHash("0");
	...
	// 저장
	@RequestMapping(value="/project/moduleinfo/set/record.do"  )
