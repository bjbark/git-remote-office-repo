...
@Controller
public class ProdRetn {

	@Autowired
	private ProdRetnService service;

	@RequestMapping(value="/mobile/prodretn/get/search.do")
	...
	@RequestMapping(value="/mobile/prodretn/get/search2.do")
	...
	@RequestMapping(value="/mobile/prodretn/set/record.do"  )
