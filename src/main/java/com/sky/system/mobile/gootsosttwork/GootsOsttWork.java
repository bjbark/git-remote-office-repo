...
@Controller
public class GootsOsttWork {

	@Autowired
	private GootsOsttWorkService service;

	@RequestMapping(value="/mobile/gootsosttwork/get/search.do")
	...
	@RequestMapping(value="/mobile/gootsosttwork/get/search2.do")
	...
	@RequestMapping(value="/mobile/gootsosttwork/get/detail.do")
	public String getDetail(@ReleaseToken HttpMessage http, Map<String, Object> model,
			@RequestParam(value="page" , required=true,  defaultValue="1" ) int page,
			@RequestParam(value="limit", required=true,  defaultValue="10") int rows,
			@RequestParam(value="sort" , required=false, defaultValue=""  ) String sort) throws Exception {
	...
	@RequestMapping(value="/mobile/gootsosttwork/get/lookup.do")
	public String getLookup(@ReleaseToken HttpMessage http, Map<String, Object> model,
			@RequestParam(value="page" , required=true,  defaultValue="1" ) int page,
			@RequestParam(value="limit", required=true,  defaultValue="10") int rows,
			@RequestParam(value="sort" , required=false, defaultValue=""  ) String sort) throws Exception {
	...
	@RequestMapping(value="/mobile/gootsosttwork/set/record.do"  )
