...
@Controller
public class MoveReqWork extends DefaultControlHandler{

	@Autowired
	private MoveReqWorkService service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movereqwork/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movereqwork/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movereqwork/get/invoice.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movereqwork/set/invoice.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movereqwork/set/del_yn.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movereqwork/get/product.do") 
	...
	@RequestMapping(value="/move/movereqwork/get/printing.do")
	public String getPrinting(HttpMessage http, Map jasperMainParam) throws Exception {
		...
		if (isReport) {
			...
			jasperData.put(JasperReportView.TITLE, "이동요청 명세서");
			...
			jasperMainParam.put(JasperReportView.FILENAME, "이동요청 명세서");				// 다운로드 시 파일명
