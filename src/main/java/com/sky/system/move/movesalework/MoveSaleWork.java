...
@Controller
public class MoveSaleWork extends DefaultControlHandler{

	@Autowired
	private MoveSaleWorkService service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movesalework/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movesalework/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movesalework/get/invoice.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movesalework/set/invoice.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movesalework/set/del_yn.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movesalework/get/dialog.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movesalework/get/product.do") 
	...
	@RequestMapping(value="/move/movesalework/get/printing.do")
	public String getPrinting(HttpMessage http, Map jasperMainParam) throws Exception {
		...
		if (isReport) {
			...
			jasperData.put(JasperReportView.TITLE, "이동출고 명세서");
			...
			jasperMainParam.put(JasperReportView.FILENAME, "이동출고 명세서");				// 다운로드 시 파일명
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movesalework/get/planmaster.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/movesalework/get/plandetail.do")
