...
@Controller
public class MoveRecvWork extends DefaultControlHandler{

	@Autowired
	private MoveRecvWorkService service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/moverecvwork/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/moverecvwork/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/moverecvwork/get/invoice.do")
	...
	// 마감 / 해지 수정
	@RequestMapping(value="/move/moverecvwork/set/close.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/moverecvwork/set/invoice.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/moverecvwork/set/del_yn.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/moverecvwork/get/dialog.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/moverecvwork/get/product.do") 
	...
	@RequestMapping(value="/move/moverecvwork/get/printing.do")
	public String getPrinting(HttpMessage http, Map jasperMainParam) throws Exception {
		...
		if (isReport) {
			...
			jasperData.put(JasperReportView.TITLE, "이동입고 명세서");
			...
			jasperMainParam.put(JasperReportView.FILENAME, "이동입고 명세서");				// 다운로드 시 파일명
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/move/moverecvwork/get/plan.do")
