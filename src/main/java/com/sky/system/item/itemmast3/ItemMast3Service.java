...
@Service()
public class ItemMast3Service extends DefaultServiceHandler {
	@Autowired
	...
	public SqlResultMap getSearch(HttpRequestArgument arg, int page, int rows, String sort ) throws Exception {
		...
		data.param
			...
			.where("     , a.safe_stok        , a.safe_deli_dcnt												")
			...
			.where("      , (select refn_cont_1fst from item_refn r where r.refn_code = ba.trac_code and r.refn_dvcd  = '3' ) as trac")
			...
			.where("      , ( select base_name from base_mast r													")
			.where("          where r.prnt_idcd = '8006' and mt.mtrl_labl_code = r.base_code					")
			.where("      ) as mtrl_labl_name																	")
			...
			.where("      , wr.zone_name as stor_palc_name   , f3.wrhs_name as stor_wrhs_name					")
...
//			.where("          and    ( 0																		")
//			.where("          or    a.acct_bacd = :acct_bacd  " , "1001", arg.getParamText("acct_code").contains("1"))
//			.where("          or    a.acct_bacd = :acct_bacd2 "  , "1002", arg.getParamText("acct_code").contains("2"))
//			.where("          or    a.acct_bacd = :acct_bacd3 "  , "2001", arg.getParamText("acct_code").contains("3"))
//			.where("          or    a.acct_bacd = :acct_bacd4 "  , "2002", arg.getParamText("acct_code").contains("4"))
//			.where("          or    a.acct_bacd = :acct_bacd5 "  , "2003", arg.getParamText("acct_code").contains("5"))
//			.where("          or    a.acct_bacd = :acct_bacd6 "  , "3000", arg.getParamText("acct_code").contains("6"))
//			.where("                  )																					")
		...
		data.param
			...
			.where("       left outer join wrhs_zone      wr on json_value(a.json_data , '$**.stor_palc_idcd') = wr.zone_idcd	")
