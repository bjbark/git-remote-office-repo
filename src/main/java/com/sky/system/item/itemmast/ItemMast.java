...
public class ItemMast  extends DefaultControlHandler{
	...
	@RequestMapping(value="/item/itemmast/get/search.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/isos.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/rett.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/lookup.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/lookup3.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/lookupdehansol.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/lookupdehansol2.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/lookupspec.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/acpt.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/prod.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/osttrett.do"  )
	...
	// 룩업
	@RequestMapping(value="/item/itemmast/get/product.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/itemacpt.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/itemCode.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/itemCodeCheck.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/image.do"  )
	...
	@RequestMapping(value="/item/itemmast/set/record.do"  )
	public String  setRecord(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setRecord(http.argument));
		return http.writer;
	}
	@RequestMapping(value="/item/itemmast/set/simple.do"  )
	...
	@RequestMapping(value="/item/itemmast/set/add.do"  )
	...
	@RequestMapping(value="/item/itemmast/set/add2.do"  )
	public String  setAdd2(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setAdd2(http.argument));
		return http.writer;
	}
	@RequestMapping(value="/item/itemmast/set/add_hj.do"  )
	...
	@RequestMapping(value="/item/itemmast/set/item_memo.do"  )
	...
	@RequestMapping(value="/item/itemmast/set/item_mngt.do"  )
	...
	// 이미지업로드
	@RequestMapping(value="item/itemmast/set/fileUpload.do"  )
	...
	@RequestMapping(value="item/itemmast/get/item_bolt_calc.do"  )
	...
	@RequestMapping(value="item/itemmast/set/item_bolt_calc.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/itemdesc.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/item_memo.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/item_mngt.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/item_pkge.do"  )
	...
	@RequestMapping(value="/item/itemmast/set/item_pkge.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/pckg_bacd.do"  )
	...
	@RequestMapping(value="/item/itemmast/set/copy.do"  )
	...
	@RequestMapping(value="/item/itemmast/get/lookupnbolt.do"  )
