...
public class EcoMast extends DefaultControlHandler{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/item/ecomast/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/item/ecomast/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/item/ecomast/get/invoice.do")
	...
	@RequestMapping(value="/item/ecomast/set/ok.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/item/ecomast/set/invoice.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/item/ecomast/set/del_yn.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/item/ecomast/get/product.do")
