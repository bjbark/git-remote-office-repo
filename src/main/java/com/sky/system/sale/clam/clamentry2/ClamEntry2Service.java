...
@Service
public class ClamEntry2Service {
	...
	public SqlResultMap getSearch(HttpRequestArgument arg, int page, int rows, String sort ) throws Exception {
		...
		data.param
			...
			.where("      , u5.user_name as pckg_drtr_name       , c.cstm_name  , c.cstm_code										")
			...
			.where("and		a.labr_drtr_idcd  = :labr_drtr_idcd	" , arg.getParamText("labr_drtr_idcd" ))
