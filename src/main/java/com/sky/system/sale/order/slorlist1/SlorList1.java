...
public class SlorList1  extends DefaultControlHandler{
	...
	@RequestMapping(value="/sale/order/slorlist1/get/search0.do"  )
	...
	@RequestMapping(value="/sale/order/slorlist1/get/search1.do"  )
	...
	@RequestMapping(value="/sale/order/slorlist1/get/search2.do"  )
	...
	@RequestMapping(value="/sale/order/slorlist1/get/search3.do"  )
	...
	@RequestMapping(value="/sale/order/slorlist1/get/detail.do"  )
