...
@Controller
public class SlorList5  extends DefaultControlHandler{

	@Autowired
	private SlorList5Service service;

	@RequestMapping(value="/sale/order/slorlist5/get/search1.do"  )
	...
	@RequestMapping(value="/sale/order/slorlist5/get/search2.do"  )
