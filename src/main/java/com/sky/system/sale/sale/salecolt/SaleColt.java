...
public class SaleColt  extends DefaultControlHandler{
	...
	@RequestMapping(value="/sale/sale/salecolt/get/master1.do")
	...
	@RequestMapping(value="/sale/sale/salecolt/get/detail1.do")
	...
	@RequestMapping(value="/sale/sale/salecolt/get/master2.do")
	...
	@RequestMapping(value="/sale/sale/salecolt/get/detail2.do")
	...
	@RequestMapping(value="/sale/sale/salecolt/get/search.do")
	...
	@RequestMapping(value="/sale/sale/salecolt/set/record.do")
	...
	//삭제
	@RequestMapping(value="/sale/sale/salecolt/set/del_yn.do")
