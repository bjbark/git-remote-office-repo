...
public class InitStay  extends DefaultControlHandler{
	...
	@RequestMapping(value="/sale/sale/initstay/get/search.do")
	...
	@RequestMapping(value="/sale/sale/initstay/get/search2.do")
	...
	@RequestMapping(value="/sale/sale/initstay/set/update.do")
	...
	@RequestMapping(value="/sale/sale/initstay/set/del_yn.do")
