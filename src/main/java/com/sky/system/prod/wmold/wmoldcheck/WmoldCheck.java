...
@Controller
public class WmoldCheck extends DefaultControlHandler{

	@Autowired
	private WmoldCheckService service;
	// master
	@RequestMapping(value="prod/wmold/wmoldcheck/get/mastersearch.do"  )
	...
	//detail1
	@RequestMapping(value="prod/wmold/wmoldcheck/get/detailsearch1.do"  )
	...
	//detail2
		@RequestMapping(value="prod/wmold/wmoldcheck/get/detailsearch2.do"  )
	...
	// 저장
	@RequestMapping(value="prod/wmold/wmoldcheck/set/detail1.do"  )
	...
	@RequestMapping(value="prod/wmold/wmoldcheck/set/detail2.do"  )
	...
	@RequestMapping(value="/prod/wmold/wmoldcheck/get/seqn1.do"  )
	...
	@RequestMapping(value="/prod/wmold/wmoldcheck/get/seqn2.do"  )
