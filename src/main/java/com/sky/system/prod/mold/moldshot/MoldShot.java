...
@Controller
public class MoldShot extends DefaultControlHandler{

	@Autowired
	private MoldShotService service;
	// master
	@RequestMapping(value="prod/mold/moldshot/get/mastersearch.do"  )
	...
	//detail
	@RequestMapping(value="prod/mold/moldshot/get/detailsearch.do"  )
	...
	@RequestMapping(value="/prod/mold/moldshot/get/seqn.do"  )
	...
	// 저장
	@RequestMapping(value="prod/mold/moldshot/set/detail.do"  )
