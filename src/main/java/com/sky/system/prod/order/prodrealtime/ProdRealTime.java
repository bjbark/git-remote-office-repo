...
@Controller
public class ProdRealTime  extends DefaultControlHandler{

	@Autowired
	private ProdRealTimeService service;

	@RequestMapping(value="/prod/order/prodrealtime/get/search1.do"  )
	...
	@RequestMapping(value="/prod/order/prodrealtime/get/search2.do"  )
	...
	@RequestMapping(value="/prod/order/prodrealtime/get/search3.do"  )
