...
@Controller
public class ProdMonitering extends DefaultControlHandler{

	@Autowired
	private ProdMoniteringService service;
	// 조회
	@RequestMapping(value="prod/order/prodmonitering/get/mastersearch.do"  )
	...
	// 조회
	@RequestMapping(value="prod/order/prodmonitering/get/detailsearch.do"  )
