...
public class ProdOrder  extends DefaultControlHandler{
	...
	@RequestMapping(value="/prod/order/prodorder/get/search1.do"  )
	...
	@RequestMapping(value="/prod/order/prodorder/get/search2.do"  )
	...
	// 룩업
	@RequestMapping(value="/prod/order/prodorder/get/lookup.do"  )
	...
	// 저장
	@RequestMapping(value="/prod/order/prodorder/set/record.do"  )
