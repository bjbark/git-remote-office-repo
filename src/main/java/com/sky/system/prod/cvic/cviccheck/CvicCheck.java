...
import com.sky.system.prod.cvic.cviccheck.CvicCheckService;

@Controller
public class CvicCheck extends DefaultControlHandler{

	@Autowired
	private CvicCheckService service;
	// master
	@RequestMapping(value="prod/cvic/cviccheck/get/mastersearch.do"  )
	...
	// 룩업
	@RequestMapping(value="/prod/cvic/cviccheck/get/lookup.do"  )
	...
	//detail
	@RequestMapping(value="prod/cvic/cviccheck/get/detailsearch.do"  )
	...
	// 저장
	@RequestMapping(value="prod/cvic/cviccheck/set/detail.do"  )
	...
	@RequestMapping(value="/prod/cvic/cviccheck/get/seqn.do"  )
