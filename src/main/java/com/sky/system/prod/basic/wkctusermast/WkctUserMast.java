...
import com.sky.system.prod.basic.wkctusermast.WkctUserMastService;

@Controller
public class WkctUserMast extends DefaultControlHandler{

	@Autowired
	private WkctUserMastService service;
	// master
	@RequestMapping(value="prod/basic/wkctusermast/get/mastersearch.do"  )
	...
	//detail
	@RequestMapping(value="prod/basic/wkctusermast/get/detailsearch.do"  )
	...
	//item1
		@RequestMapping(value="prod/basic/wkctusermast/get/item1.do"  )
		...
		//item2
		@RequestMapping(value="prod/basic/wkctusermast/get/item2.do"  )
	...
	//item2
	@RequestMapping(value="prod/basic/wkctusermast/get/itemseqn.do"  )
	public String getItemSeqn( HttpMessage http, Map<String, Object> model) throws Exception {

		model.put(HttpResponseMessage.RECORDS, service.getItemSeqn(http.argument));
		return http.writer;
	}

	// 저장
	@RequestMapping(value="prod/basic/wkctusermast/set/item1.do"  )
