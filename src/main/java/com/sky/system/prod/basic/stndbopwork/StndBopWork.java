...
@Controller
public class StndBopWork extends DefaultControlHandler{

	@Autowired
	private StndBopWorkService service;
	// 조회
	@RequestMapping(value="/prod/basic/stndbopwork/get/search.do"  )
...
//		TreeHash tree = new TreeHash("standard");
	...
	@RequestMapping(value="/prod/basic/stndbopwork/set/setTree.do"  )
	...
	@RequestMapping(value="/prod/basic/stndbopwork/set/setBop.do"  )
	...
	@RequestMapping(value="/prod/basic/stndbopwork/set/setBopWork.do"  )
	...
	@RequestMapping(value="/prod/basic/stndbopwork/get/getcstm.do"  )
	...
	@RequestMapping(value="/prod/basic/stndbopwork/get/getdeli_date.do"  )
	...
	@RequestMapping(value="prod/basic/stndbopwork/get/getlookup.do"  )
