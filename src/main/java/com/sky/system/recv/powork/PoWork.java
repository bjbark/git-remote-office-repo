...
@Controller
public class PoWork extends DefaultControlHandler{

	@Autowired
	private PoWorkService service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/powork/get/search.do")
	...
	@RequestMapping(value="/recv/powork/get/printing.do")
	public String getPrinting(HttpMessage http, Map jasperMainParam) throws Exception {
		...
		if (isReport) {
			SqlResultRow invoice = map.get(0); 
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/powork/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/powork/get/invoice.do")
	...
	// 마감 / 해지 수정
	@RequestMapping(value="/recv/powork/set/close.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/powork/set/invoice.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/powork/set/del_yn.do")
...
//	 * @throws Exception
//	 */
//	@RequestMapping(value="/recv/powork/get/product.do") 
...
//	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/powork/get/product/excel.do") 
...
//	 * @throws Exception
//	 */
//	@RequestMapping(value="/recv/powork/get/receiver.do") 
...
//	 * @throws Exception
//	 */
//	@RequestMapping(value="/recv/powork/get/stscd.do")
