...
import com.sky.http.HttpResponseMessage;
	...
	@Controller
	public class ApWork extends DefaultControlHandler{

		
		@Autowired
		private ApWorkService service;

		// 수금현황
		@RequestMapping(value="/recv/apwork/get/search.do"  )
		 ...
		 * @throws Exception
		 */
		@RequestMapping(value="/recv/apwork/get/detail.do")
		...
		// 회원정보 조회 
		@RequestMapping(value="/recv/apwork/get/lookup/vend.do"  )
		public String getLookupVend( HttpMessage http, Map<String, Object> model,
			@RequestParam(value="page" , required=true, defaultValue="1" ) int page,
			@RequestParam(value="limit", required=true, defaultValue="10") int rows,
			@RequestParam(value="sort" , required=false, defaultValue = "" ) String sort) throws Exception {
			model.put(HttpResponseMessage.RECORDS, service.getLookupVend(http.argument, page, rows, sort));
			return http.writer;
		}
		
		// INV 조회
		@RequestMapping(value="/recv/apwork/get/invoice.do"  )
		...
		// 마감 / 해지 수정
		@RequestMapping(value="/recv/apwork/set/close.do"  )
		...
		@RequestMapping(value="/recv/apwork/set/invoice.do"  )
		 ...
		 * @throws Exception
		 */
		@RequestMapping(value="/recv/apwork/set/del_yn.do")
		...
		// 수금예정리스트
		@RequestMapping(value="/recv/apwork/get/aplist.do"  )
		...
		// 수금예정리스트 - 미수현황 조회
		@RequestMapping(value="/recv/apwork/get/aplistsales.do"  )
		...
		@RequestMapping(value="/recv/apwork/get/aplistitems.do"  )
