package com.sky.system.recv.porequest;
...
public class PoRequestService  extends DefaultServiceHandler {
	...
	public SqlResultMap getProduct(HttpRequestArgument arg) throws Exception {
		...
		data.param // 조회
			...
			.query("     ,  b.item_idcd   , b.item_code    , b.item_name     , b.itm_ds  , b.item_spec , b.piece_qty		")
			...
			.query("     ,  b.cst_pri  , s.stock     , b.brcd_1 as brcd	, b.itm_shrt_cd as itm_shrt_cd			")
	...
	public SqlResultMap getProductExcel(HttpRequestArgument arg) throws Exception {
		...
		data.param
			.query("select a.stor_grp , a.stor_id																		")
			.query("     , b.unit_idcd   , b.piece_qty , (select unit_name from itm_unit where unit_idcd = b.unit_idcd) as unit_name	")
	...
	public SqlResultMap getReceiver(HttpRequestArgument arg) throws Exception {
		...
		data.param
			...
			.query("      ,a.tax_type        as recv_tax_type				")
			...
			.query("      ,b.biz_gb											")
			.query("  from stor a											")
			.query("       join vend_mst b  on b.vend_id = '" + vend_id + "' ")
