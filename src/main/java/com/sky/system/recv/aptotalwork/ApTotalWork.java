...
import com.sky.http.HttpResponseMessage;
	...
	@Controller
	public class ApTotalWork extends DefaultControlHandler{

		
		@Autowired
		private ApTotalWorkService service;

		// 수금현황
		@RequestMapping(value="/recv/aptotalwork/get/search.do"  )
		...
		// 상세 조회 
		@RequestMapping(value="/recv/aptotalwork/get/detail.do"  )
		...
		// 회원정보 조회 
		@RequestMapping(value="/recv/aptotalwork/get/dialogmemb.do"  )
		...
		// INV 조회
		@RequestMapping(value="/recv/aptotalwork/get/invoice.do"  )
		...
		@RequestMapping(value="/recv/aptotalwork/set/invoice.do"  )
		 ...
		 * @throws Exception
		 */
		@RequestMapping(value="/recv/aptotalwork/set/del_yn.do")
		...
		// 수금예정리스트
		@RequestMapping(value="/recv/aptotalwork/get/arlist.do"  )
		...
		// 수금예정리스트 - 미수현황 조회
		@RequestMapping(value="/recv/aptotalwork/get/arlistsales.do"  )
		...
		@RequestMapping(value="/recv/aptotalwork/get/arlistitems.do"  )
