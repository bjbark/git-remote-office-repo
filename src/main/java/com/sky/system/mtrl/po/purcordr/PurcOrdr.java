...
public class PurcOrdr extends DefaultControlHandler{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/mtrl/po/purcordr/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/mtrl/po/purcordr/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/mtrl/po/purcordr/get/detail2.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/mtrl/po/purcordr/get/invoice.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/mtrl/po/purcordr/get/invoice2.do")
	...
	@RequestMapping(value="/mtrl/po/purcordr/get/impt.do")
	...
	// impt
	@RequestMapping(value="/mtrl/po/purcordr/set/impt.do"  )
	...
	@RequestMapping(value="/mtrl/po/purcordr/set/ok.do"  )
	...
	// 마감 / 해지 수정
	@RequestMapping(value="/mtrl/po/purcordr/set/close.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/mtrl/po/purcordr/set/invoice.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/mtrl/po/purcordr/set/invoice2.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/mtrl/po/purcordr/set/del_yn.do")
	...
	//디테일삭제
	@RequestMapping(value="/mtrl/po/purcordr/set/del_yn2.do")
	...
	//수정체크
		@RequestMapping(value="/mtrl/po/purcordr/chk/cancel.do")
	...
	// 룩업
	@RequestMapping(value="/mtrl/po/purcordr/get/lookup.do"  )
	...
	// 룩업2
	@RequestMapping(value="/mtrl/po/purcordr/get/lookup2.do"  )
	...
	@RequestMapping(value="mtrl/po/purcordr/set/istt.do"  )
	...
	@RequestMapping(value="mtrl/po/purcordr/set/istt2.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/mtrl/po/purcordr/get/product.do")
	...
	@RequestMapping(value="/mtrl/po/purcordr/get/printing.do")
