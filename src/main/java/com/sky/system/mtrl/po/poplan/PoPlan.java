...
@Controller
public class PoPlan  extends DefaultControlHandler{

	@Autowired
	private PoPlanService service;

	@RequestMapping(value="/mtrl/po/poplan/get/search1.do"  )
	...
	@RequestMapping(value="/mtrl/po/poplan/get/search2.do"  )
	...
	@RequestMapping(value="/mtrl/po/poplan/set/detail.do")
