...
@Controller
public class PrjtPurcOrderList  extends DefaultControlHandler{

	@Autowired
	private PrjtPurcOrderListService service;

	@RequestMapping(value="/mtrl/project/prjtpurcorderlist/get/master.do"  )
	...
	@RequestMapping(value="/mtrl/project/prjtpurcorderlist/get/detail.do"  )
