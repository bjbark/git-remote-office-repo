...
@Controller
public class RefnMast extends DefaultControlHandler{

	@Autowired
	private RefnMastService service;
	// 조회
	@RequestMapping(value="/basic/refnmast/get/search.do"  )
	...
	// 룩업
	@RequestMapping(value="/basic/refnmast/get/lookup.do"  )
	...
	// 저장
	@RequestMapping(value="/basic/refnmast/set/record.do"  )
