...
@Controller
public class CarMast extends DefaultControlHandler{

	@Autowired
	private CarMastService service;

	// 조회
	@RequestMapping(value="/basic/carmast/get/search.do"  )
	...
	@RequestMapping(value="/basic/carmast/get/lookup.do"  )
	...
	// 저장
	@RequestMapping(value="/basic/carmast/set/record.do"  )
