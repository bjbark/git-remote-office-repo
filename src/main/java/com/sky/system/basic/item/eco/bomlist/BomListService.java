...
@Service("basic.eco.BomListService")
public class BomListService extends DefaultServiceHandler {
	...
	data.param
		.where("from (																							")
		.where("select a.prnt_item_idcd    , i.item_code         , i.item_name     , i.item_spec				")
	...
	public SqlResultMap getSearch(HttpRequestArgument arg ) throws Exception {
		...
		data.param
			...
			.query("         , endd_date         , stok_plac    , stok_unit_idcd   , aset_clss_dvcd   , wkfw_idcd						")
			...
			.query("         , a.endd_date       , a.stok_plac  , a.stok_unit_idcd , a.aset_clss_dvcd , a.wkfw_idcd						")
			...
			.query("         , a.incm_loss_rate  , a.otcm_loss_rate               , a.wkfw_idcd       , f.wkfw_name						")
			...
			.query("           left outer join wkfw_clss f on a.wkfw_idcd = f.wkfw_idcd													")
