...
public class EcoMast extends DefaultControlHandler{
	...
	// 조회
	@RequestMapping(value="/basic/item/eco/get/search.do"  )
	...
	@RequestMapping(value="/basic/item/eco/get/detail.do")
	...
	@RequestMapping(value="/basic/item/eco/get/detail2.do")
	...
	@RequestMapping(value="/basic/item/eco/set/detail2.do")
	...
	@RequestMapping(value="/basic/item/eco/get/invoice.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/basic/item/eco/set/invoice.do"  )
	...
	@RequestMapping(value="/basic/item/eco/set/Copy.do"  )
...
//	}
	...
	@RequestMapping(value="/basic/item/eco/set/ok.do"  )
	...
	// 룩업
	@RequestMapping(value="/basic/item/eco/get/lookup.do"  )
	...
	// 저장
	@RequestMapping(value="/basic/item/eco/set/record.do"  )
	...
	// 룩업
	@RequestMapping(value="/basic/item/eco/get/offelookup.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/basic/item/eco/set/del_yn.do")
	...
	@RequestMapping(value="/basic/item/eco/set/upload.do")
