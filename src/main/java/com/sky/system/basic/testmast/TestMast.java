...
@Controller
public class TestMast extends DefaultControlHandler{

	@Autowired
	private TestMastService service;
	// 조회
	@RequestMapping(value="/basic/testmast/get/search.do"  )
	...
	// 룩업
	@RequestMapping(value="/basic/testmast/get/lookup.do"  )
	...
	// 저장
	@RequestMapping(value="/basic/testmast/set/record.do"  )
