package com.sky.system.custom.aone.item.itemclss;
...
public class ItemClss  extends DefaultControlHandler{
	...
	@RequestMapping(value="/custom/aone/item/itemclss/get/search.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemclass/get/search/excel.do"  )
	...
	// 룩업
	@RequestMapping(value="/custom/aone/item/itemclss/get/lookup.do")
	...
	// 룩업
	@RequestMapping(value="/custom/aone/item/itemclss/get/maxCode.do")
	public String getMaxCode(
			HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.getMaxCode(http.argument));
		return http.writer;
	}
	@RequestMapping(value="/custom/aone/item/itemclss/set/record.do"  )
