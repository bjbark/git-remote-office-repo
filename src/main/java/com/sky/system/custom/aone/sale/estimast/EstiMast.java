...
public class EstiMast extends DefaultControlHandler{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/aone/sale/estimast/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/aone/sale/estimast/get/detail.do")
	public String getDetail(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.getDetail(http.argument));
		return http.writer;
	}

	@RequestMapping(value="/custom/aone/sale/estimast/get/detail2.do")
	...
	@RequestMapping(value="/custom/aone/sale/estimast/get/detail3.do")
	...
	@RequestMapping(value="/custom/aone/sale/estimast/get/detail4.do")
	...
	@RequestMapping(value="/custom/aone/sale/estimast/get/detail6.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/aone/sale/estimast/get/invoice.do")
	...
	@RequestMapping(value="/custom/aone/sale/estimast/set/detail3.do")
	...
	@RequestMapping(value="/custom/aone/sale/estimast/set/detail6.do")
	public String setDetail6(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setDetail6(http.argument));
		return http.writer;
	}

	// 이미지업로드
	@RequestMapping(value="/custom/aone/sale/estimast/set/fileUpload.do"  )
	...
	@RequestMapping(value="/custom/aone/sale/estimast/get/image.do"  )
	...
	@RequestMapping(value="/custom/aone/sale/estimast/set/esti.do")
	...
	// 마감 / 해지 수정
	@RequestMapping(value="/custom/aone/sale/estimast/set/close.do"  )
	...
	@RequestMapping(value="/custom/aone/sale/estimast/set/acpt.do"  )
	...
	@RequestMapping(value="/custom/aone/sale/estimast/set/copy.do"  )
	...
	@RequestMapping(value="/custom/aone/sale/estimast/set/amend.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/aone/sale/estimast/set/invoice.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/aone/sale/estimast/set/del_yn.do")
	...
	@RequestMapping(value="/custom/aone/sale/estimast/get/orderinfo.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/aone/sale/estimast/get/product.do")
	...
	@RequestMapping(value="/custom/aone/sale/etismast/get/printing.do")
