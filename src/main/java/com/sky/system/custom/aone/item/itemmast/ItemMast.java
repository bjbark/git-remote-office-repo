...
public class ItemMast  extends DefaultControlHandler{
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/search.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/isos.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/rett.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/lookup.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/lookup3.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/lookupspec.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/acpt.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/prod.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/osttrett.do"  )
	...
	// 룩업
	@RequestMapping(value="/custom/aone/item/itemmast/get/product.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/itemacpt.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/itemCodeCheck.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/maxCodeInfo.do"  )
	public String getMaxCodeInfo(HttpMessage http, Map<String, Object> model ) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.getMaxCodeInfo(http.argument));
		return http.writer;
	}


	@RequestMapping(value="/custom/aone/item/itemmast/get/image.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/set/record.do"  )
	public String  setRecord(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setRecord(http.argument));
		return http.writer;
	}
	@RequestMapping(value="/custom/aone/item/itemmast/set/simple.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/set/add.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/set/item_memo.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/set/item_mngt.do"  )
	...
	// 이미지업로드
	@RequestMapping(value="/custom/aone/item/itemmast/set/fileUpload.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/itemdesc.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/item_memo.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/item_mngt.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/item_pkge.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/set/item_pkge.do"  )
	...
	@RequestMapping(value="/custom/aone/item/itemmast/get/pckg_bacd.do"  )
