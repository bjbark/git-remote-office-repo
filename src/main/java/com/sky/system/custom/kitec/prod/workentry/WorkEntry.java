package com.sky.system.custom.kitec.prod.workentry;
...
public class WorkEntry extends DefaultControlHandler{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/kitec/prod/workentry/get/search.do")
	...
	@RequestMapping(value="/custom/kitec/prod/workentry/get/searchDetail.do")
	...
	@RequestMapping(value="/custom/kitec/prod/workentry/get/searchDetail2.do")
	...
	@RequestMapping(value="/custom/kitec/prod/workentry/get/searchDetail3.do")
	...
	@RequestMapping(value="/custom/kitec/prod/workentry/get/getSeqn.do"  )
	...
	@RequestMapping(value="/custom/kitec/prod/workentry/get/wkctsearch.do"  )
	...
	@RequestMapping(value="/custom/kitec/prod/workentry/get/assy_seqn.do"  )
	...
	@RequestMapping(value="/custom/kitec/prod/workentry/get/getCast.do"  )
	...
	@RequestMapping(value="/custom/kitec/prod/workentry/get/lotisossum.do"  )
	...
	//유실조회
	@RequestMapping(value="/custom/kitec/prod/workentry/get/fail.do")
	...
	//유실순번 구하기
	@RequestMapping(value="/custom/kitec/prod/workentry/get/failseqn.do"  )
	...
	//불량순번 구하기
	@RequestMapping(value="/custom/kitec/prod/workentry/get/poorseqn.do"  )
	...
	//불량순번 구하기
	@RequestMapping(value="/custom/kitec/prod/workentry/get/chekrpst.do"  )
	...
	@RequestMapping(value="/custom/kitec/prod/workentry/get/cvicsearch.do"  )
	...
	//불량조회
	@RequestMapping(value="/custom/kitec/prod/workentry/get/poor.do")
	...
	@RequestMapping(value="/custom/kitec/prod/workentry/get/mtrlseqn.do"  )
	...
	@RequestMapping(value="/custom/kitec/prod/workentry/set/setMaster.do"  )
	...
	@RequestMapping(value="/custom/kitec/prod/workentry/set/setCast.do"  )
	...
	@RequestMapping(value="/custom/kitec/prod/workentry/set/Tap.do"  )
	...
	@RequestMapping(value="/custom/kitec/prod/workentry/set/bookmtrl.do"  )
	...
	//불량내역저장
	@RequestMapping(value="/custom/kitec/prod/workentry/set/poor.do"  )
	...
	//불량내역삭제
	@RequestMapping(value="/custom/kitec/prod/workentry/set/poordelete.do"  )
	...
	//유실보고
	@RequestMapping(value="/custom/kitec/prod/workentry/set/fail.do"  )
	...
	//유실내역삭제
	@RequestMapping(value="/custom/kitec/prod/workentry/set/faildelete.do"  )
