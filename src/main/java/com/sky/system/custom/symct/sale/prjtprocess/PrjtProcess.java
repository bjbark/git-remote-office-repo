...
public class PrjtProcess  extends DefaultControlHandler{
	...
	@RequestMapping(value="/custom/symct/sale/prjtprocess/get/mastersearch.do"  )
	...
	@RequestMapping(value="/custom/symct/sale/prjtprocess/get/detail1.do"  )
	...
	@RequestMapping(value="/custom/symct/sale/prjtprocess/get/detail2.do"  )
	...
	@RequestMapping(value="/custom/symct/sale/prjtprocess/get/detail3.do"  )
	...
	@RequestMapping(value="/custom/symct/sale/prjtprocess/get/detail4.do"  )
	...
	@RequestMapping(value="/custom/symct/sale/prjtprocess/get/detail5.do"  )
	...
	@RequestMapping(value="/custom/symct/sale/prjtprocess/get/detail6.do"  )
	...
	@RequestMapping(value="/custom/symct/sale/prjtprocess/get/detail7.do"  )
	...
	@RequestMapping(value="/custom/symct/sale/prjtprocess/get/detail8.do"  )
	...
	// 수금보고
	@RequestMapping(value="/custom/symct/sale/prjtprocess/set/colt.do")
	...
	//수주내역 마감/해지/보류
	@RequestMapping(value="/custom/symct/sale/prjtprocess/set/close.do"  )
	...
	// 이미지업로드
	@RequestMapping(value="/custom/symct/sale/prjtprocess/set/fileUpload.do"  )
