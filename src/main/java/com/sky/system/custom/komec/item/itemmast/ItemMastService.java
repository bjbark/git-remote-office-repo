...
public class ItemMastService extends DefaultServiceHandler {
	...
	public SqlResultMap getSearch(HttpRequestArgument arg, int page, int rows, String sort ) throws Exception {
		...
		data.param
			...
			.where("     , (select base_name from base_mast r4  where  r4.base_code	= mt.mtrl_labl_code and r4.prnt_idcd = '8006' and line_stat = 0 limit 1) item_labl_name														")
			...
			.where("      , json_value(a.json_data,'$.drtr_idcd' 	  ) 	 as drtr_idcd						")
			.where("	  , (select user_name from user_mast where user_idcd = json_value(a.json_data,'$.drtr_idcd')) as drtr_name")
			.where("      , wr.zone_name as stor_plac_name   , f3.wrhs_name as stor_wrhs_name					")
			.where("      , mt.hala_numb     , mt.natr_yorn   , mt.incm_cost									")
