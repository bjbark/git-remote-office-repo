...
@Service("komec.stock.isos.ProdOsttWork")
@Controller
public class ProdOsttWork extends DefaultControlHandler{

	@Autowired
	private ProdOsttWorkService service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/komec/stock/isos/prodosttwork/get/search.do")
	...
	@RequestMapping(value="/custom/komec/stock/isos/prodosttwork/get/lotchk.do"  )
	public String getLotChk( HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.getLotChk(http.argument));
		return http.writer;
	}

	@RequestMapping(value="/custom/komec/stock/isos/prodosttwork/get/lot.do")
	public String getLot( HttpMessage http, Map<String, Object> model,
		@RequestParam(value="page" , required=true, defaultValue="1" ) int page,
		@RequestParam(value="limit", required=true, defaultValue="10") int rows,
		@RequestParam(value="sort" , required=false, defaultValue = "" ) String sort) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.getLot(http.argument, page, rows, sort));
		return http.writer;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/komec/stock/isos/prodosttwork/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/komec/stock/isos/prodosttwork/get/invoice.do")
	...
	// 마감 / 해지 수정
	@RequestMapping(value="/custom/komec/stock/isos/prodosttwork/set/close.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/komec/stock/isos/prodosttwork/set/invoice.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/komec/stock/isos/prodosttwork/set/del_yn.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/komec/stock/isos/prodosttwork/get/product.do")
	...
	@RequestMapping(value="/custom/komec/stock/isos/prodosttwork/get/printing.do")
