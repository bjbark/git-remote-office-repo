package com.sky.system.custom.komec.sale.order.saleorder;
...
@Service("komec.SaleOrderService")
	...
	public SqlResultMap getSearch(HttpRequestArgument arg, int page, int rows, String sort ) throws Exception {
		...
		;
			...
			data.param
				...
				.where("		, w.wrhs_code       , w.wrhs_name       , i.pdsd_yorn         , i.vatx_amnt				")
				.where("		, i.item_idcd       , i.invc_amnt       , i.cstm_lott_numb								")
...
//					.update("expt_dvcd"			, row.getParameter("expt_dvcd"			))  /*  수출구분코드  */
	...
	public SqlResultMap setInvoiceInsert(HttpRequestArgument arg) throws Exception {
		...
		System.out.println("==> STEP 1) setInvoiceInsert");
	...
	public void setInvoiceInsertDetail(HttpRequestArgument arg, DataMessage data, SqlResultRow mst, SqlResultMap map) throws Exception {
		...
		System.out.println("==> STEP 1) setInvoiceInsertDetail");
