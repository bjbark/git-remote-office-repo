...
public class ProdPlan extends DefaultControlHandler{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/inkopack/prod/prodplan/get/search1.do"  )
	...
	@RequestMapping(value="/custom/inkopack/prod/prodplan/get/search2.do"  )
	...
	@RequestMapping(value="/custom/inkopack/prod/prodplan/get/write.do" )
	...
	@RequestMapping(value="/custom/inkopack/prod/prodplan/get/writebom.do"  )
	...
	@RequestMapping(value="/custom/inkopack/prod/prodplan/set/write.do"  )
	...
	@RequestMapping(value="/custom/inkopack/prod/prodplan/set/delete.do")
	...
	// lister2 저장
	@RequestMapping(value="/custom/inkopack/prod/prodplan/set/plan.do"  )
	...
	//지시확정
	@RequestMapping(value="/custom/inkopack/prod/prodplan/set/ok.do"  )
