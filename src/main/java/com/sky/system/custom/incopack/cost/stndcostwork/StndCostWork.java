...
@Controller
public class StndCostWork extends DefaultControlHandler{

	@Autowired
	private StndCostWorkService service;
	// 조회
	@RequestMapping(value="/custom/incopack/cost/stndcostwork/get/search.do"  )
	...
	// 저장
	@RequestMapping(value="/custom/incopack/cost/stndcostwork/set/record.do"  )
	...
	// 순번
	@RequestMapping(value="/custom/incopack/cost/stndcostwork/get/work.do"  )
