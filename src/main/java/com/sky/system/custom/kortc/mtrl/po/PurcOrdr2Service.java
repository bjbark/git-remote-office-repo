...
@Service("kortc.PurcOrdr2Service")
public class PurcOrdr2Service  extends DefaultServiceHandler {
	...
	public SqlResultMap getDetail(HttpRequestArgument arg) throws Exception {
		...
		data.param
			...
			.query("	 , a.unit_idcd, u.unit_code, u.unit_name , a.user_memo , c.cstm_name							")
	...
	public SqlResultMap getSearch2(HttpRequestArgument arg, int page, int rows, String sort ) throws Exception {
		...
		data.param
			...
			.where("                       ) i on b.invc_numb = i.invc_numb											")
	...
	public SqlResultMap getSearch3(HttpRequestArgument arg) throws Exception {
		...
		data.param
			...
			.query("		, a.reqt_amnt as offr_amnt            , c.cstm_name      , c.cstm_idcd							")
		...
		data.param
			...
			.where("       left outer join cstm_mast c on c.cstm_idcd = json_value(i.json_data,'$.cstm_idcd')				")
			.where("where  1=1																								")
			.where("and    a.invc_numb	=:invc_numb		" , arg.getParamText("invc_numb"))
			.where("and    a.line_stat   < :line_stat	" , "2" , "".equals(arg.getParamText("line_stat" )))
	...
	data.param
		...
		if(arg.getParamText("hqof_idcd").toUpperCase().equals("N1000A-ONE")){
			data.param
				.where("and    a.acct_bacd   in ('102')  " , "발주".equals(arg.getParamText("acct_bacd" )))
			;
		}
...
//			}
	...
	public SqlResultMap setRecord(HttpRequestArgument arg) throws Exception {
		...
		String hq               = arg.getParamText("hqof_idcd") ;
		String invc_numb        = arg.getParamText("invc_numb") ;
		String purc_date        = arg.getParamText("invc_date") ;
...
//			data.param
//				.query("call auto_purc_ordr2_item_set (			")
//				.query("   :STOR      "  , hq			 )  // 본사코드
//				.query(" , :invc_numb "  , invc_numb	 )  // Invoice 번호
//				.query(" , :purc_date "  , purc_date 	)  //
...
//			data.execute();
	...
	public SqlResultMap Itemset(HttpRequestArgument arg) throws Exception {

		DataMessage data = arg.newStorage("POS");

		String hq	= arg.getParamText("hqof_idcd") ;
		String invc_numb  = arg.getParamText("invc_numb");
		String purc_date  = arg.getParamText("purc_date");
		String deli_date  = arg.getParamText("deli_date");
		String drtr_idcd  = arg.getParamText("drtr_idcd");
