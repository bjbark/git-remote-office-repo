...
public class SorderOsttView  extends DefaultControlHandler{
	...
	// 거래처별 월 원단 매입 통계
	@RequestMapping(value="/custom/kortc/sale/order/sorderosttview/get/master1.do")
	...
	@RequestMapping(value="/custom/kortc/sale/order/sorderosttview/get/master2.do")
	...
	// 거래처별 월 매입 통계
	@RequestMapping(value="/custom/kortc/sale/order/sorderosttview/get/master3.do")
