...
@Service("kortc.rsvdorderservice")
public class RsvdOrderService  extends DefaultServiceHandler {
	...
	public SqlResultMap getSearch(HttpRequestArgument arg, int page, int rows, String sort ) throws Exception {
		...
		data.param
			...
			.where("		, a.crte_idcd       , a.crte_urif       , count(ai.invc_numb) as item_cnt				")
	...
	public SqlResultMap getDetail(HttpRequestArgument arg) throws Exception {
		...
		data.param
			...
			.query("     , a.cstm_lott_numb , a.pdsd_yorn      , w.wrhs_name      , a.deli_date as deli_date2			")
