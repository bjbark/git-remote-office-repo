package com.sky.system.custom.kortc.mtrl.po;
...
public class PurcOrdr2 extends DefaultControlHandler{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/get/detail2.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/get/invoice.do")
	...
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/get/search2.do")
	...
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/get/search3.do")
	...
	// 마감 / 해지 수정
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/set/close.do"  )
	...
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/set/ok.do"  )
	...
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/get/itemcode.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/set/invoice.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/set/invoice2.do"  )
	...
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/get/impt.do")
	...
	// impt
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/set/impt.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/set/del_yn.do")
	...
	//디테일삭제
		@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/set/del_yn2.do")
	...
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/set/record.do")
	...
	//수정체크
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/chk/cancel.do")
	...
	// 룩업
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/get/lookup.do"  )
	...
	// 룩업2
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/get/lookup2.do"  )
	...
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/set/istt.do"  )
	...
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/set/item.do"  )
	...
	@RequestMapping(value="/custom/kortc/mtrl/po/purcordr2/set/itemset.do"  )
	public String Itemset(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.Itemset(http.argument ));
		return http.writer;
