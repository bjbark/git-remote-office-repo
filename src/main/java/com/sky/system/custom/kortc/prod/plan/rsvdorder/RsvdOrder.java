package com.sky.system.custom.kortc.prod.plan.rsvdorder;
...
public class RsvdOrder extends DefaultControlHandler{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/kortc/prod/plan/rsvdorder/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/kortc/prod/plan/rsvdorder/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/kortc/prod/plan/rsvdorder/get/invoice.do")
	...
	// 마감 / 해지 수정
	@RequestMapping(value="/custom/kortc/prod/plan/rsvdorder/set/close.do"  )
	...
	@RequestMapping(value="/custom/kortc/prod/plan/rsvdorder/set/copy.do"  )
	...
	@RequestMapping(value="/custom/kortc/prod/plan/rsvdorder/set/ok.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/kortc/prod/plan/rsvdorder/set/invoice.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/kortc/prod/plan/rsvdorder/set/del_yn.do")
	...
	// 생산지시
	@RequestMapping(value="/custom/kortc/prod/plan/rsvdorder/set/pror.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/kortc/prod/plan/rsvdorder/get/product.do")
