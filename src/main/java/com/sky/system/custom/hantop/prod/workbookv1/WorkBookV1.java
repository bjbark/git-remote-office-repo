...
public class WorkBookV1 extends DefaultControlHandler{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/hantop/prod/workbookv1/get/search.do")
	...
	@RequestMapping(value="/custom/hantop/prod/workbookv1/get/searchDetail.do")
	...
	@RequestMapping(value="/custom/hantop/prod/workbookv1/get/searchDetail2.do")
	...
	@RequestMapping(value="/custom/hantop/prod/workbookv1/get/searchDetail3.do")
	...
	@RequestMapping(value="/custom/hantop/prod/workbookv1/set/setMaster.do"  )
	...
	@RequestMapping(value="/custom/hantop/prod/workbookv1/get/getSeqn.do"  )
	...
	@RequestMapping(value="/custom/hantop/prod/workbookv1/get/cvicsearch.do"  )
	...
	//일시정지 후 시작시 필요한 정보
	@RequestMapping(value="/custom/hantop/prod/workbookv1/get/pause.do"  )
	...
	//불량순번 구하기
	@RequestMapping(value="/custom/hantop/prod/workbookv1/get/poorseqn.do"  )
	...
	//불량내역저장
	@RequestMapping(value="/custom/hantop/prod/workbookv1/set/poor.do"  )
	...
	//불량조회
	@RequestMapping(value="/custom/hantop/prod/workbookv1/get/poor.do")
	...
	//불량내역삭제
	@RequestMapping(value="/custom/hantop/prod/workbookv1/set/poordelete.do"  )
	...
	//유실조회
	@RequestMapping(value="/custom/hantop/prod/workbookv1/get/fail.do")
	...
	//유실순번 구하기
	@RequestMapping(value="/custom/hantop/prod/workbookv1/get/failseqn.do"  )
	...
	//유실보고
	@RequestMapping(value="/custom/hantop/prod/workbookv1/set/fail.do"  )
	...
	//유실내역삭제
	@RequestMapping(value="/custom/hantop/prod/workbookv1/set/faildelete.do"  )
