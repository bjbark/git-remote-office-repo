...
@Controller
public class ItemGroup extends DefaultControlHandler{

	@Autowired
	private ItemGroupService service;
	// 조회
	@RequestMapping(value="/custom/hantop/item/itemgroup/get/search.do"  )
	...
	// 룩업
	@RequestMapping(value="/custom/hantop/item/itemgroup/get/lookup.do"  )
	...
	// 저장
	@RequestMapping(value="/custom/hantop/item/itemgroup/set/record.do"  )
