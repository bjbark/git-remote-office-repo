...
@Controller
public class CstmItemMast  extends DefaultControlHandler{

	@Autowired
	private CstmItemMastService service;


	@RequestMapping(value="/custom/hantop/item/cstmitemmast/get/search.do")
	...
	@RequestMapping(value="/custom/hantop/item/cstmitemmast/get/search2.do")
	...
	@RequestMapping(value="/custom/hantop/item/cstmitemmast/get/search3.do")
	...
	@RequestMapping(value="/custom/hantop/item/cstmitemmast/get/search4.do")
