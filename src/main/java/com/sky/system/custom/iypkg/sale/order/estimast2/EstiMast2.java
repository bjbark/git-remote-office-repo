...
@Service("iypkg.EstiMast2")
@Controller
public class EstiMast2 extends DefaultControlHandler{

	@Autowired
	private EstiMast2Service service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/get/detail2.do")
	...
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/get/detail5.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/get/invoice.do")
	...
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/get/invoice2.do")
	...
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/get/invoice3.do")
	...
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/get/invoice4.do")
	public String getInvoice4(HttpMessage http, Map<String, Object> model) throws Exception {

		model.put(HttpResponseMessage.RECORDS, service.getInvoice4(http.argument));
		return http.writer;
	}

	// 마감 / 해지 수정
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/set/close.do"  )
	...
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/set/acpt.do"  )
	...
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/set/copy.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/set/invoice.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/set/invoice2.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/set/invoice3.do"  )
	public String setInvoice3(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setInvoice3(http.argument));
		return http.writer;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/set/invoice4.do"  )
	public String setInvoice4(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setInvoice4(http.argument));
		return http.writer;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/set/del_yn.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/get/product.do")
	...
	@RequestMapping(value="/custom/iypkg/sale/order/estimast2/get/printing.do")
