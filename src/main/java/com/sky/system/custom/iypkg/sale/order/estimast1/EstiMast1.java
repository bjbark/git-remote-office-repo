...
@Service("iypkg.EstiMast1")
@Controller
public class EstiMast1 extends DefaultControlHandler{

	@Autowired
	private EstiMast1Service service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast1/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast1/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast1/get/detail2.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast1/get/invoice.do")
	...
	// 마감 / 해지 수정
	@RequestMapping(value="/custom/iypkg/sale/order/estimast1/set/close.do"  )
	...
	@RequestMapping(value="/custom/iypkg/sale/order/estimast1/set/acpt.do"  )
	...
	@RequestMapping(value="/custom/iypkg/sale/order/estimast1/set/copy.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast1/set/invoice.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast1/set/del_yn.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast1/get/product.do")
	...
	@RequestMapping(value="/custom/iypkg/sale/order/estimast1/get/fabc.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/iypkg/sale/order/estimast1/set/amend.do"  )
	...
	@RequestMapping(value="/custom/iypkg/sale/order/estimast1/get/printing.do")
