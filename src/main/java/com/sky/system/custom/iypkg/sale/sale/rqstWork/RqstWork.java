...
@Controller
public class RqstWork  extends DefaultControlHandler{


	@Autowired
	private RqstWorkService service;


	@RequestMapping(value="/custom/iypkg/sale/sale/rqstwork/get/search.do")
	...
	@RequestMapping(value="/custom/iypkg/sale/sale/rqstwork/get/search2.do")
	...
	@RequestMapping(value="/custom/iypkg/sale/sale/rqstwork/get/search3.do")
	...
	@RequestMapping(value="/custom/iypkg/sale/sale/rqstwork/set/record.do")
	public String setRecord(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setRecord(http.argument));
		return http.writer;
	}

	@RequestMapping(value="/custom/iypkg/sale/sale/rqstwork/set/del_yn.do")
