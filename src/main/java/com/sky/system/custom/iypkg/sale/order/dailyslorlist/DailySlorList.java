...
@Service("iypkg.DailySlorList")
@Controller
public class DailySlorList extends DefaultControlHandler{

	@Autowired
	private DailySlorListService service;

	//조회
	@RequestMapping(value="/custom/iypkg/sale/order/dailyslorlist/get/search.do")
