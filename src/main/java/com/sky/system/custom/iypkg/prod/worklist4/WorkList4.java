...
@Service("iypkg.WorkList4")
@Controller
public class WorkList4  extends DefaultControlHandler{

	@Autowired
	private WorkList4Service service;


	@RequestMapping(value="/custom/iypkg/prod/worklist4/get/search.do")
	...
	@RequestMapping(value="/custom/iypkg/prod/worklist4/get/search2.do")
	...
	@RequestMapping(value="/custom/iypkg/prod/worklist4/get/search3.do")
