...
@Controller
public class EisReport13  extends DefaultControlHandler{

	@Autowired
	private EisReport13Service service;

	// 담당자 및 거래처
	@RequestMapping(value="/custom/iypkg/eis/eisreport13/get/search1.do")
	...
	@RequestMapping(value="/custom/iypkg/eis/eisreport13/get/detail1.do")
	...
	// 담당자 목표대비 실적
	@RequestMapping(value="/custom/iypkg/eis/eisreport13/get/search2.do")
	...
	@RequestMapping(value="/custom/iypkg/eis/eisreport13/get/detail2.do")
	...
	// 월거래처 매출 및 수금 통계
	@RequestMapping(value="/custom/iypkg/eis/eisreport13/get/search3.do")
	...
	@RequestMapping(value="/custom/iypkg/eis/eisreport13/get/detail3.do")
	...
	@RequestMapping(value="/custom/iypkg/eis/eisreport13/get/cary_amnt.do")
	...
	@RequestMapping(value="/custom/iypkg/eis/eisreport13/get/befr_amnt.do")
	...
	@RequestMapping(value="/custom/iypkg/eis/eisreport13/get/chart2.do")
	...
	@RequestMapping(value="/custom/iypkg/eis/eisreport13/get/chart3.do")
