...
@Service("iypkg.IsttWork3")
@Controller
public class IsttWork3  extends DefaultControlHandler{

	@Autowired
	private IsttWork3Service service;


	@RequestMapping(value="/custom/iypkg/stock/isos/isttwork3/get/search.do")
	...
	@RequestMapping(value="/custom/iypkg/stock/isos/isttwork3/get/search2.do")
	...
	@RequestMapping(value="/custom/iypkg/stock/isos/isttwork3/get/search3.do")
	...
	@RequestMapping(value="/custom/iypkg/stock/isos/isttwork3/set/record.do")
	public String setRecord(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setRecord(http.argument));
		return http.writer;
	}

	@RequestMapping(value="/custom/iypkg/stock/isos/isttwork3/set/record2.do")
	...
	@RequestMapping(value="/custom/iypkg/stock/isos/isttwork3/set/del_yn.do")
	...
	@RequestMapping(value="/custom/iypkg/stock/isos/isttwork3/get/invc.do"  )
