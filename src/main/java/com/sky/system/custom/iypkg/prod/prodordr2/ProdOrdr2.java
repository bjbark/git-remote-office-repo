...
@Service("iypkg.ProdOrdr2")
@Controller
public class ProdOrdr2 extends DefaultControlHandler{

	@Autowired
	private ProdOrdr2Service service;

	// master1 조회
	@RequestMapping(value="/custom/iypkg/prod/prodordr2/get/master1.do" )
	...
	// master2 조회
	@RequestMapping(value="/custom/iypkg/prod/prodordr2/get/master2.do" )
	...
	// detail1조회
	@RequestMapping(value="/custom/iypkg/prod/prodordr2/get/detail1.do" )
	...
	// detail2 조회
	@RequestMapping(value="/custom/iypkg/prod/prodordr2/get/detail2.do" )
	...
	// detail2 조회
	@RequestMapping(value="/custom/iypkg/prod/prodordr2/get/detailfabc.do" )
	...
	// 저장
	@RequestMapping(value="/custom/iypkg/prod/prodordr2/set/record.do"  )
	...
	// 삭제
	@RequestMapping(value="/custom/iypkg/prod/prodordr2/set/del_yn.do")
