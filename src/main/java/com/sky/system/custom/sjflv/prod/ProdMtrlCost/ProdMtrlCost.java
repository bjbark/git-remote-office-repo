package com.sky.system.custom.sjflv.prod.ProdMtrlCost;
...
@Controller
public class ProdMtrlCost  extends DefaultControlHandler{

	@Autowired
	private ProdMtrlCostService service;


	@RequestMapping(value="/custom/sjflv/prod/prodmtrlcost/get/list1.do")
	...
	@RequestMapping(value="/custom/sjflv/prod/prodmtrlcost/get/list2.do")
