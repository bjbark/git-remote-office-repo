...
public class EstiMast2 extends DefaultControlHandler{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/sale/order/estimast2/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/sale/order/estimast2/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/sale/order/estimast2/get/invoice.do")
	...
	// 마감 / 해지 수정
	@RequestMapping(value="/custom/sjflv/sale/order/estimast2/set/close.do"  )
	...
	@RequestMapping(value="/custom/sjflv/sale/order/estimast2/set/acpt.do"  )
	...
	@RequestMapping(value="/custom/sjflv/sale/order/estimast2/set/copy.do"  )
	...
	@RequestMapping(value="/custom/sjflv/sale/order/estimast2/set/invoiceCheck.do")
	public String getInvoiceCheck(HttpMessage http, Map<String, Object> model) throws Exception {

		model.put(HttpResponseMessage.RECORDS, service.getInvoiceCheck(http.argument));
		return http.writer;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/sale/order/estimast2/set/invoice.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/sale/order/estimast2/set/del_yn.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/sale/order/estimast2/get/product.do")
	...
	@RequestMapping(value="/custom/sjflv/sale/order/estimast2/get/checkLastSeqn.do")
	public String getCheckLastSeqn(HttpMessage http, Map<String, Object> model ) throws Exception {

		model.put(HttpResponseMessage.RECORDS, service.getCheckLastSeqn(http.argument));
		return http.writer;
	}
	...
	@RequestMapping(value="/custom/sjflv/sale/order/etismast2/get/printing.do")
