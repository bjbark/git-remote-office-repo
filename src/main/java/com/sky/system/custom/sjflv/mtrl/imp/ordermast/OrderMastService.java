...
@Service("sjflv.imp.OrderMastService")
public class OrderMastService  extends DefaultServiceHandler {
	...
	public SqlResultMap getSearch(HttpRequestArgument arg, int page, int rows, String sort ) throws Exception {
		...
		data.param
			...
			.where("       and    ship_schd_date >= :ship_schd_date1"   , arg.getParamText("ship_schd_date1"))
			.where("       and    ship_schd_date <= :ship_schd_date2"   , arg.getParamText("ship_schd_date2"))
			...
			.where("       and    incm_dvcd = :incm_dvcd"     , arg.getParamText("incm_dvcd" ))
			.where("       and    ship_viaa_dvcd = :ship_viaa_dvcd"     , arg.getParamText("ship_viaa_dvcd" ))
			.where("       and    line_stat   < :line_stat		" , "2" , "".equals(arg.getParamText("line_stat" )))
			.where("       and    buyr_name	like %:buyr_name%	" , arg.getParamText("buyr_name"))
