...
public class MtrlStockList extends DefaultControlHandler{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/stock/mtrlstocklist/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/stock/mtrlstocklist/get/detail.do")
	public String getDetail(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.getDetail(http.argument));
		return http.writer;
	}
	
	@RequestMapping(value="/custom/sjflv/stock/mtrlstocklist/get/detail2.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/stock/mtrlstocklist/get/invoice.do")
	...
	//출고내역 마감/해지
	@RequestMapping(value="/custom/sjflv/stock/mtrlstocklist/set/close.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/stock/mtrlstocklist/set/invoice.do"  )
	 ...
	 * @throws Exception
	 */
//	@RequestMapping(value="/custom/sjflv/stock/mtrlstocklist/set/del_yn.do")
...
//	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/stock/mtrlstocklist/get/product.do")
	...
	@RequestMapping(value="/custom/sjflv/stock/mtrlstocklist/get/printing.do")
