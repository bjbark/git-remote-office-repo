...
@Service("sjung.InitStay")
@Controller
public class InitStay  extends DefaultControlHandler{

	@Autowired
	private InitStayService service;


	@RequestMapping(value="/custom/sjflv/mtrl/isttcalc/initstay/get/search.do")
	...
	@RequestMapping(value="/custom/sjflv/mtrl/isttcalc/initstay/get/search2.do")
	...
	@RequestMapping(value="/custom/sjflv/mtrl/isttcalc/initstay/set/update.do")
	...
	@RequestMapping(value="/custom/sjflv/mtrl/isttcalc/initstay/set/del_yn.do")
