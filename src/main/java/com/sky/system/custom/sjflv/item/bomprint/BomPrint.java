...
@Service("sjflv.BomPrint")
@Controller
public class BomPrint  extends DefaultControlHandler{

	@Autowired
	private BomPrintService service;

	@RequestMapping(value="/custom/sjflv/item/bomprint/get/search.do"  )
	...
	@RequestMapping(value="/custom/sjflv/item/bomprint/get/search2.do"  )
	...
	@RequestMapping(value="/custom/sjflv/item/bomprint/get/search3.do"  )
