...
@Service("sjflv.imp.OrderListService")
public class OrderListService  extends DefaultServiceHandler {
	@Autowired
	...
	public SqlResultMap getSearch(HttpRequestArgument arg, int page, int rows, String sort ) throws Exception {
		...
		;
		data.param
			.query("select   z.bzpl_name        , b.bzpl_idcd       , b.incm_dvcd        , b.cstm_idcd 									")
			.query("       , b.invc_date as ordr_date               , a.invc_numb as ordr_numb											")
			.query("       , a.item_idcd        , i.item_name       , t.cstm_name as buyr												")
			...
			.query("       , cast(json_unquote(json_extract(a.json_data,'$.cmis_pric') ) as decimal) as cmis_pric        , b.buyr_name	")
			.query("       , cast(json_unquote(json_extract(a.json_data,'$.cmis_amnt') ) as decimal) as cmis_amnt						")
			.query("       , cast(json_unquote(json_extract(a.json_data,'$.pfit_pric') ) as decimal) as pfit_pric						")
			.query("       , cast(json_unquote(json_extract(a.json_data,'$.pfit_amnt') ) as decimal) as pfit_amnt						")
			.query("       , a.qntt             , a.krwn_pric       , a.krwn_amnt        , b.ship_viaa_dvcd								")
			.query("       , b.etdd             , b.etaa            , c.invc_numb        , c.invc_date                   , b.ecdd		")
			.query("       , b.trde_trnt_dvcd   , a.exch_pric       , a.exch_amnt        , b.mdtn_prsn									")
			.query("       , b.drtr_idcd        , u.user_name as drtr_name               , b.pric_cond_dvcd								")
			.query("       , b.trde_stot_dvcd   , b.stot_time_dvcd  , b.stot_ddln        , b.mney_unit									")
			.query("       , b.exrt             , b.ship_port       , b.dsch_port        , b.offr_numb									")
			.query("       , b.arvl_port        , b.pckg_unit       , b.ogin_name        , a.line_seqn									")
			.query("       , b.paym_yorn        , b.paym_date       , b.paym_numb        , b.paym_memo									")
			.query("       , td.dlvy_drtr_name as mdtn_name         , a.amnd_degr        , b.cofm_yorn									")
			.query("       , cs.cstm_name as reqt_cstm_name																						")


			.query("       , b.user_memo        , a.sysm_memo       , a.prnt_idcd        , a.line_levl	")
			.query("       , a.line_ordr        , a.line_stat       , b.line_clos        , a.find_name	")
			.query("       , a.updt_user_name   , a.updt_ipad       , a.updt_dttm        , a.updt_idcd	")
			.query("       , a.updt_urif        , a.crte_user_name  , a.crte_ipad        , a.crte_dttm	")
			.query("       , a.crte_idcd        , a.crte_urif											")
		;
		data.param
			.where("from ( select a.invc_numb,max(a.amnd_degr) as amnd_degr						")
			.where("       from impt_ordr_mast a											")
			.where("       left outer join impt_ordr_item b on a.invc_numb = b.invc_numb	")
			.where("       where  1=1 														")
			...
			.where("       and    b.ship_schd_date >= :ship_schd_date1"   , arg.getParamText("ship_schd_date1"))
			.where("       and    b.ship_schd_date <= :ship_schd_date2"   , arg.getParamText("ship_schd_date2"))
			.where("       and    a.incm_dvcd = :incm_dvcd"     , arg.getParamText("incm_dvcd" ))
			...
			.where("       and    a.incm_dvcd = :incm_dvcd"     , arg.getParamText("incm_dvcd" ))
			.where("       and    a.ship_viaa_dvcd = :ship_viaa_dvcd"     , arg.getParamText("ship_viaa_dvcd" ))
			.where("       and    a.line_stat   < :line_stat		" , "2" , "".equals(arg.getParamText("line_stat" )))
			.where("       and    a.buyr_name	like %:buyr_name%	" , arg.getParamText("buyr_name"))
	...
	public SqlResultMap getDetail(HttpRequestArgument arg) throws Exception {
		...
		data.param
			...
			.query("		, a.item_hscd       , a.mker_name       , a.unit_idcd      , a.qntt				")
			.query("		, a.exch_pric       , a.exch_amnt       , a.krwn_pric      , a.krwn_amnt		")
			.query("		, a.deli_date       , a.ship_schd_date  , a.ostt_wrhs_idcd , a.dlvy_cstm_idcd	")
			.query("		, a.dlvy_date       , a.dlvy_time       , a.orig_seqn      , a.trnt_exps		")
			.query("		, a.extr_exps       , a.sett_amnt       , a.sett_pric							")
			.query("		, a.user_memo       , a.sysm_memo       , a.prnt_idcd      , a.line_levl		")
			.query("		, a.line_ordr       , a.line_stat       , a.line_clos      , a.find_name		")
			.query("		, a.updt_user_name  , a.updt_ipad       , a.updt_dttm      , a.updt_idcd		")
			.query("		, a.updt_urif       , a.crte_user_name  , a.crte_ipad      , a.crte_dttm		")
			.query("		, a.crte_idcd       , a.crte_urif												")
			.query("		, i.item_code       , i.item_name      , i.unit_idcd							")
			.query("		, u.unit_name																	")
		;
		data.param
	...
	public SqlResultMap getInvoice(HttpRequestArgument arg) throws Exception {
		...
		data.param
			...
			.query("      , td.dlvy_drtr_name as mdtn_name        , a.cofm_yorn        , a.ship_memo		")
			.query("       , cs.cstm_name as reqt_cstm_name													")
	...
	public SqlResultMap getSply(HttpRequestArgument arg, int page, int rows, String sort ) throws Exception {
		...
		data.param
			...
			.query("       , cast(json_unquote(json_extract(a.json_data,'$.each_qntt') ) as decimal) as each_qntt         , b.vldt		")
			.query("       , cast(json_unquote(json_extract(a.json_data,'$.pckg_size') ) as decimal) as pckg_size        , b.cofm_date	")
			.query("       , cast(json_unquote(json_extract(a.json_data,'$.cmis_pric') ) as decimal) as cmis_pric						")
			.query("       , cast(json_unquote(json_extract(a.json_data,'$.cmis_amnt') ) as decimal) as cmis_amnt						")
			.query("       , cast(json_unquote(json_extract(a.json_data,'$.pfit_pric') ) as decimal) as pfit_pric						")
			.query("       , cast(json_unquote(json_extract(a.json_data,'$.pfit_amnt') ) as decimal) as pfit_amnt						")
			.query("       , a.qntt             , a.krwn_pric       , a.krwn_amnt						")
