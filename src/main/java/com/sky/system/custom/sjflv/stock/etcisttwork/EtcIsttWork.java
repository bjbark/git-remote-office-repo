...
@Controller
@Service("sjflv.EtcIsttWork")
public class EtcIsttWork extends DefaultControlHandler{

	@Autowired
	private EtcIsttWorkService service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/stock/etcisttwork/get/search.do")
	...
	@RequestMapping(value="/custom/sjflv/stock/etcisttwork/get/search2.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/stock/etcisttwork/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/stock/etcisttwork/get/invoice.do")
	...
	//입고내역 마감/해지
	@RequestMapping(value="/custom/sjflv/stock/etcisttwork/set/close.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/stock/etcisttwork/set/invoice.do"  )
	...
	@RequestMapping(value="/custom/sjflv/stock/etcisttwork/set/invoice2.do"  )
	...
	@RequestMapping(value="/custom/sjflv/stock/etcisttwork/set/etcistt.do"  )
	public String setEtcIstt(HttpMessage http, Map<String, Object> model) throws Exception {

		model.put(HttpResponseMessage.RECORDS, service.setEtcIstt(http.argument));
		return http.writer;
	}
	
	@RequestMapping(value="/custom/sjflv/stock/etcisttwork/set/etcistt2.do"  )
	public String setEtcIstt2(HttpMessage http, Map<String, Object> model) throws Exception {

		model.put(HttpResponseMessage.RECORDS, service.setEtcIstt2(http.argument));
		return http.writer;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/stock/etcisttwork/set/del_yn.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/custom/sjflv/stock/etcisttwork/get/product.do")
	...
	@RequestMapping(value="/custom/sjflv/stock/etcisttwork/get/printing.do")
