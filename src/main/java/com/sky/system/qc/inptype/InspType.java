...
@Controller
public class InspType extends DefaultControlHandler{

	@Autowired
	private InspTypeService service;
	// 조회
	@RequestMapping(value="/qc/basic/insptype/get/search.do"  )
	...
	// 룩업
	@RequestMapping(value="/qc/basic/insptype/get/lookup.do"  )
	...
	// 저장
	@RequestMapping(value="/qc/basic/insptype/set/record.do"  )
	...
	//FileSearch
		@RequestMapping(value="/qc/basic/insptype/get/filesearch.do"  )
