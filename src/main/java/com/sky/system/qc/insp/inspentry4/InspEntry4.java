...
@Controller
public class InspEntry4 extends DefaultControlHandler{

	@Autowired
	private InspEntry4Service service;
...
//	 * @throws Exception
//	 */
//	@RequestMapping(value="/qc/insp/inspentry4/get/search.do")
...
//	 * @throws Exception
//	 */
//	@RequestMapping(value="/qc/insp/inspentry4/get/detail.do")
...
//	 * @throws Exception
//	 */
//	@RequestMapping(value="/qc/insp/inspentry4/get/invoice.do")
...
//	}
	...
	@RequestMapping(value="/qc/insp/inspentry4/set/setOstt.do"  )
...
//	 * @throws Exception
//	 */
//	@RequestMapping(value="/qc/insp/inspentry4/get/product.do")
...
//	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/qc/insp/inspentry4/get/searchspts.do")
...
//	@RequestMapping(value="/qc/insp/inspentry4/set/pass.do"  )
...
//	}
	...
	@RequestMapping(value="/qc/insp/inspentry4/set/pass2.do"  )
	public String setPass2(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setPass2(http.argument ));
		return http.writer;

	}

	@RequestMapping(value="/qc/insp/inspentry4/set/pass3.do"  )
	public String setPass3(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setPass3(http.argument ));
		return http.writer;

	}

	@RequestMapping(value="/qc/insp/inspentry4/set/pass4.do"  )
	public String setPass4(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setPass4(http.argument ));
		return http.writer;
...
//	 * @throws Exception
//	 */
//	@RequestMapping(value="/qc/insp/inspentry4/get/detailspts.do")
...
//	}
	...
	@RequestMapping(value="/qc/insp/inspentry4/get/printing.do")
	...
	@RequestMapping(value="/qc/insp/inspentry4/get/inspcond.do")
	public String getInspCond( HttpMessage http, Map<String, Object> model,
			@RequestParam(value="page" , required=true, defaultValue="1" ) int page,
			@RequestParam(value="limit", required=true, defaultValue="10") int rows,
			@RequestParam(value="sort" , required=false, defaultValue = "" ) String sort) throws Exception {
			model.put(HttpResponseMessage.RECORDS, service.getInspCond(http.argument));
			return http.writer;
	}
	
	@RequestMapping(value="/qc/insp/inspentry4/set/lastinsp.do"  )
	public String setLastInsp(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setLastInsp(http.argument ));
		return http.writer;
