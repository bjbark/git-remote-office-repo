...
@Controller
public class ItemInspStd extends DefaultControlHandler{

	@Autowired
	private ItemInspStdService service;
	// master
	@RequestMapping(value="/qc/basic/iteminspstd/get/mastersearch.do"  )
	...
	//detail
	@RequestMapping(value="/qc/basic/iteminspstd/get/detailsearch.do"  )
	...
	//item1
		@RequestMapping(value="/qc/basic/iteminspstd/get/item1.do"  )
	...
	//item2
	@RequestMapping(value="/qc/basic/iteminspstd/get/item2.do"  )
	...
	// 저장
	@RequestMapping(value="/qc/basic/iteminspstd/set/item1.do"  )
