...
@Controller
public class RemkList extends DefaultControlHandler{

	@Autowired
	private RemkListService service;


	@RequestMapping(value="/qc/project/remklist/get/master1.do")
	...
	@RequestMapping(value="/qc/project/remklist/get/master2.do")
	...
	@RequestMapping(value="/qc/project/remklist/get/detail.do")
