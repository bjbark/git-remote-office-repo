...
@Controller
public class ProdOsttWait  extends DefaultControlHandler{

	@Autowired
	private ProdOsttWaitService service;

	@RequestMapping(value="/stock/prodosttwait/get/master.do"  )
	...
	@RequestMapping(value="/stock/prodosttwait/get/detail.do"  )
