...
@Controller
public class MtrlIsttWork extends DefaultControlHandler{

	@Autowired
	private MtrlIsttWorkService service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/isos/mtrlisttwork/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/isos/mtrlisttwork/get/master.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/isos/mtrlisttwork/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/isos/mtrlisttwork/set/pass.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/isos/mtrlisttwork/set/cancel.do"  )
