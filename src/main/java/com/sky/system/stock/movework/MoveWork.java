...
@Controller
public class MoveWork extends DefaultControlHandler{

	@Autowired
	private MoveWorkService service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/movework/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/movework/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/movework/get/invoice.do")
	...
	//재고이동내역 마감/해지
	@RequestMapping(value="/stock/movework/set/close.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/movework/set/invoice.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/movework/set/del_yn.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/movework/get/product.do")
	...
	@RequestMapping(value="/stock/movework/get/printing.do")
