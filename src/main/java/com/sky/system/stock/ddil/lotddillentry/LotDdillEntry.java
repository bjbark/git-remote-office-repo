...
@Controller
public class LotDdillEntry  extends DefaultControlHandler{

	@Autowired
	private LotDdillEntryService service;

	@RequestMapping(value="/stock/ddil/lotddillentry/get/search1.do"  )
	...
	@RequestMapping(value="/stock/ddil/lotddillentry/get/search2.do"  )
	...
	// 저장
	@RequestMapping(value="/stock/ddil/lotddillentry/set/record.do"  )
	public String setRecord(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setRecord(http.argument));
		return http.writer;
	}

	@RequestMapping(value="/stock/ddil/lotddillentry/set/write.do"  )
