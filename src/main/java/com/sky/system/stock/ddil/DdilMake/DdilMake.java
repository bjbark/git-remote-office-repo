...
public class DdilMake  extends DefaultControlHandler{
	...
	@RequestMapping(value="/stock/ddil/ddilmake/get/search1.do"  )
	...
	@RequestMapping(value="/stock/ddil/ddilmake/get/search2.do"  )
	...
	// 저장
	@RequestMapping(value="/stock/ddil/ddilmake/set/record.do"  )
	public String setRecord(HttpMessage http, Map<String, Object> model) throws Exception {
		model.put(HttpResponseMessage.RECORDS, service.setRecord(http.argument));
		return http.writer;
	}

	@RequestMapping(value="/stock/ddil/ddilmake/set/write.do"  )
	...
	//결과등록
	@RequestMapping(value="/stock/ddil/ddilmake/set/ddil.do"  )
