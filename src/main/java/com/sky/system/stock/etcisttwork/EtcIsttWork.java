...
public class EtcIsttWork extends DefaultControlHandler{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/etcisttwork/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/etcisttwork/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/etcisttwork/get/invoice.do")
	...
	@RequestMapping(value="/stock/etcisttwork/get/report_kind.do")
	...
	//입고내역 마감/해지
	@RequestMapping(value="/stock/etcisttwork/set/close.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/etcisttwork/set/invoice.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/etcisttwork/set/del_yn.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/etcisttwork/get/product.do")
	...
	@RequestMapping(value="/stock/etcisttwork/get/printing.do")
