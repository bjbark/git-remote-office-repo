package com.sky.system.stock.prodosttwork;
...
public class ProdOsttWork extends DefaultControlHandler{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/prodosttwork/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/prodosttwork/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/prodosttwork/get/invoice.do")
	...
	// 마감 / 해지 수정
	@RequestMapping(value="/stock/prodosttwork/set/close.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/prodosttwork/set/invoice.do"  )
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/isos/prodosttwork/set/del_yn.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/stock/prodosttwork/get/product.do")
	...
	@RequestMapping(value="/stock/prodosttwork/get/printing.do")
