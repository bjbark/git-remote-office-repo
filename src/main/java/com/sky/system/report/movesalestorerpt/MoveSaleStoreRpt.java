package com.sky.system.report.movesalestorerpt;
...
@Controller
public class MoveSaleStoreRpt extends DefaultControlHandler {

//	private static final String FILE_NAME = "alpha_poData";
//	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@Autowired
	private MoveSaleStoreRptService service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/report/movesalestorerpt/get/search.do")
	...
	@RequestMapping(value="/report/movesalestorerpt/export/search.do") 
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/report/movesalestorerpt/get/week.do")
	 ...
	 */
	@SuppressWarnings({"unchecked", "rawtypes"})
	@RequestMapping(value="/report/movesalestorerpt/export/week.do") 
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/report/movesalestorerpt/get/day.do")
	 ...
	 */
	@SuppressWarnings({"unchecked", "rawtypes"})
	@RequestMapping(value="/report/movesalestorerpt/export/day.do") 
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/report/movesalestorerpt/get/month.do")
	 ...
	 */
	@SuppressWarnings({"unchecked", "rawtypes"})
	@RequestMapping(value="/report/movesalestorerpt/export/month.do") 
