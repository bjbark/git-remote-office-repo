...
@Controller
public class SaleCustRpt extends DefaultControlHandler{

	@Autowired
	private SaleCustRptService service;
	
	// 조회 - 사업장별
	@RequestMapping(value="/report/salecustrpt/get/search.do"  )
	...
	// 조회 - 시간대별
	@RequestMapping(value="/report/salecustrpt/get/search/time.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/salecustrpt/get/search/week.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/salecustrpt/get/search/day.do"  )
	...
	// 조회 - 월별
	@RequestMapping(value="/report/salecustrpt/get/search/month.do"  )
