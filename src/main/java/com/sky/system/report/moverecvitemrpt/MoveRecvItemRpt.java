package com.sky.system.report.moverecvitemrpt;
...
@Controller
public class MoveRecvItemRpt extends DefaultControlHandler {

//	private static final String FILE_NAME = "alpha_poData";
//	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@Autowired
	private MoveRecvItemRptService service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/report/moverecvitemrpt/get/search.do")
	...
	@RequestMapping(value="/report/moverecvitemrpt/export/search.do") 
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/report/moverecvitemrpt/get/week.do")
	 ...
	 */
	@SuppressWarnings({"unchecked", "rawtypes"})
	@RequestMapping(value="/report/moverecvitemrpt/export/week.do") 
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/report/moverecvitemrpt/get/day.do")
	 ...
	 */
	@SuppressWarnings({"unchecked", "rawtypes"})
	@RequestMapping(value="/report/moverecvitemrpt/export/day.do") 
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/report/moverecvitemrpt/get/month.do")
	 ...
	 */
	@SuppressWarnings({"unchecked", "rawtypes"})
	@RequestMapping(value="/report/moverecvitemrpt/export/month.do") 
