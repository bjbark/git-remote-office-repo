...
@Controller
public class OrderUserRpt extends DefaultControlHandler{

	@Autowired
	private OrderUserRptService service;
	
	// 조회 - 사업장별
	@RequestMapping(value="/report/orderuserrpt/get/search.do"  )
	...
	// 조회 - 시간대별
	@RequestMapping(value="/report/orderuserrpt/get/searchtime.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/orderuserrpt/get/searchweek.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/orderuserrpt/get/searchday.do"  )
	...
	// 조회 - 월별
	@RequestMapping(value="/report/orderuserrpt/get/searchmonth.do"  )
