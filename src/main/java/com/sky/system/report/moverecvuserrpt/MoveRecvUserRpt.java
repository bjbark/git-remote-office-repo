package com.sky.system.report.moverecvuserrpt;
...
@Controller
public class MoveRecvUserRpt extends DefaultControlHandler {

	@Autowired
	private MoveRecvUserRptService service;

	/**
	 */
	@RequestMapping(value="/report/moverecvuserrpt/get/search.do")
	...
	@RequestMapping(value="/report/moverecvuserrpt/export/search.do") 
	...
	/**
	 */
	@RequestMapping(value="/report/moverecvuserrpt/get/week.do")
    ...
    */
	@SuppressWarnings({"unchecked", "rawtypes"})
	@RequestMapping(value="/report/moverecvuserrpt/export/week.do") 
	 ...
	 * 일자별
	 */
	@RequestMapping(value="/report/moverecvuserrpt/get/day.do")
	 ...
	 */
	@SuppressWarnings({"unchecked", "rawtypes"})
	@RequestMapping(value="/report/moverecvuserrpt/export/day.do") 
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/report/moverecvuserrpt/get/month.do")
	 ...
	 */
	@SuppressWarnings({"unchecked", "rawtypes"})
	@RequestMapping(value="/report/moverecvuserrpt/export/month.do") 
