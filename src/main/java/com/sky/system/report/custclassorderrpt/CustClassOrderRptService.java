package com.sky.system.report.custclassorderrpt;
...
public class CustClassOrderRptService  extends DefaultServiceHandler {
	...
	public SqlResultMap getSearch(HttpRequestArgument arg, int page, int rows, String sort) throws Exception {
        ...
        data.param
	        ...
	        .query("            else round(abs(a.sum_balance)/sum(abs(a.sum_balance)) over (partition by a.stor_grp), 3)*100) as rate_balance ")
	    ;
	    data.param
		    .where("  from (                                                                             ")
		    ...
		    .where("              join cust_stor s on s.stor_id = a.stor_id   and s.cust_id = a.cust_id  ")
