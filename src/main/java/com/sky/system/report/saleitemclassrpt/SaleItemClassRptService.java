package com.sky.system.report.saleitemclassrpt;
...
@Service
public class SaleItemClassRptService  extends DefaultServiceHandler {
	...
	public SqlResultMap getSearch(HttpRequestArgument arg, int page, int rows, String sort) throws Exception {
		...
		;
		data.param
			.query("select 	t1.clss_id  																					    ")
			.query("   	,	(select clss_desct from item_class  where clss_id = t1.clss_id ) as clss_desct 					    ")
			.query("    ,	t1.txfree_amt, 	t1.sply_amt,	 t1.tax_amt,	t1.inv_amt,		t1.qty									")
		...
		data.param
			...
			.where("    	,  sum(h1.tax_amt) as tax_amt , sum(h1.inv_amt) as inv_amt,  sum(h1.qty) as qty  							    ")
			.where("  	  from   																							    ")
			.where("       	(  																								    ")
	...
	public SqlResultMap getSearchTime(HttpRequestArgument arg, int page, int rows, String sort) throws Exception {
		...
		;
		data.param
	    	.query("	select 	(select clss_desct from item_class where clss_id = t1.clss_id ) as clss_desct 				")
	    	.query("	    ,	t1.*     																					")
	    ;
		data.param
	    	.where("	  from ( 																							")
	...
	public SqlResultMap getSearchWeek(HttpRequestArgument arg, int page, int rows, String sort) throws Exception {
		...
		data.param
			.where(" from (																									")
			.where("	select h1.stor_grp, h1.clss_id  																	")
			.where("			 ,	sum(case when datepart(weekday,h1.inv_dt) = '1', h1.qty     else 0 end ) as qty1		") /* 일요일 */
			.where("			 ,	sum(case when datepart(weekday,h1.inv_dt) = '1', h1.inv_amt else 0 end ) as week1		")
			.where("			 ,	sum(case when datepart(weekday,h1.inv_dt) = '2', h1.qty     else 0 end ) as qty2		")
			.where("			 ,	sum(case when datepart(weekday,h1.inv_dt) = '2', h1.inv_amt else 0 end ) as week2		")
			.where("			 ,	sum(case when datepart(weekday,h1.inv_dt) = '3', h1.qty     else 0 end ) as qty3		")
			.where("			 ,	sum(case when datepart(weekday,h1.inv_dt) = '3', h1.inv_amt else 0 end ) as week3		")
			.where("			 ,	sum(case when datepart(weekday,h1.inv_dt) = '4', h1.qty     else 0 end ) as qty4		")
			.where("			 ,	sum(case when datepart(weekday,h1.inv_dt) = '4', h1.inv_amt else 0 end ) as week4		")
			.where("			 ,	sum(case when datepart(weekday,h1.inv_dt) = '5', h1.qty     else 0 end ) as qty5		")
			.where("			 ,	sum(case when datepart(weekday,h1.inv_dt) = '5', h1.inv_amt else 0 end ) as week5		")
			.where("			 ,	sum(case when datepart(weekday,h1.inv_dt) = '6', h1.qty     else 0 end ) as qty6		")
			.where("			 ,	sum(case when datepart(weekday,h1.inv_dt) = '6', h1.inv_amt else 0 end ) as week6		")
			.where("			 ,	sum(case when datepart(weekday,h1.inv_dt) = '7', h1.qty     else 0 end ) as qty7		")
			.where("			 ,	sum(case when datepart(weekday,h1.inv_dt) = '7', h1.inv_amt else 0 end ) as week7		")
			.where("             ,	sum(h1.inv_amt  ) as inv_amt																")
			.where("             ,	sum(h1.qty     ) as qty																	")

			.where("  	  from   																							")
			.where("       	(  																								")
			.where("			select 	t1.stor_grp, t2.item_idcd,	t5.clss_id,    t1.inv_dt,								")
			.where("			        t2.txfree_amt, t2.sply_amt,	t2.tax_amt, 		t2.inv_amt,	t2.qty  					")
			.where("             from 	sale_mst t1  																		")
			.where("                    join sale_dtl t2 on t1.inv_no     = t2.inv_no										")
			.where("              	    join itm_mst t5 on t2.item_idcd    = t5.item_idcd   									")
	...
	public SqlResultMap getSearchDay(HttpRequestArgument arg, int page, int rows, String sort) throws Exception {
		...
		data.param
			.where(" from (																								")
			.where("	select h1.stor_grp, h1.clss_id  																")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '01' then  h1.qty     else 0 end ) as qty1 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '01' then  h1.inv_amt else 0 end ) as date1 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '02' then  h1.qty     else 0 end ) as qty2 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '02' then  h1.inv_amt else 0 end ) as date2 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '03' then  h1.qty     else 0 end ) as qty3 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '03' then  h1.inv_amt else 0 end ) as date3 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '04' then  h1.qty     else 0 end ) as qty4 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '04' then  h1.inv_amt else 0 end ) as date4 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '05' then  h1.qty     else 0 end ) as qty5 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '05' then  h1.inv_amt else 0 end ) as date5 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '06' then  h1.qty     else 0 end ) as qty6 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '06' then  h1.inv_amt else 0 end ) as date6 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '07' then  h1.qty     else 0 end ) as qty7 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '07' then  h1.inv_amt else 0 end ) as date7 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '08' then  h1.qty     else 0 end ) as qty8 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '08' then  h1.inv_amt else 0 end ) as date8 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '09' then  h1.qty     else 0 end ) as qty9 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '09' then  h1.inv_amt else 0 end ) as date9 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '10' then  h1.qty     else 0 end ) as qty10 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '10' then  h1.inv_amt else 0 end ) as date10 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '11' then  h1.qty     else 0 end ) as qty11 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '11' then  h1.inv_amt else 0 end ) as date11 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '12' then  h1.qty     else 0 end ) as qty12 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '12' then  h1.inv_amt else 0 end ) as date12 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '13' then  h1.qty     else 0 end ) as qty13 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '13' then  h1.inv_amt else 0 end ) as date13 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '14' then  h1.qty     else 0 end ) as qty14 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '14' then  h1.inv_amt else 0 end ) as date14 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '15' then  h1.qty     else 0 end ) as qty15 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '15' then  h1.inv_amt else 0 end ) as date15 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '16' then  h1.qty     else 0 end ) as qty16 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '16' then  h1.inv_amt else 0 end ) as date16 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '17' then  h1.qty     else 0 end ) as qty17 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '17' then  h1.inv_amt else 0 end ) as date17 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '18' then  h1.qty     else 0 end ) as qty18 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '18' then  h1.inv_amt else 0 end ) as date18 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '19' then  h1.qty     else 0 end ) as qty19 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '19' then  h1.inv_amt else 0 end ) as date19 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '20' then  h1.qty     else 0 end ) as qty20 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '20' then  h1.inv_amt else 0 end ) as date20 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '21' then  h1.qty     else 0 end ) as qty21 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '21' then  h1.inv_amt else 0 end ) as date21 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '22' then  h1.qty     else 0 end ) as qty22 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '22' then  h1.inv_amt else 0 end ) as date22 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '23' then  h1.qty     else 0 end ) as qty23 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '23' then  h1.inv_amt else 0 end ) as date23 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '24' then  h1.qty     else 0 end ) as qty24 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '24' then  h1.inv_amt else 0 end ) as date24 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '25' then  h1.qty     else 0 end ) as qty25 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '25' then  h1.inv_amt else 0 end ) as date25 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '26' then  h1.qty     else 0 end ) as qty26 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '26' then  h1.inv_amt else 0 end ) as date26 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '27' then  h1.qty     else 0 end ) as qty27 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '27' then  h1.inv_amt else 0 end ) as date27 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '28' then  h1.qty     else 0 end ) as qty28 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '28' then  h1.inv_amt else 0 end ) as date28 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '29' then  h1.qty     else 0 end ) as qty29 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '29' then  h1.inv_amt else 0 end ) as date29 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '30' then  h1.qty     else 0 end ) as qty30 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '30' then  h1.inv_amt else 0 end ) as date30 ")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '31' then  h1.qty     else 0 end ) as qty31 	")
			.where(" 		 	,	sum(case when substring(h1.inv_dt, 7, 2) = '31' then  h1.inv_amt else 0 end ) as date31 ")
			.where(" 		               ,sum(h1.inv_amt) as inv_amt 													")
			.where(" 		               ,sum(h1.qty      ) as qty 													")
			.where("  	  from   																						")
			.where("       	(  																							")
	...
	public SqlResultMap getSearchMonth(HttpRequestArgument arg, int page, int rows, String sort) throws Exception {
		...
		data.param
			...
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '01' then  h1.qty     else 0 end ) as qty1 	")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '01' then  h1.inv_amt else 0 end ) as month1 ")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '02' then  h1.qty     else 0 end ) as qty2 	")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '02' then  h1.inv_amt else 0 end ) as month2 ")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '03' then  h1.qty     else 0 end ) as qty3 	")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '03' then  h1.inv_amt else 0 end ) as month3 ")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '04' then  h1.qty     else 0 end ) as qty4 	")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '04' then  h1.inv_amt else 0 end ) as month4 ")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '05' then  h1.qty     else 0 end ) as qty5 	")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '05' then  h1.inv_amt else 0 end ) as month5 ")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '06' then  h1.qty     else 0 end ) as qty6 	")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '06' then  h1.inv_amt else 0 end ) as month6 ")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '07' then  h1.qty     else 0 end ) as qty7 	")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '07' then  h1.inv_amt else 0 end ) as month7 ")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '08' then  h1.qty     else 0 end ) as qty8 	")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '08' then  h1.inv_amt else 0 end ) as month8 ")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '09' then  h1.qty     else 0 end ) as qty9 	")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '09' then  h1.inv_amt else 0 end ) as month9 ")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '10' then  h1.qty     else 0 end ) as qty10 	")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '10' then  h1.inv_amt else 0 end ) as month10")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '11' then  h1.qty     else 0 end ) as qty11 	")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '11' then  h1.inv_amt else 0 end ) as month11")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '12' then  h1.qty     else 0 end ) as qty12 	")
			.where(" 				,	sum(case when substring(h1.inv_dt, 5, 2) = '12' then  h1.inv_amt else 0 end ) as month12")
			.where("  	  from   																					    ")
			.where("       	(  																						    ")
			.where("			select 	t1.stor_grp, t2.item_idcd,	t5.clss_id,    t1.inv_dt,						    ")
			.where("			        t2.txfree_amt, t2.sply_amt,	t2.tax_amt, 		t2.inv_amt,	t2.qty  			    ")
