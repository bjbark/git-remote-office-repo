...
@Controller
public class SaleItemClassRpt extends DefaultControlHandler{

	@Autowired
	private SaleItemClassRptService service;
	
	// 조회 - 사업장별
	@RequestMapping(value="/report/saleitemclassrpt/get/search.do"  )
	...
	// 조회 - 시간대별
	@RequestMapping(value="/report/saleitemclassrpt/get/searchtime.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/saleitemclassrpt/get/searchweek.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/saleitemclassrpt/get/searchday.do"  )
	...
	// 조회 - 월별
	@RequestMapping(value="/report/saleitemclassrpt/get/searchmonth.do"  )
