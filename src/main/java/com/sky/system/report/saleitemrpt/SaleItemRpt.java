...
@Controller
public class SaleItemRpt extends DefaultControlHandler{

	@Autowired
	private SaleItemRptService service;
	
	// 조회 - 사업장별
	@RequestMapping(value="/report/saleitemrpt/get/search.do")
	...
	// 조회 - 시간대별
	@RequestMapping(value="/report/saleitemrpt/get/search/time.do")
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/saleitemrpt/get/search/week.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/saleitemrpt/get/search/day.do"  )
	...
	// 조회 - 월별
	@RequestMapping(value="/report/saleitemrpt/get/search/month.do"  )
	...
	// 조회 - 고객별
	@RequestMapping(value="/report/saleitemrpt/get/search/cust.do"  )
	public String getSearchCust( HttpMessage http, Map<String, Object> model,
			@RequestParam(value="page" , required=true, defaultValue="1" ) int page,
			@RequestParam(value="limit", required=true, defaultValue="10") int rows,
			@RequestParam(value="sort" , required=false, defaultValue = "" ) String sort) throws Exception {
			model.put(HttpResponseMessage.RECORDS, service.getSearchCust(http.argument, page, rows, sort));
			return http.writer;
	}	
