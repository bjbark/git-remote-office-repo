...
@Controller
public class SaleStoreRpt extends DefaultControlHandler{

	@Autowired
	private SaleStoreRptService service;
	
	// 조회 - 사업장별
	@RequestMapping(value="/report/salestorerpt/get/search.do"  )
	...
	// 조회 - 시간대별
	@RequestMapping(value="/report/salestorerpt/get/search/time.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/salestorerpt/get/search/week.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/salestorerpt/get/search/day.do"  )
	...
	// 조회 - 월별
	@RequestMapping(value="/report/salestorerpt/get/search/month.do"  )
