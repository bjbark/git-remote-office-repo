...
@Controller
public class OrderItemClassRpt extends DefaultControlHandler{

	@Autowired
	private OrderItemClassRptService service;
	
	// 조회 - 사업장별
	@RequestMapping(value="/report/orderitemclassrpt/get/search.do"  )
	...
	// 조회 - 시간대별
	@RequestMapping(value="/report/orderitemclassrpt/get/searchtime.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/orderitemclassrpt/get/searchweek.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/orderitemclassrpt/get/searchday.do"  )
	...
	// 조회 - 월별
	@RequestMapping(value="/report/orderitemclassrpt/get/searchmonth.do"  )
