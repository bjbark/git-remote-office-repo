...
@Service
public class SaleSalesmanRptService  extends DefaultServiceHandler {
	...
	public SqlResultMap getSearch(HttpRequestArgument arg, int page, int rows, String sort) throws Exception {
		...
		data.param
            ...
            .where("					left outer join usr_mst t3 on t1.sales_man_id = t3.emp_id 		")
    		...
    		.where("                  		          and :to_dt       " , arg.fixParameter("to_dt"			))  // 배송예정종료일자
		    .where("		 	and     t1.chnl in ( :chnl ) " , chnl ,( chnl.length > 0) ) /* 주문 위치 */
			.where("          	and     t1.sales_man_id  = :inv_usr_id  " , arg.getParameter("inv_usr_id"  )) /* 영업담당 */
