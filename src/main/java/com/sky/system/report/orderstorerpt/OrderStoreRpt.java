...
@Controller
public class OrderStoreRpt extends DefaultControlHandler{

	@Autowired
	private OrderStoreRptService service;
	
	// 조회 - 사업장별
	@RequestMapping(value="/report/orderstorerpt/get/search.do"  )
	...
	// 조회 - 시간대별
	@RequestMapping(value="/report/orderstorerpt/get/searchtime.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/orderstorerpt/get/searchweek.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/orderstorerpt/get/searchday.do"  )
	...
	// 조회 - 월별
	@RequestMapping(value="/report/orderstorerpt/get/searchmonth.do"  )
