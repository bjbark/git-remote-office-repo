package com.sky.system.report.salevendorrpt;
...
@Service
public class SaleVendorRptService  extends DefaultServiceHandler {
	...
	public SqlResultMap getSearch(HttpRequestArgument arg, int page, int rows, String sort) throws Exception {
		...
		data.param // 조건
			...
			.where("                on c.stor_id = b.stor_id                                                                     ")
			.where("               and c.item_idcd = b.item_idcd                                                                       ")
			.where("              left outer join vend_stor v                                                                     ")
			.where("                on v.stor_grp = c.stor_grp                                                                     ")
			.where("               and v.vend_id = c.vend_id                                                                       ")
			...
			.where("          and v.clss_1 = :clss_1   	                                                                       ", arg.getParameter("clss_1"))
			.where("          and v.clss_2 = :clss_2   	                                                                       ", arg.getParameter("clss_2"))
			.where("          and v.clss_3 = :clss_3   	                                                                       ", arg.getParameter("clss_3"))
