package com.baroservice.api.edoc;
...
public class Tests {
	...
	public void RegistEDoc() throws RemoteException {
		...
		//-------------------------------------------
		edoc.setEDocProperties(new EDocProperty[3]);

		edoc.getEDocProperties()[0] = new EDocProperty();
		edoc.getEDocProperties()[0].setName("Balance");
		edoc.getEDocProperties()[0].setValue("");

		edoc.getEDocProperties()[1] = new EDocProperty();
		edoc.getEDocProperties()[1].setName("Deposit");
		edoc.getEDocProperties()[1].setValue("");

		edoc.getEDocProperties()[2] = new EDocProperty();
		edoc.getEDocProperties()[2].setName("CBalance");
		edoc.getEDocProperties()[2].setValue("");

		//-------------------------------------------
		//품목
		//-------------------------------------------
		EDocTradeLineItem[] eDocTradeLineItems = new EDocTradeLineItem[6];
		...
		for (int i = 0; i < 6; i++) {
			...
			eDocTradeLineItems[i] = eDocTradeLineItem;
		}

		edoc.setEDocTradeLineItems(eDocTradeLineItems);
	...
	public void GetAttachedFileList() throws RemoteException {
		...
		AttachedFile[] result = barobillApiService.edoc.getAttachedFileList(certKey, corpNum, id, mgtKey);
	...
	public void GetLinkedDocs() throws RemoteException {
		...
		LinkedDoc[] result = barobillApiService.edoc.getLinkedDocs(certKey, corpNum, docType, mgtKey);
	...
	public void GetEDocLog() throws RemoteException {
		...
		InvoiceLog[] result = barobillApiService.edoc.getEDocLog(certKey, corpNum, id, mgtKey);
	...
	public void GetEDocStates() throws RemoteException {
		...
		EDocState[] result = barobillApiService.edoc.getEDocStates(certKey, corpNum, id, mgtKeyList);

		for (EDocState r : result) {
