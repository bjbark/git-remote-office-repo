package com.baroservice.api.cashbill;
...
import com.baroservice.ws.CashBillLog;
...
public class Tests {
    ...
    public void GetCashBillLog() throws RemoteException {
        ...
        CashBillLog[] result = barobillApiService.cashbill.getCashBillLog(certKey, corpNum, id, mgtKey);
    ...
    public void GetCashBillStates() throws RemoteException {
        ...
        CashBillState[] result = barobillApiService.cashbill.getCashBillStates(certKey, corpNum, id, mgtKeyList);

        for (CashBillState r : result) {
