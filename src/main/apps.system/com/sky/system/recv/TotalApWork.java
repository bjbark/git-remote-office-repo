...
import com.sky.http.HttpResponseMessage;
	...
	@Controller
	public class TotalApWork extends DefaultControlHandler{

		
		@Autowired
		private TotalApWorkService service;

		// 수금현황
		@RequestMapping(value="/recv/totalapwork/get/search.do"  )
		...
		// 상세 조회 
		@RequestMapping(value="/recv/totalapwork/get/detail.do"  )
		...
		// 회원정보 조회 
		@RequestMapping(value="/recv/totalapwork/get/dialogmemb.do"  )
		...
		// INV 조회
		@RequestMapping(value="/recv/totalapwork/get/invoice.do"  )
		...
		@RequestMapping(value="/recv/totalapwork/set/invoice.do"  )
		 ...
		 * @throws Exception
		 */
		@RequestMapping(value="/recv/totalapwork/set/del_yn.do")
		...
		// 수금예정리스트
		@RequestMapping(value="/recv/totalapwork/get/arlist.do"  )
		...
		// 수금예정리스트 - 미수현황 조회
		@RequestMapping(value="/recv/totalapwork/get/arlistsales.do"  )
		...
		@RequestMapping(value="/recv/totalapwork/get/arlistitems.do"  )
