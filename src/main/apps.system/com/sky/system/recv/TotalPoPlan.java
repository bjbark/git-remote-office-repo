...
@Controller
public class TotalPoPlan extends DefaultControlHandler{

	@Autowired
	private TotalPoPlanService service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/totalpoplan/get/search.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/totalpoplan/get/detail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/totalpoplan/get/invoice.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/totalpoplan/set/invoice.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/totalpoplan/set/del_yn.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/totalpoplan/get/product.do") 
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/totalpoplan/get/planmaster.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/totalpoplan/get/plandetail.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/recv/totalpoplan/set/plandetail.do")
	public String setPlanDetail(HttpMessage http, Map<String, Object> model) throws Exception {
		
		model.put(HttpResponseMessage.RECORDS, service.setPlanDetail(http.argument));
		return http.writer;
	}
	...
	@RequestMapping(value="/recv/totalpoplan/get/printing.do")
	public String getPrinting(HttpMessage http, Map jasperMainParam) throws Exception {
		...
		if (isReport) {
			...
			jasperData.put(JasperReportView.TITLE, "    기획서");
			...
			jasperMainParam.put(JasperReportView.FILENAME, "기획서");              // 다운로드시 파일명
