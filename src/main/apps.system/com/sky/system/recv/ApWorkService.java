...
//	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	...
	public SqlResultMap getSearch(HttpRequestArgument arg, int page, int rows,String sort) throws Exception {
			...
			data.param
				...
				.where(" 			,    x.stor_nm   , x.vend_nm  , x.user_memo , x.stor_grp , x.stor_id	, x.account_id	")
	...
	public SqlResultMap getLookupVend(HttpRequestArgument arg, int page, int rows,String sort) throws Exception {
		...
		data.param
			...
			.where("and    b.vend_nm  like  %:vend_nm%   " 	  , arg.getParameter("vend_nm" 			)) // 검색어가 매입처명일 경우
	...
	public SqlResultMap getInvoice(HttpRequestArgument arg) throws Exception{
		...
		if (ori_no == null || "".equals(ori_no)) {
			...
			.query("     ,  c.dept_id as pay_dept_id 					")
		...
		for(SqlResultRow row:map){
			...
			if (rowaction == Action.delete) {
	        	...
	        	data.param
	        		...
	        		.update("account_um"    , row.getParameter("account_um"))
