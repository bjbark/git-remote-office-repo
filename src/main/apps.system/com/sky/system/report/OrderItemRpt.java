...
@Controller
public class OrderItemRpt extends DefaultControlHandler{

	@Autowired
	private OrderItemRptService service;
	
	// 조회 - 사업장별
	@RequestMapping(value="/report/orderitemrpt/get/search.do"  )
	...
	// 조회 - 시간대별
	@RequestMapping(value="/report/orderitemrpt/get/searchtime.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/orderitemrpt/get/searchweek.do"  )
	...
	// 조회 - 요일별
	@RequestMapping(value="/report/orderitemrpt/get/searchday.do"  )
	...
	// 조회 - 월별
	@RequestMapping(value="/report/orderitemrpt/get/searchmonth.do"  )
