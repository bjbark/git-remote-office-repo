...
@Service
public class OrderCustRptService  extends DefaultServiceHandler {
	...
	public SqlResultMap getSearch(HttpRequestArgument arg, int page, int rows, String sort) throws Exception {
		...
		;
        data.param
	        .query("select (select cust_cd from cust_mst where cust_id = a.cust_id) as cust_cd                                       ")
	        .query("      ,a.cust_nm                                                                                                  ")
	        .query("      ,a.mmb_id                                                                                                  ")
	        .query("      ,a.mmb_nm                                                                                                  ")
...
//			.where("          and a.inv_work_id in ('1', '2', '3', '4')                                                               ")
		    ...
		    .where("          and a.cust_gb = :cust_gb                                                                                ", arg.getParameter("cust_gb"))
		    ...
		    .where("        group by a.stor_grp, a.cust_id, a.cust_nm, a.mmb_id, a.mmb_nm                                           ")
		    .where("       ) a                                                                                                        ")
		    .where(" order by a.cust_id, a.cust_nm, a.mmb_id, a.mmb_nm                                                              ")
	    ;
...
//			.where("          and a.inv_work_id in ('1', '2', '3', '4')                                                               ")
	...
	public SqlResultMap getWeek(HttpRequestArgument arg, int page, int rows, String sort) throws Exception {
	    ...
	    data.param
		    ...
		    .where("             ,a.mmb_nm                                                                                           ")
			.where("             ,sum(a.amount)                                                              as sum_amount            ")
			.where("             ,sum(decode(to_char(to_date(a.ori_dt, 'yyyymmdd'), 'D'), '1', a.amount, 0)) as week_sun              ")
			.where("             ,sum(decode(to_char(to_date(a.ori_dt, 'yyyymmdd'), 'D'), '2', a.amount, 0)) as week_mon              ")
			.where("             ,sum(decode(to_char(to_date(a.ori_dt, 'yyyymmdd'), 'D'), '3', a.amount, 0)) as week_tue              ")
			.where("             ,sum(decode(to_char(to_date(a.ori_dt, 'yyyymmdd'), 'D'), '4', a.amount, 0)) as week_wed              ")
			.where("             ,sum(decode(to_char(to_date(a.ori_dt, 'yyyymmdd'), 'D'), '5', a.amount, 0)) as week_thu              ")
			.where("             ,sum(decode(to_char(to_date(a.ori_dt, 'yyyymmdd'), 'D'), '6', a.amount, 0)) as week_fri              ")
			.where("             ,sum(decode(to_char(to_date(a.ori_dt, 'yyyymmdd'), 'D'), '7', a.amount, 0)) as week_sat              ")
		    .where("         from order_mst a                                                                                        ")
		    .where("              left outer join cust_stor s                                                                        ")
		    .where("                on s.stor_id = a.stor_id                                                                        ")
		    .where("               and s.cust_id = a.cust_id                                                                          ")
...
//			.where("          and a.inv_work_id in ('1', '2', '3', '4')                                                               ")
	...
	public SqlResultMap getDay(HttpRequestArgument arg, int page, int rows, String sort) throws Exception {
	    ...
	    data.param
		    ...
		    .where("             ,a.mmb_nm                                                                                           ")
			.where("             ,sum(a.amount)                                          as sum_amount                                ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '01', a.amount, 0)) as date01                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '02', a.amount, 0)) as date02                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '03', a.amount, 0)) as date03                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '04', a.amount, 0)) as date04                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '05', a.amount, 0)) as date05                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '06', a.amount, 0)) as date06                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '07', a.amount, 0)) as date07                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '08', a.amount, 0)) as date08                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '09', a.amount, 0)) as date09                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '10', a.amount, 0)) as date10                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '11', a.amount, 0)) as date11                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '12', a.amount, 0)) as date12                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '13', a.amount, 0)) as date13                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '14', a.amount, 0)) as date14                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '15', a.amount, 0)) as date15                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '16', a.amount, 0)) as date16                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '17', a.amount, 0)) as date17                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '18', a.amount, 0)) as date18                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '19', a.amount, 0)) as date19                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '20', a.amount, 0)) as date20                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '21', a.amount, 0)) as date21                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '22', a.amount, 0)) as date22                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '23', a.amount, 0)) as date23                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '24', a.amount, 0)) as date24                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '25', a.amount, 0)) as date25                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '26', a.amount, 0)) as date26                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '27', a.amount, 0)) as date27                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '28', a.amount, 0)) as date28                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '29', a.amount, 0)) as date29                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '30', a.amount, 0)) as date30                                    ")
			.where("             ,sum(decode(substr(a.ori_dt, 7, 2), '31', a.amount, 0)) as date31                                    ")
		    .where("         from order_mst a                                                                                        ")
		    .where("              left outer join cust_stor s                                                                        ")
		    .where("                on s.stor_id = a.stor_id                                                                        ")
		    .where("               and s.cust_id = a.cust_id                                                                          ")
...
//			.where("          and a.inv_work_id in ('1', '2', '3', '4')                                                               ")
	...
	public SqlResultMap getMonth(HttpRequestArgument arg, int page, int rows, String sort) throws Exception {
	    ...
	    data.param
		    ...
		    .where("             ,a.mmb_nm                                                                                           ")
			.where("             ,sum(a.amount)                                          as sum_amount                                ")
			.where("             ,sum(decode(substr(a.ori_dt, 5, 2), '01', a.amount, 0)) as month01                                   ")
			.where("             ,sum(decode(substr(a.ori_dt, 5, 2), '02', a.amount, 0)) as month02                                   ")
			.where("             ,sum(decode(substr(a.ori_dt, 5, 2), '03', a.amount, 0)) as month03                                   ")
			.where("             ,sum(decode(substr(a.ori_dt, 5, 2), '04', a.amount, 0)) as month04                                   ")
			.where("             ,sum(decode(substr(a.ori_dt, 5, 2), '05', a.amount, 0)) as month05                                   ")
			.where("             ,sum(decode(substr(a.ori_dt, 5, 2), '06', a.amount, 0)) as month06                                   ")
			.where("             ,sum(decode(substr(a.ori_dt, 5, 2), '07', a.amount, 0)) as month07                                   ")
			.where("             ,sum(decode(substr(a.ori_dt, 5, 2), '08', a.amount, 0)) as month08                                   ")
			.where("             ,sum(decode(substr(a.ori_dt, 5, 2), '09', a.amount, 0)) as month09                                   ")
			.where("             ,sum(decode(substr(a.ori_dt, 5, 2), '10', a.amount, 0)) as month10                                   ")
			.where("             ,sum(decode(substr(a.ori_dt, 5, 2), '11', a.amount, 0)) as month11                                   ")
			.where("             ,sum(decode(substr(a.ori_dt, 5, 2), '12', a.amount, 0)) as month12                                   ")
		    .where("         from order_mst a                                                                                        ")
		    .where("              left outer join cust_stor s                                                                        ")
		    .where("                on s.stor_id = a.stor_id                                                                        ")
		    .where("               and s.cust_id = a.cust_id                                                                          ")
