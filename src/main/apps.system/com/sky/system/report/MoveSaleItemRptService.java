...
public class MoveSaleItemRptService  extends DefaultServiceHandler {
	...
	public SqlResultMap getSearch(HttpRequestArgument arg, int page, int rows) throws Exception {
		...
		data.param // 조회
			...
			.query("      ,a.item_spec                                                                                     ")
			.query("      ,c.unit_name                                                                                     ")
			.query("      ,(select clss_desct from item_class where class_id = d.class_id)  as class_nm					")
			.query("      ,b.stor_nm                                                                                    ")
		...
		data.param // 조건
			...
			.where("       left outer join itm_mst d    on d.item_idcd = a.item_idcd                                          ")
			.where("       left outer join stor e       on e.stor_id = a.move_id                                        ")
	...
	public SqlResultMap getDay(HttpRequestArgument arg, int page, int rows) throws Exception {
		...
		data.param // 조건
			...
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '01' then b.amount else 0 end) as date_amount_01    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '02' then b.amount else 0 end) as date_amount_02    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '03' then b.amount else 0 end) as date_amount_03    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '04' then b.amount else 0 end) as date_amount_04    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '05' then b.amount else 0 end) as date_amount_05    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '06' then b.amount else 0 end) as date_amount_06    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '07' then b.amount else 0 end) as date_amount_07    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '08' then b.amount else 0 end) as date_amount_08    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '09' then b.amount else 0 end) as date_amount_09    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '10' then b.amount else 0 end) as date_amount_10    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '11' then b.amount else 0 end) as date_amount_11    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '12' then b.amount else 0 end) as date_amount_12    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '13' then b.amount else 0 end) as date_amount_13    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '14' then b.amount else 0 end) as date_amount_14    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '15' then b.amount else 0 end) as date_amount_15    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '16' then b.amount else 0 end) as date_amount_16    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '17' then b.amount else 0 end) as date_amount_17    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '18' then b.amount else 0 end) as date_amount_18    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '19' then b.amount else 0 end) as date_amount_19    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '20' then b.amount else 0 end) as date_amount_20    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '21' then b.amount else 0 end) as date_amount_21    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '22' then b.amount else 0 end) as date_amount_22    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '23' then b.amount else 0 end) as date_amount_23    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '24' then b.amount else 0 end) as date_amount_24    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '25' then b.amount else 0 end) as date_amount_25    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '26' then b.amount else 0 end) as date_amount_26    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '27' then b.amount else 0 end) as date_amount_27    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '28' then b.amount else 0 end) as date_amount_28    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '29' then b.amount else 0 end) as date_amount_29    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '30' then b.amount else 0 end) as date_amount_30    ")
			.where("             ,sum(case when substring(a.inv_dt, 7, 2) = '31' then b.amount else 0 end) as date_amount_31    ")
			.where("         from move_ost_mst a                                                                                ")
			.where("              join move_ost_dtl b                                                                           ")
			.where("                on b.inv_no = a.inv_no                                                                      ")
			.where("        where a.stor_grp = :stor_grp   	", arg.fixParameter("stor_grp"))
	...
	public SqlResultMap getMonth(HttpRequestArgument arg, int page, int rows) throws Exception {
		...
		data.param // 조건
			...
			.where("             ,sum(case when substring(a.inv_dt, 5, 2) = '01' then  b.amount else 0 end ) as month_amount_01   ")
			.where("             ,sum(case when substring(a.inv_dt, 5, 2) = '02' then  b.amount else 0 end ) as month_amount_02   ")
			.where("             ,sum(case when substring(a.inv_dt, 5, 2) = '03' then  b.amount else 0 end ) as month_amount_03   ")
			.where("             ,sum(case when substring(a.inv_dt, 5, 2) = '04' then  b.amount else 0 end ) as month_amount_04   ")
			.where("             ,sum(case when substring(a.inv_dt, 5, 2) = '05' then  b.amount else 0 end ) as month_amount_05   ")
			.where("             ,sum(case when substring(a.inv_dt, 5, 2) = '06' then  b.amount else 0 end ) as month_amount_06   ")
			.where("             ,sum(case when substring(a.inv_dt, 5, 2) = '07' then  b.amount else 0 end ) as month_amount_07   ")
			.where("             ,sum(case when substring(a.inv_dt, 5, 2) = '08' then  b.amount else 0 end ) as month_amount_08   ")
			.where("             ,sum(case when substring(a.inv_dt, 5, 2) = '09' then  b.amount else 0 end ) as month_amount_09   ")
			.where("             ,sum(case when substring(a.inv_dt, 5, 2) = '10' then  b.amount else 0 end ) as month_amount_10   ")
			.where("             ,sum(case when substring(a.inv_dt, 5, 2) = '11' then  b.amount else 0 end ) as month_amount_11   ")
			.where("             ,sum(case when substring(a.inv_dt, 5, 2) = '12' then  b.amount else 0 end ) as month_amount_12   ")
			.where("         from move_ost_mst a                                                                                  ")
			.where("              join move_ost_dtl b                                                                             ")
			.where("                on b.inv_no = a.inv_no                                                                        ")
			.where("        where a.stor_grp = :stor_grp   	", arg.fixParameter("stor_grp"))
