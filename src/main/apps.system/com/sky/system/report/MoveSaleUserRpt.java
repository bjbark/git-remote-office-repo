...
@Controller
public class MoveSaleUserRpt extends DefaultControlHandler {

//	private static final String FILE_NAME = "alpha_poData";
//	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@Autowired
	private MoveSaleUserRptService service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/report/movesaleuserrpt/get/search.do")
	...
	@RequestMapping(value="/report/movesaleuserrpt/export/search.do") 
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/report/movesaleuserrpt/get/week.do")
	 ...
	 */
	@SuppressWarnings({"unchecked", "rawtypes"})
	@RequestMapping(value="/report/movesaleuserrpt/export/week.do") 
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/report/movesaleuserrpt/get/day.do")
	 ...
	 */
	@SuppressWarnings({"unchecked", "rawtypes"})
	@RequestMapping(value="/report/movesaleuserrpt/export/day.do") 
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/report/movesaleuserrpt/get/month.do")
	 ...
	 */
	@SuppressWarnings({"unchecked", "rawtypes"})
	@RequestMapping(value="/report/movesaleuserrpt/export/month.do") 
