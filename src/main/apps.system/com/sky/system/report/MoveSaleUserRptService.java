...
public class MoveSaleUserRptService  extends DefaultServiceHandler {
	...
	public SqlResultMap getDay(HttpRequestArgument arg, int page, int rows) throws Exception {
		...
		data.param // 조건
			...
			.where("             ,a.move_id                                                                      ")
			.where("             ,sum(a.amount)   as sum_amount                                                  ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '01' then  a.amount else 0 end) as date01 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '02' then  a.amount else 0 end) as date02 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '03' then  a.amount else 0 end) as date03 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '04' then  a.amount else 0 end) as date04 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '05' then  a.amount else 0 end) as date05 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '06' then  a.amount else 0 end) as date06 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '07' then  a.amount else 0 end) as date07 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '08' then  a.amount else 0 end) as date08 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '09' then  a.amount else 0 end) as date09 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '10' then  a.amount else 0 end) as date10 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '11' then  a.amount else 0 end) as date11 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '12' then  a.amount else 0 end) as date12 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '13' then  a.amount else 0 end) as date13 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '14' then  a.amount else 0 end) as date14 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '15' then  a.amount else 0 end) as date15 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '16' then  a.amount else 0 end) as date16 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '17' then  a.amount else 0 end) as date17 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '18' then  a.amount else 0 end) as date18 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '19' then  a.amount else 0 end) as date19 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '20' then  a.amount else 0 end) as date20 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '21' then  a.amount else 0 end) as date21 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '22' then  a.amount else 0 end) as date22 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '23' then  a.amount else 0 end) as date23 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '24' then  a.amount else 0 end) as date24 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '25' then  a.amount else 0 end) as date25 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '26' then  a.amount else 0 end) as date26 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '27' then  a.amount else 0 end) as date27 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '28' then  a.amount else 0 end) as date28 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '29' then  a.amount else 0 end) as date29 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '30' then  a.amount else 0 end) as date30 ")
			.where("             ,sum(case substring(a.inv_dt, 7, 2) = '31' then  a.amount else 0 end) as date31 ")
			.where("         from move_ost_mst a                                                                 ")
			.where("        where a.stor_grp = :stor_grp   ", arg.fixParameter("stor_grp"))
			.where("          and a.stor_id = :stor_id     ", arg.getParameter("stor_id"))
			.where("          and a.move_id = :move_id     ", arg.getParameter("move_id"))
