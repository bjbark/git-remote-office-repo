...
import com.sky.http.HttpResponseMessage;
	...
	@Controller
	public class TotalArWork extends DefaultControlHandler{

		
		@Autowired
		private TotalArWorkService service;

		// 수금현황
		@RequestMapping(value="/sale/totalarwork/get/search.do"  )
		...
		// 상세 조회 
		@RequestMapping(value="/sale/totalarwork/get/detail.do"  )
		...
		// 회원정보 조회 
		@RequestMapping(value="/sale/totalarwork/get/dialogmemb.do"  )
		...
		// INV 조회
		@RequestMapping(value="/sale/totalarwork/get/invoice.do"  )
		...
		@RequestMapping(value="/sale/totalarwork/set/invoice.do"  )
		 ...
		 * @throws Exception
		 */
		@RequestMapping(value="/sale/totalarwork/set/del_yn.do")
		...
		// 수금예정리스트
		@RequestMapping(value="/sale/totalarwork/get/arlist.do"  )
		...
		// 수금예정리스트 - 미수현황 조회
		@RequestMapping(value="/sale/totalarwork/get/arlistsales.do"  )
		...
		@RequestMapping(value="/sale/totalarwork/get/arlistitems.do"  )
		...
		@RequestMapping(value="/sale/totalarwork/export/search.do") 
		public String getExportSearch(HttpMessage http, Map<String, Object> model) throws Exception {
			
			model.put(HttpResponseMessage.RECORDS, service.getExportDetail(http.argument));
			return http.writer;
